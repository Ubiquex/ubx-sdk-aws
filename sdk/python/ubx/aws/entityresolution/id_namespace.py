...
class IdNamespace_IdMappingWorkflowProperties_ProviderProperties:
...
@dataclasses.dataclass
class IdNamespace_IdMappingWorkflowProperties_RuleBasedProperties_Rules:
...
@dataclasses.dataclass
class IdNamespace_IdMappingWorkflowProperties_RuleBasedProperties:
...
@dataclasses.dataclass
class IdNamespace_IdMappingWorkflowProperties:
...
@dataclasses.dataclass
class IdNamespace_InputSourceConfig:
...
_IdNamespace_IdMappingWorkflowProperties_ProviderPropertiesFields = {
...
_IdNamespace_IdMappingWorkflowProperties_RuleBasedProperties_RulesFields = {
    "matching_keys": ubx.FieldSpec(wire_name="matching_keys"),
    "rule_name": ubx.FieldSpec(wire_name="rule_name"),
}

_IdNamespace_IdMappingWorkflowProperties_RuleBasedPropertiesFields = {
    ...
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_IdNamespace_IdMappingWorkflowProperties_RuleBasedProperties_RulesFields,
    ),
}

_IdNamespace_IdMappingWorkflowPropertiesFields = {
    "id_mapping_type": ubx.FieldSpec(wire_name="id_mapping_type"),
    "provider_properties": ubx.FieldSpec(
        wire_name="provider_properties",
        kind="object",
        fields=_IdNamespace_IdMappingWorkflowProperties_ProviderPropertiesFields,
    ),
    "rule_based_properties": ubx.FieldSpec(
        wire_name="rule_based_properties",
        kind="object",
        fields=_IdNamespace_IdMappingWorkflowProperties_RuleBasedPropertiesFields,
    ),
}

_IdNamespace_InputSourceConfigFields = {
    "input_source_arn": ubx.FieldSpec(wire_name="input_source_arn"),
    "schema_name": ubx.FieldSpec(wire_name="schema_name"),
}

_IdNamespace_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class IdNamespaceConfig:
...
IdNamespace = ubx.ResourceBinding(
    ...
    fields={
        ...
        "id_mapping_workflow_properties": ubx.FieldSpec(
            ...
            kind="list",
            fields=_IdNamespace_IdMappingWorkflowPropertiesFields,
        ),
        ...
        "input_source_config": ubx.FieldSpec(
            ...
            kind="list",
            fields=_IdNamespace_InputSourceConfigFields,
        ),
        "role_arn": ubx.FieldSpec(wire_name="role_arn"),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_IdNamespace_TagsFields,
        ),
