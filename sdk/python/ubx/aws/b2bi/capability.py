...
class Capability_Configuration_Edi_InputLocation:
...
@dataclasses.dataclass
class Capability_Configuration_Edi_Type_X12Details:
...
@dataclasses.dataclass
class Capability_Configuration_Edi_Type:
...
@dataclasses.dataclass
class Capability_Configuration_Edi:
...
_Capability_Configuration_Edi_InputLocationFields = {
    "bucket_name": ubx.FieldSpec(wire_name="bucket_name"),
    "key": ubx.FieldSpec(wire_name="key"),
}

_Capability_Configuration_Edi_Type_X12DetailsFields = {
    "transaction_set": ubx.FieldSpec(wire_name="transaction_set"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_Capability_Configuration_Edi_TypeFields = {
    "x12_details": ubx.FieldSpec(
        wire_name="x12_details",
        kind="object",
        fields=_Capability_Configuration_Edi_Type_X12DetailsFields,
    ),
}

_Capability_Configuration_EdiFields = {
    "capability_direction": ubx.FieldSpec(wire_name="capability_direction"),
    "input_location": ubx.FieldSpec(
        wire_name="input_location",
        kind="object",
        fields=_Capability_Configuration_Edi_InputLocationFields,
    ),
    ...
    "type": ubx.FieldSpec(
        wire_name="type",
        kind="object",
        fields=_Capability_Configuration_Edi_TypeFields,
    ),
}
...
_Capability_ConfigurationFields = {
    "edi": ubx.FieldSpec(
        wire_name="edi",
        kind="object",
        fields=_Capability_Configuration_EdiFields,
    ),
}
