...
class Transformer_EdiType_X12Details:
...
@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions_X12_SplitOptions:
...
@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_CodeListValidationRule:
...
@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_ElementLengthValidationRule:
...
@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_ElementRequirementValidationRule:
...
@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules:
...
@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions:
    validation_rules: Any = None

@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions_X12:
...
@dataclasses.dataclass
class Transformer_InputConversion_AdvancedOptions:
...
@dataclasses.dataclass
class Transformer_InputConversion_FormatOptions:
...
@dataclasses.dataclass
class Transformer_InputConversion:
...
@dataclasses.dataclass
class Transformer_OutputConversion:
...
@dataclasses.dataclass
class Transformer_SampleDocuments_Keys:
    input: Any = None
    output: Any = None

@dataclasses.dataclass
class Transformer_SampleDocuments:
...
_Transformer_EdiType_X12DetailsFields = {
    "transaction_set": ubx.FieldSpec(wire_name="transaction_set"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_Transformer_EdiTypeFields = {
    "x12_details": ubx.FieldSpec(
        wire_name="x12_details",
        kind="object",
        fields=_Transformer_EdiType_X12DetailsFields,
    ),
}

_Transformer_InputConversion_AdvancedOptions_X12_SplitOptionsFields = {
    "split_by": ubx.FieldSpec(wire_name="split_by"),
}

_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_CodeListValidationRuleFields = {
...
_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_ElementLengthValidationRuleFields = {
    "element_id": ubx.FieldSpec(wire_name="element_id"),
    "max_length": ubx.FieldSpec(wire_name="max_length"),
    "min_length": ubx.FieldSpec(wire_name="min_length"),
}

_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_ElementRequirementValidationRuleFields = {
    "element_position": ubx.FieldSpec(wire_name="element_position"),
    "requirement": ubx.FieldSpec(wire_name="requirement"),
}

_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRulesFields = {
    "code_list_validation_rule": ubx.FieldSpec(
        wire_name="code_list_validation_rule",
        kind="object",
        fields=_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_CodeListValidationRuleFields,
    ),
    "element_length_validation_rule": ubx.FieldSpec(
        wire_name="element_length_validation_rule",
        kind="object",
        fields=_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_ElementLengthValidationRuleFields,
    ),
    "element_requirement_validation_rule": ubx.FieldSpec(
        wire_name="element_requirement_validation_rule",
        kind="object",
        fields=_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRules_ElementRequirementValidationRuleFields,
    ),
}

_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptionsFields = {
    "validation_rules": ubx.FieldSpec(
        wire_name="validation_rules",
        kind="list",
        fields=_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptions_ValidationRulesFields,
    ),
}

_Transformer_InputConversion_AdvancedOptions_X12Fields = {
    "split_options": ubx.FieldSpec(
        wire_name="split_options",
        kind="object",
        fields=_Transformer_InputConversion_AdvancedOptions_X12_SplitOptionsFields,
    ),
    "validation_options": ubx.FieldSpec(
        wire_name="validation_options",
        kind="object",
        fields=_Transformer_InputConversion_AdvancedOptions_X12_ValidationOptionsFields,
    ),
}

_Transformer_InputConversion_AdvancedOptionsFields = {
    "x12": ubx.FieldSpec(
        wire_name="x12",
        kind="object",
        fields=_Transformer_InputConversion_AdvancedOptions_X12Fields,
    ),
}

_Transformer_InputConversion_FormatOptionsFields = {
    "x12": ubx.FieldSpec(
        wire_name="x12",
        kind="object",
        fields=_Transformer_EdiType_X12DetailsFields,
...
_Transformer_SampleDocuments_KeysFields = {
    "input": ubx.FieldSpec(wire_name="input"),
    "output": ubx.FieldSpec(wire_name="output"),
}

_Transformer_SampleDocumentsFields = {
    "bucket_name": ubx.FieldSpec(wire_name="bucket_name"),
    "keys": ubx.FieldSpec(
        wire_name="keys",
        kind="list",
        fields=_Transformer_SampleDocuments_KeysFields,
    ),
}

_Transformer_TagsFields = {
