...
@dataclasses.dataclass
class Recipe_Steps_ConditionExpressions:
...
_Recipe_StepsFields = {
    "action": ubx.FieldSpec(
        wire_name="action",
        kind="object",
        fields=_Recipe_Steps_ActionFields,
    ),
    "condition_expressions": ubx.FieldSpec(
        wire_name="condition_expressions",
        kind="list",
        fields=_Recipe_Steps_ConditionExpressionsFields,
    ),
}
...
Recipe = ubx.ResourceBinding(
    ...
    fields={
        ...
        "steps": ubx.FieldSpec(
            wire_name="steps",
            kind="list",
            fields=_Recipe_StepsFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_Recipe_TagsFields,
        ),
    },
)
