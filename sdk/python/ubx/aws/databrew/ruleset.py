...
class Ruleset_Rules_ColumnSelectors:
...
@dataclasses.dataclass
class Ruleset_Rules_SubstitutionMap:
...
_Ruleset_RulesFields = {
    ...
    "column_selectors": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Ruleset_Rules_ColumnSelectorsFields,
    ),
    ...
    "substitution_map": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Ruleset_Rules_SubstitutionMapFields,
    ),
    "threshold": ubx.FieldSpec(
        wire_name="threshold",
        kind="object",
        fields=_Ruleset_Rules_ThresholdFields,
    ),
}
