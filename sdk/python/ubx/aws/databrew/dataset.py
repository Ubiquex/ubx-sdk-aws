...
class Dataset_FormatOptions_Csv:
...
@dataclasses.dataclass
class Dataset_FormatOptions_Excel:
...
@dataclasses.dataclass
class Dataset_FormatOptions_Json:
...
@dataclasses.dataclass
class Dataset_Input_DataCatalogInputDefinition_TempDirectory:
...
@dataclasses.dataclass
class Dataset_Input_DataCatalogInputDefinition:
    # Catalog id
    catalog_id: Any = None
    # Database name
...
@dataclasses.dataclass
class Dataset_Input_DatabaseInputDefinition:
    # Database table name
...
@dataclasses.dataclass
class Dataset_PathOptions_FilesLimit:
...
@dataclasses.dataclass
class Dataset_PathOptions_LastModifiedDateCondition_ValuesMap:
...
@dataclasses.dataclass
class Dataset_PathOptions_LastModifiedDateCondition:
...
@dataclasses.dataclass
class Dataset_PathOptions_Parameters_DatasetParameter_DatetimeOptions:
...
@dataclasses.dataclass
class Dataset_PathOptions_Parameters_DatasetParameter:
...
@dataclasses.dataclass
class Dataset_PathOptions_Parameters:
...
_Dataset_FormatOptions_CsvFields = {
    "delimiter": ubx.FieldSpec(wire_name="delimiter"),
    "header_row": ubx.FieldSpec(wire_name="header_row"),
}

_Dataset_FormatOptions_ExcelFields = {
    "header_row": ubx.FieldSpec(wire_name="header_row"),
    "sheet_indexes": ubx.FieldSpec(wire_name="sheet_indexes"),
    "sheet_names": ubx.FieldSpec(wire_name="sheet_names"),
}

_Dataset_FormatOptions_JsonFields = {
    "multi_line": ubx.FieldSpec(wire_name="multi_line"),
}

_Dataset_FormatOptionsFields = {
    "csv": ubx.FieldSpec(
        wire_name="csv",
        kind="object",
        fields=_Dataset_FormatOptions_CsvFields,
    ),
    "excel": ubx.FieldSpec(
        wire_name="excel",
        kind="object",
        fields=_Dataset_FormatOptions_ExcelFields,
    ),
    "json": ubx.FieldSpec(
        wire_name="json",
        kind="object",
        fields=_Dataset_FormatOptions_JsonFields,
    ),
}

_Dataset_Input_DataCatalogInputDefinition_TempDirectoryFields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "bucket_owner": ubx.FieldSpec(wire_name="bucket_owner"),
    "key": ubx.FieldSpec(wire_name="key"),
}

_Dataset_Input_DataCatalogInputDefinitionFields = {
    ...
    "temp_directory": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Dataset_Input_DataCatalogInputDefinition_TempDirectoryFields,
    ),
}

_Dataset_Input_DatabaseInputDefinitionFields = {
...
_Dataset_PathOptions_FilesLimitFields = {
...
_Dataset_PathOptions_LastModifiedDateCondition_ValuesMapFields = {
    "value": ubx.FieldSpec(wire_name="value"),
    "value_reference": ubx.FieldSpec(wire_name="value_reference"),
}

_Dataset_PathOptions_LastModifiedDateConditionFields = {
    "expression": ubx.FieldSpec(wire_name="expression"),
    "values_map": ubx.FieldSpec(
        wire_name="values_map",
        kind="list",
        fields=_Dataset_PathOptions_LastModifiedDateCondition_ValuesMapFields,
    ),
}

_Dataset_PathOptions_Parameters_DatasetParameter_DatetimeOptionsFields = {
...
_Dataset_PathOptions_Parameters_DatasetParameterFields = {
    "create_column": ubx.FieldSpec(wire_name="create_column"),
    "datetime_options": ubx.FieldSpec(
        wire_name="datetime_options",
        kind="object",
        fields=_Dataset_PathOptions_Parameters_DatasetParameter_DatetimeOptionsFields,
    ),
    "filter": ubx.FieldSpec(
        wire_name="filter",
        kind="object",
        fields=_Dataset_PathOptions_LastModifiedDateConditionFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_Dataset_PathOptions_ParametersFields = {
    "dataset_parameter": ubx.FieldSpec(
        wire_name="dataset_parameter",
        kind="object",
        fields=_Dataset_PathOptions_Parameters_DatasetParameterFields,
    ),
    "path_parameter_name": ubx.FieldSpec(wire_name="path_parameter_name"),
}

_Dataset_PathOptionsFields = {
    "files_limit": ubx.FieldSpec(
        wire_name="files_limit",
        kind="object",
        fields=_Dataset_PathOptions_FilesLimitFields,
    ),
    ...
    "parameters": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Dataset_PathOptions_ParametersFields,
    ),
}
...
Dataset = ubx.ResourceBinding(
    ...
    fields={
        ...
        "format_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Dataset_FormatOptionsFields,
        ),
        "input": ubx.FieldSpec(
            wire_name="input",
            kind="object",
            fields=_Dataset_InputFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "path_options": ubx.FieldSpec(
            wire_name="path_options",
            kind="object",
            fields=_Dataset_PathOptionsFields,
        ),
