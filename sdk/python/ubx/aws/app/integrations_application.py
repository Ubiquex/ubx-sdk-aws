...
@dataclasses.dataclass
class IntegrationsApplication_ApplicationConfig:
...
_IntegrationsApplication_ApplicationConfigFields = {
    "contact_handling": ubx.FieldSpec(
        wire_name="contact_handling",
        kind="object",
        fields=_IntegrationsApplication_ApplicationConfig_ContactHandlingFields,
    ),
}

_IntegrationsApplication_ApplicationSourceConfig_ExternalUrlConfigFields = {
    "access_url": ubx.FieldSpec(wire_name="access_url"),
    "approved_origins": ubx.FieldSpec(wire_name="approved_origins"),
}

_IntegrationsApplication_ApplicationSourceConfigFields = {
    "external_url_config": ubx.FieldSpec(
        wire_name="external_url_config",
        kind="object",
        fields=_IntegrationsApplication_ApplicationSourceConfig_ExternalUrlConfigFields,
    ),
}

_IntegrationsApplication_IframeConfigFields = {
    "allow": ubx.FieldSpec(wire_name="allow"),
    "sandbox": ubx.FieldSpec(wire_name="sandbox"),
}

_IntegrationsApplication_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class IntegrationsApplicationConfig:
...
@dataclasses.dataclass
class IntegrationsApplicationAttrs:
...
IntegrationsApplication = ubx.ResourceBinding(
    ...
    fields={
        ...
        "iframe_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_IntegrationsApplication_IframeConfigFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_IntegrationsApplication_TagsFields,
        ),
    },
)
