...
@dataclasses.dataclass
class RunnerAutoScalingConfigurationConfig:
...
@dataclasses.dataclass
class RunnerAutoScalingConfigurationAttrs:
...
RunnerAutoScalingConfiguration = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_RunnerAutoScalingConfiguration_TagsFields,
        ),
    },
)
