...
class ConfigExperimentDefinition_Control:
...
@dataclasses.dataclass
class ConfigExperimentDefinition_Tags:
    key: Any = None
    value: Any = None

_ConfigExperimentDefinition_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ConfigExperimentDefinitionConfig:
...
@dataclasses.dataclass
class ConfigExperimentDefinitionAttrs:
...
ConfigExperimentDefinition = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ConfigExperimentDefinition_TagsFields,
        ),
    },
)
