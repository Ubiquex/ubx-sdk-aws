...
class ScalableTarget_ScheduledActions_ScalableTargetAction:
...
@dataclasses.dataclass
class ScalableTarget_ScheduledActions:
...
@dataclasses.dataclass
class ScalableTarget_SuspendedState:
...
_ScalableTarget_SuspendedStateFields = {
...
ScalableTarget = ubx.ResourceBinding(
    wire_type="aws_application_auto_scaling_scalable_target",
    fields={
        "max_capacity": ubx.FieldSpec(wire_name="max_capacity"),
        "min_capacity": ubx.FieldSpec(wire_name="min_capacity"),
        ...
        "scheduled_actions": ubx.FieldSpec(
            wire_name="scheduled_actions",
            kind="list",
            fields=_ScalableTarget_ScheduledActionsFields,
        ),
        "service_namespace": ubx.FieldSpec(wire_name="service_namespace"),
        "suspended_state": ubx.FieldSpec(
            wire_name="suspended_state",
            kind="object",
            fields=_ScalableTarget_SuspendedStateFields,
        ),
    },
)
