...
class LoadBalancingV2TargetGroup_Matcher:
...
_LoadBalancingV2TargetGroup_MatcherFields = {
    "grpc_code": ubx.FieldSpec(wire_name="grpc_code"),
    "http_code": ubx.FieldSpec(wire_name="http_code"),
}

_LoadBalancingV2TargetGroup_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_LoadBalancingV2TargetGroup_TargetsFields = {
...
@dataclasses.dataclass
class LoadBalancingV2TargetGroupConfig:
...
@dataclasses.dataclass
class LoadBalancingV2TargetGroupAttrs:
    # Indicates whether health checks are enabled. If the target type is lambda, health checks are disabled by default but can be enabled. If the target type is instance, ip, or alb, health checks are always enabled and cannot be disabled.
    health_check_enabled: Any = None
    # The approximate amount of time, in seconds, between health checks of an individual target.
    health_check_interval_seconds: Any = None
...
LoadBalancingV2TargetGroup = ubx.ResourceBinding(
    ...
    fields={
        ...
        "matcher": ubx.FieldSpec(
            wire_name="matcher",
            kind="object",
            fields=_LoadBalancingV2TargetGroup_MatcherFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_LoadBalancingV2TargetGroup_TagsFields,
        ),
        ...
        "targets": ubx.FieldSpec(
            wire_name="targets",
            kind="list",
            fields=_LoadBalancingV2TargetGroup_TargetsFields,
        ),
