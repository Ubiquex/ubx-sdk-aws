...
@dataclasses.dataclass
class AutoScalingScalableTarget_SuspendedState:
...
_AutoScalingScalableTarget_SuspendedStateFields = {
...
@dataclasses.dataclass
class AutoScalingScalableTargetConfig:
...
AutoScalingScalableTarget = ubx.ResourceBinding(
