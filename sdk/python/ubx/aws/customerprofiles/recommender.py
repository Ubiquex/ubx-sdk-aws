...
class Recommender_LatestRecommenderUpdate_RecommenderConfig_EventsConfig_EventParametersList:
...
@dataclasses.dataclass
class Recommender_LatestRecommenderUpdate_RecommenderConfig_EventsConfig:
    # List of event parameters with their value thresholds
    event_parameters_list: Any = None

@dataclasses.dataclass
class Recommender_LatestRecommenderUpdate_RecommenderConfig:
    # Configuration for events used in the recommender
    events_config: Any = None

@dataclasses.dataclass
class Recommender_LatestRecommenderUpdate:
...
@dataclasses.dataclass
class Recommender_TrainingMetrics_Metrics:
...
@dataclasses.dataclass
class Recommender_TrainingMetrics:
    metrics: Any = None
    time: Any = None

_Recommender_LatestRecommenderUpdate_RecommenderConfig_EventsConfig_EventParametersListFields = {
    "event_type": ubx.FieldSpec(wire_name="event_type"),
    "event_value_threshold": ubx.FieldSpec(wire_name="event_value_threshold"),
}

_Recommender_LatestRecommenderUpdate_RecommenderConfig_EventsConfigFields = {
    "event_parameters_list": ubx.FieldSpec(
        wire_name="event_parameters_list",
        kind="list",
        fields=_Recommender_LatestRecommenderUpdate_RecommenderConfig_EventsConfig_EventParametersListFields,
    ),
}

_Recommender_LatestRecommenderUpdate_RecommenderConfigFields = {
    "events_config": ubx.FieldSpec(
        wire_name="events_config",
        kind="object",
        fields=_Recommender_LatestRecommenderUpdate_RecommenderConfig_EventsConfigFields,
    ),
}

_Recommender_TagsFields = {
...
Recommender = ubx.ResourceBinding(
    ...
    fields={
        ...
        "recommender_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Recommender_LatestRecommenderUpdate_RecommenderConfigFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_Recommender_TagsFields,
        ),
    },
)
