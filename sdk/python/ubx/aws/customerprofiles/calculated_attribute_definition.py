...
class CalculatedAttributeDefinition_AttributeDetails_Attributes:
...
@dataclasses.dataclass
class CalculatedAttributeDefinition_AttributeDetails:
...
@dataclasses.dataclass
class CalculatedAttributeDefinition_Conditions_Range_ValueRange:
...
@dataclasses.dataclass
class CalculatedAttributeDefinition_Conditions_Range:
...
@dataclasses.dataclass
class CalculatedAttributeDefinition_Conditions_Threshold:
...
@dataclasses.dataclass
class CalculatedAttributeDefinition_Conditions:
...
@dataclasses.dataclass
class CalculatedAttributeDefinition_Readiness:
...
@dataclasses.dataclass
class CalculatedAttributeDefinition_Tags:
...
_CalculatedAttributeDefinition_AttributeDetails_AttributesFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_CalculatedAttributeDefinition_AttributeDetailsFields = {
    "attributes": ubx.FieldSpec(
        wire_name="attributes",
        kind="list",
        fields=_CalculatedAttributeDefinition_AttributeDetails_AttributesFields,
    ),
    "expression": ubx.FieldSpec(wire_name="expression"),
}

_CalculatedAttributeDefinition_Conditions_Range_ValueRangeFields = {
    "end": ubx.FieldSpec(wire_name="end"),
    "start": ubx.FieldSpec(wire_name="start"),
}

_CalculatedAttributeDefinition_Conditions_RangeFields = {
    ...
    "value_range": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CalculatedAttributeDefinition_Conditions_Range_ValueRangeFields,
    ),
}

_CalculatedAttributeDefinition_Conditions_ThresholdFields = {
    "operator": ubx.FieldSpec(wire_name="operator"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_CalculatedAttributeDefinition_ConditionsFields = {
    "object_count": ubx.FieldSpec(wire_name="object_count"),
    "range": ubx.FieldSpec(
        wire_name="range",
        kind="object",
        fields=_CalculatedAttributeDefinition_Conditions_RangeFields,
    ),
    "threshold": ubx.FieldSpec(
        wire_name="threshold",
        kind="object",
        fields=_CalculatedAttributeDefinition_Conditions_ThresholdFields,
    ),
}

_CalculatedAttributeDefinition_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class CalculatedAttributeDefinitionConfig:
...
@dataclasses.dataclass
class CalculatedAttributeDefinitionAttrs:
    # Mathematical expression and a list of attribute items specified in that expression.
    attribute_details: Any = None
    # The unique name of the calculated attribute.
    calculated_attribute_name: Any = None
...
CalculatedAttributeDefinition = ubx.ResourceBinding(
    ...
    fields={
        "attribute_details": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CalculatedAttributeDefinition_AttributeDetailsFields,
        ),
        "calculated_attribute_name": ubx.FieldSpec(wire_name="calculated_attribute_name"),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="object",
            fields=_CalculatedAttributeDefinition_ConditionsFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_CalculatedAttributeDefinition_TagsFields,
        ),
