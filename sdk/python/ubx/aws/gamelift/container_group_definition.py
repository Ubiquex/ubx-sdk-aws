...
class ContainerGroupDefinition_GameServerContainerDefinition_DependsOn:
...
@dataclasses.dataclass
class ContainerGroupDefinition_GameServerContainerDefinition_EnvironmentOverride:
...
@dataclasses.dataclass
class ContainerGroupDefinition_GameServerContainerDefinition_LinuxCapabilities:
    # The list of Linux capabilities to add to the container's default configuration.
    include: Any = None

@dataclasses.dataclass
class ContainerGroupDefinition_GameServerContainerDefinition_MountPoints:
...
@dataclasses.dataclass
class ContainerGroupDefinition_GameServerContainerDefinition_PortConfiguration_ContainerPortRanges:
...
@dataclasses.dataclass
class ContainerGroupDefinition_GameServerContainerDefinition_PortConfiguration:
    # Specifies one or more ranges of ports on a container.
    container_port_ranges: Any = None

@dataclasses.dataclass
class ContainerGroupDefinition_GameServerContainerDefinition:
...
@dataclasses.dataclass
class ContainerGroupDefinition_SupportContainerDefinitions_HealthCheck:
...
@dataclasses.dataclass
class ContainerGroupDefinition_SupportContainerDefinitions:
...
@dataclasses.dataclass
class ContainerGroupDefinition_Tags:
...
_ContainerGroupDefinition_GameServerContainerDefinition_DependsOnFields = {
    "condition": ubx.FieldSpec(wire_name="condition"),
    "container_name": ubx.FieldSpec(wire_name="container_name"),
}

_ContainerGroupDefinition_GameServerContainerDefinition_EnvironmentOverrideFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_ContainerGroupDefinition_GameServerContainerDefinition_LinuxCapabilitiesFields = {
    "include": ubx.FieldSpec(wire_name="include"),
}

_ContainerGroupDefinition_GameServerContainerDefinition_MountPointsFields = {
...
_ContainerGroupDefinition_GameServerContainerDefinition_PortConfiguration_ContainerPortRangesFields = {
...
_ContainerGroupDefinition_GameServerContainerDefinition_PortConfigurationFields = {
    "container_port_ranges": ubx.FieldSpec(
        wire_name="container_port_ranges",
        kind="list",
        fields=_ContainerGroupDefinition_GameServerContainerDefinition_PortConfiguration_ContainerPortRangesFields,
    ),
}

_ContainerGroupDefinition_GameServerContainerDefinitionFields = {
    "container_name": ubx.FieldSpec(wire_name="container_name"),
    "depends_on": ubx.FieldSpec(
        wire_name="depends_on",
        kind="list",
        fields=_ContainerGroupDefinition_GameServerContainerDefinition_DependsOnFields,
    ),
    "environment_override": ubx.FieldSpec(
        wire_name="environment_override",
        kind="list",
        fields=_ContainerGroupDefinition_GameServerContainerDefinition_EnvironmentOverrideFields,
    ),
    "image_uri": ubx.FieldSpec(wire_name="image_uri"),
    "linux_capabilities": ubx.FieldSpec(
        wire_name="linux_capabilities",
        kind="object",
        fields=_ContainerGroupDefinition_GameServerContainerDefinition_LinuxCapabilitiesFields,
    ),
    "mount_points": ubx.FieldSpec(
        wire_name="mount_points",
        kind="list",
        fields=_ContainerGroupDefinition_GameServerContainerDefinition_MountPointsFields,
    ),
    "port_configuration": ubx.FieldSpec(
        wire_name="port_configuration",
        kind="object",
        fields=_ContainerGroupDefinition_GameServerContainerDefinition_PortConfigurationFields,
    ),
...
_ContainerGroupDefinition_SupportContainerDefinitions_HealthCheckFields = {
...
_ContainerGroupDefinition_SupportContainerDefinitionsFields = {
    "container_name": ubx.FieldSpec(wire_name="container_name"),
    "depends_on": ubx.FieldSpec(
        wire_name="depends_on",
        kind="list",
    ...
    "health_check": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ContainerGroupDefinition_SupportContainerDefinitions_HealthCheckFields,
    ),
    "image_uri": ubx.FieldSpec(wire_name="image_uri"),
    "linux_capabilities": ubx.FieldSpec(
        wire_name="linux_capabilities",
...
_ContainerGroupDefinition_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ContainerGroupDefinitionConfig:
...
@dataclasses.dataclass
class ContainerGroupDefinitionAttrs:
...
ContainerGroupDefinition = ubx.ResourceBinding(
    ...
    fields={
        ...
        "game_server_container_definition": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ContainerGroupDefinition_GameServerContainerDefinitionFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "support_container_definitions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ContainerGroupDefinition_SupportContainerDefinitionsFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ContainerGroupDefinition_TagsFields,
        ),
