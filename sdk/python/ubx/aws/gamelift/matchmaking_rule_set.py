...
_MatchmakingRuleSet_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class MatchmakingRuleSetConfig:
...
MatchmakingRuleSet = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_MatchmakingRuleSet_TagsFields,
        ),
    },
)
