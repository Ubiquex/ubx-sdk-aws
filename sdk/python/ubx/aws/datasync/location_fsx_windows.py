...
class LocationFsxWindows_CmkSecretConfig:
...
@dataclasses.dataclass
class LocationFsxWindows_CustomSecretConfig:
...
@dataclasses.dataclass
class LocationFsxWindows_ManagedSecretConfig:
    # Specifies the ARN for an AWS Secrets Manager secret.
    secret_arn: Any = None

@dataclasses.dataclass
class LocationFsxWindows_Tags:
...
LocationFsxWindows = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_LocationFsxWindows_TagsFields,
        ),
