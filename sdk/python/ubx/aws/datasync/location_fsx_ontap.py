...
class LocationFsxOntap_Protocol_Nfs_MountOptions:
    # The specific NFS version that you want DataSync to use to mount your NFS share.
    version: Any = None

@dataclasses.dataclass
class LocationFsxOntap_Protocol_Nfs:
    # The NFS mount options that DataSync can use to mount your NFS share.
    mount_options: Any = None

@dataclasses.dataclass
class LocationFsxOntap_Protocol_Smb_CmkSecretConfig:
...
@dataclasses.dataclass
class LocationFsxOntap_Protocol_Smb_CustomSecretConfig:
...
@dataclasses.dataclass
class LocationFsxOntap_Protocol_Smb_ManagedSecretConfig:
    # Specifies the ARN for an AWS Secrets Manager secret.
    secret_arn: Any = None

@dataclasses.dataclass
class LocationFsxOntap_Protocol_Smb:
...
@dataclasses.dataclass
class LocationFsxOntap_Protocol:
...
_LocationFsxOntap_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class LocationFsxOntapConfig:
...
LocationFsxOntap = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_LocationFsxOntap_TagsFields,
        ),
    },
)
