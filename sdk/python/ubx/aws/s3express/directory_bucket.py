...
class DirectoryBucket_BucketEncryption_ServerSideEncryptionConfiguration_ServerSideEncryptionByDefault:
...
@dataclasses.dataclass
class DirectoryBucket_BucketEncryption_ServerSideEncryptionConfiguration:
...
@dataclasses.dataclass
class DirectoryBucket_BucketEncryption:
    # Specifies the default server-side-encryption configuration.
    server_side_encryption_configuration: Any = None

@dataclasses.dataclass
class DirectoryBucket_InventoryConfigurations_Destination:
...
@dataclasses.dataclass
class DirectoryBucket_InventoryConfigurations:
...
@dataclasses.dataclass
class DirectoryBucket_LifecycleConfiguration_Rules_AbortIncompleteMultipartUpload:
...
@dataclasses.dataclass
class DirectoryBucket_LifecycleConfiguration_Rules:
...
@dataclasses.dataclass
class DirectoryBucket_LifecycleConfiguration:
    # A lifecycle rule for individual objects in an Amazon S3 Express bucket.
    rules: Any = None

@dataclasses.dataclass
class DirectoryBucket_MetricsConfigurations:
...
_DirectoryBucket_BucketEncryption_ServerSideEncryptionConfiguration_ServerSideEncryptionByDefaultFields = {
    "kmsmaster_key_id": ubx.FieldSpec(wire_name="kmsmaster_key_id"),
    "ssealgorithm": ubx.FieldSpec(wire_name="ssealgorithm"),
}

_DirectoryBucket_BucketEncryption_ServerSideEncryptionConfigurationFields = {
    ...
    "server_side_encryption_by_default": ubx.FieldSpec(
        ...
        kind="object",
        fields=_DirectoryBucket_BucketEncryption_ServerSideEncryptionConfiguration_ServerSideEncryptionByDefaultFields,
    ),
}

_DirectoryBucket_BucketEncryptionFields = {
    "server_side_encryption_configuration": ubx.FieldSpec(
        wire_name="server_side_encryption_configuration",
        kind="list",
        fields=_DirectoryBucket_BucketEncryption_ServerSideEncryptionConfigurationFields,
    ),
}

_DirectoryBucket_InventoryConfigurations_DestinationFields = {
...
_DirectoryBucket_InventoryConfigurationsFields = {
    "destination": ubx.FieldSpec(
        wire_name="destination",
        kind="object",
        fields=_DirectoryBucket_InventoryConfigurations_DestinationFields,
    ),
...
_DirectoryBucket_LifecycleConfiguration_Rules_AbortIncompleteMultipartUploadFields = {
    "days_after_initiation": ubx.FieldSpec(wire_name="days_after_initiation"),
}

_DirectoryBucket_LifecycleConfiguration_RulesFields = {
    "abort_incomplete_multipart_upload": ubx.FieldSpec(
        wire_name="abort_incomplete_multipart_upload",
        kind="object",
        fields=_DirectoryBucket_LifecycleConfiguration_Rules_AbortIncompleteMultipartUploadFields,
    ),
...
_DirectoryBucket_LifecycleConfigurationFields = {
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_DirectoryBucket_LifecycleConfiguration_RulesFields,
    ),
}

_DirectoryBucket_MetricsConfigurationsFields = {
    "access_point_arn": ubx.FieldSpec(wire_name="access_point_arn"),
    "id": ubx.FieldSpec(wire_name="id"),
    "prefix": ubx.FieldSpec(wire_name="prefix"),
}

_DirectoryBucket_TagsFields = {
...
DirectoryBucket = ubx.ResourceBinding(
    ...
    fields={
        "bucket_encryption": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DirectoryBucket_BucketEncryptionFields,
        ),
        ...
        "inventory_configurations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_DirectoryBucket_InventoryConfigurationsFields,
        ),
        "lifecycle_configuration": ubx.FieldSpec(
            wire_name="lifecycle_configuration",
            kind="object",
            fields=_DirectoryBucket_LifecycleConfigurationFields,
        ),
        "location_name": ubx.FieldSpec(wire_name="location_name"),
        "metrics_configurations": ubx.FieldSpec(
            wire_name="metrics_configurations",
            kind="list",
            fields=_DirectoryBucket_MetricsConfigurationsFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_DirectoryBucket_TagsFields,
        ),
    },
)
