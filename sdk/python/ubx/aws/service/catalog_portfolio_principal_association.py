...
class CatalogPortfolioPrincipalAssociationConfig:
    # The language code.
...
@dataclasses.dataclass
class CatalogPortfolioPrincipalAssociationAttrs:
    # The language code.
    accept_language: Any = None
    # The portfolio identifier.
    portfolio_id: Any = None
...
CatalogPortfolioPrincipalAssociation = ubx.ResourceBinding(
