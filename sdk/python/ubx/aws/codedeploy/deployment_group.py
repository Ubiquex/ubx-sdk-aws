...
class DeploymentGroup_AlarmConfiguration_Alarms:
...
@dataclasses.dataclass
class DeploymentGroup_BlueGreenDeploymentConfiguration_DeploymentReadyOption:
...
@dataclasses.dataclass
class DeploymentGroup_BlueGreenDeploymentConfiguration_GreenFleetProvisioningOption:
    # The method used to add instances to a replacement environment.
    action: Any = None

@dataclasses.dataclass
class DeploymentGroup_BlueGreenDeploymentConfiguration_TerminateBlueInstancesOnDeploymentSuccess:
...
@dataclasses.dataclass
class DeploymentGroup_BlueGreenDeploymentConfiguration:
...
@dataclasses.dataclass
class DeploymentGroup_Deployment_Revision_GitHubLocation:
...
@dataclasses.dataclass
class DeploymentGroup_Deployment_Revision_S3Location:
...
@dataclasses.dataclass
class DeploymentGroup_Deployment_Revision:
...
@dataclasses.dataclass
class DeploymentGroup_Deployment:
...
@dataclasses.dataclass
class DeploymentGroup_Ecsservices:
...
@dataclasses.dataclass
class DeploymentGroup_Ec2TagFilters:
...
@dataclasses.dataclass
class DeploymentGroup_Ec2TagSet_Ec2TagSetList:
...
@dataclasses.dataclass
class DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoList_ProdTrafficRoute:
...
@dataclasses.dataclass
class DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoList:
...
@dataclasses.dataclass
class DeploymentGroup_OnPremisesTagSet_OnPremisesTagSetList:
...
@dataclasses.dataclass
class DeploymentGroup_TriggerConfigurations:
...
_DeploymentGroup_AlarmConfiguration_AlarmsFields = {
...
_DeploymentGroup_AlarmConfigurationFields = {
    "alarms": ubx.FieldSpec(
        wire_name="alarms",
        kind="list",
        fields=_DeploymentGroup_AlarmConfiguration_AlarmsFields,
    ),
...
_DeploymentGroup_BlueGreenDeploymentConfiguration_DeploymentReadyOptionFields = {
...
_DeploymentGroup_BlueGreenDeploymentConfiguration_GreenFleetProvisioningOptionFields = {
    "action": ubx.FieldSpec(wire_name="action"),
}

_DeploymentGroup_BlueGreenDeploymentConfiguration_TerminateBlueInstancesOnDeploymentSuccessFields = {
    "action": ubx.FieldSpec(wire_name="action"),
    "termination_wait_time_in_minutes": ubx.FieldSpec(wire_name="termination_wait_time_in_minutes"),
}

_DeploymentGroup_BlueGreenDeploymentConfigurationFields = {
    "deployment_ready_option": ubx.FieldSpec(
        wire_name="deployment_ready_option",
        kind="object",
        fields=_DeploymentGroup_BlueGreenDeploymentConfiguration_DeploymentReadyOptionFields,
    ),
    "green_fleet_provisioning_option": ubx.FieldSpec(
        wire_name="green_fleet_provisioning_option",
        kind="object",
        fields=_DeploymentGroup_BlueGreenDeploymentConfiguration_GreenFleetProvisioningOptionFields,
    ),
    "terminate_blue_instances_on_deployment_success": ubx.FieldSpec(
        wire_name="terminate_blue_instances_on_deployment_success",
        kind="object",
        fields=_DeploymentGroup_BlueGreenDeploymentConfiguration_TerminateBlueInstancesOnDeploymentSuccessFields,
    ),
}

_DeploymentGroup_Deployment_Revision_GitHubLocationFields = {
    "commit_id": ubx.FieldSpec(wire_name="commit_id"),
    "repository": ubx.FieldSpec(wire_name="repository"),
}

_DeploymentGroup_Deployment_Revision_S3LocationFields = {
...
_DeploymentGroup_Ec2TagSetFields = {
    "ec2_tag_set_list": ubx.FieldSpec(
        ...
        kind="list",
        fields=_DeploymentGroup_Ec2TagSet_Ec2TagSetListFields,
    ),
}

_DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoList_ProdTrafficRouteFields = {
    "listener_arns": ubx.FieldSpec(wire_name="listener_arns"),
}

_DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoListFields = {
    "prod_traffic_route": ubx.FieldSpec(
        wire_name="prod_traffic_route",
        kind="object",
        fields=_DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoList_ProdTrafficRouteFields,
    ),
...
_DeploymentGroup_LoadBalancerInfoFields = {
    ...
    "target_group_pair_info_list": ubx.FieldSpec(
        ...
        kind="list",
        fields=_DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoListFields,
    ),
}

_DeploymentGroup_OnPremisesTagSet_OnPremisesTagSetListFields = {
...
_DeploymentGroup_OnPremisesTagSetFields = {
    "on_premises_tag_set_list": ubx.FieldSpec(
        wire_name="on_premises_tag_set_list",
        kind="list",
        fields=_DeploymentGroup_OnPremisesTagSet_OnPremisesTagSetListFields,
    ),
}

_DeploymentGroup_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_DeploymentGroup_TriggerConfigurationsFields = {
...
DeploymentGroup = ubx.ResourceBinding(
    ...
    fields={
        ...
        "blue_green_deployment_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DeploymentGroup_BlueGreenDeploymentConfigurationFields,
        ),
        "deployment": ubx.FieldSpec(
            wire_name="deployment",
            kind="object",
            fields=_DeploymentGroup_DeploymentFields,
        ),
        ...
        "ecsservices": ubx.FieldSpec(
            ...
            kind="list",
            fields=_DeploymentGroup_EcsservicesFields,
        ),
        ...
        "on_premises_tag_set": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DeploymentGroup_OnPremisesTagSetFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_DeploymentGroup_TagsFields,
        ),
        ...
        "trigger_configurations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_DeploymentGroup_TriggerConfigurationsFields,
        ),
    },
)
