...
@dataclasses.dataclass
class DeploymentConfig_TrafficRoutingConfig_TimeBasedLinear:
...
_DeploymentConfig_TrafficRoutingConfig_TimeBasedLinearFields = {
...
_DeploymentConfig_TrafficRoutingConfigFields = {
    ...
    "time_based_linear": ubx.FieldSpec(
        ...
        kind="object",
        fields=_DeploymentConfig_TrafficRoutingConfig_TimeBasedLinearFields,
    ),
    "type": ubx.FieldSpec(wire_name="type"),
}
