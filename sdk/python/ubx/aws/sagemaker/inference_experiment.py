...
class InferenceExperiment_DataStorageConfig_ContentType:
...
@dataclasses.dataclass
class InferenceExperiment_DataStorageConfig:
...
@dataclasses.dataclass
class InferenceExperiment_EndpointMetadata:
...
@dataclasses.dataclass
class InferenceExperiment_ModelVariants_InfrastructureConfig_RealTimeInferenceConfig:
...
@dataclasses.dataclass
class InferenceExperiment_ModelVariants_InfrastructureConfig:
...
@dataclasses.dataclass
class InferenceExperiment_ModelVariants:
...
@dataclasses.dataclass
class InferenceExperiment_Schedule:
...
@dataclasses.dataclass
class InferenceExperiment_ShadowModeConfig_ShadowModelVariants:
...
@dataclasses.dataclass
class InferenceExperiment_ShadowModeConfig:
...
@dataclasses.dataclass
class InferenceExperiment_Tags:
...
_InferenceExperiment_ModelVariants_InfrastructureConfigFields = {
    ...
    "real_time_inference_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_InferenceExperiment_ModelVariants_InfrastructureConfig_RealTimeInferenceConfigFields,
    ),
}

_InferenceExperiment_ModelVariantsFields = {
    "infrastructure_config": ubx.FieldSpec(
        wire_name="infrastructure_config",
        kind="object",
        fields=_InferenceExperiment_ModelVariants_InfrastructureConfigFields,
    ),
    "model_name": ubx.FieldSpec(wire_name="model_name"),
    "variant_name": ubx.FieldSpec(wire_name="variant_name"),
}

_InferenceExperiment_ScheduleFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_InferenceExperiment_ShadowModeConfig_ShadowModelVariantsFields = {
...
_InferenceExperiment_ShadowModeConfigFields = {
    "shadow_model_variants": ubx.FieldSpec(
        wire_name="shadow_model_variants",
        kind="list",
        fields=_InferenceExperiment_ShadowModeConfig_ShadowModelVariantsFields,
    ),
    "source_model_variant_name": ubx.FieldSpec(wire_name="source_model_variant_name"),
}

_InferenceExperiment_TagsFields = {
...
@dataclasses.dataclass
class InferenceExperimentAttrs:
...
InferenceExperiment = ubx.ResourceBinding(
    ...
    fields={
        ...
        "model_variants": ubx.FieldSpec(
            ...
            kind="list",
            fields=_InferenceExperiment_ModelVariantsFields,
        ),
        ...
        "schedule": ubx.FieldSpec(
            wire_name="schedule",
            kind="object",
            fields=_InferenceExperiment_ScheduleFields,
        ),
        "shadow_mode_config": ubx.FieldSpec(
            wire_name="shadow_mode_config",
            kind="object",
            fields=_InferenceExperiment_ShadowModeConfigFields,
        ),
        "status_reason": ubx.FieldSpec(wire_name="status_reason"),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_InferenceExperiment_TagsFields,
        ),
