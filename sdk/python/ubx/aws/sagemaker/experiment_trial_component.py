...
class ExperimentTrialComponent_MetadataProperties:
...
@dataclasses.dataclass
class ExperimentTrialComponent_Status:
...
@dataclasses.dataclass
class ExperimentTrialComponent_Tags:
...
_ExperimentTrialComponent_MetadataPropertiesFields = {
...
_ExperimentTrialComponent_StatusFields = {
    "message": ubx.FieldSpec(wire_name="message"),
    "primary_status": ubx.FieldSpec(wire_name="primary_status"),
}

_ExperimentTrialComponent_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ExperimentTrialComponentConfig:
...
@dataclasses.dataclass
class ExperimentTrialComponentAttrs:
...
ExperimentTrialComponent = ubx.ResourceBinding(
    ...
    fields={
        ...
        "metadata_properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ExperimentTrialComponent_MetadataPropertiesFields,
        ),
        "start_time": ubx.FieldSpec(wire_name="start_time"),
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_ExperimentTrialComponent_StatusFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ExperimentTrialComponent_TagsFields,
        ),
