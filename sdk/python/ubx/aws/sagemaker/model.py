...
class Model_Containers_ImageConfig_RepositoryAuthConfig:
...
@dataclasses.dataclass
class Model_Containers_ImageConfig:
...
@dataclasses.dataclass
class Model_Containers_ModelDataSource_S3DataSource_HubAccessConfig:
...
@dataclasses.dataclass
class Model_Containers_ModelDataSource_S3DataSource_ModelAccessConfig:
...
@dataclasses.dataclass
class Model_Containers_ModelDataSource_S3DataSource:
...
@dataclasses.dataclass
class Model_Containers_ModelDataSource:
...
@dataclasses.dataclass
class Model_Containers_MultiModelConfig:
...
_Model_Containers_ImageConfigFields = {
    ...
    "repository_auth_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Model_Containers_ImageConfig_RepositoryAuthConfigFields,
    ),
}

_Model_Containers_ModelDataSource_S3DataSource_HubAccessConfigFields = {
    "hub_content_arn": ubx.FieldSpec(wire_name="hub_content_arn"),
}

_Model_Containers_ModelDataSource_S3DataSource_ModelAccessConfigFields = {
    "accept_eula": ubx.FieldSpec(wire_name="accept_eula"),
}

_Model_Containers_ModelDataSource_S3DataSourceFields = {
    "compression_type": ubx.FieldSpec(wire_name="compression_type"),
    "hub_access_config": ubx.FieldSpec(
        wire_name="hub_access_config",
        kind="object",
        fields=_Model_Containers_ModelDataSource_S3DataSource_HubAccessConfigFields,
    ),
    "model_access_config": ubx.FieldSpec(
        wire_name="model_access_config",
        kind="object",
        fields=_Model_Containers_ModelDataSource_S3DataSource_ModelAccessConfigFields,
    ),
    "s3_data_type": ubx.FieldSpec(wire_name="s3_data_type"),
    "s3_uri": ubx.FieldSpec(wire_name="s3_uri"),
}

_Model_Containers_ModelDataSourceFields = {
    "s3_data_source": ubx.FieldSpec(
        wire_name="s3_data_source",
        kind="object",
        fields=_Model_Containers_ModelDataSource_S3DataSourceFields,
    ),
}

_Model_Containers_MultiModelConfigFields = {
    "model_cache_setting": ubx.FieldSpec(wire_name="model_cache_setting"),
}

_Model_ContainersFields = {
    ...
    "image_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Model_Containers_ImageConfigFields,
    ),
    ...
    "model_data_source": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Model_Containers_ModelDataSourceFields,
    ),
    ...
    "multi_model_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Model_Containers_MultiModelConfigFields,
    ),
}
...
Model = ubx.ResourceBinding(
    ...
    fields={
        "containers": ubx.FieldSpec(
            ...
            kind="list",
            fields=_Model_ContainersFields,
        ),
