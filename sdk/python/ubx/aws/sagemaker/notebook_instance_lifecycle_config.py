...
class NotebookInstanceLifecycleConfig_OnCreate:
...
_NotebookInstanceLifecycleConfig_OnCreateFields = {
    "content": ubx.FieldSpec(wire_name="content"),
}

@dataclasses.dataclass
class NotebookInstanceLifecycleConfigConfig:
...
@dataclasses.dataclass
class NotebookInstanceLifecycleConfigAttrs:
...
NotebookInstanceLifecycleConfig = ubx.ResourceBinding(
    ...
    fields={
        ...
        "on_create": ubx.FieldSpec(
            wire_name="on_create",
            kind="list",
            fields=_NotebookInstanceLifecycleConfig_OnCreateFields,
        ),
