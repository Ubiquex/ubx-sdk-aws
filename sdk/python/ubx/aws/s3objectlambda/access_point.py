...
@dataclasses.dataclass
class AccessPoint_ObjectLambdaConfiguration_TransformationConfigurations:
...
@dataclasses.dataclass
class AccessPoint_ObjectLambdaConfiguration:
...
@dataclasses.dataclass
class AccessPoint_PolicyStatus:
...
_AccessPoint_ObjectLambdaConfiguration_TransformationConfigurationsFields = {
    "actions": ubx.FieldSpec(wire_name="actions"),
    "content_transformation": ubx.FieldSpec(wire_name="content_transformation"),
}

_AccessPoint_ObjectLambdaConfigurationFields = {
    ...
    "transformation_configurations": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AccessPoint_ObjectLambdaConfiguration_TransformationConfigurationsFields,
    ),
}
...
AccessPoint = ubx.ResourceBinding(
    ...
    fields={
        ...
        "object_lambda_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AccessPoint_ObjectLambdaConfigurationFields,
        ),
    },
)
