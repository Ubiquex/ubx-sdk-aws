...
class AgentSpace_AwsResources_Vpcs:
...
@dataclasses.dataclass
class AgentSpace_CodeReviewSettings:
...
@dataclasses.dataclass
class AgentSpace_IntegratedResources_ProviderResources_BitbucketCapabilities:
...
@dataclasses.dataclass
class AgentSpace_IntegratedResources_ProviderResources_BitbucketRepository:
...
@dataclasses.dataclass
class AgentSpace_IntegratedResources_ProviderResources_ConfluenceCapabilities:
...
@dataclasses.dataclass
class AgentSpace_IntegratedResources_ProviderResources_ConfluenceDocument:
...
@dataclasses.dataclass
class AgentSpace_IntegratedResources_ProviderResources_GitHubRepository:
    name: Any = None
    # The GitHub user or organization that owns the repository to be integrated as a provider resource. (AI-inferred)
    owner: Any = None

@dataclasses.dataclass
class AgentSpace_IntegratedResources_ProviderResources_GitLabRepository:
    name: Any = None
...
@dataclasses.dataclass
class AgentSpace_IntegratedResources_ProviderResources:
...
@dataclasses.dataclass
class AgentSpace_IntegratedResources:
...
_AgentSpace_AwsResources_VpcsFields = {
...
_AgentSpace_AwsResourcesFields = {
    ...
    "vpcs": ubx.FieldSpec(
        wire_name="vpcs",
        kind="list",
        fields=_AgentSpace_AwsResources_VpcsFields,
    ),
}

_AgentSpace_CodeReviewSettingsFields = {
...
AgentSpace = ubx.ResourceBinding(
    ...
    fields={
        "aws_resources": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AgentSpace_AwsResourcesFields,
        ),
        "code_review_settings": ubx.FieldSpec(
            wire_name="code_review_settings",
            kind="object",
            fields=_AgentSpace_CodeReviewSettingsFields,
        ),
