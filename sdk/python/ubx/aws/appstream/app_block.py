...
class AppBlock_PostSetupScriptDetails_ScriptS3Location:
...
@dataclasses.dataclass
class AppBlock_PostSetupScriptDetails:
...
_AppBlock_PostSetupScriptDetails_ScriptS3LocationFields = {
    "s3_bucket": ubx.FieldSpec(wire_name="s3_bucket"),
    "s3_key": ubx.FieldSpec(wire_name="s3_key"),
}

_AppBlock_PostSetupScriptDetailsFields = {
    ...
    "script_s3_location": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AppBlock_PostSetupScriptDetails_ScriptS3LocationFields,
    ),
    "timeout_in_seconds": ubx.FieldSpec(wire_name="timeout_in_seconds"),
}

_AppBlock_TagsFields = {
...
AppBlock = ubx.ResourceBinding(
    ...
    fields={
        ...
        "post_setup_script_details": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AppBlock_PostSetupScriptDetailsFields,
        ),
