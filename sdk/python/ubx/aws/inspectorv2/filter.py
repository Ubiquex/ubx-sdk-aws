...
@dataclasses.dataclass
class Filter_FilterCriteria_EcrImagePushedAt:
...
@dataclasses.dataclass
class Filter_FilterCriteria_EpssScore:
...
_Filter_FilterCriteria_VulnerablePackagesFields = {
    ...
    "epoch": ubx.FieldSpec(
        wire_name="epoch",
        kind="object",
        fields=_Filter_FilterCriteria_EpssScoreFields,
    ),
...
_Filter_FilterCriteriaFields = {
    ...
    "ecr_image_pushed_at": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Filter_FilterCriteria_EcrImagePushedAtFields,
    ),
