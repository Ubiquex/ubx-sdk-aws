...
class Volume_TagSpecifications_Tags:
    key: Any = None
...
@dataclasses.dataclass
class Volume_TagSpecifications:
...
_Volume_TagSpecifications_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_Volume_TagSpecificationsFields = {
    "resource_type": ubx.FieldSpec(wire_name="resource_type"),
    "tags": ubx.FieldSpec(
        wire_name="tags",
        kind="list",
        fields=_Volume_TagSpecifications_TagsFields,
    ),
}
...
Volume = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tag_specifications": ubx.FieldSpec(
            ...
            kind="list",
            fields=_Volume_TagSpecificationsFields,
        ),
