...
@dataclasses.dataclass
class Rule_Match_HttpMatch_HeaderMatches_Match:
...
@dataclasses.dataclass
class Rule_Match_HttpMatch_HeaderMatches:
...
@dataclasses.dataclass
class Rule_Match_HttpMatch_PathMatch_Match:
...
@dataclasses.dataclass
class Rule_Match_HttpMatch_PathMatch:
...
_Rule_ActionFields = {
    "fixed_response": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Rule_Action_FixedResponseFields,
    ),
    "forward": ubx.FieldSpec(
        wire_name="forward",
        kind="object",
        fields=_Rule_Action_ForwardFields,
    ),
}

_Rule_Match_HttpMatch_HeaderMatches_MatchFields = {
    "contains": ubx.FieldSpec(wire_name="contains"),
    "exact": ubx.FieldSpec(wire_name="exact"),
    "prefix": ubx.FieldSpec(wire_name="prefix"),
}

_Rule_Match_HttpMatch_HeaderMatchesFields = {
    "case_sensitive": ubx.FieldSpec(wire_name="case_sensitive"),
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_Rule_Match_HttpMatch_HeaderMatches_MatchFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

_Rule_Match_HttpMatch_PathMatch_MatchFields = {
    "exact": ubx.FieldSpec(wire_name="exact"),
    "prefix": ubx.FieldSpec(wire_name="prefix"),
}

_Rule_Match_HttpMatch_PathMatchFields = {
    "case_sensitive": ubx.FieldSpec(wire_name="case_sensitive"),
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_Rule_Match_HttpMatch_PathMatch_MatchFields,
    ),
}

_Rule_Match_HttpMatchFields = {
    "header_matches": ubx.FieldSpec(
        wire_name="header_matches",
        kind="list",
        fields=_Rule_Match_HttpMatch_HeaderMatchesFields,
    ),
    "method": ubx.FieldSpec(wire_name="method"),
    "path_match": ubx.FieldSpec(
        wire_name="path_match",
        kind="object",
        fields=_Rule_Match_HttpMatch_PathMatchFields,
    ),
}
...
_Rule_MatchFields = {
    "http_match": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Rule_Match_HttpMatchFields,
    ),
}
