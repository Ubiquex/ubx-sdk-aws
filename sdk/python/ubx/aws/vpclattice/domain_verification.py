...
class DomainVerification_Tags:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class DomainVerification_TxtMethodConfig:
...
_DomainVerification_TagsFields = {
...
DomainVerification = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_DomainVerification_TagsFields,
        ),
    },
)
