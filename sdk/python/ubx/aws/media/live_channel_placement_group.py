...
@dataclasses.dataclass
class LiveChannelPlacementGroupConfig:
...
@dataclasses.dataclass
class LiveChannelPlacementGroupAttrs:
...
LiveChannelPlacementGroup = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_LiveChannelPlacementGroup_TagsFields,
        ),
    },
)
