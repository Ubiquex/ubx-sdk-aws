...
class ConnectRouterNetworkInterface_Configuration_Public_AllowRules:
    cidr: Any = None

@dataclasses.dataclass
class ConnectRouterNetworkInterface_Configuration_Public:
...
@dataclasses.dataclass
class ConnectRouterNetworkInterface_Configuration:
    public: Any = None
    vpc: Any = None
...
_ConnectRouterNetworkInterface_Configuration_PublicFields = {
    "allow_rules": ubx.FieldSpec(
        wire_name="allow_rules",
        kind="list",
        fields=_ConnectRouterNetworkInterface_Configuration_Public_AllowRulesFields,
    ),
}

_ConnectRouterNetworkInterface_Configuration_VpcFields = {
    "security_group_ids": ubx.FieldSpec(wire_name="security_group_ids"),
    "subnet_id": ubx.FieldSpec(wire_name="subnet_id"),
}

_ConnectRouterNetworkInterface_ConfigurationFields = {
    "public": ubx.FieldSpec(
        wire_name="public",
        kind="object",
        fields=_ConnectRouterNetworkInterface_Configuration_PublicFields,
    ),
    "vpc": ubx.FieldSpec(
        wire_name="vpc",
        kind="object",
        fields=_ConnectRouterNetworkInterface_Configuration_VpcFields,
    ),
}

_ConnectRouterNetworkInterface_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ConnectRouterNetworkInterfaceConfig:
...
ConnectRouterNetworkInterface = ubx.ResourceBinding(
    wire_type="aws_media_connect_router_network_interface",
    fields={
        "configuration": ubx.FieldSpec(
            wire_name="configuration",
            kind="object",
            fields=_ConnectRouterNetworkInterface_ConfigurationFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ConnectRouterNetworkInterface_TagsFields,
        ),
    },
)
