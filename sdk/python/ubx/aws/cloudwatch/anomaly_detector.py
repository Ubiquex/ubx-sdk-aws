...
class AnomalyDetector_Configuration_ExcludedTimeRanges:
...
@dataclasses.dataclass
class AnomalyDetector_Dimensions:
...
@dataclasses.dataclass
class AnomalyDetector_MetricCharacteristics:
...
@dataclasses.dataclass
class AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueries_MetricStat_Metric:
...
@dataclasses.dataclass
class AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueries_MetricStat:
...
@dataclasses.dataclass
class AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueries:
...
@dataclasses.dataclass
class AnomalyDetector_MetricMathAnomalyDetector:
...
@dataclasses.dataclass
class AnomalyDetector_SingleMetricAnomalyDetector:
...
_AnomalyDetector_Configuration_ExcludedTimeRangesFields = {
...
_AnomalyDetector_ConfigurationFields = {
    "excluded_time_ranges": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AnomalyDetector_Configuration_ExcludedTimeRangesFields,
    ),
    "metric_time_zone": ubx.FieldSpec(wire_name="metric_time_zone"),
}

_AnomalyDetector_DimensionsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_AnomalyDetector_MetricCharacteristicsFields = {
    "periodic_spikes": ubx.FieldSpec(wire_name="periodic_spikes"),
}

_AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueries_MetricStat_MetricFields = {
    "dimensions": ubx.FieldSpec(
        wire_name="dimensions",
        kind="list",
        fields=_AnomalyDetector_DimensionsFields,
    ),
    "metric_name": ubx.FieldSpec(wire_name="metric_name"),
    "namespace": ubx.FieldSpec(wire_name="namespace"),
}

_AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueries_MetricStatFields = {
    "metric": ubx.FieldSpec(
        wire_name="metric",
        kind="object",
        fields=_AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueries_MetricStat_MetricFields,
    ),
...
_AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueriesFields = {
    ...
    "metric_stat": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueries_MetricStatFields,
    ),
    "period": ubx.FieldSpec(wire_name="period"),
    "return_data": ubx.FieldSpec(wire_name="return_data"),
}

_AnomalyDetector_MetricMathAnomalyDetectorFields = {
    "metric_data_queries": ubx.FieldSpec(
        wire_name="metric_data_queries",
        kind="list",
        fields=_AnomalyDetector_MetricMathAnomalyDetector_MetricDataQueriesFields,
    ),
}

_AnomalyDetector_SingleMetricAnomalyDetectorFields = {
    "account_id": ubx.FieldSpec(wire_name="account_id"),
    "dimensions": ubx.FieldSpec(
        wire_name="dimensions",
        kind="list",
...
AnomalyDetector = ubx.ResourceBinding(
    ...
    fields={
        ...
        "metric_characteristics": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AnomalyDetector_MetricCharacteristicsFields,
        ),
        "metric_math_anomaly_detector": ubx.FieldSpec(
            wire_name="metric_math_anomaly_detector",
            kind="object",
            fields=_AnomalyDetector_MetricMathAnomalyDetectorFields,
        ),
        "metric_name": ubx.FieldSpec(wire_name="metric_name"),
        "namespace": ubx.FieldSpec(wire_name="namespace"),
        "single_metric_anomaly_detector": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AnomalyDetector_SingleMetricAnomalyDetectorFields,
        ),
        "stat": ubx.FieldSpec(wire_name="stat"),
    },
)
