...
_ResolverOutpostResolver_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ResolverOutpostResolverConfig:
...
@dataclasses.dataclass
class ResolverOutpostResolverAttrs:
...
ResolverOutpostResolver = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ResolverOutpostResolver_TagsFields,
        ),
    },
)
