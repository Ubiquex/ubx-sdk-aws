...
class ApiGatewayManagedOverrides_Integration:
...
@dataclasses.dataclass
class ApiGatewayManagedOverrides_Route:
...
@dataclasses.dataclass
class ApiGatewayManagedOverrides_Stage_AccessLogSettings:
...
@dataclasses.dataclass
class ApiGatewayManagedOverrides_Stage_DefaultRouteSettings:
...
@dataclasses.dataclass
class ApiGatewayManagedOverrides_Stage:
...
_ApiGatewayManagedOverrides_IntegrationFields = {
...
_ApiGatewayManagedOverrides_RouteFields = {
...
_ApiGatewayManagedOverrides_Stage_AccessLogSettingsFields = {
    "destination_arn": ubx.FieldSpec(wire_name="destination_arn"),
    "format": ubx.FieldSpec(wire_name="format"),
}

_ApiGatewayManagedOverrides_Stage_DefaultRouteSettingsFields = {
...
@dataclasses.dataclass
class ApiGatewayManagedOverridesConfig:
...
@dataclasses.dataclass
class ApiGatewayManagedOverridesAttrs:
    # The ID of the API for which to override the configuration of API Gateway-managed resources.
    api_id: Any = None
...
ApiGatewayManagedOverrides = ubx.ResourceBinding(
    ...
    fields={
        ...
        "integration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ApiGatewayManagedOverrides_IntegrationFields,
        ),
        "route": ubx.FieldSpec(
            wire_name="route",
            kind="object",
            fields=_ApiGatewayManagedOverrides_RouteFields,
        ),
        "stage": ubx.FieldSpec(
            wire_name="stage",
            kind="object",
            fields=_ApiGatewayManagedOverrides_StageFields,
        ),
    },
)
