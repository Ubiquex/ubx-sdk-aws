...
@dataclasses.dataclass
class FlowOutput_MediaStreamOutputConfigurations_DestinationConfigurations_Interface:
...
@dataclasses.dataclass
class FlowOutput_MediaStreamOutputConfigurations_DestinationConfigurations:
...
@dataclasses.dataclass
class FlowOutput_MediaStreamOutputConfigurations_EncodingParameters:
...
@dataclasses.dataclass
class FlowOutput_MediaStreamOutputConfigurations:
...
@dataclasses.dataclass
class FlowOutput_RouterIntegrationTransitEncryption_EncryptionKeyConfiguration_SecretsManager:
...
@dataclasses.dataclass
class FlowOutput_RouterIntegrationTransitEncryption_EncryptionKeyConfiguration:
...
@dataclasses.dataclass
class FlowOutput_RouterIntegrationTransitEncryption:
...
@dataclasses.dataclass
class FlowOutput_VpcInterfaceAttachment:
    # The name of the VPC interface to use for this output.
    vpc_interface_name: Any = None

_FlowOutput_EncryptionFields = {
...
_FlowOutput_MediaStreamOutputConfigurations_DestinationConfigurations_InterfaceFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_FlowOutput_MediaStreamOutputConfigurations_DestinationConfigurationsFields = {
    ...
    "interface": ubx.FieldSpec(
        wire_name="interface",
        kind="object",
        fields=_FlowOutput_MediaStreamOutputConfigurations_DestinationConfigurations_InterfaceFields,
    ),
}

_FlowOutput_MediaStreamOutputConfigurations_EncodingParametersFields = {
    "compression_factor": ubx.FieldSpec(wire_name="compression_factor"),
    "encoder_profile": ubx.FieldSpec(wire_name="encoder_profile"),
}

_FlowOutput_MediaStreamOutputConfigurationsFields = {
    "destination_configurations": ubx.FieldSpec(
        wire_name="destination_configurations",
        kind="list",
        fields=_FlowOutput_MediaStreamOutputConfigurations_DestinationConfigurationsFields,
    ),
    "encoding_name": ubx.FieldSpec(wire_name="encoding_name"),
    "encoding_parameters": ubx.FieldSpec(
        wire_name="encoding_parameters",
        kind="object",
        fields=_FlowOutput_MediaStreamOutputConfigurations_EncodingParametersFields,
    ),
    "media_stream_name": ubx.FieldSpec(wire_name="media_stream_name"),
}

_FlowOutput_RouterIntegrationTransitEncryption_EncryptionKeyConfiguration_SecretsManagerFields = {
    "role_arn": ubx.FieldSpec(wire_name="role_arn"),
    "secret_arn": ubx.FieldSpec(wire_name="secret_arn"),
}

_FlowOutput_RouterIntegrationTransitEncryption_EncryptionKeyConfigurationFields = {
    "automatic": ubx.FieldSpec(wire_name="automatic"),
    "secrets_manager": ubx.FieldSpec(
        wire_name="secrets_manager",
        kind="object",
        fields=_FlowOutput_RouterIntegrationTransitEncryption_EncryptionKeyConfiguration_SecretsManagerFields,
    ),
}

_FlowOutput_RouterIntegrationTransitEncryptionFields = {
    "encryption_key_configuration": ubx.FieldSpec(
        wire_name="encryption_key_configuration",
        kind="object",
        fields=_FlowOutput_RouterIntegrationTransitEncryption_EncryptionKeyConfigurationFields,
    ),
    "encryption_key_type": ubx.FieldSpec(wire_name="encryption_key_type"),
}

_FlowOutput_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_FlowOutput_VpcInterfaceAttachmentFields = {
    "vpc_interface_name": ubx.FieldSpec(wire_name="vpc_interface_name"),
}

@dataclasses.dataclass
class FlowOutputConfig:
...
FlowOutput = ubx.ResourceBinding(
    ...
    fields={
        ...
        "encryption": ubx.FieldSpec(
            ...
            kind="object",
            fields=_FlowOutput_EncryptionFields,
        ),
        ...
        "media_stream_output_configurations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_FlowOutput_MediaStreamOutputConfigurationsFields,
        ),
        ...
        "router_integration_transit_encryption": ubx.FieldSpec(
            ...
            kind="object",
            fields=_FlowOutput_RouterIntegrationTransitEncryptionFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_FlowOutput_TagsFields,
        ),
        "vpc_interface_attachment": ubx.FieldSpec(
            wire_name="vpc_interface_attachment",
            kind="object",
            fields=_FlowOutput_VpcInterfaceAttachmentFields,
        ),
    },
)
