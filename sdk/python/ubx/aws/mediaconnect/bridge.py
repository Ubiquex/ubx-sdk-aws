...
@dataclasses.dataclass
class Bridge_Outputs_NetworkOutput:
...
@dataclasses.dataclass
class Bridge_SourceFailoverConfig_SourcePriority:
    # The name of the source you choose as the primary source for this flow.
    primary_source: Any = None

@dataclasses.dataclass
class Bridge_SourceFailoverConfig:
...
@dataclasses.dataclass
class Bridge_Sources_FlowSource_FlowVpcInterfaceAttachment:
...
@dataclasses.dataclass
class Bridge_Sources_FlowSource:
...
@dataclasses.dataclass
class Bridge_Sources_NetworkSource_MulticastSourceSettings:
...
@dataclasses.dataclass
class Bridge_Sources_NetworkSource:
...
_Bridge_EgressGatewayBridgeFields = {
    "max_bitrate": ubx.FieldSpec(wire_name="max_bitrate"),
}

_Bridge_IngressGatewayBridgeFields = {
    "max_bitrate": ubx.FieldSpec(wire_name="max_bitrate"),
    "max_outputs": ubx.FieldSpec(wire_name="max_outputs"),
}

_Bridge_Outputs_NetworkOutputFields = {
...
_Bridge_OutputsFields = {
    "network_output": ubx.FieldSpec(
        wire_name="network_output",
        kind="object",
        fields=_Bridge_Outputs_NetworkOutputFields,
    ),
}

_Bridge_SourceFailoverConfig_SourcePriorityFields = {
    "primary_source": ubx.FieldSpec(wire_name="primary_source"),
}

_Bridge_SourceFailoverConfigFields = {
    "failover_mode": ubx.FieldSpec(wire_name="failover_mode"),
    "source_priority": ubx.FieldSpec(
        wire_name="source_priority",
        kind="object",
        fields=_Bridge_SourceFailoverConfig_SourcePriorityFields,
    ),
    "state": ubx.FieldSpec(wire_name="state"),
}

_Bridge_Sources_FlowSource_FlowVpcInterfaceAttachmentFields = {
    "vpc_interface_name": ubx.FieldSpec(wire_name="vpc_interface_name"),
}

_Bridge_Sources_FlowSourceFields = {
    ...
    "flow_vpc_interface_attachment": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Bridge_Sources_FlowSource_FlowVpcInterfaceAttachmentFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

_Bridge_Sources_NetworkSource_MulticastSourceSettingsFields = {
    "multicast_source_ip": ubx.FieldSpec(wire_name="multicast_source_ip"),
}

_Bridge_Sources_NetworkSourceFields = {
    ...
    "multicast_source_settings": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Bridge_Sources_NetworkSource_MulticastSourceSettingsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "network_name": ubx.FieldSpec(wire_name="network_name"),
    "port": ubx.FieldSpec(wire_name="port"),
...
_Bridge_SourcesFields = {
    "flow_source": ubx.FieldSpec(
        wire_name="flow_source",
        kind="object",
        fields=_Bridge_Sources_FlowSourceFields,
    ),
    "network_source": ubx.FieldSpec(
        wire_name="network_source",
        kind="object",
        fields=_Bridge_Sources_NetworkSourceFields,
    ),
}
