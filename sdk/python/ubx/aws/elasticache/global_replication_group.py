...
class GlobalReplicationGroup_Members:
...
@dataclasses.dataclass
class GlobalReplicationGroup_RegionalConfigurations_ReshardingConfigurations:
...
@dataclasses.dataclass
class GlobalReplicationGroup_RegionalConfigurations:
...
_GlobalReplicationGroup_MembersFields = {
...
_GlobalReplicationGroup_RegionalConfigurations_ReshardingConfigurationsFields = {
...
_GlobalReplicationGroup_RegionalConfigurationsFields = {
    "replication_group_id": ubx.FieldSpec(wire_name="replication_group_id"),
    "replication_group_region": ubx.FieldSpec(wire_name="replication_group_region"),
    "resharding_configurations": ubx.FieldSpec(
        wire_name="resharding_configurations",
        kind="list",
        fields=_GlobalReplicationGroup_RegionalConfigurations_ReshardingConfigurationsFields,
    ),
}
...
@dataclasses.dataclass
class GlobalReplicationGroupAttrs:
    # AutomaticFailoverEnabled
    automatic_failover_enabled: Any = None
    # The cache node type of the Global Datastore
    cache_node_type: Any = None
...
GlobalReplicationGroup = ubx.ResourceBinding(
    ...
    fields={
        ...
        "members": ubx.FieldSpec(
            wire_name="members",
            kind="list",
            fields=_GlobalReplicationGroup_MembersFields,
        ),
        "regional_configurations": ubx.FieldSpec(
            wire_name="regional_configurations",
            kind="list",
            fields=_GlobalReplicationGroup_RegionalConfigurationsFields,
        ),
    },
)
