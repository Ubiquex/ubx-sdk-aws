...
class Member_MemberConfiguration_MemberFrameworkConfiguration_MemberFabricConfiguration:
...
@dataclasses.dataclass
class Member_MemberConfiguration_MemberFrameworkConfiguration:
...
@dataclasses.dataclass
class Member_MemberConfiguration:
...
@dataclasses.dataclass
class Member_NetworkConfiguration_NetworkFrameworkConfiguration_NetworkFabricConfiguration:
...
@dataclasses.dataclass
class Member_NetworkConfiguration_NetworkFrameworkConfiguration:
...
@dataclasses.dataclass
class Member_NetworkConfiguration_VotingPolicy_ApprovalThresholdPolicy:
...
@dataclasses.dataclass
class Member_NetworkConfiguration_VotingPolicy:
...
@dataclasses.dataclass
class Member_NetworkConfiguration:
...
_Member_MemberConfiguration_MemberFrameworkConfiguration_MemberFabricConfigurationFields = {
    "admin_password": ubx.FieldSpec(wire_name="admin_password"),
    "admin_username": ubx.FieldSpec(wire_name="admin_username"),
}

_Member_MemberConfiguration_MemberFrameworkConfigurationFields = {
    "member_fabric_configuration": ubx.FieldSpec(
        wire_name="member_fabric_configuration",
        kind="object",
        fields=_Member_MemberConfiguration_MemberFrameworkConfiguration_MemberFabricConfigurationFields,
    ),
}

_Member_MemberConfigurationFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "member_framework_configuration": ubx.FieldSpec(
        wire_name="member_framework_configuration",
        kind="object",
        fields=_Member_MemberConfiguration_MemberFrameworkConfigurationFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

_Member_NetworkConfiguration_NetworkFrameworkConfiguration_NetworkFabricConfigurationFields = {
    "edition": ubx.FieldSpec(wire_name="edition"),
}

_Member_NetworkConfiguration_NetworkFrameworkConfigurationFields = {
    "network_fabric_configuration": ubx.FieldSpec(
        wire_name="network_fabric_configuration",
        kind="object",
        fields=_Member_NetworkConfiguration_NetworkFrameworkConfiguration_NetworkFabricConfigurationFields,
    ),
}

_Member_NetworkConfiguration_VotingPolicy_ApprovalThresholdPolicyFields = {
...
_Member_NetworkConfiguration_VotingPolicyFields = {
    "approval_threshold_policy": ubx.FieldSpec(
        wire_name="approval_threshold_policy",
        kind="object",
        fields=_Member_NetworkConfiguration_VotingPolicy_ApprovalThresholdPolicyFields,
    ),
}

_Member_NetworkConfigurationFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    ...
    "network_framework_configuration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Member_NetworkConfiguration_NetworkFrameworkConfigurationFields,
    ),
    "voting_policy": ubx.FieldSpec(
        wire_name="voting_policy",
        kind="object",
        fields=_Member_NetworkConfiguration_VotingPolicyFields,
    ),
}
...
Member = ubx.ResourceBinding(
    ...
    fields={
        ...
        "member_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Member_MemberConfigurationFields,
        ),
        "network_configuration": ubx.FieldSpec(
            wire_name="network_configuration",
            kind="object",
            fields=_Member_NetworkConfigurationFields,
        ),
