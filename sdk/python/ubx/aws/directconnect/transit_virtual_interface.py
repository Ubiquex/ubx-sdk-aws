...
class TransitVirtualInterface_BgpPeers:
...
@dataclasses.dataclass
class TransitVirtualInterface_Tags:
...
_TransitVirtualInterface_TagsFields = {
...
@dataclasses.dataclass
class TransitVirtualInterfaceAttrs:
    # The Amazon Resource Name (ARN) of the role to allocate the TransitVifAllocation. Needs directconnect:AllocateTransitVirtualInterface permissions and tag permissions if applicable.
    allocate_transit_virtual_interface_role_arn: Any = None
...
TransitVirtualInterface = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_TransitVirtualInterface_TagsFields,
        ),
