...
class ProfilesDomainObjectType_Tags:
...
_ProfilesDomainObjectType_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ProfilesDomainObjectTypeConfig:
...
@dataclasses.dataclass
class ProfilesDomainObjectTypeAttrs:
...
ProfilesDomainObjectType = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ProfilesDomainObjectType_TagsFields,
        ),
    },
)
