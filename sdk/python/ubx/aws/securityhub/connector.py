...
class Connector_Issues:
    code: Any = None
    message: Any = None

@dataclasses.dataclass
class Connector_Provider_Azure_ScopeConfiguration:
...
@dataclasses.dataclass
class Connector_Provider_Azure:
...
_Connector_Provider_AzureFields = {
    ...
    "scope_configuration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connector_Provider_Azure_ScopeConfigurationFields,
    ),
}

_Connector_ProviderFields = {
    "azure": ubx.FieldSpec(
        wire_name="azure",
        kind="object",
        fields=_Connector_Provider_AzureFields,
    ),
}
...
Connector = ubx.ResourceBinding(
    ...
    fields={
        ...
        "provider": ubx.FieldSpec(
            wire_name="provider",
            kind="object",
            fields=_Connector_ProviderFields,
        ),
