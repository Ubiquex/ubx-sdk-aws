...
class DataLake_EncryptionConfiguration:
    # The id of KMS encryption key used by Amazon Security Lake to encrypt the Security Lake object.
    kms_key_id: Any = None

@dataclasses.dataclass
class DataLake_LifecycleConfiguration_Expiration:
    # Number of days before data expires in the Amazon Security Lake object.
    days: Any = None

@dataclasses.dataclass
class DataLake_LifecycleConfiguration_Transitions:
...
@dataclasses.dataclass
class DataLake_LifecycleConfiguration:
...
@dataclasses.dataclass
class DataLake_ReplicationConfiguration:
...
_DataLake_EncryptionConfigurationFields = {
    "kms_key_id": ubx.FieldSpec(wire_name="kms_key_id"),
}

_DataLake_LifecycleConfiguration_ExpirationFields = {
    "days": ubx.FieldSpec(wire_name="days"),
}

_DataLake_LifecycleConfiguration_TransitionsFields = {
    "days": ubx.FieldSpec(wire_name="days"),
    "storage_class": ubx.FieldSpec(wire_name="storage_class"),
}

_DataLake_LifecycleConfigurationFields = {
    "expiration": ubx.FieldSpec(
        wire_name="expiration",
        kind="object",
        fields=_DataLake_LifecycleConfiguration_ExpirationFields,
    ),
    "transitions": ubx.FieldSpec(
        wire_name="transitions",
        kind="list",
        fields=_DataLake_LifecycleConfiguration_TransitionsFields,
    ),
}

_DataLake_ReplicationConfigurationFields = {
    "regions": ubx.FieldSpec(wire_name="regions"),
    "role_arn": ubx.FieldSpec(wire_name="role_arn"),
}

_DataLake_TagsFields = {
...
DataLake = ubx.ResourceBinding(
    ...
    fields={
        "encryption_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DataLake_EncryptionConfigurationFields,
        ),
        "lifecycle_configuration": ubx.FieldSpec(
            wire_name="lifecycle_configuration",
            kind="object",
            fields=_DataLake_LifecycleConfigurationFields,
        ),
        ...
        "replication_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DataLake_ReplicationConfigurationFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_DataLake_TagsFields,
        ),
    },
)
