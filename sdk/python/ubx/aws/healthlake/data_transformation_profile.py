...
class DataTransformationProfile_Source_ExistingVersionedProfileId:
...
@dataclasses.dataclass
class DataTransformationProfile_Tags:
...
_DataTransformationProfile_Source_ExistingVersionedProfileIdFields = {
    "profile_id": ubx.FieldSpec(wire_name="profile_id"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_DataTransformationProfile_Source_ProfileMappingFields = {
    "profile_mapping": ubx.FieldSpec(wire_name="profile_mapping"),
}

_DataTransformationProfile_Source_StarterProfileFields = {
    "starter_profile_name": ubx.FieldSpec(wire_name="starter_profile_name"),
}

_DataTransformationProfile_SourceFields = {
    "existing_versioned_profile_id": ubx.FieldSpec(
        wire_name="existing_versioned_profile_id",
        kind="object",
        fields=_DataTransformationProfile_Source_ExistingVersionedProfileIdFields,
    ),
    "profile_mapping": ubx.FieldSpec(
        wire_name="profile_mapping",
        kind="object",
        fields=_DataTransformationProfile_Source_ProfileMappingFields,
    ),
    "starter_profile": ubx.FieldSpec(
        wire_name="starter_profile",
        kind="object",
        fields=_DataTransformationProfile_Source_StarterProfileFields,
    ),
}

_DataTransformationProfile_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class DataTransformationProfileConfig:
...
@dataclasses.dataclass
class DataTransformationProfileAttrs:
...
DataTransformationProfile = ubx.ResourceBinding(
    ...
    fields={
        ...
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
            fields=_DataTransformationProfile_SourceFields,
        ),
        "source_format": ubx.FieldSpec(wire_name="source_format"),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_DataTransformationProfile_TagsFields,
        ),
    },
)
