...
class Table_AttributeDefinitions:
...
@dataclasses.dataclass
class Table_ContributorInsightsSpecification:
...
@dataclasses.dataclass
class Table_GlobalSecondaryIndexes_KeySchema:
...
@dataclasses.dataclass
class Table_GlobalSecondaryIndexes_OnDemandThroughput:
...
@dataclasses.dataclass
class Table_GlobalSecondaryIndexes_Projection:
...
@dataclasses.dataclass
class Table_GlobalSecondaryIndexes_ProvisionedThroughput:
...
@dataclasses.dataclass
class Table_GlobalSecondaryIndexes_WarmThroughput:
...
@dataclasses.dataclass
class Table_GlobalSecondaryIndexes:
...
@dataclasses.dataclass
class Table_ImportSourceSpecification_InputFormatOptions_Csv:
...
@dataclasses.dataclass
class Table_ImportSourceSpecification_InputFormatOptions:
    # The options for imported source files in CSV format. The values are Delimiter and HeaderList.
    csv: Any = None

@dataclasses.dataclass
class Table_ImportSourceSpecification_S3BucketSource:
...
@dataclasses.dataclass
class Table_ImportSourceSpecification:
...
@dataclasses.dataclass
class Table_KinesisStreamSpecification:
...
@dataclasses.dataclass
class Table_LocalSecondaryIndexes:
...
@dataclasses.dataclass
class Table_PointInTimeRecoverySpecification:
...
@dataclasses.dataclass
class Table_StreamSpecification_Tags:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class Table_StreamSpecification:
...
@dataclasses.dataclass
class Table_TimeToLiveSpecification:
...
_Table_GlobalSecondaryIndexes_WarmThroughputFields = {
...
_Table_GlobalSecondaryIndexesFields = {
    "contributor_insights_specification": ubx.FieldSpec(
        wire_name="contributor_insights_specification",
        kind="object",
        fields=_Table_ContributorInsightsSpecificationFields,
    ),
    "index_name": ubx.FieldSpec(wire_name="index_name"),
    "key_schema": ubx.FieldSpec(
        wire_name="key_schema",
        kind="list",
        fields=_Table_GlobalSecondaryIndexes_KeySchemaFields,
    ),
    "on_demand_throughput": ubx.FieldSpec(
        wire_name="on_demand_throughput",
        kind="object",
        fields=_Table_GlobalSecondaryIndexes_OnDemandThroughputFields,
    ),
    "projection": ubx.FieldSpec(
        wire_name="projection",
        kind="object",
        fields=_Table_GlobalSecondaryIndexes_ProjectionFields,
    ),
    "provisioned_throughput": ubx.FieldSpec(
        wire_name="provisioned_throughput",
        kind="object",
        fields=_Table_GlobalSecondaryIndexes_ProvisionedThroughputFields,
    ),
    "warm_throughput": ubx.FieldSpec(
        wire_name="warm_throughput",
        kind="object",
        fields=_Table_GlobalSecondaryIndexes_WarmThroughputFields,
    ),
}

_Table_ImportSourceSpecification_InputFormatOptions_CsvFields = {
    "delimiter": ubx.FieldSpec(wire_name="delimiter"),
    "header_list": ubx.FieldSpec(wire_name="header_list"),
}

_Table_ImportSourceSpecification_InputFormatOptionsFields = {
    "csv": ubx.FieldSpec(
        wire_name="csv",
        kind="object",
        fields=_Table_ImportSourceSpecification_InputFormatOptions_CsvFields,
    ),
}

_Table_ImportSourceSpecification_S3BucketSourceFields = {
...
_Table_ImportSourceSpecificationFields = {
    ...
    "input_format_options": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Table_ImportSourceSpecification_InputFormatOptionsFields,
    ),
    "s3_bucket_source": ubx.FieldSpec(
        wire_name="s3_bucket_source",
        kind="object",
        fields=_Table_ImportSourceSpecification_S3BucketSourceFields,
    ),
}

_Table_KinesisStreamSpecificationFields = {
...
_Table_LocalSecondaryIndexesFields = {
    "index_name": ubx.FieldSpec(wire_name="index_name"),
    "key_schema": ubx.FieldSpec(
        wire_name="key_schema",
        kind="list",
...
_Table_PointInTimeRecoverySpecificationFields = {
...
_Table_ResourcePolicyFields = {
    "policy_document": ubx.FieldSpec(wire_name="policy_document"),
}

_Table_SsespecificationFields = {
...
_Table_StreamSpecification_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_Table_StreamSpecificationFields = {
    "resource_policy": ubx.FieldSpec(
        wire_name="resource_policy",
        kind="object",
        fields=_Table_ResourcePolicyFields,
    ),
    "stream_view_type": ubx.FieldSpec(wire_name="stream_view_type"),
    "tags": ubx.FieldSpec(
        wire_name="tags",
        kind="list",
        fields=_Table_StreamSpecification_TagsFields,
    ),
}

_Table_TimeToLiveSpecificationFields = {
    "attribute_name": ubx.FieldSpec(wire_name="attribute_name"),
    "enabled": ubx.FieldSpec(wire_name="enabled"),
}
...
Table = ubx.ResourceBinding(
    ...
    fields={
        "attribute_definitions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_Table_AttributeDefinitionsFields,
        ),
        ...
        "global_secondary_indexes": ubx.FieldSpec(
            ...
            kind="list",
            fields=_Table_GlobalSecondaryIndexesFields,
        ),
        "import_source_specification": ubx.FieldSpec(
            wire_name="import_source_specification",
            kind="object",
            fields=_Table_ImportSourceSpecificationFields,
        ),
        ...
        "kinesis_stream_specification": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Table_KinesisStreamSpecificationFields,
        ),
        "local_secondary_indexes": ubx.FieldSpec(
            wire_name="local_secondary_indexes",
            kind="list",
            fields=_Table_LocalSecondaryIndexesFields,
        ),
        "on_demand_throughput": ubx.FieldSpec(
            wire_name="on_demand_throughput",
            kind="object",
        ...
        "point_in_time_recovery_specification": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Table_PointInTimeRecoverySpecificationFields,
        ),
        "provisioned_throughput": ubx.FieldSpec(
            wire_name="provisioned_throughput",
            kind="object",
        ...
        "ssespecification": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Table_SsespecificationFields,
        ),
        "stream_specification": ubx.FieldSpec(
            wire_name="stream_specification",
            kind="object",
            fields=_Table_StreamSpecificationFields,
        ),
        ...
        "time_to_live_specification": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Table_TimeToLiveSpecificationFields,
        ),
        "warm_throughput": ubx.FieldSpec(
            wire_name="warm_throughput",
            kind="object",
