...
class FirewallRuleGroup_FirewallRules_FirewallRuleType_FirewallAdvancedContentCategory:
...
@dataclasses.dataclass
class FirewallRuleGroup_FirewallRules_FirewallRuleType_PartnerThreatProtection:
    partner: Any = None

@dataclasses.dataclass
class FirewallRuleGroup_FirewallRules_FirewallRuleType:
...
@dataclasses.dataclass
class FirewallRuleGroup_FirewallRules:
