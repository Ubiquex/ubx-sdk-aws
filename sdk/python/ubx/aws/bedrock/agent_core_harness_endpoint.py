...
class AgentCoreHarnessEndpoint_Tags:
    key: Any = None
    value: Any = None

_AgentCoreHarnessEndpoint_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class AgentCoreHarnessEndpointConfig:
...
@dataclasses.dataclass
class AgentCoreHarnessEndpointAttrs:
...
AgentCoreHarnessEndpoint = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_AgentCoreHarnessEndpoint_TagsFields,
        ),
