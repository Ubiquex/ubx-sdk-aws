...
class GitHubRepository_Code_S3:
...
_GitHubRepository_Code_S3Fields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "key": ubx.FieldSpec(wire_name="key"),
    "object_version": ubx.FieldSpec(wire_name="object_version"),
}

_GitHubRepository_CodeFields = {
    "s3": ubx.FieldSpec(
        wire_name="s3",
        kind="object",
        fields=_GitHubRepository_Code_S3Fields,
    ),
}
...
GitHubRepository = ubx.ResourceBinding(
    wire_type="aws_code_star_git_hub_repository",
    fields={
        "code": ubx.FieldSpec(
            wire_name="code",
            kind="object",
            fields=_GitHubRepository_CodeFields,
        ),
