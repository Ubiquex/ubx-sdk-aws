...
class ImageRecipe_AdditionalInstanceConfiguration_SystemsManagerAgent:
...
@dataclasses.dataclass
class ImageRecipe_AdditionalInstanceConfiguration:
...
@dataclasses.dataclass
class ImageRecipe_BlockDeviceMappings_Ebs:
...
@dataclasses.dataclass
class ImageRecipe_BlockDeviceMappings:
...
@dataclasses.dataclass
class ImageRecipe_Components_Parameters:
...
@dataclasses.dataclass
class ImageRecipe_LatestVersion:
...
_ImageRecipe_AdditionalInstanceConfiguration_SystemsManagerAgentFields = {
    "uninstall_after_build": ubx.FieldSpec(wire_name="uninstall_after_build"),
}

_ImageRecipe_AdditionalInstanceConfigurationFields = {
    "systems_manager_agent": ubx.FieldSpec(
        wire_name="systems_manager_agent",
        kind="object",
        fields=_ImageRecipe_AdditionalInstanceConfiguration_SystemsManagerAgentFields,
    ),
    "user_data_override": ubx.FieldSpec(wire_name="user_data_override"),
}

_ImageRecipe_BlockDeviceMappings_EbsFields = {
...
ImageRecipe = ubx.ResourceBinding(
    ...
    fields={
        "additional_instance_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ImageRecipe_AdditionalInstanceConfigurationFields,
        ),
        ...
        "block_device_mappings": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ImageRecipe_BlockDeviceMappingsFields,
        ),
        "components": ubx.FieldSpec(
            wire_name="components",
            kind="list",
            fields=_ImageRecipe_ComponentsFields,
        ),
