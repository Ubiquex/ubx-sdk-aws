...
class TrustStoreRevocation_RevocationContents:
...
@dataclasses.dataclass
class TrustStoreRevocation_TrustStoreRevocations:
...
_TrustStoreRevocation_RevocationContentsFields = {
...
@dataclasses.dataclass
class TrustStoreRevocationAttrs:
    # The attributes required to create a trust store revocation.
    revocation_contents: Any = None
...
TrustStoreRevocation = ubx.ResourceBinding(
    ...
    fields={
        "revocation_contents": ubx.FieldSpec(
            ...
            kind="list",
            fields=_TrustStoreRevocation_RevocationContentsFields,
        ),
