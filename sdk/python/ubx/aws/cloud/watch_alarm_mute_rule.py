...
class WatchAlarmMuteRule_MuteTargets:
    # The alarm names to be mute by the AlarmMuteRule
    alarm_names: Any = None

@dataclasses.dataclass
class WatchAlarmMuteRule_Rule_Schedule:
...
_WatchAlarmMuteRule_Rule_ScheduleFields = {
...
_WatchAlarmMuteRule_RuleFields = {
    "schedule": ubx.FieldSpec(
        wire_name="schedule",
        kind="object",
        fields=_WatchAlarmMuteRule_Rule_ScheduleFields,
    ),
}

_WatchAlarmMuteRule_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class WatchAlarmMuteRuleConfig:
...
WatchAlarmMuteRule = ubx.ResourceBinding(
    ...
    fields={
        ...
        "mute_targets": ubx.FieldSpec(
            ...
            kind="object",
            fields=_WatchAlarmMuteRule_MuteTargetsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "rule": ubx.FieldSpec(
            wire_name="rule",
            kind="object",
            fields=_WatchAlarmMuteRule_RuleFields,
        ),
        "start_date": ubx.FieldSpec(wire_name="start_date"),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_WatchAlarmMuteRule_TagsFields,
        ),
    },
)
