...
@dataclasses.dataclass
class FormationHookVersionAttrs:
...
FormationHookVersion = ubx.ResourceBinding(
    wire_type="aws_cloud_formation_hook_version",
    fields={
        "execution_role_arn": ubx.FieldSpec(wire_name="execution_role_arn"),
        "logging_config": ubx.FieldSpec(
            wire_name="logging_config",
            kind="object",
            fields=_FormationHookVersion_LoggingConfigFields,
        ),
