...
class TablesTableBucket_EncryptionConfiguration:
...
@dataclasses.dataclass
class TablesTableBucket_MetricsConfiguration:
...
@dataclasses.dataclass
class TablesTableBucket_ReplicationConfiguration:
...
@dataclasses.dataclass
class TablesTableBucket_StorageClassConfiguration:
...
@dataclasses.dataclass
class TablesTableBucket_UnreferencedFileRemoval:
...
_TablesTableBucket_EncryptionConfigurationFields = {
    "kmskey_arn": ubx.FieldSpec(wire_name="kmskey_arn"),
    "ssealgorithm": ubx.FieldSpec(wire_name="ssealgorithm"),
}

_TablesTableBucket_MetricsConfigurationFields = {
    "status": ubx.FieldSpec(wire_name="status"),
}

_TablesTableBucket_ReplicationConfiguration_Rules_DestinationsFields = {
    "destination_table_bucket_arn": ubx.FieldSpec(wire_name="destination_table_bucket_arn"),
}

_TablesTableBucket_ReplicationConfiguration_RulesFields = {
    "destinations": ubx.FieldSpec(
        wire_name="destinations",
        kind="list",
        fields=_TablesTableBucket_ReplicationConfiguration_Rules_DestinationsFields,
    ),
}

_TablesTableBucket_ReplicationConfigurationFields = {
    "role": ubx.FieldSpec(wire_name="role"),
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_TablesTableBucket_ReplicationConfiguration_RulesFields,
    ),
}

_TablesTableBucket_StorageClassConfigurationFields = {
    "storage_class": ubx.FieldSpec(wire_name="storage_class"),
}

_TablesTableBucket_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_TablesTableBucket_UnreferencedFileRemovalFields = {
