...
@dataclasses.dataclass
class ConnectPeer_Configuration_BgpConfigurations:
...
@dataclasses.dataclass
class ConnectPeer_Configuration:
...
ConnectPeer = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ConnectPeer_TagsFields,
        ),
    },
)
