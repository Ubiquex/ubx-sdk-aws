...
@dataclasses.dataclass
class CoreNetwork_NetworkFunctionGroups_Segments:
...
@dataclasses.dataclass
class CoreNetwork_NetworkFunctionGroups:
...
CoreNetwork = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_CoreNetwork_TagsFields,
        ),
    },
)
