...
class Function_CustomOutputConfiguration:
    output: Any = None
    runtime: Any = None

@dataclasses.dataclass
class Function_HttpRequestConfiguration:
...
@dataclasses.dataclass
class Function_SequentialExecutorConfiguration_FunctionList:
...
@dataclasses.dataclass
class Function_SequentialExecutorConfiguration:
...
_Function_CustomOutputConfigurationFields = {
    "output": ubx.FieldSpec(wire_name="output"),
    "runtime": ubx.FieldSpec(wire_name="runtime"),
}

_Function_HttpRequestConfigurationFields = {
...
_Function_SequentialExecutorConfiguration_FunctionListFields = {
    "function_id": ubx.FieldSpec(wire_name="function_id"),
    "run_condition": ubx.FieldSpec(wire_name="run_condition"),
}

_Function_SequentialExecutorConfigurationFields = {
    "function_list": ubx.FieldSpec(
        wire_name="function_list",
        kind="list",
        fields=_Function_SequentialExecutorConfiguration_FunctionListFields,
    ),
    "output": ubx.FieldSpec(wire_name="output"),
    "runtime": ubx.FieldSpec(wire_name="runtime"),
...
Function = ubx.ResourceBinding(
    ...
    fields={
        "custom_output_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Function_CustomOutputConfigurationFields,
        ),
        ...
        "http_request_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Function_HttpRequestConfigurationFields,
        ),
        "sequential_executor_configuration": ubx.FieldSpec(
            wire_name="sequential_executor_configuration",
            kind="object",
            fields=_Function_SequentialExecutorConfigurationFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
