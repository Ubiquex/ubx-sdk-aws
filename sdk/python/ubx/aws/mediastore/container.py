...
@dataclasses.dataclass
class Container_MetricPolicy_MetricPolicyRules:
...
_Container_MetricPolicyFields = {
    ...
    "metric_policy_rules": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Container_MetricPolicy_MetricPolicyRulesFields,
    ),
}
