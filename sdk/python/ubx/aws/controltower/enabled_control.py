...
class EnabledControl_Parameters:
...
_EnabledControl_ParametersFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_EnabledControl_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class EnabledControlConfig:
    # Arn of the control.
...
EnabledControl = ubx.ResourceBinding(
    ...
    fields={
        ...
        "parameters": ubx.FieldSpec(
            ...
            kind="list",
            fields=_EnabledControl_ParametersFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_EnabledControl_TagsFields,
        ),
