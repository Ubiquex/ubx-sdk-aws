...
class BillScenario_BillInterval:
    end: Any = None
...
_BillScenario_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class BillScenarioConfig:
...
BillScenario = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_BillScenario_TagsFields,
        ),
    },
)
