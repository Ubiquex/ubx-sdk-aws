...
@dataclasses.dataclass
class IntermediateTable_AnalysisRules_Policy_V1_Custom_DifferentialPrivacy:
...
@dataclasses.dataclass
class IntermediateTable_AnalysisRules_Policy_V1:
...
@dataclasses.dataclass
class IntermediateTable_AnalysisRules_Policy:
    v1: Any = None

@dataclasses.dataclass
class IntermediateTable_AnalysisRules:
    policy: Any = None
    type: Any = None

@dataclasses.dataclass
class IntermediateTable_PopulationAnalysisConfiguration_SqlParameters:
...
@dataclasses.dataclass
class IntermediateTable_PopulationAnalysisConfiguration:
...
_IntermediateTable_AnalysisRules_Policy_V1_Custom_DifferentialPrivacyFields = {
    "columns": ubx.FieldSpec(
        wire_name="columns",
        kind="list",
        fields=_IntermediateTable_AnalysisRules_Policy_V1_Custom_DifferentialPrivacy_ColumnsFields,
    ),
}
...
_IntermediateTable_AnalysisRules_Policy_V1_CustomFields = {
    ...
    "differential_privacy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_IntermediateTable_AnalysisRules_Policy_V1_Custom_DifferentialPrivacyFields,
    ),
    "disallowed_output_columns": ubx.FieldSpec(wire_name="disallowed_output_columns"),
}

_IntermediateTable_AnalysisRules_Policy_V1Fields = {
    "custom": ubx.FieldSpec(
        wire_name="custom",
        kind="object",
        fields=_IntermediateTable_AnalysisRules_Policy_V1_CustomFields,
    ),
}

_IntermediateTable_AnalysisRules_PolicyFields = {
    "v1": ubx.FieldSpec(
        wire_name="v1",
        kind="object",
        fields=_IntermediateTable_AnalysisRules_Policy_V1Fields,
    ),
}

_IntermediateTable_AnalysisRulesFields = {
    "policy": ubx.FieldSpec(
        wire_name="policy",
        kind="object",
        fields=_IntermediateTable_AnalysisRules_PolicyFields,
    ),
    "type": ubx.FieldSpec(wire_name="type"),
}

_IntermediateTable_PopulationAnalysisConfiguration_SqlParametersFields = {
    "analysis_template_arn": ubx.FieldSpec(wire_name="analysis_template_arn"),
    "query_string": ubx.FieldSpec(wire_name="query_string"),
}

_IntermediateTable_PopulationAnalysisConfigurationFields = {
    "sql_parameters": ubx.FieldSpec(
        wire_name="sql_parameters",
        kind="object",
        fields=_IntermediateTable_PopulationAnalysisConfiguration_SqlParametersFields,
    ),
}

_IntermediateTable_TagsFields = {
...
IntermediateTable = ubx.ResourceBinding(
    ...
    fields={
        "analysis_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_IntermediateTable_AnalysisRulesFields,
        ),
        ...
        "population_analysis_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_IntermediateTable_PopulationAnalysisConfigurationFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_IntermediateTable_TagsFields,
        ),
    },
)
