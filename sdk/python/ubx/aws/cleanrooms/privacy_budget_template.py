...
class PrivacyBudgetTemplate_Parameters_BudgetParameters:
...
@dataclasses.dataclass
class PrivacyBudgetTemplate_Parameters:
...
@dataclasses.dataclass
class PrivacyBudgetTemplate_Tags:
    key: Any = None
    value: Any = None

_PrivacyBudgetTemplate_Parameters_BudgetParametersFields = {
    "auto_refresh": ubx.FieldSpec(wire_name="auto_refresh"),
    "budget": ubx.FieldSpec(wire_name="budget"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_PrivacyBudgetTemplate_ParametersFields = {
    "budget_parameters": ubx.FieldSpec(
        wire_name="budget_parameters",
        kind="list",
        fields=_PrivacyBudgetTemplate_Parameters_BudgetParametersFields,
    ),
...
_PrivacyBudgetTemplate_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class PrivacyBudgetTemplateConfig:
...
@dataclasses.dataclass
class PrivacyBudgetTemplateAttrs:
...
PrivacyBudgetTemplate = ubx.ResourceBinding(
    ...
    fields={
        ...
        "parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_PrivacyBudgetTemplate_ParametersFields,
        ),
        "privacy_budget_type": ubx.FieldSpec(wire_name="privacy_budget_type"),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_PrivacyBudgetTemplate_TagsFields,
        ),
    },
)
