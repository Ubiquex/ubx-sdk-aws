...
@dataclasses.dataclass
class Group_ResourceQuery_Query_TagFilters:
...
@dataclasses.dataclass
class Group_ResourceQuery_Query:
...
_Group_ResourceQuery_Query_TagFiltersFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_Group_ResourceQuery_QueryFields = {
    ...
    "tag_filters": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Group_ResourceQuery_Query_TagFiltersFields,
    ),
}
...
_Group_ResourceQueryFields = {
    "query": ubx.FieldSpec(
        wire_name="query",
        kind="object",
        fields=_Group_ResourceQuery_QueryFields,
    ),
    "type": ubx.FieldSpec(wire_name="type"),
}
