...
@dataclasses.dataclass
class CustomDetectionRuleAssociationConfig:
...
@dataclasses.dataclass
class CustomDetectionRuleAssociationAttrs:
...
CustomDetectionRuleAssociation = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_CustomDetectionRuleAssociation_TagsFields,
        ),
    },
)
