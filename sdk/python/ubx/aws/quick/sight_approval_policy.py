...
class SightApprovalPolicy_ApplicableTo:
    # Required when type = GROUP. One or more group ARNs.
    group_arns: Any = None
    type: Any = None

_SightApprovalPolicy_ApplicableToFields = {
    "group_arns": ubx.FieldSpec(wire_name="group_arns"),
    "type": ubx.FieldSpec(wire_name="type"),
}

@dataclasses.dataclass
class SightApprovalPolicyConfig:
...
@dataclasses.dataclass
class SightApprovalPolicyAttrs:
    # List of governed actions a policy applies to.
    actions: Any = None
    # Scoping: who the policy applies to. GROUP: `groupArns` required (one or more group ARNs).
    applicable_to: Any = None
...
SightApprovalPolicy = ubx.ResourceBinding(
    ...
    fields={
        ...
        "applicable_to": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SightApprovalPolicy_ApplicableToFields,
        ),
