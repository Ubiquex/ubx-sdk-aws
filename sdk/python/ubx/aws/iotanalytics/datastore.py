...
class Datastore_DatastorePartitions_Partitions_Partition:
...
@dataclasses.dataclass
class Datastore_DatastorePartitions_Partitions_TimestampPartition:
...
@dataclasses.dataclass
class Datastore_DatastorePartitions_Partitions:
...
@dataclasses.dataclass
class Datastore_DatastorePartitions:
...
@dataclasses.dataclass
class Datastore_DatastoreStorage_CustomerManagedS3:
...
@dataclasses.dataclass
class Datastore_DatastoreStorage_IotSiteWiseMultiLayerStorage_CustomerManagedS3Storage:
...
@dataclasses.dataclass
class Datastore_DatastoreStorage_IotSiteWiseMultiLayerStorage:
...
@dataclasses.dataclass
class Datastore_DatastoreStorage:
...
@dataclasses.dataclass
class Datastore_FileFormatConfiguration_ParquetConfiguration_SchemaDefinition_Columns:
...
@dataclasses.dataclass
class Datastore_FileFormatConfiguration_ParquetConfiguration_SchemaDefinition:
...
@dataclasses.dataclass
class Datastore_FileFormatConfiguration_ParquetConfiguration:
...
@dataclasses.dataclass
class Datastore_FileFormatConfiguration:
...
@dataclasses.dataclass
class Datastore_RetentionPeriod:
...
_Datastore_DatastorePartitions_Partitions_PartitionFields = {
    "attribute_name": ubx.FieldSpec(wire_name="attribute_name"),
}

_Datastore_DatastorePartitions_Partitions_TimestampPartitionFields = {
    "attribute_name": ubx.FieldSpec(wire_name="attribute_name"),
    "timestamp_format": ubx.FieldSpec(wire_name="timestamp_format"),
}

_Datastore_DatastorePartitions_PartitionsFields = {
    "partition": ubx.FieldSpec(
        wire_name="partition",
        kind="object",
        fields=_Datastore_DatastorePartitions_Partitions_PartitionFields,
    ),
    "timestamp_partition": ubx.FieldSpec(
        wire_name="timestamp_partition",
        kind="object",
        fields=_Datastore_DatastorePartitions_Partitions_TimestampPartitionFields,
    ),
}

_Datastore_DatastorePartitionsFields = {
    "partitions": ubx.FieldSpec(
        wire_name="partitions",
        kind="list",
        fields=_Datastore_DatastorePartitions_PartitionsFields,
    ),
}

_Datastore_DatastoreStorage_CustomerManagedS3Fields = {
...
_Datastore_DatastoreStorage_IotSiteWiseMultiLayerStorage_CustomerManagedS3StorageFields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "key_prefix": ubx.FieldSpec(wire_name="key_prefix"),
}

_Datastore_DatastoreStorage_IotSiteWiseMultiLayerStorageFields = {
    "customer_managed_s3_storage": ubx.FieldSpec(
        wire_name="customer_managed_s3_storage",
        kind="object",
        fields=_Datastore_DatastoreStorage_IotSiteWiseMultiLayerStorage_CustomerManagedS3StorageFields,
    ),
}

_Datastore_DatastoreStorageFields = {
    "customer_managed_s3": ubx.FieldSpec(
        wire_name="customer_managed_s3",
        kind="object",
        fields=_Datastore_DatastoreStorage_CustomerManagedS3Fields,
    ),
    "iot_site_wise_multi_layer_storage": ubx.FieldSpec(
        wire_name="iot_site_wise_multi_layer_storage",
        kind="object",
        fields=_Datastore_DatastoreStorage_IotSiteWiseMultiLayerStorageFields,
    ),
    "service_managed_s3": ubx.FieldSpec(wire_name="service_managed_s3"),
}

_Datastore_FileFormatConfiguration_ParquetConfiguration_SchemaDefinition_ColumnsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_Datastore_FileFormatConfiguration_ParquetConfiguration_SchemaDefinitionFields = {
    "columns": ubx.FieldSpec(
        wire_name="columns",
        kind="list",
        fields=_Datastore_FileFormatConfiguration_ParquetConfiguration_SchemaDefinition_ColumnsFields,
    ),
}

_Datastore_FileFormatConfiguration_ParquetConfigurationFields = {
    "schema_definition": ubx.FieldSpec(
        wire_name="schema_definition",
        kind="object",
        fields=_Datastore_FileFormatConfiguration_ParquetConfiguration_SchemaDefinitionFields,
    ),
}

_Datastore_FileFormatConfigurationFields = {
    ...
    "parquet_configuration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Datastore_FileFormatConfiguration_ParquetConfigurationFields,
    ),
}

_Datastore_RetentionPeriodFields = {
    "number_of_days": ubx.FieldSpec(wire_name="number_of_days"),
    "unlimited": ubx.FieldSpec(wire_name="unlimited"),
}

_Datastore_TagsFields = {
...
Datastore = ubx.ResourceBinding(
    ...
    fields={
        ...
        "datastore_partitions": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Datastore_DatastorePartitionsFields,
        ),
        "datastore_storage": ubx.FieldSpec(
            wire_name="datastore_storage",
            kind="object",
            fields=_Datastore_DatastoreStorageFields,
        ),
        "file_format_configuration": ubx.FieldSpec(
            wire_name="file_format_configuration",
            kind="object",
            fields=_Datastore_FileFormatConfigurationFields,
        ),
        "retention_period": ubx.FieldSpec(
            wire_name="retention_period",
            kind="object",
            fields=_Datastore_RetentionPeriodFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_Datastore_TagsFields,
        ),
    },
)
