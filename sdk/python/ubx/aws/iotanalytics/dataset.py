...
class Dataset_Actions_ContainerAction_ResourceConfiguration:
...
@dataclasses.dataclass
class Dataset_Actions_ContainerAction_Variables_DatasetContentVersionValue:
...
@dataclasses.dataclass
class Dataset_Actions_ContainerAction_Variables_OutputFileUriValue:
    file_name: Any = None

@dataclasses.dataclass
class Dataset_Actions_ContainerAction_Variables:
...
@dataclasses.dataclass
class Dataset_Actions_ContainerAction:
...
@dataclasses.dataclass
class Dataset_Actions_QueryAction_Filters_DeltaTime:
...
@dataclasses.dataclass
class Dataset_Actions_QueryAction_Filters:
...
@dataclasses.dataclass
class Dataset_Actions_QueryAction:
...
@dataclasses.dataclass
class Dataset_ContentDeliveryRules_Destination_IotEventsDestinationConfiguration:
...
@dataclasses.dataclass
class Dataset_ContentDeliveryRules_Destination_S3DestinationConfiguration_GlueConfiguration:
...
@dataclasses.dataclass
class Dataset_ContentDeliveryRules_Destination_S3DestinationConfiguration:
...
@dataclasses.dataclass
class Dataset_ContentDeliveryRules_Destination:
...
@dataclasses.dataclass
class Dataset_ContentDeliveryRules:
...
@dataclasses.dataclass
class Dataset_LateDataRules_RuleConfiguration_DeltaTimeSessionWindowConfiguration:
...
@dataclasses.dataclass
class Dataset_LateDataRules_RuleConfiguration:
...
@dataclasses.dataclass
class Dataset_Triggers_Schedule:
...
@dataclasses.dataclass
class Dataset_VersioningConfiguration:
...
_Dataset_Actions_ContainerActionFields = {
    ...
    "resource_configuration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Dataset_Actions_ContainerAction_ResourceConfigurationFields,
    ),
    "variables": ubx.FieldSpec(
        wire_name="variables",
        kind="list",
        fields=_Dataset_Actions_ContainerAction_VariablesFields,
    ),
}

_Dataset_Actions_QueryAction_Filters_DeltaTimeFields = {
    "offset_seconds": ubx.FieldSpec(wire_name="offset_seconds"),
    "time_expression": ubx.FieldSpec(wire_name="time_expression"),
}

_Dataset_Actions_QueryAction_FiltersFields = {
    "delta_time": ubx.FieldSpec(
        wire_name="delta_time",
        kind="object",
        fields=_Dataset_Actions_QueryAction_Filters_DeltaTimeFields,
    ),
}

_Dataset_Actions_QueryActionFields = {
    "filters": ubx.FieldSpec(
        wire_name="filters",
        kind="list",
        fields=_Dataset_Actions_QueryAction_FiltersFields,
    ),
    "sql_query": ubx.FieldSpec(wire_name="sql_query"),
}

_Dataset_ActionsFields = {
    "action_name": ubx.FieldSpec(wire_name="action_name"),
    "container_action": ubx.FieldSpec(
        wire_name="container_action",
        kind="object",
        fields=_Dataset_Actions_ContainerActionFields,
    ),
    "query_action": ubx.FieldSpec(
        wire_name="query_action",
        kind="object",
        fields=_Dataset_Actions_QueryActionFields,
    ),
}

_Dataset_ContentDeliveryRules_Destination_IotEventsDestinationConfigurationFields = {
    "input_name": ubx.FieldSpec(wire_name="input_name"),
    "role_arn": ubx.FieldSpec(wire_name="role_arn"),
}

_Dataset_ContentDeliveryRules_Destination_S3DestinationConfiguration_GlueConfigurationFields = {
    "database_name": ubx.FieldSpec(wire_name="database_name"),
    "table_name": ubx.FieldSpec(wire_name="table_name"),
}

_Dataset_ContentDeliveryRules_Destination_S3DestinationConfigurationFields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "glue_configuration": ubx.FieldSpec(
        wire_name="glue_configuration",
        kind="object",
        fields=_Dataset_ContentDeliveryRules_Destination_S3DestinationConfiguration_GlueConfigurationFields,
    ),
    "key": ubx.FieldSpec(wire_name="key"),
    "role_arn": ubx.FieldSpec(wire_name="role_arn"),
}

_Dataset_ContentDeliveryRules_DestinationFields = {
    "iot_events_destination_configuration": ubx.FieldSpec(
        wire_name="iot_events_destination_configuration",
        kind="object",
        fields=_Dataset_ContentDeliveryRules_Destination_IotEventsDestinationConfigurationFields,
    ),
    "s3_destination_configuration": ubx.FieldSpec(
        wire_name="s3_destination_configuration",
        kind="object",
        fields=_Dataset_ContentDeliveryRules_Destination_S3DestinationConfigurationFields,
    ),
}

_Dataset_ContentDeliveryRulesFields = {
    "destination": ubx.FieldSpec(
        wire_name="destination",
        kind="object",
        fields=_Dataset_ContentDeliveryRules_DestinationFields,
    ),
    "entry_name": ubx.FieldSpec(wire_name="entry_name"),
}

_Dataset_LateDataRules_RuleConfiguration_DeltaTimeSessionWindowConfigurationFields = {
    "timeout_in_minutes": ubx.FieldSpec(wire_name="timeout_in_minutes"),
}

_Dataset_LateDataRules_RuleConfigurationFields = {
    "delta_time_session_window_configuration": ubx.FieldSpec(
        wire_name="delta_time_session_window_configuration",
        kind="object",
        fields=_Dataset_LateDataRules_RuleConfiguration_DeltaTimeSessionWindowConfigurationFields,
    ),
}

_Dataset_LateDataRulesFields = {
    "rule_configuration": ubx.FieldSpec(
        wire_name="rule_configuration",
        kind="object",
        fields=_Dataset_LateDataRules_RuleConfigurationFields,
    ),
    "rule_name": ubx.FieldSpec(wire_name="rule_name"),
}

_Dataset_RetentionPeriodFields = {
...
_Dataset_Triggers_ScheduleFields = {
    "schedule_expression": ubx.FieldSpec(wire_name="schedule_expression"),
}

_Dataset_TriggersFields = {
    "schedule": ubx.FieldSpec(
        wire_name="schedule",
        kind="object",
        fields=_Dataset_Triggers_ScheduleFields,
    ),
...
_Dataset_VersioningConfigurationFields = {
...
Dataset = ubx.ResourceBinding(
    ...
    fields={
        ...
        "triggers": ubx.FieldSpec(
            wire_name="triggers",
            kind="list",
            fields=_Dataset_TriggersFields,
        ),
        "versioning_configuration": ubx.FieldSpec(
            wire_name="versioning_configuration",
            kind="object",
            fields=_Dataset_VersioningConfigurationFields,
        ),
    },
)
