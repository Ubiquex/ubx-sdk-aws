...
class OriginRequestPolicy_OriginRequestPolicyConfig_CookiesConfig:
...
@dataclasses.dataclass
class OriginRequestPolicy_OriginRequestPolicyConfig_HeadersConfig:
...
@dataclasses.dataclass
class OriginRequestPolicy_OriginRequestPolicyConfig_QueryStringsConfig:
...
@dataclasses.dataclass
class OriginRequestPolicy_OriginRequestPolicyConfig:
...
@dataclasses.dataclass
class OriginRequestPolicyAttrs:
...
OriginRequestPolicy = ubx.ResourceBinding(
    ...
    fields={
        "origin_request_policy_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_OriginRequestPolicy_OriginRequestPolicyConfigFields,
        ),
    },
)
