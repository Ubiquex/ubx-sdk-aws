...
class StreamingDistribution_StreamingDistributionConfig_Logging:
...
@dataclasses.dataclass
class StreamingDistribution_StreamingDistributionConfig_S3Origin:
...
@dataclasses.dataclass
class StreamingDistribution_StreamingDistributionConfig_TrustedSigners:
...
@dataclasses.dataclass
class StreamingDistribution_StreamingDistributionConfig:
...
@dataclasses.dataclass
class StreamingDistribution_Tags:
...
_StreamingDistribution_StreamingDistributionConfigFields = {
    ...
    "logging": ubx.FieldSpec(
        wire_name="logging",
        kind="object",
        fields=_StreamingDistribution_StreamingDistributionConfig_LoggingFields,
    ),
    "price_class": ubx.FieldSpec(wire_name="price_class"),
    "s3_origin": ubx.FieldSpec(
        wire_name="s3_origin",
        kind="object",
        fields=_StreamingDistribution_StreamingDistributionConfig_S3OriginFields,
    ),
    "trusted_signers": ubx.FieldSpec(
        wire_name="trusted_signers",
        kind="object",
        fields=_StreamingDistribution_StreamingDistributionConfig_TrustedSignersFields,
    ),
}

_StreamingDistribution_TagsFields = {
...
@dataclasses.dataclass
class StreamingDistributionAttrs:
...
StreamingDistribution = ubx.ResourceBinding(
    ...
    fields={
        "streaming_distribution_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_StreamingDistribution_StreamingDistributionConfigFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_StreamingDistribution_TagsFields,
        ),
    },
)
