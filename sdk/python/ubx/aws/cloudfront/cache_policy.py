...
class CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfig:
...
@dataclasses.dataclass
class CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfig:
...
@dataclasses.dataclass
class CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfig:
...
@dataclasses.dataclass
class CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin:
...
@dataclasses.dataclass
class CachePolicy_CachePolicyConfig:
...
_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfigFields = {
    "cookie_behavior": ubx.FieldSpec(wire_name="cookie_behavior"),
    "cookies": ubx.FieldSpec(wire_name="cookies"),
}

_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfigFields = {
    "header_behavior": ubx.FieldSpec(wire_name="header_behavior"),
    "headers": ubx.FieldSpec(wire_name="headers"),
}

_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfigFields = {
    "query_string_behavior": ubx.FieldSpec(wire_name="query_string_behavior"),
    "query_strings": ubx.FieldSpec(wire_name="query_strings"),
}

_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOriginFields = {
    "cookies_config": ubx.FieldSpec(
        wire_name="cookies_config",
        kind="object",
        fields=_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfigFields,
    ),
    ...
    "headers_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfigFields,
    ),
    "query_strings_config": ubx.FieldSpec(
        wire_name="query_strings_config",
        kind="object",
        fields=_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfigFields,
    ),
}

_CachePolicy_CachePolicyConfigFields = {
    ...
    "parameters_in_cache_key_and_forwarded_to_origin": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOriginFields,
    ),
}
...
CachePolicy = ubx.ResourceBinding(
    ...
    fields={
        "cache_policy_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CachePolicy_CachePolicyConfigFields,
        ),
    },
)
