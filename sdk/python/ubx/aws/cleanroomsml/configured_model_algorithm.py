...
class ConfiguredModelAlgorithm_InferenceContainerConfig:
...
@dataclasses.dataclass
class ConfiguredModelAlgorithm_Tags:
...
@dataclasses.dataclass
class ConfiguredModelAlgorithm_TrainingContainerConfig_MetricDefinitions:
...
@dataclasses.dataclass
class ConfiguredModelAlgorithm_TrainingContainerConfig:
...
_ConfiguredModelAlgorithm_InferenceContainerConfigFields = {
    "image_uri": ubx.FieldSpec(wire_name="image_uri"),
}

_ConfiguredModelAlgorithm_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_ConfiguredModelAlgorithm_TrainingContainerConfig_MetricDefinitionsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "regex": ubx.FieldSpec(wire_name="regex"),
}

_ConfiguredModelAlgorithm_TrainingContainerConfigFields = {
    ...
    "metric_definitions": ubx.FieldSpec(
        ...
        kind="list",
        fields=_ConfiguredModelAlgorithm_TrainingContainerConfig_MetricDefinitionsFields,
    ),
}

@dataclasses.dataclass
class ConfiguredModelAlgorithmConfig:
...
@dataclasses.dataclass
class ConfiguredModelAlgorithmAttrs:
...
ConfiguredModelAlgorithm = ubx.ResourceBinding(
    ...
    fields={
        ...
        "inference_container_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ConfiguredModelAlgorithm_InferenceContainerConfigFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ConfiguredModelAlgorithm_TagsFields,
        ),
        "training_container_config": ubx.FieldSpec(
            wire_name="training_container_config",
            kind="object",
            fields=_ConfiguredModelAlgorithm_TrainingContainerConfigFields,
        ),
    },
)
