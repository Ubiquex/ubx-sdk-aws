...
class PackagingGroup_Authorization:
...
@dataclasses.dataclass
class PackagingGroup_EgressAccessLogs:
...
_PackagingGroup_AuthorizationFields = {
...
_PackagingGroup_EgressAccessLogsFields = {
    "log_group_name": ubx.FieldSpec(wire_name="log_group_name"),
}

_PackagingGroup_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class PackagingGroupConfig:
