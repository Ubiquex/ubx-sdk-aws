# Code generated by `ubx sdk gen` from aws_security_hub_finding_aggregator. DO NOT EDIT.
...
class HubFindingAggregatorConfig:
...
@dataclasses.dataclass
class HubFindingAggregatorAttrs:
    # The AWS Region where the finding aggregator is created and where findings from linked Regions are aggregated. (AI-inferred)
    finding_aggregation_region: Any = None
    # The Amazon Resource Name (ARN) that uniquely identifies the finding aggregator. (AI-inferred)
...
HubFindingAggregator = ubx.ResourceBinding(
    wire_type="aws_security_hub_finding_aggregator",
    fields={
