...
class AgentTargetDomain_Tags:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class AgentTargetDomain_VerificationDetails_DnsTxt:
...
@dataclasses.dataclass
class AgentTargetDomain_VerificationDetails_HttpRoute:
...
@dataclasses.dataclass
class AgentTargetDomain_VerificationDetails:
...
_AgentTargetDomain_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class AgentTargetDomainConfig:
...
AgentTargetDomain = ubx.ResourceBinding(
    wire_type="aws_security_agent_target_domain",
    fields={
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_AgentTargetDomain_TagsFields,
        ),
