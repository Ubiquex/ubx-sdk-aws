...
class ZonalAutoshiftConfiguration_PracticeRunConfiguration_BlockingAlarms:
...
@dataclasses.dataclass
class ZonalAutoshiftConfiguration_PracticeRunConfiguration:
...
_ZonalAutoshiftConfiguration_PracticeRunConfiguration_BlockingAlarmsFields = {
    "alarm_identifier": ubx.FieldSpec(wire_name="alarm_identifier"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_ZonalAutoshiftConfiguration_PracticeRunConfigurationFields = {
    ...
    "blocking_alarms": ubx.FieldSpec(
        ...
        kind="list",
        fields=_ZonalAutoshiftConfiguration_PracticeRunConfiguration_BlockingAlarmsFields,
    ),
...
@dataclasses.dataclass
class ZonalAutoshiftConfigurationAttrs:
    # Defines the practice run configuration for zonal autoshift, specifying blocking windows/dates and the outcome alarms that must clear for a practice run to be considered successful. (AI-inferred)
    practice_run_configuration: Any = None
    # The identifier (such as an ARN) of the resource for which the zonal autoshift configuration is set, enabling automatic traffic shifting away from an Availability Zone for that resource. (AI-inferred)
    resource_identifier: Any = None
...
ZonalAutoshiftConfiguration = ubx.ResourceBinding(
    ...
    fields={
        "practice_run_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ZonalAutoshiftConfiguration_PracticeRunConfigurationFields,
        ),
