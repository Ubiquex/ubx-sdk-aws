...
class SecurityProfile_AdditionalMetricsToRetainV2_MetricDimension:
...
@dataclasses.dataclass
class SecurityProfile_AdditionalMetricsToRetainV2:
...
@dataclasses.dataclass
class SecurityProfile_Behaviors_Criteria_MlDetectionConfig:
...
@dataclasses.dataclass
class SecurityProfile_Behaviors_Criteria_StatisticalThreshold:
...
@dataclasses.dataclass
class SecurityProfile_Behaviors_Criteria_Value:
...
@dataclasses.dataclass
class SecurityProfile_Behaviors_Criteria:
...
@dataclasses.dataclass
class SecurityProfile_Behaviors:
...
@dataclasses.dataclass
class SecurityProfile_MetricsExportConfig:
...
_SecurityProfile_AdditionalMetricsToRetainV2Fields = {
    ...
    "metric_dimension": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SecurityProfile_AdditionalMetricsToRetainV2_MetricDimensionFields,
    ),
}

_SecurityProfile_Behaviors_Criteria_MlDetectionConfigFields = {
    "confidence_level": ubx.FieldSpec(wire_name="confidence_level"),
}

_SecurityProfile_Behaviors_Criteria_StatisticalThresholdFields = {
    "statistic": ubx.FieldSpec(wire_name="statistic"),
}

_SecurityProfile_Behaviors_Criteria_ValueFields = {
...
_SecurityProfile_Behaviors_CriteriaFields = {
    ...
    "ml_detection_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SecurityProfile_Behaviors_Criteria_MlDetectionConfigFields,
    ),
    "statistical_threshold": ubx.FieldSpec(
        wire_name="statistical_threshold",
        kind="object",
        fields=_SecurityProfile_Behaviors_Criteria_StatisticalThresholdFields,
    ),
    "value": ubx.FieldSpec(
        wire_name="value",
        kind="object",
        fields=_SecurityProfile_Behaviors_Criteria_ValueFields,
    ),
}

_SecurityProfile_BehaviorsFields = {
    "criteria": ubx.FieldSpec(
        wire_name="criteria",
        kind="object",
        fields=_SecurityProfile_Behaviors_CriteriaFields,
    ),
    "export_metric": ubx.FieldSpec(wire_name="export_metric"),
    "metric": ubx.FieldSpec(wire_name="metric"),
    "metric_dimension": ubx.FieldSpec(
...
SecurityProfile = ubx.ResourceBinding(
    ...
    fields={
        "additional_metrics_to_retain_v2": ubx.FieldSpec(
            ...
            kind="list",
            fields=_SecurityProfile_AdditionalMetricsToRetainV2Fields,
        ),
        "alert_targets": ubx.FieldSpec(wire_name="alert_targets"),
        "behaviors": ubx.FieldSpec(
            wire_name="behaviors",
            kind="list",
            fields=_SecurityProfile_BehaviorsFields,
        ),
        "metrics_export_config": ubx.FieldSpec(
            wire_name="metrics_export_config",
            kind="object",
            fields=_SecurityProfile_MetricsExportConfigFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_SecurityProfile_TagsFields,
        ),
