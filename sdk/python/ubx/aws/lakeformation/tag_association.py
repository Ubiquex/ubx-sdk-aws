...
@dataclasses.dataclass
class TagAssociation_Resource_Database:
...
@dataclasses.dataclass
class TagAssociation_Resource_Table:
...
@dataclasses.dataclass
class TagAssociation_Resource_TableWithColumns:
...
_TagAssociation_Resource_DatabaseFields = {
    "catalog_id": ubx.FieldSpec(wire_name="catalog_id"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_TagAssociation_Resource_TableFields = {
    "catalog_id": ubx.FieldSpec(wire_name="catalog_id"),
...
_TagAssociation_Resource_TableWithColumnsFields = {
    "catalog_id": ubx.FieldSpec(wire_name="catalog_id"),
...
_TagAssociation_ResourceFields = {
    "catalog": ubx.FieldSpec(wire_name="catalog"),
    "database": ubx.FieldSpec(
        wire_name="database",
        kind="object",
        fields=_TagAssociation_Resource_DatabaseFields,
    ),
    "table": ubx.FieldSpec(
        wire_name="table",
        kind="object",
        fields=_TagAssociation_Resource_TableFields,
    ),
    "table_with_columns": ubx.FieldSpec(
        wire_name="table_with_columns",
        kind="object",
        fields=_TagAssociation_Resource_TableWithColumnsFields,
    ),
}

@dataclasses.dataclass
class TagAssociationConfig:
...
TagAssociation = ubx.ResourceBinding(
    wire_type="aws_lake_formation_tag_association",
    fields={
        "lftags": ubx.FieldSpec(
            wire_name="lftags",
            kind="list",
            fields=_TagAssociation_LftagsFields,
        ),
        "resource": ubx.FieldSpec(
            wire_name="resource",
            kind="object",
            fields=_TagAssociation_ResourceFields,
        ),
    },
)
