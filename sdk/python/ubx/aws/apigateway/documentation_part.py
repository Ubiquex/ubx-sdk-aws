...
class DocumentationPart_Location:
...
_DocumentationPart_LocationFields = {
...
DocumentationPart = ubx.ResourceBinding(
    wire_type="aws_api_gateway_documentation_part",
    fields={
        "location": ubx.FieldSpec(
            wire_name="location",
            kind="object",
            fields=_DocumentationPart_LocationFields,
        ),
