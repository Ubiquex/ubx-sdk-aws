...
UsagePlan = ubx.ResourceBinding(
    wire_type="aws_api_gateway_usage_plan",
    fields={
        "api_stages": ubx.FieldSpec(
            wire_name="api_stages",
            kind="list",
            fields=_UsagePlan_ApiStagesFields,
        ),
        "description": ubx.FieldSpec(wire_name="description"),
        "quota": ubx.FieldSpec(
            wire_name="quota",
            kind="object",
            fields=_UsagePlan_QuotaFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_UsagePlan_TagsFields,
        ),
        "throttle": ubx.FieldSpec(
            wire_name="throttle",
            kind="object",
            fields=_UsagePlan_ThrottleFields,
        ),
