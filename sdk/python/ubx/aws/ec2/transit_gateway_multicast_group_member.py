...
class TransitGatewayMulticastGroupMemberConfig:
...
@dataclasses.dataclass
class TransitGatewayMulticastGroupMemberAttrs:
    # The IP address assigned to the transit gateway multicast group.
    group_ip_address: Any = None
...
TransitGatewayMulticastGroupMember = ubx.ResourceBinding(
    wire_type="aws_ec2_transit_gateway_multicast_group_member",
    fields={
