...
class NetworkInterfaceAttachment_EnaSrdSpecification_EnaSrdUdpSpecification:
...
@dataclasses.dataclass
class NetworkInterfaceAttachment_EnaSrdSpecification:
    # Indicates whether ENA Express is enabled for the network interface.
    ena_srd_enabled: Any = None
    # Configures ENA Express for UDP network traffic.
    ena_srd_udp_specification: Any = None

_NetworkInterfaceAttachment_EnaSrdSpecification_EnaSrdUdpSpecificationFields = {
    "ena_srd_udp_enabled": ubx.FieldSpec(wire_name="ena_srd_udp_enabled"),
}

_NetworkInterfaceAttachment_EnaSrdSpecificationFields = {
    ...
    "ena_srd_udp_specification": ubx.FieldSpec(
        ...
        kind="object",
        fields=_NetworkInterfaceAttachment_EnaSrdSpecification_EnaSrdUdpSpecificationFields,
    ),
}

@dataclasses.dataclass
class NetworkInterfaceAttachmentConfig:
...
@dataclasses.dataclass
class NetworkInterfaceAttachmentAttrs:
...
NetworkInterfaceAttachment = ubx.ResourceBinding(
    ...
    fields={
        ...
        "ena_srd_specification": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkInterfaceAttachment_EnaSrdSpecificationFields,
        ),
