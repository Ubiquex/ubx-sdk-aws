...
class PhidetectionJob_ComprehendMedicalAsyncJobProperties_InputDataConfig:
    s3_bucket: Any = None
    s3_key: Any = None

@dataclasses.dataclass
class PhidetectionJob_ComprehendMedicalAsyncJobProperties:
...
@dataclasses.dataclass
class PhidetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class PhidetectionJobAttrs:
    # <p>Provides information about a detection job.</p>
    comprehend_medical_async_job_properties: Any = None
    job_id: Any = None

PhidetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehendmedical_phidetection_job",
    fields={
