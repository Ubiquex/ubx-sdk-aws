...
class CostForecast_Filter_And:
    pass

@dataclasses.dataclass
class CostForecast_Filter_CostCategories:
...
@dataclasses.dataclass
class CostForecast_ForecastResultsByTime_TimePeriod:
    end: Any = None
    start: Any = None

@dataclasses.dataclass
class CostForecast_ForecastResultsByTime:
    mean_value: Any = None
...
@dataclasses.dataclass
class CostForecast_Total:
    amount: Any = None
    unit: Any = None

_CostForecast_Filter_AndFields = {
}

_CostForecast_Filter_CostCategoriesFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "match_options": ubx.FieldSpec(wire_name="match_options"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_CostForecast_FilterFields = {
    "and_": ubx.FieldSpec(
        wire_name="and",
        kind="list",
        fields=_CostForecast_Filter_AndFields,
    ),
    "cost_categories": ubx.FieldSpec(
        wire_name="cost_categories",
        kind="object",
        fields=_CostForecast_Filter_CostCategoriesFields,
    ),
...
_CostForecast_ForecastResultsByTime_TimePeriodFields = {
...
CostForecast = ubx.DataSourceBinding(
    wire_type="aws_ce_cost_forecast",
    fields={
        "billing_view_arn": ubx.FieldSpec(wire_name="billing_view_arn"),
        "filter": ubx.FieldSpec(
            wire_name="filter",
            kind="object",
            fields=_CostForecast_FilterFields,
        ),
        ...
        "time_period": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CostForecast_ForecastResultsByTime_TimePeriodFields,
        ),
    },
)
