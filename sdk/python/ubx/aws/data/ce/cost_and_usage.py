...
class CostAndUsage_DimensionValueAttributes:
    attributes: Any = None
    value: Any = None

@dataclasses.dataclass
class CostAndUsage_Filter_And:
    pass

@dataclasses.dataclass
class CostAndUsage_Filter_CostCategories:
...
@dataclasses.dataclass
class CostAndUsage_GroupBy:
    key: Any = None
    type: Any = None

@dataclasses.dataclass
class CostAndUsage_ResultsByTime_Groups_Metrics:
    amount: Any = None
    unit: Any = None

@dataclasses.dataclass
class CostAndUsage_ResultsByTime_Groups:
    keys: Any = None
    metrics: Any = None

@dataclasses.dataclass
class CostAndUsage_ResultsByTime_TimePeriod:
    end: Any = None
    start: Any = None

@dataclasses.dataclass
class CostAndUsage_ResultsByTime:
    estimated: Any = None
    groups: Any = None
    time_period: Any = None
    total: Any = None

_CostAndUsage_Filter_AndFields = {
}

_CostAndUsage_Filter_CostCategoriesFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "match_options": ubx.FieldSpec(wire_name="match_options"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_CostAndUsage_FilterFields = {
    "and_": ubx.FieldSpec(
        wire_name="and",
        kind="list",
        fields=_CostAndUsage_Filter_AndFields,
    ),
    "cost_categories": ubx.FieldSpec(
        wire_name="cost_categories",
        kind="object",
        fields=_CostAndUsage_Filter_CostCategoriesFields,
    ),
...
_CostAndUsage_GroupByFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_CostAndUsage_ResultsByTime_TimePeriodFields = {
    "end": ubx.FieldSpec(wire_name="end"),
    "start": ubx.FieldSpec(wire_name="start"),
}

@dataclasses.dataclass
class CostAndUsageConfig:
...
CostAndUsage = ubx.DataSourceBinding(
    wire_type="aws_ce_cost_and_usage",
    fields={
        "billing_view_arn": ubx.FieldSpec(wire_name="billing_view_arn"),
        "filter": ubx.FieldSpec(
            wire_name="filter",
            kind="object",
            fields=_CostAndUsage_FilterFields,
        ),
        "granularity": ubx.FieldSpec(wire_name="granularity"),
        "group_by": ubx.FieldSpec(
            wire_name="group_by",
            kind="list",
            fields=_CostAndUsage_GroupByFields,
        ),
        ...
        "time_period": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CostAndUsage_ResultsByTime_TimePeriodFields,
        ),
    },
)
