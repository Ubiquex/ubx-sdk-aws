...
class ResourceGroupsTagSyncTask_ResourceQuery:
    query: Any = None
    type: Any = None

@dataclasses.dataclass
class ResourceGroupsTagSyncTaskConfig:
    task_arn: Any = None

@dataclasses.dataclass
class ResourceGroupsTagSyncTaskAttrs:
    created_at: Any = None
...
ResourceGroupsTagSyncTask = ubx.DataSourceBinding(
