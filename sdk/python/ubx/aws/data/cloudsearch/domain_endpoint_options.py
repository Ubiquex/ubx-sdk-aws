...
class DomainEndpointOptions_DomainEndpointOptions_Options:
    enforce_https: Any = None
    # <p>The minimum required TLS version.</p>
    tlssecurity_policy: Any = None

@dataclasses.dataclass
class DomainEndpointOptions_DomainEndpointOptions_Status:
...
@dataclasses.dataclass
class DomainEndpointOptions_DomainEndpointOptions:
...
DomainEndpointOptions = ubx.DataSourceBinding(
    wire_type="aws_cloudsearch_domain_endpoint_options",
    fields={
