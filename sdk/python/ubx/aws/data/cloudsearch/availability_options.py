...
class AvailabilityOptions_AvailabilityOptions_Status:
...
@dataclasses.dataclass
class AvailabilityOptions_AvailabilityOptions:
    options: Any = None
    # <p>The status of domain configuration option.</p>
    status: Any = None

@dataclasses.dataclass
class AvailabilityOptionsConfig:
    deployed: Any = None
    # <p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p>
    domain_name: Any = None

@dataclasses.dataclass
class AvailabilityOptionsAttrs:
    # <p>The status and configuration of the domain's availability options.</p>
    availability_options: Any = None
    deployed: Any = None
    # <p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p>
    domain_name: Any = None

AvailabilityOptions = ubx.DataSourceBinding(
    wire_type="aws_cloudsearch_availability_options",
    fields={
