...
class CachePolicyConfig_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfig_Cookies:
    items: Any = None
    quantity: Any = None

@dataclasses.dataclass
class CachePolicyConfig_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfig:
    cookie_behavior: Any = None
    # <p>Contains a list of cookie names.</p>
    cookies: Any = None

@dataclasses.dataclass
class CachePolicyConfig_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfig:
    header_behavior: Any = None
    # <p>Contains a list of HTTP header names.</p>
    headers: Any = None

@dataclasses.dataclass
class CachePolicyConfig_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfig:
    query_string_behavior: Any = None
    # <p>Contains a list of query string names.</p>
    query_strings: Any = None

@dataclasses.dataclass
class CachePolicyConfig_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin:
...
@dataclasses.dataclass
class CachePolicyConfig_CachePolicyConfig:
    comment: Any = None
...
@dataclasses.dataclass
class CachePolicyConfigConfig:
    id: Any = None

@dataclasses.dataclass
class CachePolicyConfigAttrs:
...
CachePolicyConfig = ubx.DataSourceBinding(
    wire_type="aws_cloudfront_cache_policy_config",
    fields={
