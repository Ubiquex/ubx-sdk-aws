...
class PackagesForDomain_DomainPackageDetailsList_AssociationConfiguration_KeyStoreAccessOption:
    key_access_role_arn: Any = None
    key_store_access_enabled: Any = None

@dataclasses.dataclass
class PackagesForDomain_DomainPackageDetailsList_AssociationConfiguration:
...
PackagesForDomain = ubx.DataSourceBinding(
    wire_type="aws_opensearch_packages_for_domain",
    fields={
