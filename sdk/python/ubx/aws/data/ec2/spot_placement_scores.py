...
class SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_AcceleratorCount:
    max: Any = None
    min: Any = None

@dataclasses.dataclass
class SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_Cpu_References:
    instance_family: Any = None

@dataclasses.dataclass
class SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_Cpu:
    references: Any = None

@dataclasses.dataclass
class SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors:
    # <p>The CPU performance to consider, using an instance family as the baseline reference.</p>
    cpu: Any = None

@dataclasses.dataclass
class SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements:
...
@dataclasses.dataclass
class SpotPlacementScores_InstanceRequirementsWithMetadata:
...
@dataclasses.dataclass
class SpotPlacementScores_SpotPlacementScores:
    availability_zone_id: Any = None
    region: Any = None
    score: Any = None

_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_AcceleratorCountFields = {
    "max": ubx.FieldSpec(wire_name="max"),
    "min": ubx.FieldSpec(wire_name="min"),
}

_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_Cpu_ReferencesFields = {
    "instance_family": ubx.FieldSpec(wire_name="instance_family"),
}

_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_CpuFields = {
    "references": ubx.FieldSpec(
        wire_name="references",
        kind="list",
        fields=_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_Cpu_ReferencesFields,
    ),
}

_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactorsFields = {
    "cpu": ubx.FieldSpec(
        wire_name="cpu",
        kind="object",
        fields=_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_CpuFields,
    ),
}

_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirementsFields = {
    "accelerator_count": ubx.FieldSpec(
        wire_name="accelerator_count",
        kind="object",
        fields=_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_AcceleratorCountFields,
    ),
    ...
    "baseline_performance_factors": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactorsFields,
    ),
...
_SpotPlacementScores_InstanceRequirementsWithMetadataFields = {
    ...
    "instance_requirements": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirementsFields,
    ),
    "virtualization_types": ubx.FieldSpec(wire_name="virtualization_types"),
}

@dataclasses.dataclass
class SpotPlacementScoresConfig:
    dry_run: Any = None
    include_local_zones: Any = None
    ...
    instance_requirements_with_metadata: Any = None
...
@dataclasses.dataclass
class SpotPlacementScoresAttrs:
    dry_run: Any = None
    include_local_zones: Any = None
    # <p>The architecture type, virtualization type, and other attributes for the instance types. When you specify instance attributes, Amazon EC2 will identify instance types with those attributes.</p> <p>If you specify <code>InstanceRequirementsWithMetadataRequest</code>, you can't specify <code>InstanceTypes</code>.</p>
    instance_requirements_with_metadata: Any = None
    ...
    region_names: Any = None
    single_availability_zone: Any = None
    spot_placement_scores: Any = None
    target_capacity: Any = None
    target_capacity_unit_type: Any = None

SpotPlacementScores = ubx.DataSourceBinding(
    wire_type="aws_ec2_spot_placement_scores",
    fields={
        "dry_run": ubx.FieldSpec(wire_name="dry_run"),
        "include_local_zones": ubx.FieldSpec(wire_name="include_local_zones"),
        "instance_requirements_with_metadata": ubx.FieldSpec(
            wire_name="instance_requirements_with_metadata",
            kind="object",
            fields=_SpotPlacementScores_InstanceRequirementsWithMetadataFields,
        ),
