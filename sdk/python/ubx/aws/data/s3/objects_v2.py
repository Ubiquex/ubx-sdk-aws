...
class ObjectsV2_CommonPrefixes:
    prefix: Any = None

@dataclasses.dataclass
class ObjectsV2_Contents_Owner:
    display_name: Any = None
    id: Any = None

@dataclasses.dataclass
class ObjectsV2_Contents_RestoreStatus:
    is_restore_in_progress: Any = None
    restore_expiry_date: Any = None

@dataclasses.dataclass
class ObjectsV2_Contents:
...
ObjectsV2 = ubx.DataSourceBinding(
    wire_type="aws_s3_objects_v2",
    fields={
        ...
        "fetch_owner": ubx.FieldSpec(wire_name="fetch_owner"),
