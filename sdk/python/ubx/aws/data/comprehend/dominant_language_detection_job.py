...
class DominantLanguageDetectionJob_DominantLanguageDetectionJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class DominantLanguageDetectionJob_DominantLanguageDetectionJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class DominantLanguageDetectionJob_DominantLanguageDetectionJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class DominantLanguageDetectionJob_DominantLanguageDetectionJobProperties_VpcConfig:
    security_group_ids: Any = None
    subnets: Any = None

@dataclasses.dataclass
class DominantLanguageDetectionJob_DominantLanguageDetectionJobProperties:
...
@dataclasses.dataclass
class DominantLanguageDetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class DominantLanguageDetectionJobAttrs:
    # <p>Provides information about a dominant language detection job.</p>
    dominant_language_detection_job_properties: Any = None
    job_id: Any = None

DominantLanguageDetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_dominant_language_detection_job",
    fields={
