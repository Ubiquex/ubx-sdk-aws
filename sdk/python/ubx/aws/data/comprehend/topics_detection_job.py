...
class TopicsDetectionJob_TopicsDetectionJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class TopicsDetectionJob_TopicsDetectionJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class TopicsDetectionJob_TopicsDetectionJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class TopicsDetectionJob_TopicsDetectionJobProperties_VpcConfig:
    security_group_ids: Any = None
    subnets: Any = None

@dataclasses.dataclass
class TopicsDetectionJob_TopicsDetectionJobProperties:
...
@dataclasses.dataclass
class TopicsDetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class TopicsDetectionJobAttrs:
    job_id: Any = None
    # <p>Provides information about a topic detection job.</p>
    topics_detection_job_properties: Any = None

TopicsDetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_topics_detection_job",
    fields={
