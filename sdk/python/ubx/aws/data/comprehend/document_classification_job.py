...
class DocumentClassificationJob_DocumentClassificationJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class DocumentClassificationJob_DocumentClassificationJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class DocumentClassificationJob_DocumentClassificationJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class DocumentClassificationJob_DocumentClassificationJobProperties_VpcConfig:
    security_group_ids: Any = None
    subnets: Any = None

@dataclasses.dataclass
class DocumentClassificationJob_DocumentClassificationJobProperties:
...
@dataclasses.dataclass
class DocumentClassificationJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class DocumentClassificationJobAttrs:
    # <p>Provides information about a document classification job.</p>
    document_classification_job_properties: Any = None
    job_id: Any = None

DocumentClassificationJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_document_classification_job",
    fields={
