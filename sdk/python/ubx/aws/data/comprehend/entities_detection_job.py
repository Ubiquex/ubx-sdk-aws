...
class EntitiesDetectionJob_EntitiesDetectionJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class EntitiesDetectionJob_EntitiesDetectionJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class EntitiesDetectionJob_EntitiesDetectionJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class EntitiesDetectionJob_EntitiesDetectionJobProperties_VpcConfig:
    security_group_ids: Any = None
    subnets: Any = None

@dataclasses.dataclass
class EntitiesDetectionJob_EntitiesDetectionJobProperties:
...
@dataclasses.dataclass
class EntitiesDetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class EntitiesDetectionJobAttrs:
    # <p>Provides information about an entities detection job.</p>
    entities_detection_job_properties: Any = None
    job_id: Any = None

EntitiesDetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_entities_detection_job",
    fields={
