...
class EventsDetectionJob_EventsDetectionJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class EventsDetectionJob_EventsDetectionJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class EventsDetectionJob_EventsDetectionJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class EventsDetectionJob_EventsDetectionJobProperties:
...
@dataclasses.dataclass
class EventsDetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class EventsDetectionJobAttrs:
    # <p>Provides information about an events detection job.</p>
    events_detection_job_properties: Any = None
    job_id: Any = None

EventsDetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_events_detection_job",
    fields={
