...
class KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_VpcConfig:
    security_group_ids: Any = None
    subnets: Any = None

@dataclasses.dataclass
class KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties:
...
@dataclasses.dataclass
class KeyPhrasesDetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class KeyPhrasesDetectionJobAttrs:
    job_id: Any = None
    # <p>Provides information about a key phrases detection job.</p>
    key_phrases_detection_job_properties: Any = None

KeyPhrasesDetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_key_phrases_detection_job",
    fields={
