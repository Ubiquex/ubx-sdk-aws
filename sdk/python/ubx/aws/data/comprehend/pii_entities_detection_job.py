...
class PiiEntitiesDetectionJob_PiiEntitiesDetectionJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class PiiEntitiesDetectionJob_PiiEntitiesDetectionJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class PiiEntitiesDetectionJob_PiiEntitiesDetectionJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class PiiEntitiesDetectionJob_PiiEntitiesDetectionJobProperties_RedactionConfig:
    mask_character: Any = None
    mask_mode: Any = None
    pii_entity_types: Any = None

@dataclasses.dataclass
class PiiEntitiesDetectionJob_PiiEntitiesDetectionJobProperties:
...
@dataclasses.dataclass
class PiiEntitiesDetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class PiiEntitiesDetectionJobAttrs:
    job_id: Any = None
    # <p>Provides information about a PII entities detection job.</p>
    pii_entities_detection_job_properties: Any = None

PiiEntitiesDetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_pii_entities_detection_job",
    fields={
