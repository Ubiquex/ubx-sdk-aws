...
class SentimentDetectionJob_SentimentDetectionJobProperties_InputDataConfig_DocumentReaderConfig:
    document_read_action: Any = None
    document_read_mode: Any = None
    feature_types: Any = None

@dataclasses.dataclass
class SentimentDetectionJob_SentimentDetectionJobProperties_InputDataConfig:
...
@dataclasses.dataclass
class SentimentDetectionJob_SentimentDetectionJobProperties_OutputDataConfig:
    kms_key_id: Any = None
    s3_uri: Any = None

@dataclasses.dataclass
class SentimentDetectionJob_SentimentDetectionJobProperties_VpcConfig:
    security_group_ids: Any = None
    subnets: Any = None

@dataclasses.dataclass
class SentimentDetectionJob_SentimentDetectionJobProperties:
...
@dataclasses.dataclass
class SentimentDetectionJobConfig:
    job_id: Any = None

@dataclasses.dataclass
class SentimentDetectionJobAttrs:
    job_id: Any = None
    # <p>Provides information about a sentiment detection job.</p>
    sentiment_detection_job_properties: Any = None

SentimentDetectionJob = ubx.DataSourceBinding(
    wire_type="aws_comprehend_sentiment_detection_job",
    fields={
