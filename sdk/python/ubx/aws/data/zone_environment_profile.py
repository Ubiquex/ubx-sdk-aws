...
@dataclasses.dataclass
class ZoneEnvironmentProfileConfig:
...
@dataclasses.dataclass
class ZoneEnvironmentProfileAttrs:
    # The AWS account in which the Amazon DataZone environment is created.
    aws_account_id: Any = None
    # The AWS region in which this environment profile is created.
    aws_account_region: Any = None
...
ZoneEnvironmentProfile = ubx.ResourceBinding(
    ...
    fields={
        ...
        "user_parameters": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ZoneEnvironmentProfile_UserParametersFields,
        ),
    },
)
