...
class AwsdefaultServiceQuota_Quota_ErrorReason:
    error_code: Any = None
    error_message: Any = None

@dataclasses.dataclass
class AwsdefaultServiceQuota_Quota_Period:
    period_unit: Any = None
    period_value: Any = None

@dataclasses.dataclass
class AwsdefaultServiceQuota_Quota_QuotaContext:
    context_id: Any = None
    context_scope: Any = None
    context_scope_type: Any = None

@dataclasses.dataclass
class AwsdefaultServiceQuota_Quota_UsageMetric:
...
@dataclasses.dataclass
class AwsdefaultServiceQuota_Quota:
    adjustable: Any = None
...
@dataclasses.dataclass
class AwsdefaultServiceQuotaConfig:
    quota_code: Any = None
    service_code: Any = None

@dataclasses.dataclass
class AwsdefaultServiceQuotaAttrs:
    # <p>Information about a quota.</p>
    quota: Any = None
    quota_code: Any = None
    service_code: Any = None

AwsdefaultServiceQuota = ubx.DataSourceBinding(
    wire_type="aws_servicequotas_awsdefault_service_quota",
    fields={
