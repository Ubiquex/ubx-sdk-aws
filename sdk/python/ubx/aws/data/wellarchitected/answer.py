...
class Answer_Answer_ChoiceAnswers:
    choice_id: Any = None
    notes: Any = None
    reason: Any = None
    status: Any = None
...
@dataclasses.dataclass
class Answer_Answer_Choices_AdditionalResources_Content:
    display_text: Any = None
    url: Any = None

@dataclasses.dataclass
class Answer_Answer_Choices_AdditionalResources:
    content: Any = None
    type: Any = None

@dataclasses.dataclass
class Answer_Answer_Choices:
...
@dataclasses.dataclass
class Answer_Answer_JiraConfiguration:
...
Answer = ubx.DataSourceBinding(
    wire_type="aws_wellarchitected_answer",
    fields={
