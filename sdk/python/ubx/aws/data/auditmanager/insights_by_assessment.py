...
class InsightsByAssessment_Insights:
...
@dataclasses.dataclass
class InsightsByAssessmentConfig:
    assessment_id: Any = None

@dataclasses.dataclass
class InsightsByAssessmentAttrs:
    assessment_id: Any = None
...
InsightsByAssessment = ubx.DataSourceBinding(
    wire_type="aws_auditmanager_insights_by_assessment",
    fields={
