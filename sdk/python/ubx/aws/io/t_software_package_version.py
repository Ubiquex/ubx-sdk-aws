...
class TSoftwarePackageVersion_Artifact_S3Location:
    # The S3 bucket
    bucket: Any = None
    # The S3 key
    key: Any = None
...
@dataclasses.dataclass
class TSoftwarePackageVersion_Artifact:
    # The Amazon S3 location
    s3_location: Any = None

@dataclasses.dataclass
class TSoftwarePackageVersion_Tags:
...
_TSoftwarePackageVersion_Artifact_S3LocationFields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "key": ubx.FieldSpec(wire_name="key"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_TSoftwarePackageVersion_ArtifactFields = {
    "s3_location": ubx.FieldSpec(
        wire_name="s3_location",
        kind="object",
        fields=_TSoftwarePackageVersion_Artifact_S3LocationFields,
    ),
}

_TSoftwarePackageVersion_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class TSoftwarePackageVersionConfig:
...
@dataclasses.dataclass
class TSoftwarePackageVersionAttrs:
    # The artifact location of the package version
    artifact: Any = None
    # Specifies metadata attributes as key-value pairs that are attached to the software package version in AWS IoT, allowing you to add custom searchable or informational data to the version's registry entry. (AI-inferred)
    attributes: Any = None
...
TSoftwarePackageVersion = ubx.ResourceBinding(
    wire_type="aws_io_t_software_package_version",
    fields={
        "artifact": ubx.FieldSpec(
            wire_name="artifact",
            kind="object",
            fields=_TSoftwarePackageVersion_ArtifactFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_TSoftwarePackageVersion_TagsFields,
        ),
