...
_TwirelessWirelessDeviceImportTask_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class TwirelessWirelessDeviceImportTaskConfig:
...
@dataclasses.dataclass
class TwirelessWirelessDeviceImportTaskAttrs:
...
TwirelessWirelessDeviceImportTask = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_TwirelessWirelessDeviceImportTask_TagsFields,
        ),
    },
)
