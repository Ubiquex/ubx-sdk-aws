...
class GroupingConfiguration_GroupingAttributeDefinitions:
...
_GroupingConfiguration_GroupingAttributeDefinitionsFields = {
...
@dataclasses.dataclass
class GroupingConfigurationConfig:
    grouping_attribute_definitions: Any = None

@dataclasses.dataclass
class GroupingConfigurationAttrs:
...
GroupingConfiguration = ubx.ResourceBinding(
    ...
    fields={
        "grouping_attribute_definitions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_GroupingConfiguration_GroupingAttributeDefinitionsFields,
        ),
    },
)
