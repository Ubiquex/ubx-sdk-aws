...
class Workgroup_ConfigParameters:
...
@dataclasses.dataclass
class Workgroup_Workgroup_Endpoint_VpcEndpoints_NetworkInterfaces:
...
@dataclasses.dataclass
class Workgroup_Workgroup_Endpoint_VpcEndpoints:
...
@dataclasses.dataclass
class Workgroup_Workgroup_Endpoint:
...
_Workgroup_ConfigParametersFields = {
...
Workgroup = ubx.ResourceBinding(
    ...
    fields={
        ...
        "config_parameters": ubx.FieldSpec(
            ...
            kind="list",
            fields=_Workgroup_ConfigParametersFields,
        ),
