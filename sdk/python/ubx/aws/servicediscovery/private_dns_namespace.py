...
class PrivateDnsNamespace_Properties_DnsProperties_Soa:
...
@dataclasses.dataclass
class PrivateDnsNamespace_Properties_DnsProperties:
...
@dataclasses.dataclass
class PrivateDnsNamespace_Properties:
...
@dataclasses.dataclass
class PrivateDnsNamespace_Tags:
    key: Any = None
    value: Any = None

_PrivateDnsNamespace_Properties_DnsProperties_SoaFields = {
    "ttl": ubx.FieldSpec(wire_name="ttl"),
}

_PrivateDnsNamespace_Properties_DnsPropertiesFields = {
    "soa": ubx.FieldSpec(
        wire_name="soa",
        kind="object",
        fields=_PrivateDnsNamespace_Properties_DnsProperties_SoaFields,
    ),
}

_PrivateDnsNamespace_PropertiesFields = {
    "dns_properties": ubx.FieldSpec(
        wire_name="dns_properties",
        kind="object",
        fields=_PrivateDnsNamespace_Properties_DnsPropertiesFields,
    ),
}

_PrivateDnsNamespace_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class PrivateDnsNamespaceConfig:
...
@dataclasses.dataclass
class PrivateDnsNamespaceAttrs:
...
PrivateDnsNamespace = ubx.ResourceBinding(
    ...
    fields={
        ...
        "properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_PrivateDnsNamespace_PropertiesFields,
        ),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_PrivateDnsNamespace_TagsFields,
        ),
