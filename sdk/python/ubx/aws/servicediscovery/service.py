...
class Service_DnsConfig_DnsRecords:
...
@dataclasses.dataclass
class Service_HealthCheckConfig:
...
@dataclasses.dataclass
class Service_HealthCheckCustomConfig:
