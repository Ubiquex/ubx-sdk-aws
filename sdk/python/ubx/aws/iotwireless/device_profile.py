...
DeviceProfile = ubx.ResourceBinding(
    wire_type="aws_io_twireless_device_profile",
    fields={
        "lo_ra_wan": ubx.FieldSpec(
            wire_name="lo_ra_wan",
            kind="object",
            fields=_DeviceProfile_LoRaWanFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_DeviceProfile_TagsFields,
        ),
    },
)
