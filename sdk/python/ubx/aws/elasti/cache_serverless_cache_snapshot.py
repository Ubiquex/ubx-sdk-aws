...
class CacheServerlessCacheSnapshot_ServerlessCacheConfiguration:
...
_CacheServerlessCacheSnapshot_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class CacheServerlessCacheSnapshotConfig:
...
@dataclasses.dataclass
class CacheServerlessCacheSnapshotAttrs:
...
CacheServerlessCacheSnapshot = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_CacheServerlessCacheSnapshot_TagsFields,
        ),
    },
)
