...
class MakerAction_MetadataProperties:
    # The commit ID.
    commit_id: Any = None
...
_MakerAction_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class MakerActionConfig:
...
MakerAction = ubx.ResourceBinding(
    ...
    fields={
        ...
        "metadata_properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_MakerAction_MetadataPropertiesFields,
        ),
        "properties": ubx.FieldSpec(wire_name="properties"),
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
            fields=_MakerAction_SourceFields,
        ),
        "status": ubx.FieldSpec(wire_name="status"),
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_MakerAction_TagsFields,
        ),
    },
)
