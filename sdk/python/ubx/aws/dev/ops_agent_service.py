...
class OpsAgentService_Tags:
    key: Any = None
    value: Any = None

_OpsAgentService_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class OpsAgentServiceConfig:
...
OpsAgentService = ubx.ResourceBinding(
    ...
    fields={
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_OpsAgentService_TagsFields,
        ),
