...
class ConfigurationBundle_CreatedBy:
...
@dataclasses.dataclass
class ConfigurationBundle_LineageMetadata:
...
@dataclasses.dataclass
class ConfigurationBundle_Tags:
    key: Any = None
    value: Any = None

_ConfigurationBundle_CreatedByFields = {
    "arn": ubx.FieldSpec(wire_name="arn"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_ConfigurationBundle_TagsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ConfigurationBundleConfig:
...
@dataclasses.dataclass
class ConfigurationBundleAttrs:
    # The branch name for version tracking.
    branch_name: Any = None
...
ConfigurationBundle = ubx.ResourceBinding(
    ...
    fields={
        ...
        "created_by": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ConfigurationBundle_CreatedByFields,
        ),
        ...
        "tags": ubx.FieldSpec(
            wire_name="tags",
            kind="list",
            fields=_ConfigurationBundle_TagsFields,
        ),
    },
)
