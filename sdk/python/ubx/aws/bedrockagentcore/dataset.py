...
_Dataset_Source_InlineExamplesFields = {
    "examples": ubx.FieldSpec(wire_name="examples"),
}

_Dataset_Source_S3SourceFields = {
    "s3_uri": ubx.FieldSpec(wire_name="s3_uri"),
}

_Dataset_SourceFields = {
    "inline_examples": ubx.FieldSpec(
        wire_name="inline_examples",
        kind="object",
        fields=_Dataset_Source_InlineExamplesFields,
    ),
    "s3_source": ubx.FieldSpec(
        wire_name="s3_source",
        kind="object",
        fields=_Dataset_Source_S3SourceFields,
    ),
}
