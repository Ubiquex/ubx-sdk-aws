...
class PaymentConnector_CredentialProviderConfigurations_CoinbaseCdp:
...
@dataclasses.dataclass
class PaymentConnector_CredentialProviderConfigurations:
    coinbase_cdp: Any = None
    stripe_privy: Any = None

_PaymentConnector_CredentialProviderConfigurations_CoinbaseCdpFields = {
    "credential_provider_arn": ubx.FieldSpec(wire_name="credential_provider_arn"),
}

_PaymentConnector_CredentialProviderConfigurationsFields = {
    "coinbase_cdp": ubx.FieldSpec(
        wire_name="coinbase_cdp",
        kind="object",
        fields=_PaymentConnector_CredentialProviderConfigurations_CoinbaseCdpFields,
    ),
...
PaymentConnector = ubx.ResourceBinding(
    ...
    fields={
        ...
        "credential_provider_configurations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_PaymentConnector_CredentialProviderConfigurationsFields,
        ),
