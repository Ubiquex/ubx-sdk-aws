...
class Runtime_AgentRuntimeArtifact_CodeConfiguration_Code_S3:
    # S3 bucket name
    bucket: Any = None
...
@dataclasses.dataclass
class Runtime_AgentRuntimeArtifact_CodeConfiguration_Code:
    # S3 Location Configuration
    s3: Any = None

@dataclasses.dataclass
class Runtime_AgentRuntimeArtifact_CodeConfiguration:
...
@dataclasses.dataclass
class Runtime_AgentRuntimeArtifact_ContainerConfiguration:
    # The ECR URI of the container
    container_uri: Any = None

@dataclasses.dataclass
class Runtime_AgentRuntimeArtifact:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_AllowedWorkloadConfiguration_HostingEnvironments:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_AllowedWorkloadConfiguration:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValue:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_ManagedVpcResource:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_SelfManagedLatticeResource:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint:
    managed_vpc_resource: Any = None
    self_managed_lattice_resource: Any = None

@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpointOverrides:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration_CustomJwtauthorizer:
...
@dataclasses.dataclass
class Runtime_AuthorizerConfiguration:
    # Configuration for custom JWT authorizer
    custom_jwtauthorizer: Any = None

@dataclasses.dataclass
class Runtime_CapacityProviderConfiguration:
    # ARN of the capacity provider
    capacity_provider_arn: Any = None

@dataclasses.dataclass
class Runtime_FilesystemConfigurations_CapacityProviderVolume:
    mount_path: Any = None
    volume_name: Any = None

@dataclasses.dataclass
class Runtime_FilesystemConfigurations_EfsAccessPoint:
...
@dataclasses.dataclass
class Runtime_FilesystemConfigurations_SessionStorage:
...
@dataclasses.dataclass
class Runtime_FilesystemConfigurations:
...
@dataclasses.dataclass
class Runtime_LifecycleConfiguration:
...
@dataclasses.dataclass
class Runtime_NetworkConfiguration_NetworkModeConfig:
...
@dataclasses.dataclass
class Runtime_NetworkConfiguration:
...
@dataclasses.dataclass
class Runtime_RequestHeaderConfiguration:
    # List of allowed HTTP headers for agent runtime requests
    request_header_allowlist: Any = None

@dataclasses.dataclass
class Runtime_WorkloadIdentityDetails:
    # ARN of the workload identity
    workload_identity_arn: Any = None

_Runtime_AgentRuntimeArtifact_CodeConfiguration_Code_S3Fields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "prefix": ubx.FieldSpec(wire_name="prefix"),
    "version_id": ubx.FieldSpec(wire_name="version_id"),
}

_Runtime_AgentRuntimeArtifact_CodeConfiguration_CodeFields = {
    "s3": ubx.FieldSpec(
        wire_name="s3",
        kind="object",
        fields=_Runtime_AgentRuntimeArtifact_CodeConfiguration_Code_S3Fields,
    ),
}

_Runtime_AgentRuntimeArtifact_CodeConfigurationFields = {
    "code": ubx.FieldSpec(
        wire_name="code",
        kind="object",
        fields=_Runtime_AgentRuntimeArtifact_CodeConfiguration_CodeFields,
    ),
    "entry_point": ubx.FieldSpec(wire_name="entry_point"),
    "runtime": ubx.FieldSpec(wire_name="runtime"),
}

_Runtime_AgentRuntimeArtifact_ContainerConfigurationFields = {
    "container_uri": ubx.FieldSpec(wire_name="container_uri"),
}

_Runtime_AgentRuntimeArtifactFields = {
    "code_configuration": ubx.FieldSpec(
        wire_name="code_configuration",
        kind="object",
        fields=_Runtime_AgentRuntimeArtifact_CodeConfigurationFields,
    ),
    "container_configuration": ubx.FieldSpec(
        wire_name="container_configuration",
        kind="object",
        fields=_Runtime_AgentRuntimeArtifact_ContainerConfigurationFields,
    ),
}

_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_AllowedWorkloadConfiguration_HostingEnvironmentsFields = {
    "arn": ubx.FieldSpec(wire_name="arn"),
}

_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_AllowedWorkloadConfigurationFields = {
    "hosting_environments": ubx.FieldSpec(
        wire_name="hosting_environments",
        kind="list",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_AllowedWorkloadConfiguration_HostingEnvironmentsFields,
    ),
    "workload_identities": ubx.FieldSpec(wire_name="workload_identities"),
}

_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValueFields = {
...
_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValueFields = {
    ...
    "claim_match_value": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValueFields,
    ),
}

_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaimsFields = {
    "authorizing_claim_match_value": ubx.FieldSpec(
        wire_name="authorizing_claim_match_value",
        kind="object",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValueFields,
    ),
...
_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_ManagedVpcResourceFields = {
...
_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_SelfManagedLatticeResourceFields = {
    "resource_configuration_identifier": ubx.FieldSpec(wire_name="resource_configuration_identifier"),
}

_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpointFields = {
    "managed_vpc_resource": ubx.FieldSpec(
        wire_name="managed_vpc_resource",
        kind="object",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_ManagedVpcResourceFields,
    ),
    "self_managed_lattice_resource": ubx.FieldSpec(
        wire_name="self_managed_lattice_resource",
        kind="object",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_SelfManagedLatticeResourceFields,
    ),
}

_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpointOverridesFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
    "private_endpoint": ubx.FieldSpec(
        wire_name="private_endpoint",
        kind="object",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpointFields,
    ),
}

_Runtime_AuthorizerConfiguration_CustomJwtauthorizerFields = {
    ...
    "allowed_workload_configuration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_AllowedWorkloadConfigurationFields,
    ),
    "custom_claims": ubx.FieldSpec(
        wire_name="custom_claims",
        kind="list",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaimsFields,
    ),
    ...
    "private_endpoint_overrides": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpointOverridesFields,
    ),
}

_Runtime_AuthorizerConfigurationFields = {
    "custom_jwtauthorizer": ubx.FieldSpec(
        wire_name="custom_jwtauthorizer",
        kind="object",
        fields=_Runtime_AuthorizerConfiguration_CustomJwtauthorizerFields,
    ),
}

_Runtime_CapacityProviderConfigurationFields = {
    "capacity_provider_arn": ubx.FieldSpec(wire_name="capacity_provider_arn"),
}

_Runtime_FilesystemConfigurations_CapacityProviderVolumeFields = {
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
    "volume_name": ubx.FieldSpec(wire_name="volume_name"),
}

_Runtime_FilesystemConfigurations_EfsAccessPointFields = {
    "access_point_arn": ubx.FieldSpec(wire_name="access_point_arn"),
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
}

_Runtime_FilesystemConfigurations_SessionStorageFields = {
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
}

_Runtime_FilesystemConfigurationsFields = {
    "capacity_provider_volume": ubx.FieldSpec(
        wire_name="capacity_provider_volume",
        kind="object",
        fields=_Runtime_FilesystemConfigurations_CapacityProviderVolumeFields,
    ),
    "efs_access_point": ubx.FieldSpec(
        wire_name="efs_access_point",
        kind="object",
        fields=_Runtime_FilesystemConfigurations_EfsAccessPointFields,
    ),
    ...
    "session_storage": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Runtime_FilesystemConfigurations_SessionStorageFields,
    ),
}

_Runtime_LifecycleConfigurationFields = {
...
Runtime = ubx.ResourceBinding(
    ...
    fields={
        "agent_runtime_artifact": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Runtime_AgentRuntimeArtifactFields,
        ),
        ...
        "authorizer_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Runtime_AuthorizerConfigurationFields,
        ),
        "capacity_provider_configuration": ubx.FieldSpec(
            wire_name="capacity_provider_configuration",
            kind="object",
            fields=_Runtime_CapacityProviderConfigurationFields,
        ),
        ...
        "request_header_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Runtime_RequestHeaderConfigurationFields,
        ),
