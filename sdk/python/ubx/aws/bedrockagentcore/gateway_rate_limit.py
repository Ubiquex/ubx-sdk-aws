...
class GatewayRateLimit_Entries_Connections:
    period: Any = None
...
@dataclasses.dataclass
class GatewayRateLimit_Entries:
    connections: Any = None
    dimensions: Any = None
    requests: Any = None
    tokens: Any = None

_GatewayRateLimit_Entries_ConnectionsFields = {
    "period": ubx.FieldSpec(wire_name="period"),
    "rate": ubx.FieldSpec(wire_name="rate"),
}

_GatewayRateLimit_EntriesFields = {
    "connections": ubx.FieldSpec(
        wire_name="connections",
        kind="list",
        fields=_GatewayRateLimit_Entries_ConnectionsFields,
    ),
...
GatewayRateLimit = ubx.ResourceBinding(
    ...
    fields={
        ...
        "entries": ubx.FieldSpec(
            wire_name="entries",
            kind="list",
            fields=_GatewayRateLimit_EntriesFields,
        ),
