...
export interface SecurityProfile_AdditionalMetricsToRetainV2_MetricDimension {
...
export interface SecurityProfile_AdditionalMetricsToRetainV2 {
  ...
  metricDimension?: SecurityProfile_AdditionalMetricsToRetainV2_MetricDimension | Computed<SecurityProfile_AdditionalMetricsToRetainV2_MetricDimension>;
}

export interface SecurityProfile_Behaviors_Criteria_MlDetectionConfig {
...
export interface SecurityProfile_Behaviors_Criteria_StatisticalThreshold {
...
export interface SecurityProfile_Behaviors_Criteria_Value {
...
export interface SecurityProfile_Behaviors_Criteria {
  ...
  mlDetectionConfig?: SecurityProfile_Behaviors_Criteria_MlDetectionConfig | Computed<SecurityProfile_Behaviors_Criteria_MlDetectionConfig>;
  ...
  statisticalThreshold?: SecurityProfile_Behaviors_Criteria_StatisticalThreshold | Computed<SecurityProfile_Behaviors_Criteria_StatisticalThreshold>;
  ...
  value?: SecurityProfile_Behaviors_Criteria_Value | Computed<SecurityProfile_Behaviors_Criteria_Value>;
}

export interface SecurityProfile_Behaviors {
  ...
  criteria?: SecurityProfile_Behaviors_Criteria | Computed<SecurityProfile_Behaviors_Criteria>;
...
export interface SecurityProfile_MetricsExportConfig {
...
export interface SecurityProfile_Tags {
...
const SecurityProfile_AdditionalMetricsToRetainV2_MetricDimensionFields: FieldMap = {
  dimensionName: "dimension_name",
  operator: "operator",
};

const SecurityProfile_AdditionalMetricsToRetainV2Fields: FieldMap = {
...
const SecurityProfile_Behaviors_Criteria_MlDetectionConfigFields: FieldMap = {
  confidenceLevel: "confidence_level",
};

const SecurityProfile_Behaviors_Criteria_StatisticalThresholdFields: FieldMap = {
  statistic: "statistic",
};

const SecurityProfile_Behaviors_Criteria_ValueFields: FieldMap = {
  cidrs: "cidrs",
  count: "count",
  number: "number",
  numbers: "numbers",
...
const SecurityProfile_Behaviors_CriteriaFields: FieldMap = {
...
const SecurityProfile_BehaviorsFields: FieldMap = {
  criteria: {
    wireName: "criteria",
    kind: "object",
...
const SecurityProfile_MetricsExportConfigFields: FieldMap = {
  mqttTopic: "mqtt_topic",
  roleArn: "role_arn",
};

const SecurityProfile_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface SecurityProfileConfig {
  ...
  additionalMetricsToRetainV2?: SecurityProfile_AdditionalMetricsToRetainV2[] | Computed<SecurityProfile_AdditionalMetricsToRetainV2[]>;
  /** Specifies the destinations to which alerts are sent. */
  alertTargets?: unknown | Computed<unknown>;
  /** Specifies the behaviors that, when violated by a device (thing), cause an alert. */
  behaviors?: SecurityProfile_Behaviors[] | Computed<SecurityProfile_Behaviors[]>;
  /** A structure containing the mqtt topic for metrics export. */
  metricsExportConfig?: SecurityProfile_MetricsExportConfig | Computed<SecurityProfile_MetricsExportConfig>;
  /** A description of the security profile. */
  securityProfileDescription?: string | Computed<string>;
  /** A unique identifier for the security profile. */
  securityProfileName?: string | Computed<string>;
  /** Metadata that can be used to manage the security profile. */
  tags?: SecurityProfile_Tags[] | Computed<SecurityProfile_Tags[]>;
...
export interface SecurityProfileAttrs {
  /** A list of metrics whose data is retained (stored). By default, data is retained for any metric used in the profile's behaviors, but it is also retained for any metric specified here. */
  additionalMetricsToRetainV2: SecurityProfile_AdditionalMetricsToRetainV2[];
  /** Specifies the destinations to which alerts are sent. */
  alertTargets: unknown;
  /** Specifies the behaviors that, when violated by a device (thing), cause an alert. */
  behaviors: SecurityProfile_Behaviors[];
  /** A structure containing the mqtt topic for metrics export. */
  metricsExportConfig: SecurityProfile_MetricsExportConfig;
