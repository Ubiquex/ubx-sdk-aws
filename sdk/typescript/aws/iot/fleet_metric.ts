...
export interface FleetMetric_AggregationType {
...
export interface FleetMetric_Tags {
...
const FleetMetric_AggregationTypeFields: FieldMap = {
  name: "name",
  values: "values",
};

const FleetMetric_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface FleetMetricConfig {
  /** The aggregation field to perform aggregation and metric emission */
  aggregationField?: string | Computed<string>;
  /** Aggregation types supported by Fleet Indexing */
  aggregationType?: FleetMetric_AggregationType | Computed<FleetMetric_AggregationType>;
  ...
  tags?: FleetMetric_Tags[] | Computed<FleetMetric_Tags[]>;
  /** The unit of data points emitted by a fleet metric */
  unit?: string | Computed<string>;
}

export interface FleetMetricAttrs {
  /** The aggregation field to perform aggregation and metric emission */
  aggregationField: string;
  /** Aggregation types supported by Fleet Indexing */
  aggregationType: FleetMetric_AggregationType;
...
export const FleetMetric: ResourceBinding<FleetMetricConfig, FleetMetricAttrs> = {
