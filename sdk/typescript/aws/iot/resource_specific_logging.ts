...
export interface ResourceSpecificLoggingConfig {
...
export interface ResourceSpecificLoggingAttrs {
  /** The log level for a specific target. Valid values are: ERROR, WARN, INFO, DEBUG, or DISABLED. */
  logLevel: string;
...
export const ResourceSpecificLogging: ResourceBinding<ResourceSpecificLoggingConfig, ResourceSpecificLoggingAttrs> = {
