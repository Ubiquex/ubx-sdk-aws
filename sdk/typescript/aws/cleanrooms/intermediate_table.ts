...
export interface IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholds_OutputColumnThresholds {
  minimumIdentityCount?: number | Computed<number>;
  outputColumnName?: string | Computed<string>;
}

export interface IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholds {
  allowedAggregateExpressionType?: string | Computed<string>;
  identityColumns?: string[] | Computed<string[]>;
  minimumIdentityCount?: number | Computed<number>;
  outputColumnThresholds?: IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholds_OutputColumnThresholds[] | Computed<IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholds_OutputColumnThresholds[]>;
  type?: string | Computed<string>;
}

export interface IntermediateTable_AnalysisRules_Policy_V1_Custom_ComparisonControls {
...
export interface IntermediateTable_AnalysisRules_Policy_V1_Custom {
  ...
  aggregationThresholds?: IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholds[] | Computed<IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholds[]>;
  ...
  comparisonControls?: IntermediateTable_AnalysisRules_Policy_V1_Custom_ComparisonControls | Computed<IntermediateTable_AnalysisRules_Policy_V1_Custom_ComparisonControls>;
...
const IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholds_OutputColumnThresholdsFields: FieldMap = {
  minimumIdentityCount: "minimum_identity_count",
  outputColumnName: "output_column_name",
};

const IntermediateTable_AnalysisRules_Policy_V1_Custom_AggregationThresholdsFields: FieldMap = {
...
const IntermediateTable_AnalysisRules_Policy_V1_Custom_ComparisonControlsFields: FieldMap = {
