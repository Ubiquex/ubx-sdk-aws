...
export interface ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_Aggregation {
...
export interface ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1 {
  ...
  aggregation?: ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_Aggregation | Computed<ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_Aggregation>;
  ...
  custom?: ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_Aggregation | Computed<ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_Aggregation>;
  ...
  list?: ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_Aggregation | Computed<ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_Aggregation>;
}

export interface ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy {
  ...
  v1?: ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1 | Computed<ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1>;
}

export interface ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules {
  ...
  policy?: ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy | Computed<ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy>;
...
export interface ConfiguredTableAssociation_Tags {
...
const ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1_AggregationFields: FieldMap = {
  allowedAdditionalAnalyses: "allowed_additional_analyses",
  allowedResultReceivers: "allowed_result_receivers",
};

const ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_Policy_V1Fields: FieldMap = {
  aggregation: {
...
const ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules_PolicyFields: FieldMap = {
  v1: {
    wireName: "v1",
    kind: "object",
...
const ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRulesFields: FieldMap = {
  policy: {
    wireName: "policy",
    kind: "object",
...
const ConfiguredTableAssociation_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface ConfiguredTableAssociationConfig {
  ...
  configuredTableAssociationAnalysisRules?: ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules[] | Computed<ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules[]>;
  ...
  tags?: ConfiguredTableAssociation_Tags[] | Computed<ConfiguredTableAssociation_Tags[]>;
}

export interface ConfiguredTableAssociationAttrs {
  ...
  arn: string;
  /** Configures the analysis rules for the configured table association, specifying the permitted analysis types (e.g., list, aggregate, custom) and their policy constraints for querying the associated configured table within a collaboration. (AI-inferred) */
  configuredTableAssociationAnalysisRules: ConfiguredTableAssociation_ConfiguredTableAssociationAnalysisRules[];
  ...
  roleArn: string;
  /** An arbitrary set of tags (key-value pairs) for this cleanrooms collaboration. */
  tags: ConfiguredTableAssociation_Tags[];
}

export const ConfiguredTableAssociation: ResourceBinding<ConfiguredTableAssociationConfig, ConfiguredTableAssociationAttrs> = {
