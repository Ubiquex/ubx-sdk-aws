...
export interface DirectConnectGateway_Tags {
...
const DirectConnectGateway_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface DirectConnectGatewayConfig {
  ...
  tags?: DirectConnectGateway_Tags[] | Computed<DirectConnectGateway_Tags[]>;
}

export interface DirectConnectGatewayAttrs {
  /** The autonomous system number (ASN) for the Amazon side of the connection. */
  ...
  /** The tags associated with the Direct Connect gateway. */
  tags: DirectConnectGateway_Tags[];
}

export const DirectConnectGateway: ResourceBinding<DirectConnectGatewayConfig, DirectConnectGatewayAttrs> = {
