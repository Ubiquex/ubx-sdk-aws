...
export interface DirectConnectGatewayAssociationConfig {
...
export interface DirectConnectGatewayAssociationAttrs {
  /** The Amazon Resource Name (ARN) of the role to accept the Direct Connect Gateway association proposal. Needs directconnect:AcceptDirectConnectGatewayAssociationProposal permissions. */
...
export const DirectConnectGatewayAssociation: ResourceBinding<DirectConnectGatewayAssociationConfig, DirectConnectGatewayAssociationAttrs> = {
