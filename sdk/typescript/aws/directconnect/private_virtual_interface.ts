...
export interface PrivateVirtualInterface_BgpPeers {
...
export interface PrivateVirtualInterface_Tags {
...
const PrivateVirtualInterface_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface PrivateVirtualInterfaceConfig {
  ...
  tags?: PrivateVirtualInterface_Tags[] | Computed<PrivateVirtualInterface_Tags[]>;
...
export interface PrivateVirtualInterfaceAttrs {
  ...
  bgpPeers: PrivateVirtualInterface_BgpPeers[];
  /** The ID or ARN of the connection or LAG. */
  ...
  rateLimit: string;
  /** The tags associated with the private virtual interface. */
  tags: PrivateVirtualInterface_Tags[];
  /** The ID or ARN of the virtual private gateway. */
