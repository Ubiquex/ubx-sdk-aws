...
export interface TelemetryPipelines_Configuration {
  body: string | Computed<string>;
}

export interface TelemetryPipelines_Pipeline_StatusReason {
...
export interface TelemetryPipelines_Pipeline_Tags {
...
export interface TelemetryPipelines_Pipeline {
  ...
  statusReason?: TelemetryPipelines_Pipeline_StatusReason | Computed<TelemetryPipelines_Pipeline_StatusReason>;
  /** An array of key-value pairs to apply to this resource */
  tags?: TelemetryPipelines_Pipeline_Tags[] | Computed<TelemetryPipelines_Pipeline_Tags[]>;
}

const TelemetryPipelines_ConfigurationFields: FieldMap = {
  body: "body",
};

const TelemetryPipelines_Pipeline_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface TelemetryPipelinesAttrs {
  ...
  statusReason: TelemetryPipelines_Pipeline_StatusReason;
  /** An array of key-value pairs to apply to this resource */
  tags: TelemetryPipelines_Pipeline_Tags[];
}

export const TelemetryPipelines: ResourceBinding<TelemetryPipelinesConfig, TelemetryPipelinesAttrs> = {
