...
export interface FlowVpcInterface_Tags {
...
const FlowVpcInterface_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface FlowVpcInterfaceConfig {
  ...
  tags?: FlowVpcInterface_Tags[] | Computed<FlowVpcInterface_Tags[]>;
}

export interface FlowVpcInterfaceAttrs {
  /** The Amazon Resource Name (ARN), a unique identifier for any AWS resource, of the flow. */
  flowArn: string;
  /** Immutable and has to be a unique against other VpcInterfaces in this Flow. */
  name: string;
  ...
  subnetId: string;
  /** Key-value pairs that can be used to tag and organize this VPC network interface. */
  tags: FlowVpcInterface_Tags[];
}

export const FlowVpcInterface: ResourceBinding<FlowVpcInterfaceConfig, FlowVpcInterfaceAttrs> = {
