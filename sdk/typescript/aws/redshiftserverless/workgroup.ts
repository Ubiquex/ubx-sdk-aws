...
export interface Workgroup_ConfigParameters {
...
export interface Workgroup_Workgroup_Endpoint_VpcEndpoints_NetworkInterfaces {
...
export interface Workgroup_Workgroup_Endpoint_VpcEndpoints {
  ...
  networkInterfaces?: Workgroup_Workgroup_Endpoint_VpcEndpoints_NetworkInterfaces[] | Computed<Workgroup_Workgroup_Endpoint_VpcEndpoints_NetworkInterfaces[]>;
...
export interface Workgroup_Workgroup_Endpoint {
  ...
  vpcEndpoints?: Workgroup_Workgroup_Endpoint_VpcEndpoints[] | Computed<Workgroup_Workgroup_Endpoint_VpcEndpoints[]>;
}

export interface Workgroup_Workgroup {
  ...
  configParameters?: Workgroup_ConfigParameters[] | Computed<Workgroup_ConfigParameters[]>;
  ...
  endpoint?: Workgroup_Workgroup_Endpoint | Computed<Workgroup_Workgroup_Endpoint>;
...
const Workgroup_ConfigParametersFields: FieldMap = {
...
export interface WorkgroupAttrs {
  ...
  baseCapacity: number;
  /** A list of parameters to set for finer control over a database. Available options are datestyle, enable_user_activity_logging, query_group, search_path, max_query_execution_time, and require_ssl. */
  configParameters: Workgroup_ConfigParameters[];
  /** The value that specifies whether to enable enhanced virtual private cloud (VPC) routing, which forces Amazon Redshift Serverless to route traffic through your VPC. */
