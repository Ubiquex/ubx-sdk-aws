...
export interface ReviewTemplate_Tags {
...
const ReviewTemplate_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface ReviewTemplateConfig {
  ...
  tags?: ReviewTemplate_Tags[] | Computed<ReviewTemplate_Tags[]>;
  /** The name of the review template. */
  templateName: string | Computed<string>;
}

export interface ReviewTemplateAttrs {
  /** The review template description. */
  description: string;
  /** The lenses applied to the review template. */
  lenses: string[];
...
export const ReviewTemplate: ResourceBinding<ReviewTemplateConfig, ReviewTemplateAttrs> = {
