...
export interface Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_AutoRollbackConfiguration {
...
export interface Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy_MaximumBatchSize {
...
export interface Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy {
  ...
  maximumBatchSize?: Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy_MaximumBatchSize | Computed<Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy_MaximumBatchSize>;
  ...
  rollbackMaximumBatchSize?: Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy_MaximumBatchSize | Computed<Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy_MaximumBatchSize>;
}

export interface Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig {
  ...
  autoRollbackConfiguration?: Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_AutoRollbackConfiguration[] | Computed<Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_AutoRollbackConfiguration[]>;
  rollingUpdatePolicy?: Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy | Computed<Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig_RollingUpdatePolicy>;
...
export interface Cluster_InstanceGroups_AutoPatchConfig_PatchSchedule {
...
export interface Cluster_InstanceGroups_AutoPatchConfig {
  ...
  deploymentConfig?: Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig | Computed<Cluster_InstanceGroups_AutoPatchConfig_DeploymentConfig>;
  ...
  patchSchedule?: Cluster_InstanceGroups_AutoPatchConfig_PatchSchedule | Computed<Cluster_InstanceGroups_AutoPatchConfig_PatchSchedule>;
...
export interface Cluster_InstanceGroups_CapacityRequirements {
...
export interface Cluster_InstanceGroups_InstanceRequirements {
...
export interface Cluster_InstanceGroups_InstanceStorageConfigs_EbsVolumeConfig {
...
export interface Cluster_InstanceGroups_InstanceStorageConfigs_FsxLustreConfig {
...
export interface Cluster_InstanceGroups_InstanceStorageConfigs_FsxOpenZfsConfig {
...
export interface Cluster_InstanceGroups_InstanceStorageConfigs {
  ...
  ebsVolumeConfig?: Cluster_InstanceGroups_InstanceStorageConfigs_EbsVolumeConfig | Computed<Cluster_InstanceGroups_InstanceStorageConfigs_EbsVolumeConfig>;
  ...
  fsxLustreConfig?: Cluster_InstanceGroups_InstanceStorageConfigs_FsxLustreConfig | Computed<Cluster_InstanceGroups_InstanceStorageConfigs_FsxLustreConfig>;
  ...
  fsxOpenZfsConfig?: Cluster_InstanceGroups_InstanceStorageConfigs_FsxOpenZfsConfig | Computed<Cluster_InstanceGroups_InstanceStorageConfigs_FsxOpenZfsConfig>;
}

export interface Cluster_InstanceGroups_KubernetesConfig_Taints {
...
export interface Cluster_InstanceGroups_KubernetesConfig {
  ...
  taints?: Cluster_InstanceGroups_KubernetesConfig_Taints[] | Computed<Cluster_InstanceGroups_KubernetesConfig_Taints[]>;
}

export interface Cluster_InstanceGroups_LifeCycleConfig {
...
export interface Cluster_InstanceGroups_NetworkInterface {
...
export interface Cluster_InstanceGroups_OverrideVpcConfig {
...
export interface Cluster_InstanceGroups_ScheduledUpdateConfig {
...
export interface Cluster_InstanceGroups_SlurmConfig {
...
export interface Cluster_InstanceGroups {
  ...
  autoPatchConfig?: Cluster_InstanceGroups_AutoPatchConfig | Computed<Cluster_InstanceGroups_AutoPatchConfig>;
  ...
  capacityRequirements?: Cluster_InstanceGroups_CapacityRequirements | Computed<Cluster_InstanceGroups_CapacityRequirements>;
  ...
  instanceRequirements?: Cluster_InstanceGroups_InstanceRequirements | Computed<Cluster_InstanceGroups_InstanceRequirements>;
  ...
  instanceStorageConfigs?: Cluster_InstanceGroups_InstanceStorageConfigs[] | Computed<Cluster_InstanceGroups_InstanceStorageConfigs[]>;
  ...
  kubernetesConfig?: Cluster_InstanceGroups_KubernetesConfig | Computed<Cluster_InstanceGroups_KubernetesConfig>;
  ...
  lifeCycleConfig?: Cluster_InstanceGroups_LifeCycleConfig | Computed<Cluster_InstanceGroups_LifeCycleConfig>;
  ...
  networkInterface?: Cluster_InstanceGroups_NetworkInterface | Computed<Cluster_InstanceGroups_NetworkInterface>;
  ...
  overrideVpcConfig?: Cluster_InstanceGroups_OverrideVpcConfig | Computed<Cluster_InstanceGroups_OverrideVpcConfig>;
  ...
  scheduledUpdateConfig?: Cluster_InstanceGroups_ScheduledUpdateConfig | Computed<Cluster_InstanceGroups_ScheduledUpdateConfig>;
  ...
  slurmConfig?: Cluster_InstanceGroups_SlurmConfig | Computed<Cluster_InstanceGroups_SlurmConfig>;
...
export interface Cluster_Orchestrator_Eks {
...
export interface Cluster_Orchestrator {
  ...
  eks?: Cluster_Orchestrator_Eks | Computed<Cluster_Orchestrator_Eks>;
...
export interface Cluster_RestrictedInstanceGroups_EnvironmentConfig_FsxLustreConfig {
...
export interface Cluster_RestrictedInstanceGroups_EnvironmentConfig {
  fsxLustreConfig?: Cluster_RestrictedInstanceGroups_EnvironmentConfig_FsxLustreConfig | Computed<Cluster_RestrictedInstanceGroups_EnvironmentConfig_FsxLustreConfig>;
}

export interface Cluster_RestrictedInstanceGroups {
  ...
  currentCount?: number | Computed<number>;
  environmentConfig?: Cluster_RestrictedInstanceGroups_EnvironmentConfig | Computed<Cluster_RestrictedInstanceGroups_EnvironmentConfig>;
...
export interface Cluster_RestrictedInstanceGroupsConfig_SharedEnvironmentConfig {
...
export interface Cluster_RestrictedInstanceGroupsConfig {
  /** The shared environment configuration for restricted instance groups that use cluster-level shared FSx Lustre storage. */
  sharedEnvironmentConfig: Cluster_RestrictedInstanceGroupsConfig_SharedEnvironmentConfig | Computed<Cluster_RestrictedInstanceGroupsConfig_SharedEnvironmentConfig>;
}
...
export interface Cluster_TieredStorageConfig {
...
const Cluster_Orchestrator_EksFields: FieldMap = {
...
const Cluster_RestrictedInstanceGroups_EnvironmentConfig_FsxLustreConfigFields: FieldMap = {
  perUnitStorageThroughput: "per_unit_storage_throughput",
  sizeInGiB: "size_in_gi_b",
};

const Cluster_RestrictedInstanceGroupsConfig_SharedEnvironmentConfigFields: FieldMap = {
  fsxLustreConfig: {
...
const Cluster_RestrictedInstanceGroupsConfigFields: FieldMap = {
...
const Cluster_TieredStorageConfigFields: FieldMap = {
  instanceMemoryAllocationPercentage: "instance_memory_allocation_percentage",
  mode: "mode",
};

const Cluster_InstanceGroups_OverrideVpcConfigFields: FieldMap = {
...
export interface ClusterConfig {
  ...
  restrictedInstanceGroupsConfig?: Cluster_RestrictedInstanceGroupsConfig | Computed<Cluster_RestrictedInstanceGroupsConfig>;
  ...
  tieredStorageConfig?: Cluster_TieredStorageConfig | Computed<Cluster_TieredStorageConfig>;
  /** Specifies an Amazon Virtual Private Cloud (VPC) that your SageMaker jobs, hosted models, and compute resources have access to. You can control access to and from your resources by configuring a VPC. */
  vpcConfig?: Cluster_InstanceGroups_OverrideVpcConfig | Computed<Cluster_InstanceGroups_OverrideVpcConfig>;
}
...
export interface ClusterAttrs {
  ...
  instanceGroups: Cluster_InstanceGroups[];
  /** Determines the scaling strategy for the SageMaker HyperPod cluster. When set to 'Continuous', enables continuous scaling which dynamically manages node provisioning. If the parameter is omitted, uses the standard scaling approach in previous release. */
  ...
  restrictedInstanceGroups: Cluster_RestrictedInstanceGroups[];
  /** The cluster-level configuration for restricted instance groups, including shared environment settings for inter-RIG communication and FSx Lustre sharing. */
  restrictedInstanceGroupsConfig: Cluster_RestrictedInstanceGroupsConfig;
  /** Custom tags for managing the SageMaker HyperPod cluster as an AWS resource. You can add tags to your cluster in the same way you add them in other AWS services that support tagging. */
  tags: Cluster_Tags[];
  /** Configuration for tiered storage in the SageMaker HyperPod cluster. */
  tieredStorageConfig: Cluster_TieredStorageConfig;
  /** Specifies an Amazon Virtual Private Cloud (VPC) that your SageMaker jobs, hosted models, and compute resources have access to. You can control access to and from your resources by configuring a VPC. */
  vpcConfig: Cluster_InstanceGroups_OverrideVpcConfig;
}
