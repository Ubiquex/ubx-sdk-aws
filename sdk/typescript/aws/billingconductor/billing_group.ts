...
export interface BillingGroup_AccountGrouping {
...
export interface BillingGroup_ComputationPreference {
...
export interface BillingGroupConfig {
  ...
  accountGrouping: BillingGroup_AccountGrouping | Computed<BillingGroup_AccountGrouping>;
  ...
  computationPreference: BillingGroup_ComputationPreference | Computed<BillingGroup_ComputationPreference>;
...
export interface BillingGroupAttrs {
  /** Specifies the linked accounts (by their account IDs) that are grouped together in this AWS Billing Conductor billing group for consolidated billing and custom pricing. (AI-inferred) */
  accountGrouping: BillingGroup_AccountGrouping;
  /** Billing Group ARN */
  arn: string;
  /** Specifies the cost computation preference for the billing group, referencing the pricing rule ARN that determines how the group's billed amounts are calculated. (AI-inferred) */
  computationPreference: BillingGroup_ComputationPreference;
