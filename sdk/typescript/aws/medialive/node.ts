...
export interface Node_NodeInterfaceMappings {
...
export interface Node_SdiSourceMappings {
...
const Node_NodeInterfaceMappingsFields: FieldMap = {
...
const Node_SdiSourceMappingsFields: FieldMap = {
  cardNumber: "card_number",
  channelNumber: "channel_number",
  sdiSource: "sdi_source",
};

const Node_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface NodeConfig {
  ...
  nodeInterfaceMappings?: Node_NodeInterfaceMappings[] | Computed<Node_NodeInterfaceMappings[]>;
  ...
  sdiSourceMappings?: Node_SdiSourceMappings[] | Computed<Node_SdiSourceMappings[]>;
  /** A collection of key-value pairs. */
  tags?: Node_Tags[] | Computed<Node_Tags[]>;
}
...
export interface NodeAttrs {
  ...
  name: string;
  /** An array of interface mappings for the Node. */
  nodeInterfaceMappings: Node_NodeInterfaceMappings[];
  /** The role of the Node in the Cluster. ACTIVE means the Node is available for encoding. BACKUP means the Node is a redundant Node and might get used if an ACTIVE Node fails. */
  role: string;
  /** An array of SDI source mappings. */
  sdiSourceMappings: Node_SdiSourceMappings[];
