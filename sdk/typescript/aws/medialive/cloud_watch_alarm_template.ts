...
export interface CloudWatchAlarmTemplateConfig {
...
export interface CloudWatchAlarmTemplateAttrs {
...
export const CloudWatchAlarmTemplate: ResourceBinding<CloudWatchAlarmTemplateConfig, CloudWatchAlarmTemplateAttrs> = {
