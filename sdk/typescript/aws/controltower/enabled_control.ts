...
export interface EnabledControl_Parameters {
...
export interface EnabledControl_Tags {
...
const EnabledControl_ParametersFields: FieldMap = {
  key: "key",
  value: "value",
};

const EnabledControl_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface EnabledControlConfig {
  /** Arn of the control. */
  controlIdentifier: string | Computed<string>;
  /** Parameters to configure the enabled control behavior. */
  parameters?: EnabledControl_Parameters[] | Computed<EnabledControl_Parameters[]>;
  /** A set of tags to assign to the enabled control. */
  tags?: EnabledControl_Tags[] | Computed<EnabledControl_Tags[]>;
  /** Arn for Organizational unit to which the control needs to be applied */
  targetIdentifier: string | Computed<string>;
}

export interface EnabledControlAttrs {
  /** Arn of the control. */
  controlIdentifier: string;
  /** Parameters to configure the enabled control behavior. */
  parameters: EnabledControl_Parameters[];
  /** A set of tags to assign to the enabled control. */
  tags: EnabledControl_Tags[];
  /** Arn for Organizational unit to which the control needs to be applied */
  targetIdentifier: string;
}

export const EnabledControl: ResourceBinding<EnabledControlConfig, EnabledControlAttrs> = {
