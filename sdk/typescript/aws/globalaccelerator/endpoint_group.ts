...
export interface EndpointGroup_EndpointConfigurations {
...
export interface EndpointGroup_PortOverrides {
...
const EndpointGroup_EndpointConfigurationsFields: FieldMap = {
...
const EndpointGroup_PortOverridesFields: FieldMap = {
...
export interface EndpointGroupConfig {
  ...
  endpointConfigurations?: EndpointGroup_EndpointConfigurations[] | Computed<EndpointGroup_EndpointConfigurations[]>;
  ...
  portOverrides?: EndpointGroup_PortOverrides[] | Computed<EndpointGroup_PortOverrides[]>;
...
export interface EndpointGroupAttrs {
  /** The list of endpoint objects. */
  endpointConfigurations: EndpointGroup_EndpointConfigurations[];
  ...
  listenerArn: string;
  /** A list of port overrides that map a listener port to a different endpoint port for the endpoint group, allowing traffic to be redirected to a custom port on the endpoint. (AI-inferred) */
  portOverrides: EndpointGroup_PortOverrides[];
  /** The number of consecutive health checks required to set the state of the endpoint to unhealthy. */
