...
export interface Rule_Action_FixedResponse {
...
export interface Rule_Action_Forward_TargetGroups {
...
export interface Rule_Action_Forward {
  /** Specifies the list of target groups and their weights to which the forward action distributes traffic. (AI-inferred) */
  targetGroups: Rule_Action_Forward_TargetGroups[] | Computed<Rule_Action_Forward_TargetGroups[]>;
}
...
export interface Rule_Action {
  ...
  fixedResponse?: Rule_Action_FixedResponse | Computed<Rule_Action_FixedResponse>;
  ...
  forward?: Rule_Action_Forward | Computed<Rule_Action_Forward>;
}

export interface Rule_Match_HttpMatch_HeaderMatches_Match {
...
export interface Rule_Match_HttpMatch_HeaderMatches {
  ...
  match?: Rule_Match_HttpMatch_HeaderMatches_Match | Computed<Rule_Match_HttpMatch_HeaderMatches_Match>;
...
export interface Rule_Match_HttpMatch_PathMatch_Match {
...
export interface Rule_Match_HttpMatch_PathMatch {
  ...
  match: Rule_Match_HttpMatch_PathMatch_Match | Computed<Rule_Match_HttpMatch_PathMatch_Match>;
}

export interface Rule_Match_HttpMatch {
  ...
  headerMatches?: Rule_Match_HttpMatch_HeaderMatches[] | Computed<Rule_Match_HttpMatch_HeaderMatches[]>;
  ...
  pathMatch?: Rule_Match_HttpMatch_PathMatch | Computed<Rule_Match_HttpMatch_PathMatch>;
}

export interface Rule_Match {
  ...
  httpMatch: Rule_Match_HttpMatch | Computed<Rule_Match_HttpMatch>;
}
...
const Rule_Action_FixedResponseFields: FieldMap = {
  statusCode: "status_code",
};

const Rule_Action_Forward_TargetGroupsFields: FieldMap = {
  targetGroupIdentifier: "target_group_identifier",
  weight: "weight",
};

const Rule_Action_ForwardFields: FieldMap = {
  targetGroups: {
...
const Rule_ActionFields: FieldMap = {
  fixedResponse: {
...
const Rule_Match_HttpMatch_HeaderMatches_MatchFields: FieldMap = {
  contains: "contains",
  exact: "exact",
  prefix: "prefix",
};

const Rule_Match_HttpMatch_HeaderMatchesFields: FieldMap = {
...
const Rule_Match_HttpMatch_PathMatch_MatchFields: FieldMap = {
  exact: "exact",
  prefix: "prefix",
};

const Rule_Match_HttpMatch_PathMatchFields: FieldMap = {
  caseSensitive: "case_sensitive",
  match: {
    wireName: "match",
    kind: "object",
...
const Rule_Match_HttpMatchFields: FieldMap = {
  headerMatches: {
...
const Rule_MatchFields: FieldMap = {
  httpMatch: {
    wireName: "http_match",
    kind: "object",
...
export interface RuleConfig {
  ...
  action: Rule_Action | Computed<Rule_Action>;
  ...
  match: Rule_Match | Computed<Rule_Match>;
