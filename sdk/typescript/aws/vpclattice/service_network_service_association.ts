...
export interface ServiceNetworkServiceAssociation_Tags {
...
const ServiceNetworkServiceAssociation_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface ServiceNetworkServiceAssociationConfig {
  ...
  tags?: ServiceNetworkServiceAssociation_Tags[] | Computed<ServiceNetworkServiceAssociation_Tags[]>;
}
...
export interface ServiceNetworkServiceAssociationAttrs {
  ...
  status: string;
  /** Specifies a list of tag objects (key-value pairs) to attach to this VPC Lattice service network service association for metadata and cost tracking. (AI-inferred) */
  tags: ServiceNetworkServiceAssociation_Tags[];
}
