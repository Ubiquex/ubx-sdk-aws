...
export interface HubFindingAggregatorConfig {
...
export interface HubFindingAggregatorAttrs {
...
export const HubFindingAggregator: ResourceBinding<HubFindingAggregatorConfig, HubFindingAggregatorAttrs> = {
