...
const HubStandard_DisabledStandardsControlsFields: FieldMap = {
  reason: "reason",
  standardsControlArn: "standards_control_arn",
};

export interface HubStandardConfig {
  /** Specifies which controls are to be disabled in a standard. *Maximum*: ``100`` */
  disabledStandardsControls?: HubStandard_DisabledStandardsControls[] | Computed<HubStandard_DisabledStandardsControls[]>;
...
export interface HubStandardAttrs {
  /** Specifies which controls are to be disabled in a standard. *Maximum*: ``100`` */
...
export const HubStandard: ResourceBinding<HubStandardConfig, HubStandardAttrs> = {
