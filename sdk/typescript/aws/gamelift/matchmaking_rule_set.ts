...
export interface MatchmakingRuleSet_Tags {
...
const MatchmakingRuleSet_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface MatchmakingRuleSetConfig {
  /** A unique identifier for the matchmaking rule set. */
  name: string | Computed<string>;
  /** A collection of matchmaking rules, formatted as a JSON string. */
  ruleSetBody: string | Computed<string>;
  /** An array of key-value pairs to apply to this resource. */
  tags?: MatchmakingRuleSet_Tags[] | Computed<MatchmakingRuleSet_Tags[]>;
}

export interface MatchmakingRuleSetAttrs {
  ...
  ruleSetBody: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: MatchmakingRuleSet_Tags[];
}

export const MatchmakingRuleSet: ResourceBinding<MatchmakingRuleSetConfig, MatchmakingRuleSetAttrs> = {
