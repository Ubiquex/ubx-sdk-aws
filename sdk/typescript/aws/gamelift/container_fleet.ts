...
export interface ContainerFleet_DeploymentConfiguration {
...
export interface ContainerFleet_DeploymentDetails {
...
export interface ContainerFleet_GameSessionCreationLimitPolicy {
...
export interface ContainerFleet_InstanceConnectionPortRange {
...
export interface ContainerFleet_InstanceInboundPermissions {
...
export interface ContainerFleet_Locations_LocationCapacity_ManagedCapacityConfiguration {
...
export interface ContainerFleet_Locations_LocationCapacity {
  ...
  managedCapacityConfiguration?: ContainerFleet_Locations_LocationCapacity_ManagedCapacityConfiguration | Computed<ContainerFleet_Locations_LocationCapacity_ManagedCapacityConfiguration>;
...
export interface ContainerFleet_Locations {
  ...
  locationCapacity?: ContainerFleet_Locations_LocationCapacity | Computed<ContainerFleet_Locations_LocationCapacity>;
...
export interface ContainerFleet_LogConfiguration {
...
export interface ContainerFleet_ScalingPolicies_TargetConfiguration {
...
export interface ContainerFleet_ScalingPolicies {
  ...
  targetConfiguration?: ContainerFleet_ScalingPolicies_TargetConfiguration | Computed<ContainerFleet_ScalingPolicies_TargetConfiguration>;
...
export interface ContainerFleet_Tags {
...
const ContainerFleet_DeploymentConfigurationFields: FieldMap = {
...
const ContainerFleet_GameSessionCreationLimitPolicyFields: FieldMap = {
  newGameSessionsPerCreator: "new_game_sessions_per_creator",
  policyPeriodInMinutes: "policy_period_in_minutes",
};

const ContainerFleet_InstanceConnectionPortRangeFields: FieldMap = {
  fromPort: "from_port",
  toPort: "to_port",
};

const ContainerFleet_InstanceInboundPermissionsFields: FieldMap = {
  fromPort: "from_port",
  ipRange: "ip_range",
  protocol: "protocol",
  toPort: "to_port",
...
const ContainerFleet_LogConfigurationFields: FieldMap = {
  logDestination: "log_destination",
  logGroupArn: "log_group_arn",
  s3BucketName: "s3_bucket_name",
};

const ContainerFleet_ScalingPolicies_TargetConfigurationFields: FieldMap = {
  targetValue: "target_value",
};

const ContainerFleet_ScalingPoliciesFields: FieldMap = {
...
const ContainerFleet_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface ContainerFleetConfig {
  ...
  deploymentConfiguration?: ContainerFleet_DeploymentConfiguration | Computed<ContainerFleet_DeploymentConfiguration>;
  ...
  gameSessionCreationLimitPolicy?: ContainerFleet_GameSessionCreationLimitPolicy | Computed<ContainerFleet_GameSessionCreationLimitPolicy>;
  /** Defines the range of ports on the instance that allow inbound traffic to connect with containers in a fleet. */
  instanceConnectionPortRange?: ContainerFleet_InstanceConnectionPortRange | Computed<ContainerFleet_InstanceConnectionPortRange>;
  /** A range of IP addresses and port settings that allow inbound traffic to connect to server processes on an Amazon GameLift server. */
  instanceInboundPermissions?: ContainerFleet_InstanceInboundPermissions[] | Computed<ContainerFleet_InstanceInboundPermissions[]>;
  ...
  logConfiguration?: ContainerFleet_LogConfiguration | Computed<ContainerFleet_LogConfiguration>;
  ...
  scalingPolicies?: ContainerFleet_ScalingPolicies[] | Computed<ContainerFleet_ScalingPolicies[]>;
  /** An array of key-value pairs to apply to this resource. */
  tags?: ContainerFleet_Tags[] | Computed<ContainerFleet_Tags[]>;
}

export interface ContainerFleetAttrs {
  /** Indicates whether to use On-Demand instances or Spot instances for this fleet. If empty, the default is ON_DEMAND. Both categories of instances use identical hardware and configurations based on the instance type selected for this fleet. */
  billingType: string;
  /** A time stamp indicating when this data object was created. Format is a number expressed in Unix time as milliseconds (for example "1469498468.057"). */
  creationTime: string;
  /** Provides details about how to drain old tasks and replace them with new updated tasks. */
  deploymentConfiguration: ContainerFleet_DeploymentConfiguration;
  /** Provides information about the last deployment ID and its status. */
  deploymentDetails: ContainerFleet_DeploymentDetails;
  /** A human-readable description of a fleet. */
  description: string;
  ...
  /** A policy that limits the number of game sessions a player can create on the same fleet. This optional policy gives game owners control over how players can consume available game server resources. A resource creation policy makes the following statement: "An individual player can create a maximum number of new game sessions within a specified time period". The policy is evaluated when a player tries to create a new game session. For example, assume you have a policy of 10 new game sessions and a time period of 60 minutes. On receiving a CreateGameSession request, Amazon GameLift checks that the player (identified by CreatorId) has created fewer than 10 game sessions in the past 60 minutes. */
  gameSessionCreationLimitPolicy: ContainerFleet_GameSessionCreationLimitPolicy;
  /** Defines the range of ports on the instance that allow inbound traffic to connect with containers in a fleet. */
  instanceConnectionPortRange: ContainerFleet_InstanceConnectionPortRange;
  /** A range of IP addresses and port settings that allow inbound traffic to connect to server processes on an Amazon GameLift server. */
  instanceInboundPermissions: ContainerFleet_InstanceInboundPermissions[];
  /** The name of an EC2 instance type that is supported in Amazon GameLift. A fleet instance type determines the computing resources of each instance in the fleet, including CPU, memory, storage, and networking capacity. Amazon GameLift supports the following EC2 instance types. See Amazon EC2 Instance Types for detailed descriptions. */
  instanceType: string;
  ...
  locations: ContainerFleet_Locations[];
  /** A policy the location and provider of logs from the fleet. */
  logConfiguration: ContainerFleet_LogConfiguration;
  ...
  /** A list of rules that control how a fleet is scaled. */
  scalingPolicies: ContainerFleet_ScalingPolicies[];
  /** The current status of the container fleet. */
  status: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: ContainerFleet_Tags[];
}

export const ContainerFleet: ResourceBinding<ContainerFleetConfig, ContainerFleetAttrs> = {
