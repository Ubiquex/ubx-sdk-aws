...
export interface GameServerGroup_AutoScalingPolicy {
  ...
  targetTrackingConfiguration: GameServerGroup_AutoScalingPolicy_TargetTrackingConfiguration | Computed<GameServerGroup_AutoScalingPolicy_TargetTrackingConfiguration>;
}

export interface GameServerGroup_InstanceDefinitions {
...
export interface GameServerGroup_Tags {
...
const GameServerGroup_InstanceDefinitionsFields: FieldMap = {
...
const GameServerGroup_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface GameServerGroupConfig {
  ...
  instanceDefinitions: GameServerGroup_InstanceDefinitions[] | Computed<GameServerGroup_InstanceDefinitions[]>;
  ...
  tags?: GameServerGroup_Tags[] | Computed<GameServerGroup_Tags[]>;
...
export interface GameServerGroupAttrs {
  ...
  /** A set of EC2 instance types to use when creating instances in the group. */
  instanceDefinitions: GameServerGroup_InstanceDefinitions[];
  /** The EC2 launch template that contains configuration settings and game server code to be deployed to all instances in the game server group. Updating this game server group property will not take effect for the created EC2 Auto Scaling group, please update the EC2 Auto Scaling group directly after creating the resource. */
