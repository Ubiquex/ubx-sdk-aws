...
export interface MatchmakingConfiguration_GameProperties {
...
const MatchmakingConfiguration_GamePropertiesFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface MatchmakingConfigurationConfig {
  ...
  gameProperties?: MatchmakingConfiguration_GameProperties[] | Computed<MatchmakingConfiguration_GameProperties[]>;
  ...
  tags?: MatchmakingConfiguration_GameProperties[] | Computed<MatchmakingConfiguration_GameProperties[]>;
}

export interface MatchmakingConfigurationAttrs {
  /** A flag that indicates whether a match that was created with this configuration must be accepted by the matched players */
  ...
  /** A set of custom properties for a game session, formatted as key:value pairs. */
  gameProperties: MatchmakingConfiguration_GameProperties[];
  /** A set of custom game session properties, formatted as a single string value. */
  ...
  ruleSetName: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: MatchmakingConfiguration_GameProperties[];
}

export const MatchmakingConfiguration: ResourceBinding<MatchmakingConfigurationConfig, MatchmakingConfigurationAttrs> = {
