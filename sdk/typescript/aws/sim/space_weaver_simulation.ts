...
export interface SpaceWeaverSimulation_SchemaS3Location {
...
const SpaceWeaverSimulation_SchemaS3LocationFields: FieldMap = {
  bucketName: "bucket_name",
  objectKey: "object_key",
};

export interface SpaceWeaverSimulationConfig {
...
export interface SpaceWeaverSimulationAttrs {
...
export const SpaceWeaverSimulation: ResourceBinding<SpaceWeaverSimulationConfig, SpaceWeaverSimulationAttrs> = {
