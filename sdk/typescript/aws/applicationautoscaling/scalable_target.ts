...
export interface ScalableTarget_ScheduledActions_ScalableTargetAction {
...
export interface ScalableTarget_ScheduledActions {
  ...
  scalableTargetAction?: ScalableTarget_ScheduledActions_ScalableTargetAction | Computed<ScalableTarget_ScheduledActions_ScalableTargetAction>;
...
export interface ScalableTarget_SuspendedState {
...
const ScalableTarget_ScheduledActions_ScalableTargetActionFields: FieldMap = {
  maxCapacity: "max_capacity",
  minCapacity: "min_capacity",
};

const ScalableTarget_ScheduledActionsFields: FieldMap = {
  endTime: "end_time",
...
const ScalableTarget_SuspendedStateFields: FieldMap = {
...
export interface ScalableTargetConfig {
  ...
  scheduledActions?: ScalableTarget_ScheduledActions[] | Computed<ScalableTarget_ScheduledActions[]>;
  ...
  suspendedState?: ScalableTarget_SuspendedState | Computed<ScalableTarget_SuspendedState>;
}

export interface ScalableTargetAttrs {
  ...
  /** The scheduled actions for the scalable target. Duplicates aren't allowed. */
  scheduledActions: ScalableTarget_ScheduledActions[];
  /** The namespace of the AWS service that provides the resource, or a ``custom-resource``. */
  serviceNamespace: string;
  /** ``SuspendedState`` is a property of the [AWS::ApplicationAutoScaling::ScalableTarget](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-applicationautoscaling-scalabletarget.html) resource that specifies whether the scaling activities for a scalable target are in a suspended state. For more information, see [Suspending and resuming scaling](https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-suspend-resume-scaling.html) in the *Application Auto Scaling User Guide*. */
  suspendedState: ScalableTarget_SuspendedState;
}

export const ScalableTarget: ResourceBinding<ScalableTargetConfig, ScalableTargetAttrs> = {
