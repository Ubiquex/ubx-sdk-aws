...
export interface Domain_Aimloptions {
  ...
  s3VectorsEngine?: Domain_Aimloptions_S3VectorsEngine | Computed<Domain_Aimloptions_S3VectorsEngine>;
  ...
  serverlessVectorAcceleration?: Domain_Aimloptions_S3VectorsEngine | Computed<Domain_Aimloptions_S3VectorsEngine>;
}

export interface Domain_AdvancedSecurityOptions_IamfederationOptions {
...
export interface Domain_AdvancedSecurityOptions_Samloptions_Idp {
...
export interface Domain_AdvancedSecurityOptions_Samloptions {
  ...
  idp?: Domain_AdvancedSecurityOptions_Samloptions_Idp | Computed<Domain_AdvancedSecurityOptions_Samloptions_Idp>;
...
export interface Domain_AdvancedSecurityOptions {
  ...
  iamfederationOptions?: Domain_AdvancedSecurityOptions_IamfederationOptions | Computed<Domain_AdvancedSecurityOptions_IamfederationOptions>;
  ...
  jwtoptions?: Domain_AdvancedSecurityOptions_Jwtoptions | Computed<Domain_AdvancedSecurityOptions_Jwtoptions>;
  ...
  samloptions?: Domain_AdvancedSecurityOptions_Samloptions | Computed<Domain_AdvancedSecurityOptions_Samloptions>;
}

export interface Domain_AutomatedSnapshotPauseOptions {
...
export interface Domain_ClusterConfig_NodeOptions {
  ...
  nodeConfig?: Domain_ClusterConfig_NodeOptions_NodeConfig | Computed<Domain_ClusterConfig_NodeOptions_NodeConfig>;
...
export interface Domain_ClusterConfig {
  ...
  coldStorageOptions?: Domain_Aimloptions_S3VectorsEngine | Computed<Domain_Aimloptions_S3VectorsEngine>;
  ...
  nodeOptions?: Domain_ClusterConfig_NodeOptions[] | Computed<Domain_ClusterConfig_NodeOptions[]>;
  ...
  zoneAwarenessConfig?: Domain_ClusterConfig_ZoneAwarenessConfig | Computed<Domain_ClusterConfig_ZoneAwarenessConfig>;
...
export interface Domain_OffPeakWindowOptions_OffPeakWindow {
  ...
  windowStartTime?: Domain_OffPeakWindowOptions_OffPeakWindow_WindowStartTime | Computed<Domain_OffPeakWindowOptions_OffPeakWindow_WindowStartTime>;
}
...
export interface Domain_OffPeakWindowOptions {
  ...
  offPeakWindow?: Domain_OffPeakWindowOptions_OffPeakWindow | Computed<Domain_OffPeakWindowOptions_OffPeakWindow>;
}

export interface Domain_ServiceSoftwareOptions {
...
const Domain_AutomatedSnapshotPauseOptionsFields: FieldMap = {
  enabled: "enabled",
  endTime: "end_time",
...
export interface DomainConfig {
  ...
  automatedSnapshotPauseOptions?: Domain_AutomatedSnapshotPauseOptions | Computed<Domain_AutomatedSnapshotPauseOptions>;
  ...
  nodeToNodeEncryptionOptions?: Domain_Aimloptions_S3VectorsEngine | Computed<Domain_Aimloptions_S3VectorsEngine>;
...
export interface DomainAttrs {
  ...
  arn: string;
  /** Configures a recurring time window during which automated snapshots are paused for the OpenSearch Service domain, preventing snapshot creation during periods of high activity or maintenance. (AI-inferred) */
  automatedSnapshotPauseOptions: Domain_AutomatedSnapshotPauseOptions;
  /** The cluster_config object configures the OpenSearch cluster's compute and sizing settings, including instance type, instance count, dedicated master nodes, and zone awareness for the domain. (AI-inferred) */
  ...
  /** Specifies settings for encrypting traffic between nodes in the Amazon OpenSearch Service domain, with an Enabled boolean that must be true to activate node-to-node encryption. (AI-inferred) */
  nodeToNodeEncryptionOptions: Domain_Aimloptions_S3VectorsEngine;
  /** Configures a daily off-peak window during which the OpenSearch Service domain can perform maintenance activities such as software updates, helping minimize impact on active traffic. (AI-inferred) */
  ...
  serviceSoftwareOptions: Domain_ServiceSoftwareOptions;
  /** Set this to true to make Terraform skip waiting for shard migration to complete when reducing the number of data nodes in the OpenSearch domain, allowing the cluster configuration update to finish faster. (AI-inferred) */
