...
export interface DomainObjectType_Tags {
...
const DomainObjectType_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface DomainObjectTypeConfig {
  ...
  tags?: DomainObjectType_Tags[] | Computed<DomainObjectType_Tags[]>;
}
...
export interface DomainObjectTypeAttrs {
  ...
  /** An array of key-value pairs to apply to this resource. */
  tags: DomainObjectType_Tags[];
}

export const DomainObjectType: ResourceBinding<DomainObjectTypeConfig, DomainObjectTypeAttrs> = {
