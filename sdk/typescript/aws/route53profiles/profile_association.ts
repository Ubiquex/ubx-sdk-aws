...
export interface ProfileAssociation_Tags {
...
const ProfileAssociation_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface ProfileAssociationConfig {
  ...
  tags?: ProfileAssociation_Tags[] | Computed<ProfileAssociation_Tags[]>;
}
...
export interface ProfileAssociationAttrs {
  ...
  resourceId: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: ProfileAssociation_Tags[];
}

export const ProfileAssociation: ResourceBinding<ProfileAssociationConfig, ProfileAssociationAttrs> = {
