...
export interface Permissions_DataLakePrincipal {
...
export interface Permissions_Resource_DataLocationResource {
...
export interface Permissions_Resource_DatabaseResource {
...
export interface Permissions_Resource_TableResource {
...
export interface Permissions_Resource_TableWithColumnsResource_ColumnWildcard {
...
export interface Permissions_Resource_TableWithColumnsResource {
  ...
  columnWildcard?: Permissions_Resource_TableWithColumnsResource_ColumnWildcard | Computed<Permissions_Resource_TableWithColumnsResource_ColumnWildcard>;
...
export interface Permissions_Resource {
  ...
  dataLocationResource?: Permissions_Resource_DataLocationResource | Computed<Permissions_Resource_DataLocationResource>;
  ...
  databaseResource?: Permissions_Resource_DatabaseResource | Computed<Permissions_Resource_DatabaseResource>;
  ...
  tableResource?: Permissions_Resource_TableResource | Computed<Permissions_Resource_TableResource>;
  ...
  tableWithColumnsResource?: Permissions_Resource_TableWithColumnsResource | Computed<Permissions_Resource_TableWithColumnsResource>;
}

const Permissions_DataLakePrincipalFields: FieldMap = {
  dataLakePrincipalIdentifier: "data_lake_principal_identifier",
};

const Permissions_Resource_DataLocationResourceFields: FieldMap = {
  catalogId: "catalog_id",
  s3Resource: "s3_resource",
};

const Permissions_Resource_DatabaseResourceFields: FieldMap = {
  catalogId: "catalog_id",
  name: "name",
};

const Permissions_Resource_TableResourceFields: FieldMap = {
  catalogId: "catalog_id",
...
const Permissions_Resource_TableWithColumnsResource_ColumnWildcardFields: FieldMap = {
  excludedColumnNames: "excluded_column_names",
};

const Permissions_Resource_TableWithColumnsResourceFields: FieldMap = {
  catalogId: "catalog_id",
...
const Permissions_ResourceFields: FieldMap = {
...
export interface PermissionsConfig {
  ...
  dataLakePrincipal: Permissions_DataLakePrincipal | Computed<Permissions_DataLakePrincipal>;
  ...
  resource: Permissions_Resource | Computed<Permissions_Resource>;
}

export interface PermissionsAttrs {
  /** The AWS Lake Formation principal (such as an IAM user, role, or account) that receives the granted permissions, identified by its data lake principal identifier. (AI-inferred) */
  dataLakePrincipal: Permissions_DataLakePrincipal;
