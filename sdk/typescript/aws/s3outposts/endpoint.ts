...
export interface Endpoint_FailedReason {
...
const Endpoint_FailedReasonFields: FieldMap = {
...
export interface EndpointConfig {
  ...
  failedReason?: Endpoint_FailedReason | Computed<Endpoint_FailedReason>;
...
export interface EndpointAttrs {
  ...
  /** The failure reason for the S3 on Outposts endpoint, providing an error code and message if endpoint creation failed. (AI-inferred) */
  failedReason: Endpoint_FailedReason;
