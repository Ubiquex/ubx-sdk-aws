...
export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Attribute {
...
export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables_Value_PropertyPath {
...
export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables_Value {
  ...
  propertyPath?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables_Value_PropertyPath[] | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables_Value_PropertyPath[]>;
}

export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables {
  ...
  value?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables_Value | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables_Value>;
}

export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Window_Tumbling {
...
export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Window {
  ...
  tumbling?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Window_Tumbling | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Window_Tumbling>;
}

export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric {
  ...
  variables?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables[] | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Variables[]>;
  ...
  window?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Window | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric_Window>;
}

export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Transform {
...
export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type {
  ...
  attribute?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Attribute | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Attribute>;
  ...
  metric?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Metric>;
  ...
  transform?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Transform | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type_Transform>;
...
export interface AssetModel_AssetModelCompositeModels_CompositeModelProperties {
  ...
  type?: AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties_Type>;
...
export interface AssetModel_AssetModelCompositeModels {
  ...
  compositeModelProperties?: AssetModel_AssetModelCompositeModels_CompositeModelProperties[] | Computed<AssetModel_AssetModelCompositeModels_CompositeModelProperties[]>;
...
export interface AssetModel_AssetModelHierarchies {
...
export interface AssetModel_EnforcedAssetModelInterfaceRelationships_PropertyMappings {
...
export interface AssetModel_EnforcedAssetModelInterfaceRelationships {
  ...
  propertyMappings?: AssetModel_EnforcedAssetModelInterfaceRelationships_PropertyMappings[] | Computed<AssetModel_EnforcedAssetModelInterfaceRelationships_PropertyMappings[]>;
}

export interface AssetModel_Tags {
...
const AssetModel_EnforcedAssetModelInterfaceRelationships_PropertyMappingsFields: FieldMap = {
...
const AssetModel_EnforcedAssetModelInterfaceRelationshipsFields: FieldMap = {
...
const AssetModel_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface AssetModelConfig {
  ...
  enforcedAssetModelInterfaceRelationships?: AssetModel_EnforcedAssetModelInterfaceRelationships[] | Computed<AssetModel_EnforcedAssetModelInterfaceRelationships[]>;
  /** A list of key-value pairs that contain metadata for the asset model. */
  tags?: AssetModel_Tags[] | Computed<AssetModel_Tags[]>;
}

export interface AssetModelAttrs {
  ...
  assetModelCompositeModels: AssetModel_AssetModelCompositeModels[];
  /** A description for the asset model. */
  assetModelDescription: string;
  /** The external ID of the asset model. */
  assetModelExternalId: string;
  /** The hierarchy definitions of the asset model. Each hierarchy specifies an asset model whose assets can be children of any other assets created from this asset model. You can specify up to 10 hierarchies per asset model. */
  assetModelHierarchies: AssetModel_AssetModelHierarchies[];
  /** The ID of the asset model. */
  assetModelId: string;
  /** A unique, friendly name for the asset model. */
  assetModelName: string;
  /** The property definitions of the asset model. You can specify up to 200 properties per asset model. */
  assetModelProperties: AssetModel_AssetModelCompositeModels_CompositeModelProperties[];
  /** The type of the asset model (ASSET_MODEL OR COMPONENT_MODEL or INTERFACE) */
  assetModelType: string;
  /** a list of asset model and interface relationships */
  enforcedAssetModelInterfaceRelationships: AssetModel_EnforcedAssetModelInterfaceRelationships[];
  /** A list of key-value pairs that contain metadata for the asset model. */
  tags: AssetModel_Tags[];
}

export const AssetModel: ResourceBinding<AssetModelConfig, AssetModelAttrs> = {
