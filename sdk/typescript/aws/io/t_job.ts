...
export interface TJob_AbortConfig_CriteriaList {
...
export interface TJob_AbortConfig {
  /** The list of criteria that determine when and how to abort the job. */
  criteriaList: TJob_AbortConfig_CriteriaList[] | Computed<TJob_AbortConfig_CriteriaList[]>;
}

export interface TJob_JobExecutionsRetryConfig_CriteriaList {
...
export interface TJob_JobExecutionsRetryConfig {
  /** The list of criteria that determines how many retries are allowed for each failure type for a job. */
  criteriaList: TJob_JobExecutionsRetryConfig_CriteriaList[] | Computed<TJob_JobExecutionsRetryConfig_CriteriaList[]>;
}

export interface TJob_JobExecutionsRolloutConfig_ExponentialRate_RateIncreaseCriteria {
...
export interface TJob_JobExecutionsRolloutConfig_ExponentialRate {
  ...
  rateIncreaseCriteria: TJob_JobExecutionsRolloutConfig_ExponentialRate_RateIncreaseCriteria | Computed<TJob_JobExecutionsRolloutConfig_ExponentialRate_RateIncreaseCriteria>;
}

export interface TJob_JobExecutionsRolloutConfig {
  /** Allows you to create an exponential rate of rollout for a job. */
  exponentialRate?: TJob_JobExecutionsRolloutConfig_ExponentialRate | Computed<TJob_JobExecutionsRolloutConfig_ExponentialRate>;
  /** The maximum number of things that will be notified of a pending job, per minute. This parameter allows you to create a staged rollout. */
  maximumPerMinute?: number | Computed<number>;
}

export interface TJob_PresignedUrlConfig {
...
export interface TJob_SchedulingConfig_MaintenanceWindows {
...
export interface TJob_SchedulingConfig {
  ...
  maintenanceWindows?: TJob_SchedulingConfig_MaintenanceWindows[] | Computed<TJob_SchedulingConfig_MaintenanceWindows[]>;
  /** The time a job will begin rollout of the job document to all devices in the target group for a job. */
  startTime?: string | Computed<string>;
}

export interface TJob_Tags {
...
export interface TJob_TimeoutConfig {
...
const TJob_AbortConfig_CriteriaListFields: FieldMap = {
  action: "action",
...
const TJob_AbortConfigFields: FieldMap = {
  criteriaList: {
...
const TJob_JobExecutionsRetryConfig_CriteriaListFields: FieldMap = {
  failureType: "failure_type",
  numberOfRetries: "number_of_retries",
};

const TJob_JobExecutionsRetryConfigFields: FieldMap = {
  criteriaList: {
    wireName: "criteria_list",
    kind: "list",
...
const TJob_JobExecutionsRolloutConfig_ExponentialRate_RateIncreaseCriteriaFields: FieldMap = {
  numberOfNotifiedThings: "number_of_notified_things",
  numberOfSucceededThings: "number_of_succeeded_things",
};

const TJob_JobExecutionsRolloutConfig_ExponentialRateFields: FieldMap = {
...
const TJob_JobExecutionsRolloutConfigFields: FieldMap = {
  exponentialRate: {
...
const TJob_PresignedUrlConfigFields: FieldMap = {
  expiresInSec: "expires_in_sec",
  roleArn: "role_arn",
};

const TJob_SchedulingConfig_MaintenanceWindowsFields: FieldMap = {
  durationInMinutes: "duration_in_minutes",
  startTime: "start_time",
};

const TJob_SchedulingConfigFields: FieldMap = {
...
const TJob_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

const TJob_TimeoutConfigFields: FieldMap = {
  inProgressTimeoutInMinutes: "in_progress_timeout_in_minutes",
};

export interface TJobConfig {
  /** The criteria that determine when and how a job abort takes place. */
  abortConfig?: TJob_AbortConfig | Computed<TJob_AbortConfig>;
  ...
  jobExecutionsRetryConfig?: TJob_JobExecutionsRetryConfig | Computed<TJob_JobExecutionsRetryConfig>;
  /** Allows you to create a staged rollout of a job. */
  jobExecutionsRolloutConfig?: TJob_JobExecutionsRolloutConfig | Computed<TJob_JobExecutionsRolloutConfig>;
  /** A job identifier which must be unique for your AWS account. We recommend using a UUID. Alpha-numeric characters, '-' and '_' are valid for use here. */
  jobId: string | Computed<string>;
  /** The ARN of the job template used to create the job. */
  jobTemplateArn?: string | Computed<string>;
  /** Configuration for pre-signed S3 URLs. */
  presignedUrlConfig?: TJob_PresignedUrlConfig | Computed<TJob_PresignedUrlConfig>;
  /** Specifies the date and time that a job will begin the rollout of the job document to all devices in the target group. */
  schedulingConfig?: TJob_SchedulingConfig | Computed<TJob_SchedulingConfig>;
  /** Metadata which can be used to manage the job. */
  tags?: TJob_Tags[] | Computed<TJob_Tags[]>;
  ...
  timeoutConfig?: TJob_TimeoutConfig | Computed<TJob_TimeoutConfig>;
}

export interface TJobAttrs {
  /** The criteria that determine when and how a job abort takes place. */
  abortConfig: TJob_AbortConfig;
  ...
  /** The configuration that determines how many retries are allowed for each failure type for a job. */
  jobExecutionsRetryConfig: TJob_JobExecutionsRetryConfig;
  /** Allows you to create a staged rollout of a job. */
  jobExecutionsRolloutConfig: TJob_JobExecutionsRolloutConfig;
  /** A job identifier which must be unique for your AWS account. We recommend using a UUID. Alpha-numeric characters, '-' and '_' are valid for use here. */
  jobId: string;
  /** The ARN of the job template used to create the job. */
  jobTemplateArn: string;
  /** Configuration for pre-signed S3 URLs. */
  presignedUrlConfig: TJob_PresignedUrlConfig;
  /** Specifies the date and time that a job will begin the rollout of the job document to all devices in the target group. */
  schedulingConfig: TJob_SchedulingConfig;
  /** Metadata which can be used to manage the job. */
  tags: TJob_Tags[];
  /** Specifies whether the job will continue to run (CONTINUOUS), or will be complete after all those things specified as targets have completed the job (SNAPSHOT). */
  ...
  targets: string[];
  /** Specifies the amount of time each device has to finish its execution of the job. */
  timeoutConfig: TJob_TimeoutConfig;
}

export const TJob: ResourceBinding<TJobConfig, TJobAttrs> = {
