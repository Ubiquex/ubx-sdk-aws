...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHints {
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_CloudWatchLoggingOptions {
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_Processors_Parameters {
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_Processors {
  ...
  parameters?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_Processors_Parameters[] | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_Processors_Parameters[]>;
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration {
  ...
  processors?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_Processors[] | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_Processors[]>;
}

export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_RetryOptions {
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfiguration_KmsencryptionConfig {
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfiguration {
  ...
  kmsencryptionConfig?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfiguration_KmsencryptionConfig | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfiguration_KmsencryptionConfig>;
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration {
  ...
  bufferingHints?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHints | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHints>;
  ...
  cloudWatchLoggingOptions?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_CloudWatchLoggingOptions | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_CloudWatchLoggingOptions>;
  ...
  encryptionConfiguration?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfiguration | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfiguration>;
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_VpcConfiguration {
...
export interface DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration {
  ...
  processingConfiguration?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration>;
  ...
  retryOptions?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_RetryOptions | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_RetryOptions>;
  ...
  s3Configuration: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration>;
  ...
  vpcConfiguration?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_VpcConfiguration | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_VpcConfiguration>;
}

export interface DeliveryStream_AmazonopensearchserviceDestinationConfiguration_DocumentIdOptions {
...
export interface DeliveryStream_AmazonopensearchserviceDestinationConfiguration {
  ...
  documentIdOptions?: DeliveryStream_AmazonopensearchserviceDestinationConfiguration_DocumentIdOptions | Computed<DeliveryStream_AmazonopensearchserviceDestinationConfiguration_DocumentIdOptions>;
...
export interface DeliveryStream_DatabaseSourceConfiguration_Columns {
...
export interface DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfiguration_SecretsManagerConfiguration {
...
export interface DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfiguration {
  ...
  secretsManagerConfiguration: DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfiguration_SecretsManagerConfiguration | Computed<DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfiguration_SecretsManagerConfiguration>;
}

export interface DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceVpcconfiguration {
...
export interface DeliveryStream_DatabaseSourceConfiguration {
  ...
  columns?: DeliveryStream_DatabaseSourceConfiguration_Columns | Computed<DeliveryStream_DatabaseSourceConfiguration_Columns>;
  ...
  databaseSourceAuthenticationConfiguration: DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfiguration | Computed<DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfiguration>;
  ...
  databaseSourceVpcconfiguration: DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceVpcconfiguration | Computed<DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceVpcconfiguration>;
  ...
  databases: DeliveryStream_DatabaseSourceConfiguration_Columns | Computed<DeliveryStream_DatabaseSourceConfiguration_Columns>;
  ...
  tables: DeliveryStream_DatabaseSourceConfiguration_Columns | Computed<DeliveryStream_DatabaseSourceConfiguration_Columns>;
...
export interface DeliveryStream_DeliveryStreamEncryptionConfigurationInput {
...
export interface DeliveryStream_DirectPutSourceConfiguration {
...
export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_HiveJsonSerDe {
...
export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_OpenXjsonSerDe {
...
export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer {
  ...
  hiveJsonSerDe?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_HiveJsonSerDe | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_HiveJsonSerDe>;
  ...
  openXjsonSerDe?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_OpenXjsonSerDe | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_OpenXjsonSerDe>;
}

export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration {
  ...
  deserializer?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer>;
}

export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_OrcSerDe {
...
export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_ParquetSerDe {
...
export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer {
  ...
  orcSerDe?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_OrcSerDe | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_OrcSerDe>;
  ...
  parquetSerDe?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_ParquetSerDe | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_ParquetSerDe>;
}

export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration {
  ...
  serializer?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer>;
}

export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_SchemaConfiguration {
...
export interface DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration {
  ...
  inputFormatConfiguration?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration>;
  ...
  outputFormatConfiguration?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration>;
  ...
  schemaConfiguration?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_SchemaConfiguration | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_SchemaConfiguration>;
}

export interface DeliveryStream_ExtendedS3DestinationConfiguration_DynamicPartitioningConfiguration {
...
export interface DeliveryStream_ExtendedS3DestinationConfiguration {
  ...
  dataFormatConversionConfiguration?: DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration>;
  ...
  dynamicPartitioningConfiguration?: DeliveryStream_ExtendedS3DestinationConfiguration_DynamicPartitioningConfiguration | Computed<DeliveryStream_ExtendedS3DestinationConfiguration_DynamicPartitioningConfiguration>;
  ...
  s3BackupConfiguration?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration>;
  /** Specifies whether Amazon S3 backups for the destination are enabled (Enabled) or disabled (Disabled). (AI-inferred) */
  s3BackupMode?: string | Computed<string>;
}

export interface DeliveryStream_HttpEndpointDestinationConfiguration_EndpointConfiguration {
...
export interface DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfiguration_CommonAttributes {
...
export interface DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfiguration {
  /** Specifies key-value pairs that are included in every HTTP request Firehose sends to the destination endpoint. (AI-inferred) */
  commonAttributes?: DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfiguration_CommonAttributes[] | Computed<DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfiguration_CommonAttributes[]>;
...
export interface DeliveryStream_HttpEndpointDestinationConfiguration {
  ...
  endpointConfiguration: DeliveryStream_HttpEndpointDestinationConfiguration_EndpointConfiguration | Computed<DeliveryStream_HttpEndpointDestinationConfiguration_EndpointConfiguration>;
  ...
  requestConfiguration?: DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfiguration | Computed<DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfiguration>;
...
export interface DeliveryStream_IcebergDestinationConfiguration_CatalogConfiguration {
...
export interface DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpec_Identity {
...
export interface DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpec {
  ...
  identity?: DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpec_Identity[] | Computed<DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpec_Identity[]>;
}

export interface DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList {
  ...
  partitionSpec?: DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpec | Computed<DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpec>;
...
export interface DeliveryStream_IcebergDestinationConfiguration_SchemaEvolutionConfiguration {
...
export interface DeliveryStream_IcebergDestinationConfiguration {
  ...
  catalogConfiguration: DeliveryStream_IcebergDestinationConfiguration_CatalogConfiguration | Computed<DeliveryStream_IcebergDestinationConfiguration_CatalogConfiguration>;
  ...
  destinationTableConfigurationList?: DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList[] | Computed<DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList[]>;
  ...
  schemaEvolutionConfiguration?: DeliveryStream_IcebergDestinationConfiguration_SchemaEvolutionConfiguration | Computed<DeliveryStream_IcebergDestinationConfiguration_SchemaEvolutionConfiguration>;
  ...
  tableCreationConfiguration?: DeliveryStream_IcebergDestinationConfiguration_SchemaEvolutionConfiguration | Computed<DeliveryStream_IcebergDestinationConfiguration_SchemaEvolutionConfiguration>;
}
...
export interface DeliveryStream_MsksourceConfiguration_AuthenticationConfiguration {
...
export interface DeliveryStream_MsksourceConfiguration {
  ...
  authenticationConfiguration: DeliveryStream_MsksourceConfiguration_AuthenticationConfiguration | Computed<DeliveryStream_MsksourceConfiguration_AuthenticationConfiguration>;
...
export interface DeliveryStream_RedshiftDestinationConfiguration_CopyCommand {
...
export interface DeliveryStream_RedshiftDestinationConfiguration {
  ...
  copyCommand: DeliveryStream_RedshiftDestinationConfiguration_CopyCommand | Computed<DeliveryStream_RedshiftDestinationConfiguration_CopyCommand>;
...
export interface DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeRoleConfiguration {
...
export interface DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeVpcConfiguration {
...
export interface DeliveryStream_SnowflakeDestinationConfiguration {
  ...
  snowflakeRoleConfiguration?: DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeRoleConfiguration | Computed<DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeRoleConfiguration>;
  ...
  snowflakeVpcConfiguration?: DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeVpcConfiguration | Computed<DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeVpcConfiguration>;
...
export interface DeliveryStream_Tags {
...
const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHintsFields: FieldMap = {
  intervalInSeconds: "interval_in_seconds",
  sizeInMbs: "size_in_mbs",
};

const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_CloudWatchLoggingOptionsFields: FieldMap = {
  enabled: "enabled",
  logGroupName: "log_group_name",
  logStreamName: "log_stream_name",
};

const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_Processors_ParametersFields: FieldMap = {
  parameterName: "parameter_name",
  parameterValue: "parameter_value",
};

const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfiguration_ProcessorsFields: FieldMap = {
  parameters: {
    wireName: "parameters",
    kind: "list",
...
const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_ProcessingConfigurationFields: FieldMap = {
  enabled: "enabled",
  processors: {
    wireName: "processors",
    kind: "list",
...
const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_RetryOptionsFields: FieldMap = {
  durationInSeconds: "duration_in_seconds",
};

const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfiguration_KmsencryptionConfigFields: FieldMap = {
  awskmskeyArn: "awskmskey_arn",
};

const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration_EncryptionConfigurationFields: FieldMap = {
  kmsencryptionConfig: {
...
const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3ConfigurationFields: FieldMap = {
...
const DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_VpcConfigurationFields: FieldMap = {
  roleArn: "role_arn",
  securityGroupIds: "security_group_ids",
  subnetIds: "subnet_ids",
};

const DeliveryStream_AmazonOpenSearchServerlessDestinationConfigurationFields: FieldMap = {
  bufferingHints: {
    wireName: "buffering_hints",
    kind: "object",
    fields: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHintsFields,
...
const DeliveryStream_AmazonopensearchserviceDestinationConfiguration_DocumentIdOptionsFields: FieldMap = {
  defaultDocumentIdFormat: "default_document_id_format",
};

const DeliveryStream_AmazonopensearchserviceDestinationConfigurationFields: FieldMap = {
  bufferingHints: {
    wireName: "buffering_hints",
    kind: "object",
    fields: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHintsFields,
...
const DeliveryStream_DatabaseSourceConfiguration_ColumnsFields: FieldMap = {
  exclude: "exclude",
  include: "include",
};

const DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfiguration_SecretsManagerConfigurationFields: FieldMap = {
  enabled: "enabled",
  roleArn: "role_arn",
  secretArn: "secret_arn",
};

const DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceAuthenticationConfigurationFields: FieldMap = {
...
const DeliveryStream_DatabaseSourceConfiguration_DatabaseSourceVpcconfigurationFields: FieldMap = {
  vpcEndpointServiceName: "vpc_endpoint_service_name",
};

const DeliveryStream_DatabaseSourceConfigurationFields: FieldMap = {
  columns: {
    wireName: "columns",
    kind: "object",
...
const DeliveryStream_DeliveryStreamEncryptionConfigurationInputFields: FieldMap = {
  keyArn: "key_arn",
  keyType: "key_type",
};

const DeliveryStream_DirectPutSourceConfigurationFields: FieldMap = {
  throughputHintInMbs: "throughput_hint_in_mbs",
};

const DeliveryStream_ElasticsearchDestinationConfigurationFields: FieldMap = {
  bufferingHints: {
    wireName: "buffering_hints",
    kind: "object",
    fields: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHintsFields,
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_HiveJsonSerDeFields: FieldMap = {
  timestampFormats: "timestamp_formats",
};

const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_Deserializer_OpenXjsonSerDeFields: FieldMap = {
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfiguration_DeserializerFields: FieldMap = {
  hiveJsonSerDe: {
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_InputFormatConfigurationFields: FieldMap = {
  deserializer: {
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_OrcSerDeFields: FieldMap = {
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_Serializer_ParquetSerDeFields: FieldMap = {
  blockSizeBytes: "block_size_bytes",
  compression: "compression",
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfiguration_SerializerFields: FieldMap = {
  orcSerDe: {
    wireName: "orc_ser_de",
    kind: "object",
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_OutputFormatConfigurationFields: FieldMap = {
  serializer: {
    wireName: "serializer",
    kind: "object",
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfiguration_SchemaConfigurationFields: FieldMap = {
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DataFormatConversionConfigurationFields: FieldMap = {
  enabled: "enabled",
...
const DeliveryStream_ExtendedS3DestinationConfiguration_DynamicPartitioningConfigurationFields: FieldMap = {
  enabled: "enabled",
  retryOptions: {
    wireName: "retry_options",
    kind: "object",
...
const DeliveryStream_ExtendedS3DestinationConfigurationFields: FieldMap = {
  bucketArn: "bucket_arn",
  bufferingHints: {
    wireName: "buffering_hints",
    kind: "object",
...
const DeliveryStream_HttpEndpointDestinationConfiguration_EndpointConfigurationFields: FieldMap = {
  accessKey: "access_key",
  name: "name",
  url: "url",
};

const DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfiguration_CommonAttributesFields: FieldMap = {
  attributeName: "attribute_name",
  attributeValue: "attribute_value",
};

const DeliveryStream_HttpEndpointDestinationConfiguration_RequestConfigurationFields: FieldMap = {
  commonAttributes: {
...
const DeliveryStream_HttpEndpointDestinationConfigurationFields: FieldMap = {
  bufferingHints: {
    wireName: "buffering_hints",
    kind: "object",
    fields: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHintsFields,
...
const DeliveryStream_IcebergDestinationConfiguration_CatalogConfigurationFields: FieldMap = {
  catalogArn: "catalog_arn",
  warehouseLocation: "warehouse_location",
};

const DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpec_IdentityFields: FieldMap = {
  sourceName: "source_name",
};

const DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationList_PartitionSpecFields: FieldMap = {
  identity: {
    wireName: "identity",
    kind: "list",
...
const DeliveryStream_IcebergDestinationConfiguration_DestinationTableConfigurationListFields: FieldMap = {
...
const DeliveryStream_IcebergDestinationConfiguration_SchemaEvolutionConfigurationFields: FieldMap = {
  enabled: "enabled",
};

const DeliveryStream_IcebergDestinationConfigurationFields: FieldMap = {
...
const DeliveryStream_KinesisStreamSourceConfigurationFields: FieldMap = {
  kinesisStreamArn: "kinesis_stream_arn",
  roleArn: "role_arn",
};

const DeliveryStream_MsksourceConfiguration_AuthenticationConfigurationFields: FieldMap = {
  connectivity: "connectivity",
  roleArn: "role_arn",
};

const DeliveryStream_MsksourceConfigurationFields: FieldMap = {
...
const DeliveryStream_RedshiftDestinationConfiguration_CopyCommandFields: FieldMap = {
  copyOptions: "copy_options",
  dataTableColumns: "data_table_columns",
  dataTableName: "data_table_name",
};

const DeliveryStream_RedshiftDestinationConfigurationFields: FieldMap = {
  cloudWatchLoggingOptions: {
    wireName: "cloud_watch_logging_options",
    kind: "object",
    fields: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_CloudWatchLoggingOptionsFields,
...
const DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeRoleConfigurationFields: FieldMap = {
  enabled: "enabled",
  snowflakeRole: "snowflake_role",
};

const DeliveryStream_SnowflakeDestinationConfiguration_SnowflakeVpcConfigurationFields: FieldMap = {
  privateLinkVpceId: "private_link_vpce_id",
};

const DeliveryStream_SnowflakeDestinationConfigurationFields: FieldMap = {
...
const DeliveryStream_SplunkDestinationConfigurationFields: FieldMap = {
  bufferingHints: {
    wireName: "buffering_hints",
    kind: "object",
    fields: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_BufferingHintsFields,
...
const DeliveryStream_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface DeliveryStreamConfig {
  ...
  amazonOpenSearchServerlessDestinationConfiguration?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration>;
  ...
  amazonopensearchserviceDestinationConfiguration?: DeliveryStream_AmazonopensearchserviceDestinationConfiguration | Computed<DeliveryStream_AmazonopensearchserviceDestinationConfiguration>;
  ...
  databaseSourceConfiguration?: DeliveryStream_DatabaseSourceConfiguration | Computed<DeliveryStream_DatabaseSourceConfiguration>;
  ...
  deliveryStreamEncryptionConfigurationInput?: DeliveryStream_DeliveryStreamEncryptionConfigurationInput | Computed<DeliveryStream_DeliveryStreamEncryptionConfigurationInput>;
  ...
  directPutSourceConfiguration?: DeliveryStream_DirectPutSourceConfiguration | Computed<DeliveryStream_DirectPutSourceConfiguration>;
  ...
  elasticsearchDestinationConfiguration?: DeliveryStream_ElasticsearchDestinationConfiguration | Computed<DeliveryStream_ElasticsearchDestinationConfiguration>;
  ...
  extendedS3DestinationConfiguration?: DeliveryStream_ExtendedS3DestinationConfiguration | Computed<DeliveryStream_ExtendedS3DestinationConfiguration>;
  ...
  httpEndpointDestinationConfiguration?: DeliveryStream_HttpEndpointDestinationConfiguration | Computed<DeliveryStream_HttpEndpointDestinationConfiguration>;
  ...
  icebergDestinationConfiguration?: DeliveryStream_IcebergDestinationConfiguration | Computed<DeliveryStream_IcebergDestinationConfiguration>;
  ...
  kinesisStreamSourceConfiguration?: DeliveryStream_KinesisStreamSourceConfiguration | Computed<DeliveryStream_KinesisStreamSourceConfiguration>;
  ...
  msksourceConfiguration?: DeliveryStream_MsksourceConfiguration | Computed<DeliveryStream_MsksourceConfiguration>;
  ...
  redshiftDestinationConfiguration?: DeliveryStream_RedshiftDestinationConfiguration | Computed<DeliveryStream_RedshiftDestinationConfiguration>;
  ...
  s3DestinationConfiguration?: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration | Computed<DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration>;
  ...
  snowflakeDestinationConfiguration?: DeliveryStream_SnowflakeDestinationConfiguration | Computed<DeliveryStream_SnowflakeDestinationConfiguration>;
  ...
  splunkDestinationConfiguration?: DeliveryStream_SplunkDestinationConfiguration | Computed<DeliveryStream_SplunkDestinationConfiguration>;
  ...
  tags?: DeliveryStream_Tags[] | Computed<DeliveryStream_Tags[]>;
}

export interface DeliveryStreamAttrs {
  /** Specifies the configuration for delivering data from the Firehose stream to an Amazon OpenSearch Serverless collection, including the collection endpoint, index name, buffering hints, and authentication details. (AI-inferred) */
  amazonOpenSearchServerlessDestinationConfiguration: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration;
  /** Specifies the destination configuration for delivering data to Amazon OpenSearch Service, including cluster endpoint, domain ARN, index name, S3 backup configuration, and buffering hints. (AI-inferred) */
  ...
  arn: string;
  /** Configures the database source from which the delivery stream pulls data, including the database type, connection endpoint, port, database name, table name, credentials, and optional VPC networking settings. (AI-inferred) */
  databaseSourceConfiguration: DeliveryStream_DatabaseSourceConfiguration;
  /** Configures server-side encryption for the Kinesis Data Firehose delivery stream by specifying the AWS KMS key ARN and the key type (AWS-owned or customer-managed). (AI-inferred) */
  ...
  directPutSourceConfiguration: DeliveryStream_DirectPutSourceConfiguration;
  /** Defines the delivery stream's target as Amazon Elasticsearch Service (now OpenSearch), specifying the domain/endpoint, index and type, buffering and retry behavior, and optional S3 backup for failed records. (AI-inferred) */
  ...
  /** Defines the Amazon MSK source parameters for the delivery stream, including the Kafka topic name, MSK cluster endpoint, and authentication configuration used to ingest streaming data from an Amazon Managed Streaming for Apache Kafka cluster. (AI-inferred) */
  msksourceConfiguration: DeliveryStream_MsksourceConfiguration;
  /** Specifies the destination settings for delivering Firehose stream data to an Amazon Redshift cluster, including the JDBC connection URL, copy command, S3 staging configuration, and IAM role. (AI-inferred) */
  redshiftDestinationConfiguration: DeliveryStream_RedshiftDestinationConfiguration;
  /** Configures an Amazon S3 bucket as the delivery destination for a Kinesis Data Firehose delivery stream, specifying the bucket ARN, IAM role, and optional prefix/buffering settings. (AI-inferred) */
  s3DestinationConfiguration: DeliveryStream_AmazonOpenSearchServerlessDestinationConfiguration_S3Configuration;
  /** This field specifies the configuration for delivering Kinesis Data Firehose stream data to a Snowflake destination, including the Snowflake account URL, database, schema, table, and authentication credentials. (AI-inferred) */
  snowflakeDestinationConfiguration: DeliveryStream_SnowflakeDestinationConfiguration;
  /** Defines the destination configuration for sending data to Splunk, including the Splunk endpoint, access credentials, buffering and retry settings, and optional S3 backup for failed records. (AI-inferred) */
  splunkDestinationConfiguration: DeliveryStream_SplunkDestinationConfiguration;
  /** Assigns a list of key-value tags to the Kinesis Data Firehose delivery stream, enabling resource categorization for cost allocation and access management. (AI-inferred) */
  tags: DeliveryStream_Tags[];
}

export const DeliveryStream: ResourceBinding<DeliveryStreamConfig, DeliveryStreamAttrs> = {
