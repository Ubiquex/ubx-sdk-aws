...
const DbMultiRegionCluster_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface DbMultiRegionClusterConfig {
  ...
  tags?: DbMultiRegionCluster_Tags[] | Computed<DbMultiRegionCluster_Tags[]>;
...
export interface DbMultiRegionClusterAttrs {
  ...
  tlsenabled: boolean;
  /** An array of key-value pairs to apply to this multi region cluster. */
  tags: DbMultiRegionCluster_Tags[];
  /** An enum string value that determines the update strategy for scaling. Possible values are 'COORDINATED' and 'UNCOORDINATED'. Default is 'COORDINATED'. */
  updateStrategy: string;
}

export const DbMultiRegionCluster: ResourceBinding<DbMultiRegionClusterConfig, DbMultiRegionClusterAttrs> = {
  ...
  fields: {
    ...
    tags: {
      wireName: "tags",
      kind: "list",
      fields: DbMultiRegionCluster_TagsFields,
    },
