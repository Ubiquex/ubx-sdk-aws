...
export interface DirectoryRegistrationConfig {
...
export interface DirectoryRegistrationAttrs {
  /** The identifier of the AWS Managed Microsoft Active Directory that is registered with the Private CA Connector for Active Directory. (AI-inferred) */
  directoryId: string;
...
export const DirectoryRegistration: ResourceBinding<DirectoryRegistrationConfig, DirectoryRegistrationAttrs> = {
