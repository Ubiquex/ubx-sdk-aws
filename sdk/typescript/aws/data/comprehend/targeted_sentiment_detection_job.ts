...
export interface TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_InputDataConfig_DocumentReaderConfig {
  documentReadAction: string | Computed<string>;
  documentReadMode?: string | Computed<string>;
  featureTypes?: string[] | Computed<string[]>;
}

export interface TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_InputDataConfig {
  ...
  documentReaderConfig?: TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_InputDataConfig_DocumentReaderConfig | Computed<TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_InputDataConfig_DocumentReaderConfig>;
  inputFormat?: string | Computed<string>;
  s3Uri: string | Computed<string>;
}

export interface TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_OutputDataConfig {
  kmsKeyId?: string | Computed<string>;
  s3Uri: string | Computed<string>;
}

export interface TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_VpcConfig {
  securityGroupIds: string[] | Computed<string[]>;
  subnets: string[] | Computed<string[]>;
}

export interface TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties {
  ...
  inputDataConfig?: TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_InputDataConfig | Computed<TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_InputDataConfig>;
  ...
  outputDataConfig?: TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_OutputDataConfig | Computed<TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_OutputDataConfig>;
  ...
  vpcConfig?: TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_VpcConfig | Computed<TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties_VpcConfig>;
}

export interface TargetedSentimentDetectionJobConfig {
  jobId: string | Computed<string>;
}

export interface TargetedSentimentDetectionJobAttrs {
  jobId: string;
  /** <p>Provides information about a targeted sentiment detection job.</p> */
  targetedSentimentDetectionJobProperties: TargetedSentimentDetectionJob_TargetedSentimentDetectionJobProperties;
}

export const TargetedSentimentDetectionJob: DataSourceBinding<TargetedSentimentDetectionJobConfig, TargetedSentimentDetectionJobAttrs> = {
