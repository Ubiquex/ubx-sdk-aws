// Code generated by `ubx sdk gen` from aws_comprehend_key_phrases_detection_job. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig_DocumentReaderConfig {
  documentReadAction: string | Computed<string>;
  documentReadMode?: string | Computed<string>;
  featureTypes?: string[] | Computed<string[]>;
}

export interface KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig {
  ...
  documentReaderConfig?: KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig_DocumentReaderConfig | Computed<KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig_DocumentReaderConfig>;
  inputFormat?: string | Computed<string>;
  s3Uri: string | Computed<string>;
}

export interface KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_OutputDataConfig {
  kmsKeyId?: string | Computed<string>;
  s3Uri: string | Computed<string>;
}

export interface KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_VpcConfig {
  securityGroupIds: string[] | Computed<string[]>;
  subnets: string[] | Computed<string[]>;
}

export interface KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties {
  ...
  inputDataConfig?: KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig | Computed<KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig>;
  ...
  outputDataConfig?: KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_OutputDataConfig | Computed<KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_OutputDataConfig>;
  ...
  vpcConfig?: KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_VpcConfig | Computed<KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_VpcConfig>;
}

export interface KeyPhrasesDetectionJobConfig {
  jobId: string | Computed<string>;
}

export interface KeyPhrasesDetectionJobAttrs {
  jobId: string;
  /** <p>Provides information about a key phrases detection job.</p> */
  keyPhrasesDetectionJobProperties: KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties;
}

export const KeyPhrasesDetectionJob: DataSourceBinding<KeyPhrasesDetectionJobConfig, KeyPhrasesDetectionJobAttrs> = {
  wireType: "aws_comprehend_key_phrases_detection_job",
  fields: {
    jobId: "job_id",
  },
};
