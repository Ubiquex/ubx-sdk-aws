...
export interface ObjectTorrentConfig {
...
export interface ObjectTorrentAttrs {
  body: string;
  bucket: string;
...
export const ObjectTorrent: DataSourceBinding<ObjectTorrentConfig, ObjectTorrentAttrs> = {
