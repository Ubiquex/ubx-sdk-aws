...
export interface ResourceGroupsTagSyncTask_ResourceQuery {
  query: string | Computed<string>;
  type: string | Computed<string>;
}

export interface ResourceGroupsTagSyncTaskConfig {
  taskArn: string | Computed<string>;
}

export interface ResourceGroupsTagSyncTaskAttrs {
  createdAt: string;
  errorMessage: string;
  groupArn: string;
  groupName: string;
  ...
  resourceQuery: ResourceGroupsTagSyncTask_ResourceQuery;
  roleArn: string;
  status: string;
  tagKey: string;
  tagValue: string;
...
export const ResourceGroupsTagSyncTask: DataSourceBinding<ResourceGroupsTagSyncTaskConfig, ResourceGroupsTagSyncTaskAttrs> = {
