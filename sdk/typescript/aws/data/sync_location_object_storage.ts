...
export interface SyncLocationObjectStorage_CmkSecretConfig {
...
export interface SyncLocationObjectStorage_CustomSecretConfig {
...
export interface SyncLocationObjectStorage_ManagedSecretConfig {
...
const SyncLocationObjectStorage_CustomSecretConfigFields: FieldMap = {
  secretAccessRoleArn: "secret_access_role_arn",
  secretArn: "secret_arn",
};

const SyncLocationObjectStorage_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface SyncLocationObjectStorageConfig {
  ...
  customSecretConfig?: SyncLocationObjectStorage_CustomSecretConfig | Computed<SyncLocationObjectStorage_CustomSecretConfig>;
  ...
  tags?: SyncLocationObjectStorage_Tags[] | Computed<SyncLocationObjectStorage_Tags[]>;
}

export interface SyncLocationObjectStorageAttrs {
  /** Optional. The access key is used if credentials are required to access the self-managed object storage server. */
  accessKey: string;
  /** Specifies the Amazon Resource Names (ARNs) of the DataSync agents that can connect with your object storage system. If you are setting up an agentless cross-cloud transfer, you do not need to specify a value for this parameter. */
  agentArns: string[];
  ...
  cmkSecretConfig: SyncLocationObjectStorage_CmkSecretConfig;
  /** Specifies configuration information for a customer-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and an IAM role that DataSync can assume and access the customer-managed secret. */
  customSecretConfig: SyncLocationObjectStorage_CustomSecretConfig;
  ...
  managedSecretConfig: SyncLocationObjectStorage_ManagedSecretConfig;
  /** Optional. The secret key is used if credentials are required to access the self-managed object storage server. */
  secretKey: string;
  /** X.509 PEM content containing a certificate authority or chain to trust. */
  ...
  subdirectory: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: SyncLocationObjectStorage_Tags[];
}

export const SyncLocationObjectStorage: ResourceBinding<SyncLocationObjectStorageConfig, SyncLocationObjectStorageAttrs> = {
  ...
  fields: {
    ...
    customSecretConfig: {
      ...
      kind: "object",
      fields: SyncLocationObjectStorage_CustomSecretConfigFields,
    },
    ...
    tags: {
      wireName: "tags",
      kind: "list",
      fields: SyncLocationObjectStorage_TagsFields,
    },
  },
};
