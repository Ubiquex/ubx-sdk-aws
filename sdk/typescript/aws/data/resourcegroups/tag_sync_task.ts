...
export interface TagSyncTask_ResourceQuery {
...
export interface TagSyncTaskAttrs {
  ...
  resourceQuery: TagSyncTask_ResourceQuery;
  roleArn: string;
  status: string;
  tagKey: string;
  tagValue: string;
...
export const TagSyncTask: DataSourceBinding<TagSyncTaskConfig, TagSyncTaskAttrs> = {
