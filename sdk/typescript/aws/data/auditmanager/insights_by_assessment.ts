// Code generated by `ubx sdk gen` from aws_auditmanager_insights_by_assessment. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface InsightsByAssessment_Insights {
...
export interface InsightsByAssessmentConfig {
  assessmentId: string | Computed<string>;
}

export interface InsightsByAssessmentAttrs {
  assessmentId: string;
  ...
  insights: InsightsByAssessment_Insights;
}

export const InsightsByAssessment: DataSourceBinding<InsightsByAssessmentConfig, InsightsByAssessmentAttrs> = {
  wireType: "aws_auditmanager_insights_by_assessment",
  fields: {
