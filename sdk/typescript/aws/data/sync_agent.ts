...
export interface SyncAgent_Tags {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

const SyncAgent_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export const SyncAgent: ResourceBinding<SyncAgentConfig, SyncAgentAttrs> = {
