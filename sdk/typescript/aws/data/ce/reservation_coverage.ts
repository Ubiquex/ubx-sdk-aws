// Code generated by `ubx sdk gen` from aws_ce_reservation_coverage. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageCost {
  onDemandCost?: string | Computed<string>;
}

export interface ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageHours {
  coverageHoursPercentage?: string | Computed<string>;
  onDemandHours?: string | Computed<string>;
  reservedHours?: string | Computed<string>;
  totalRunningHours?: string | Computed<string>;
}

export interface ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageNormalizedUnits {
  coverageNormalizedUnitsPercentage?: string | Computed<string>;
  onDemandNormalizedUnits?: string | Computed<string>;
  reservedNormalizedUnits?: string | Computed<string>;
  totalRunningNormalizedUnits?: string | Computed<string>;
}

export interface ReservationCoverage_CoveragesByTime_Groups_Coverage {
  coverageCost?: ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageCost | Computed<ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageCost>;
  coverageHours?: ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageHours | Computed<ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageHours>;
  coverageNormalizedUnits?: ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageNormalizedUnits | Computed<ReservationCoverage_CoveragesByTime_Groups_Coverage_CoverageNormalizedUnits>;
}

export interface ReservationCoverage_CoveragesByTime_Groups {
  attributes?: Record<string, string> | Computed<Record<string, string>>;
  coverage?: ReservationCoverage_CoveragesByTime_Groups_Coverage | Computed<ReservationCoverage_CoveragesByTime_Groups_Coverage>;
}

export interface ReservationCoverage_CoveragesByTime_TimePeriod {
  end?: string | Computed<string>;
  start?: string | Computed<string>;
}

export interface ReservationCoverage_CoveragesByTime {
  groups?: ReservationCoverage_CoveragesByTime_Groups[] | Computed<ReservationCoverage_CoveragesByTime_Groups[]>;
  timePeriod?: ReservationCoverage_CoveragesByTime_TimePeriod | Computed<ReservationCoverage_CoveragesByTime_TimePeriod>;
  total?: ReservationCoverage_CoveragesByTime_Groups_Coverage | Computed<ReservationCoverage_CoveragesByTime_Groups_Coverage>;
}

export interface ReservationCoverage_Filter_And {
}

export interface ReservationCoverage_Filter_CostCategories {
...
export interface ReservationCoverage_Filter {
  and?: ReservationCoverage_Filter_And[] | Computed<ReservationCoverage_Filter_And[]>;
  ...
  costCategories?: ReservationCoverage_Filter_CostCategories | Computed<ReservationCoverage_Filter_CostCategories>;
  ...
  dimensions?: ReservationCoverage_Filter_CostCategories | Computed<ReservationCoverage_Filter_CostCategories>;
  ...
  or?: ReservationCoverage_Filter_And[] | Computed<ReservationCoverage_Filter_And[]>;
  ...
  tags?: ReservationCoverage_Filter_CostCategories | Computed<ReservationCoverage_Filter_CostCategories>;
}

export interface ReservationCoverage_GroupBy {
  key?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface ReservationCoverage_SortBy {
  key: string | Computed<string>;
  sortOrder?: string | Computed<string>;
}

const ReservationCoverage_Filter_AndFields: FieldMap = {
};

const ReservationCoverage_Filter_CostCategoriesFields: FieldMap = {
  key: "key",
  matchOptions: "match_options",
  values: "values",
};

const ReservationCoverage_FilterFields: FieldMap = {
  and: {
    wireName: "and",
    kind: "list",
    fields: ReservationCoverage_Filter_AndFields,
  },
  costCategories: {
    wireName: "cost_categories",
    kind: "object",
    fields: ReservationCoverage_Filter_CostCategoriesFields,
  },
  dimensions: {
    wireName: "dimensions",
    kind: "object",
...
const ReservationCoverage_GroupByFields: FieldMap = {
  key: "key",
  type: "type",
};

const ReservationCoverage_SortByFields: FieldMap = {
  key: "key",
  sortOrder: "sort_order",
};

const ReservationCoverage_CoveragesByTime_TimePeriodFields: FieldMap = {
  end: "end",
  start: "start",
};

export interface ReservationCoverageConfig {
  /** <p>Use <code>Expression</code> to filter in various Cost Explorer APIs.</p> <p>Not all <code>Expression</code> types are supported in each API. Refer to the documentation for each specific API to see what is supported.</p> <p>There are two patterns:</p> <ul> <li> <p>Simple dimension values.</p> <ul> <li> <p>There are three types of simple dimension values: <code>CostCategories</code>, <code>Tags</code>, and <code>Dimensions</code>.</p> <ul> <li> <p>Specify the <code>CostCategories</code> field to define a filter that acts on Cost Categories.</p> </li> <li> <p>Specify the <code>Tags</code> field to define a filter that acts on Cost Allocation Tags.</p> </li> <li> <p>Specify the <code>Dimensions</code> field to define a filter that acts on the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_DimensionValues.html"> <code>DimensionValues</code> </a>.</p> </li> </ul> </li> <li> <p>For each filter type, you can set the dimension name and values for the filters that you plan to use.</p> <ul> <li> <p>For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. For <code>GetRightsizingRecommendation</code>, the Region is a full name (for example, <code>REGION==US East (N. Virginia)</code>.</p> </li> <li> <p>The corresponding <code>Expression</code> for this example is as follows: <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] } }</code> </p> </li> <li> <p>As shown in the previous example, lists of dimension values are combined with <code>OR</code> when applying the filter.</p> </li> </ul> </li> <li> <p>You can also set different match options to further control how the filter behaves. Not all APIs support match options. Refer to the documentation for each specific API to see what is supported.</p> <ul> <li> <p>For example, you can filter for linked account names that start with "a".</p> </li> <li> <p>The corresponding <code>Expression</code> for this example is as follows: <code>{ "Dimensions": { "Key": "LINKED_ACCOUNT_NAME", "MatchOptions": [ "STARTS_WITH" ], "Values": [ "a" ] } }</code> </p> </li> </ul> </li> </ul> </li> <li> <p>Compound <code>Expression</code> types with logical operations.</p> <ul> <li> <p>You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. By doing this, you can filter by more advanced options.</p> </li> <li> <p>For example, you can filter by <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>.</p> </li> <li> <p>The corresponding <code>Expression</code> for this example is as follows: <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> </li> </ul> <note> <p>Because each <code>Expression</code> can have only one operator, the service returns an error if more than one is specified. The following example shows an <code>Expression</code> object that creates an error: <code> { "And": [ ... ], "Dimensions": { "Key": "USAGE_TYPE", "Values": [ "DataTransfer" ] } } </code> </p> <p>The following is an example of the corresponding error message: <code>"Expression has more than one roots. Only one root operator is allowed for each expression: And, Or, Not, Dimensions, Tags, CostCategories"</code> </p> </note> </li> </ul> <note> <p>For the <code>GetRightsizingRecommendation</code> action, a combination of OR and NOT isn't supported. OR isn't supported between different dimensions, or dimensions and tags. NOT operators aren't supported. Dimensions are also limited to <code>LINKED_ACCOUNT</code>, <code>REGION</code>, or <code>RIGHTSIZING_TYPE</code>.</p> <p>For the <code>GetReservationPurchaseRecommendation</code> action, only NOT is supported. AND and OR aren't supported. Dimensions are limited to <code>LINKED_ACCOUNT</code>.</p> </note> */
  filter?: ReservationCoverage_Filter | Computed<ReservationCoverage_Filter>;
  granularity?: string | Computed<string>;
  groupBy?: ReservationCoverage_GroupBy[] | Computed<ReservationCoverage_GroupBy[]>;
  ...
  sortBy?: ReservationCoverage_SortBy | Computed<ReservationCoverage_SortBy>;
  /** <p>The time period of the request. </p> */
  timePeriod: ReservationCoverage_CoveragesByTime_TimePeriod | Computed<ReservationCoverage_CoveragesByTime_TimePeriod>;
}

export interface ReservationCoverageAttrs {
  coveragesByTime: ReservationCoverage_CoveragesByTime[];
  /** <p>Use <code>Expression</code> to filter in various Cost Explorer APIs.</p> <p>Not all <code>Expression</code> types are supported in each API. Refer to the documentation for each specific API to see what is supported.</p> <p>There are two patterns:</p> <ul> <li> <p>Simple dimension values.</p> <ul> <li> <p>There are three types of simple dimension values: <code>CostCategories</code>, <code>Tags</code>, and <code>Dimensions</code>.</p> <ul> <li> <p>Specify the <code>CostCategories</code> field to define a filter that acts on Cost Categories.</p> </li> <li> <p>Specify the <code>Tags</code> field to define a filter that acts on Cost Allocation Tags.</p> </li> <li> <p>Specify the <code>Dimensions</code> field to define a filter that acts on the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_DimensionValues.html"> <code>DimensionValues</code> </a>.</p> </li> </ul> </li> <li> <p>For each filter type, you can set the dimension name and values for the filters that you plan to use.</p> <ul> <li> <p>For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. For <code>GetRightsizingRecommendation</code>, the Region is a full name (for example, <code>REGION==US East (N. Virginia)</code>.</p> </li> <li> <p>The corresponding <code>Expression</code> for this example is as follows: <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] } }</code> </p> </li> <li> <p>As shown in the previous example, lists of dimension values are combined with <code>OR</code> when applying the filter.</p> </li> </ul> </li> <li> <p>You can also set different match options to further control how the filter behaves. Not all APIs support match options. Refer to the documentation for each specific API to see what is supported.</p> <ul> <li> <p>For example, you can filter for linked account names that start with "a".</p> </li> <li> <p>The corresponding <code>Expression</code> for this example is as follows: <code>{ "Dimensions": { "Key": "LINKED_ACCOUNT_NAME", "MatchOptions": [ "STARTS_WITH" ], "Values": [ "a" ] } }</code> </p> </li> </ul> </li> </ul> </li> <li> <p>Compound <code>Expression</code> types with logical operations.</p> <ul> <li> <p>You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. By doing this, you can filter by more advanced options.</p> </li> <li> <p>For example, you can filter by <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>.</p> </li> <li> <p>The corresponding <code>Expression</code> for this example is as follows: <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> </li> </ul> <note> <p>Because each <code>Expression</code> can have only one operator, the service returns an error if more than one is specified. The following example shows an <code>Expression</code> object that creates an error: <code> { "And": [ ... ], "Dimensions": { "Key": "USAGE_TYPE", "Values": [ "DataTransfer" ] } } </code> </p> <p>The following is an example of the corresponding error message: <code>"Expression has more than one roots. Only one root operator is allowed for each expression: And, Or, Not, Dimensions, Tags, CostCategories"</code> </p> </note> </li> </ul> <note> <p>For the <code>GetRightsizingRecommendation</code> action, a combination of OR and NOT isn't supported. OR isn't supported between different dimensions, or dimensions and tags. NOT operators aren't supported. Dimensions are also limited to <code>LINKED_ACCOUNT</code>, <code>REGION</code>, or <code>RIGHTSIZING_TYPE</code>.</p> <p>For the <code>GetReservationPurchaseRecommendation</code> action, only NOT is supported. AND and OR aren't supported. Dimensions are limited to <code>LINKED_ACCOUNT</code>.</p> </note> */
  filter: ReservationCoverage_Filter;
  granularity: string;
  groupBy: ReservationCoverage_GroupBy[];
  maxResults: number;
  metrics: string[];
  nextPageToken: string;
  /** <p>The details for how to sort the data.</p> */
  sortBy: ReservationCoverage_SortBy;
  /** <p>The time period of the request. </p> */
  timePeriod: ReservationCoverage_CoveragesByTime_TimePeriod;
  /** <p>The amount of instance usage that a reservation covered.</p> */
  total: ReservationCoverage_CoveragesByTime_Groups_Coverage;
}

export const ReservationCoverage: DataSourceBinding<ReservationCoverageConfig, ReservationCoverageAttrs> = {
  wireType: "aws_ce_reservation_coverage",
  fields: {
    filter: {
      wireName: "filter",
      kind: "object",
      fields: ReservationCoverage_FilterFields,
    },
    granularity: "granularity",
    groupBy: {
      wireName: "group_by",
      kind: "list",
      fields: ReservationCoverage_GroupByFields,
    },
    ...
    sortBy: {
      wireName: "sort_by",
      kind: "object",
      fields: ReservationCoverage_SortByFields,
    },
    timePeriod: {
      wireName: "time_period",
      kind: "object",
      fields: ReservationCoverage_CoveragesByTime_TimePeriodFields,
    },
  },
};
