...
export interface Tags_Filter_And {
}

export interface Tags_Filter_CostCategories {
...
export interface Tags_Filter {
  and?: Tags_Filter_And[] | Computed<Tags_Filter_And[]>;
  ...
  costCategories?: Tags_Filter_CostCategories | Computed<Tags_Filter_CostCategories>;
  ...
  dimensions?: Tags_Filter_CostCategories | Computed<Tags_Filter_CostCategories>;
  ...
  or?: Tags_Filter_And[] | Computed<Tags_Filter_And[]>;
  ...
  tags?: Tags_Filter_CostCategories | Computed<Tags_Filter_CostCategories>;
}

export interface Tags_SortBy {
  key?: string | Computed<string>;
  sortOrder?: string | Computed<string>;
}

export interface Tags_TimePeriod {
  end: string | Computed<string>;
  start: string | Computed<string>;
}

const Tags_Filter_AndFields: FieldMap = {
};

const Tags_Filter_CostCategoriesFields: FieldMap = {
  key: "key",
  matchOptions: "match_options",
  values: "values",
};

const Tags_FilterFields: FieldMap = {
  and: {
    wireName: "and",
    kind: "list",
    fields: Tags_Filter_AndFields,
  },
  costCategories: {
    wireName: "cost_categories",
    kind: "object",
    fields: Tags_Filter_CostCategoriesFields,
  },
  dimensions: {
    wireName: "dimensions",
    kind: "object",
...
const Tags_SortByFields: FieldMap = {
  key: "key",
  sortOrder: "sort_order",
};

const Tags_TimePeriodFields: FieldMap = {
  end: "end",
  start: "start",
};
...
export const Tags: DataSourceBinding<TagsConfig, TagsAttrs> = {
  ...
  fields: {
    ...
    sortBy: {
      wireName: "sort_by",
      kind: "list",
      fields: Tags_SortByFields,
    },
    tagKey: "tag_key",
    timePeriod: {
      wireName: "time_period",
      kind: "object",
      fields: Tags_TimePeriodFields,
    },
  },
};
