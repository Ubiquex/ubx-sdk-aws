...
export interface ServiceAccessPolicies_AccessPolicies_Status {
...
export interface ServiceAccessPolicies_AccessPolicies {
  ...
  status: ServiceAccessPolicies_AccessPolicies_Status | Computed<ServiceAccessPolicies_AccessPolicies_Status>;
}

export interface ServiceAccessPoliciesConfig {
  deployed?: boolean | Computed<boolean>;
  /** <p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p> */
  domainName: string | Computed<string>;
}

export interface ServiceAccessPoliciesAttrs {
  /** <p>The configured access rules for the domain's document and search endpoints, and the current status of those rules.</p> */
  accessPolicies: ServiceAccessPolicies_AccessPolicies;
  deployed: boolean;
  /** <p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p> */
  domainName: string;
}

export const ServiceAccessPolicies: DataSourceBinding<ServiceAccessPoliciesConfig, ServiceAccessPoliciesAttrs> = {
