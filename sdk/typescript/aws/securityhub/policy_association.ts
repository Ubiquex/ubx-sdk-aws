...
export interface PolicyAssociationConfig {
...
export interface PolicyAssociationAttrs {
...
export const PolicyAssociation: ResourceBinding<PolicyAssociationConfig, PolicyAssociationAttrs> = {
