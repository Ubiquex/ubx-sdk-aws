...
export interface Identity_MailFromAttributes {
...
export interface Identity_Tags {
...
const Identity_MailFromAttributesFields: FieldMap = {
  behaviorOnMxFailure: "behavior_on_mx_failure",
  mailFromDomain: "mail_from_domain",
};

const Identity_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface IdentityConfig {
  ...
  mailFromAttributes?: Identity_MailFromAttributes | Computed<Identity_MailFromAttributes>;
  ...
  tags?: Identity_Tags[] | Computed<Identity_Tags[]>;
}
...
export interface IdentityAttrs {
  ...
  /** Specifies the custom MAIL FROM domain and the behavior (use the default value or reject the message) to take when the MAIL FROM domain is not available for this Pinpoint email identity. (AI-inferred) */
  mailFromAttributes: Identity_MailFromAttributes;
  /** The email address or domain name that serves as the Amazon Pinpoint email identity for sending email. (AI-inferred) */
  name: string;
  /** Assigns a list of key-value tags to the Amazon Pinpoint email identity to help organize, identify, and manage the resource (e.g., for cost allocation and access control). (AI-inferred) */
  tags: Identity_Tags[];
...
export const Identity: ResourceBinding<IdentityConfig, IdentityAttrs> = {
