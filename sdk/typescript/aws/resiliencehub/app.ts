...
export interface App_EventSubscriptions {
...
export interface App_PermissionModel {
...
export interface App_ResourceMappings_PhysicalResourceId {
...
export interface App_ResourceMappings {
  ...
  physicalResourceId?: App_ResourceMappings_PhysicalResourceId | Computed<App_ResourceMappings_PhysicalResourceId>;
...
const App_EventSubscriptionsFields: FieldMap = {
  eventType: "event_type",
  name: "name",
  snsTopicArn: "sns_topic_arn",
};

const App_PermissionModelFields: FieldMap = {
  crossAccountRoleArns: "cross_account_role_arns",
  invokerRoleName: "invoker_role_name",
  type: "type",
};

const App_ResourceMappings_PhysicalResourceIdFields: FieldMap = {
...
const App_ResourceMappingsFields: FieldMap = {
...
export interface AppConfig {
  ...
  eventSubscriptions?: App_EventSubscriptions[] | Computed<App_EventSubscriptions[]>;
  /** Name of the app. */
  name: string | Computed<string>;
  /** Defines the roles and credentials that AWS Resilience Hub would use while creating the application, importing its resources, and running an assessment. */
  permissionModel?: App_PermissionModel | Computed<App_PermissionModel>;
  /** Amazon Resource Name (ARN) of the Resiliency Policy. */
  resiliencyPolicyArn?: string | Computed<string>;
  /** An array of ResourceMapping objects. */
  resourceMappings: App_ResourceMappings[] | Computed<App_ResourceMappings[]>;
...
export interface AppAttrs {
  ...
  driftStatus: string;
  /** The list of events you would like to subscribe and get notification for. */
  eventSubscriptions: App_EventSubscriptions[];
  /** Name of the app. */
  name: string;
  /** Defines the roles and credentials that AWS Resilience Hub would use while creating the application, importing its resources, and running an assessment. */
  permissionModel: App_PermissionModel;
  /** Amazon Resource Name (ARN) of the Resiliency Policy. */
  resiliencyPolicyArn: string;
  /** An array of ResourceMapping objects. */
  resourceMappings: App_ResourceMappings[];
  /** A map of key-value tags to attach to the AWS Resilience Hub application, used for identifying, organizing, and enabling attribute-based access control. (AI-inferred) */
  tags: unknown;
}
