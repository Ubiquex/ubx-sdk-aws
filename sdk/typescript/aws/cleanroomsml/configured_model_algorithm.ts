...
export interface ConfiguredModelAlgorithm_InferenceContainerConfig {
...
export interface ConfiguredModelAlgorithm_Tags {
...
export interface ConfiguredModelAlgorithm_TrainingContainerConfig_MetricDefinitions {
...
export interface ConfiguredModelAlgorithm_TrainingContainerConfig {
  ...
  metricDefinitions?: ConfiguredModelAlgorithm_TrainingContainerConfig_MetricDefinitions[] | Computed<ConfiguredModelAlgorithm_TrainingContainerConfig_MetricDefinitions[]>;
}

const ConfiguredModelAlgorithm_InferenceContainerConfigFields: FieldMap = {
  imageUri: "image_uri",
};

const ConfiguredModelAlgorithm_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

const ConfiguredModelAlgorithm_TrainingContainerConfig_MetricDefinitionsFields: FieldMap = {
  name: "name",
  regex: "regex",
};

const ConfiguredModelAlgorithm_TrainingContainerConfigFields: FieldMap = {
  arguments: "arguments",
...
export interface ConfiguredModelAlgorithmConfig {
  ...
  inferenceContainerConfig?: ConfiguredModelAlgorithm_InferenceContainerConfig | Computed<ConfiguredModelAlgorithm_InferenceContainerConfig>;
  ...
  tags?: ConfiguredModelAlgorithm_Tags[] | Computed<ConfiguredModelAlgorithm_Tags[]>;
  ...
  trainingContainerConfig?: ConfiguredModelAlgorithm_TrainingContainerConfig | Computed<ConfiguredModelAlgorithm_TrainingContainerConfig>;
}

export interface ConfiguredModelAlgorithmAttrs {
  ...
  roleArn: string;
  /** An arbitrary set of tags (key-value pairs) for this cleanrooms-ml configured model algorithm. */
  tags: ConfiguredModelAlgorithm_Tags[];
  /** Configures the Docker container (e.g., image URI and runtime parameters) that runs the training algorithm for this configured model algorithm in AWS Clean Rooms ML. (AI-inferred) */
  trainingContainerConfig: ConfiguredModelAlgorithm_TrainingContainerConfig;
}

export const ConfiguredModelAlgorithm: ResourceBinding<ConfiguredModelAlgorithmConfig, ConfiguredModelAlgorithmAttrs> = {
