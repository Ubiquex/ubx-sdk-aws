...
export interface LoadBalancer_Policies_Attributes {
...
export interface LoadBalancer_Policies {
  ...
  attributes?: LoadBalancer_Policies_Attributes[] | Computed<LoadBalancer_Policies_Attributes[]>;
...
export interface LoadBalancer_SourceSecurityGroup {
...
const LoadBalancer_AccessLoggingPolicyFields: FieldMap = {
...
const LoadBalancer_AppCookieStickinessPolicyFields: FieldMap = {
  cookieName: "cookie_name",
  policyName: "policy_name",
};

const LoadBalancer_ConnectionDrainingPolicyFields: FieldMap = {
  enabled: "enabled",
  timeout: "timeout",
};

const LoadBalancer_ConnectionSettingsFields: FieldMap = {
  idleTimeout: "idle_timeout",
};

const LoadBalancer_HealthCheckFields: FieldMap = {
...
const LoadBalancer_LbcookieStickinessPolicyFields: FieldMap = {
  cookieExpirationPeriod: "cookie_expiration_period",
  policyName: "policy_name",
};

const LoadBalancer_ListenersFields: FieldMap = {
...
const LoadBalancer_Policies_AttributesFields: FieldMap = {
  name: "name",
  value: "value",
};

const LoadBalancer_PoliciesFields: FieldMap = {
  attributes: {
    wireName: "attributes",
    kind: "list",
...
export interface LoadBalancerConfig {
  ...
  accessLoggingPolicy?: LoadBalancer_AccessLoggingPolicy | Computed<LoadBalancer_AccessLoggingPolicy>;
  /** Information about a policy for application-controlled session stickiness. */
  appCookieStickinessPolicy?: LoadBalancer_AppCookieStickinessPolicy[] | Computed<LoadBalancer_AppCookieStickinessPolicy[]>;
  ...
  connectionDrainingPolicy?: LoadBalancer_ConnectionDrainingPolicy | Computed<LoadBalancer_ConnectionDrainingPolicy>;
  /** If enabled, the load balancer allows the connections to remain idle (no data is sent over the connection) for the specified duration. */
  connectionSettings?: LoadBalancer_ConnectionSettings | Computed<LoadBalancer_ConnectionSettings>;
  ...
  healthCheck?: LoadBalancer_HealthCheck | Computed<LoadBalancer_HealthCheck>;
  /** The IDs of the instances for the load balancer. */
  instances?: string[] | Computed<string[]>;
  /** Information about a policy for duration-based session stickiness. */
  lbcookieStickinessPolicy?: LoadBalancer_LbcookieStickinessPolicy[] | Computed<LoadBalancer_LbcookieStickinessPolicy[]>;
  /** The Listeners for the load balancer. You can specify at most one listener per port. */
  listeners: LoadBalancer_Listeners[] | Computed<LoadBalancer_Listeners[]>;
  ...
  policies?: LoadBalancer_Policies[] | Computed<LoadBalancer_Policies[]>;
...
export interface LoadBalancerAttrs {
  ...
  sourceSecurityGroup: LoadBalancer_SourceSecurityGroup;
  /** The IDs of the subnets for the load balancer. You can specify at most one subnet per Availability Zone. */
  subnets: string[];
  /** The tags associated with a load balancer. */
