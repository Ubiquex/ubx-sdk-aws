...
export interface CacheReplicationGroup_ConfigurationEndPoint {
...
export interface CacheReplicationGroup_ReadEndPoint {
...
const CacheReplicationGroup_LogDeliveryConfigurations_DestinationDetails_CloudWatchLogsDetailsFields: FieldMap = {
  logGroup: "log_group",
};

const CacheReplicationGroup_LogDeliveryConfigurations_DestinationDetails_KinesisFirehoseDetailsFields: FieldMap = {
  deliveryStream: "delivery_stream",
};

const CacheReplicationGroup_LogDeliveryConfigurations_DestinationDetailsFields: FieldMap = {
...
const CacheReplicationGroup_LogDeliveryConfigurationsFields: FieldMap = {
  destinationDetails: {
...
const CacheReplicationGroup_NodeGroupConfigurationFields: FieldMap = {
...
const CacheReplicationGroup_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface CacheReplicationGroupConfig {
  ...
  logDeliveryConfigurations?: CacheReplicationGroup_LogDeliveryConfigurations[] | Computed<CacheReplicationGroup_LogDeliveryConfigurations[]>;
  ...
  nodeGroupConfiguration?: CacheReplicationGroup_NodeGroupConfiguration[] | Computed<CacheReplicationGroup_NodeGroupConfiguration[]>;
  ...
  tags?: CacheReplicationGroup_Tags[] | Computed<CacheReplicationGroup_Tags[]>;
...
export interface CacheReplicationGroupAttrs {
  /** A flag that enables encryption at rest when set to true.AtRestEncryptionEnabled after the replication group is created. To enable encryption at rest on a replication group you must set AtRestEncryptionEnabled to true when you create the replication group. */
  ...
  kmsKeyId: string;
  /** Specifies the destination, format and type of the logs. */
  logDeliveryConfigurations: CacheReplicationGroup_LogDeliveryConfigurations[];
  /** A flag indicating if you have Multi-AZ enabled to enhance fault tolerance. For more information, see Minimizing Downtime: Multi-AZ. */
  multiAzenabled: boolean;
  /** Must be either ipv4 | ipv6 | dual_stack. IPv6 is supported for workloads using Redis OSS engine version 6.2 onward or Memcached engine version 1.6.6 on all instances built on the Nitro system */
  networkType: string;
  /** NodeGroupConfiguration is a property of the AWS::ElastiCache::ReplicationGroup resource that configures an Amazon ElastiCache (ElastiCache) Redis cluster node group. */
  nodeGroupConfiguration: CacheReplicationGroup_NodeGroupConfiguration[];
  /** The Amazon Resource Name (ARN) of the Amazon Simple Notification Service (SNS) topic to which notifications are sent. */
  ...
  /** A list of cost allocation tags to be added to this resource. Tags are comma-separated key,value pairs (e.g. Key=myKey, Value=myKeyValue. You can include multiple tags as shown following: Key=myKey, Value=myKeyValue Key=mySecondKey, Value=mySecondKeyValue. */
  tags: CacheReplicationGroup_Tags[];
  /** A flag that enables in-transit encryption when set to true. */
...
export const CacheReplicationGroup: ResourceBinding<CacheReplicationGroupConfig, CacheReplicationGroupAttrs> = {
