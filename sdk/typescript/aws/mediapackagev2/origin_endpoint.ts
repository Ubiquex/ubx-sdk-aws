...
export interface OriginEndpoint_DashManifests_AvailabilityStartTimeConfiguration {
...
export interface OriginEndpoint_DashManifests_BaseUrls {
...
export interface OriginEndpoint_DashManifests_DvbSettings_ErrorMetrics {
...
export interface OriginEndpoint_DashManifests_DvbSettings_FontDownload {
...
export interface OriginEndpoint_DashManifests_DvbSettings {
  errorMetrics?: OriginEndpoint_DashManifests_DvbSettings_ErrorMetrics[] | Computed<OriginEndpoint_DashManifests_DvbSettings_ErrorMetrics[]>;
  fontDownload?: OriginEndpoint_DashManifests_DvbSettings_FontDownload | Computed<OriginEndpoint_DashManifests_DvbSettings_FontDownload>;
}

export interface OriginEndpoint_DashManifests_FilterConfiguration {
...
export interface OriginEndpoint_DashManifests_ProgramInformation {
...
export interface OriginEndpoint_DashManifests_ScteDash {
...
export interface OriginEndpoint_DashManifests_SubtitleConfiguration_TtmlConfiguration {
...
export interface OriginEndpoint_DashManifests_SubtitleConfiguration {
  ...
  ttmlConfiguration?: OriginEndpoint_DashManifests_SubtitleConfiguration_TtmlConfiguration | Computed<OriginEndpoint_DashManifests_SubtitleConfiguration_TtmlConfiguration>;
}

export interface OriginEndpoint_DashManifests_UtcTiming {
...
export interface OriginEndpoint_DashManifests {
  ...
  availabilityStartTimeConfiguration?: OriginEndpoint_DashManifests_AvailabilityStartTimeConfiguration | Computed<OriginEndpoint_DashManifests_AvailabilityStartTimeConfiguration>;
  ...
  baseUrls?: OriginEndpoint_DashManifests_BaseUrls[] | Computed<OriginEndpoint_DashManifests_BaseUrls[]>;
  ...
  dvbSettings?: OriginEndpoint_DashManifests_DvbSettings | Computed<OriginEndpoint_DashManifests_DvbSettings>;
  ...
  filterConfiguration?: OriginEndpoint_DashManifests_FilterConfiguration | Computed<OriginEndpoint_DashManifests_FilterConfiguration>;
  ...
  programInformation?: OriginEndpoint_DashManifests_ProgramInformation | Computed<OriginEndpoint_DashManifests_ProgramInformation>;
  ...
  scteDash?: OriginEndpoint_DashManifests_ScteDash | Computed<OriginEndpoint_DashManifests_ScteDash>;
  ...
  subtitleConfiguration?: OriginEndpoint_DashManifests_SubtitleConfiguration | Computed<OriginEndpoint_DashManifests_SubtitleConfiguration>;
  ...
  utcTiming?: OriginEndpoint_DashManifests_UtcTiming | Computed<OriginEndpoint_DashManifests_UtcTiming>;
}

export interface OriginEndpoint_ForceEndpointErrorConfiguration {
...
export interface OriginEndpoint_HlsManifests_ScteHls {
...
export interface OriginEndpoint_HlsManifests_StartTag {
...
export interface OriginEndpoint_HlsManifests {
  ...
  scteHls?: OriginEndpoint_HlsManifests_ScteHls | Computed<OriginEndpoint_HlsManifests_ScteHls>;
  ...
  startTag?: OriginEndpoint_HlsManifests_StartTag | Computed<OriginEndpoint_HlsManifests_StartTag>;
...
export interface OriginEndpoint_MssManifests {
...
export interface OriginEndpoint_Segment_Encryption_EncryptionMethod {
...
export interface OriginEndpoint_Segment_Encryption_SpekeKeyProvider_EncryptionContractConfiguration {
...
export interface OriginEndpoint_Segment_Encryption_SpekeKeyProvider {
  ...
  encryptionContractConfiguration: OriginEndpoint_Segment_Encryption_SpekeKeyProvider_EncryptionContractConfiguration | Computed<OriginEndpoint_Segment_Encryption_SpekeKeyProvider_EncryptionContractConfiguration>;
...
export interface OriginEndpoint_Segment_Encryption {
  ...
  encryptionMethod: OriginEndpoint_Segment_Encryption_EncryptionMethod | Computed<OriginEndpoint_Segment_Encryption_EncryptionMethod>;
  ...
  spekeKeyProvider: OriginEndpoint_Segment_Encryption_SpekeKeyProvider | Computed<OriginEndpoint_Segment_Encryption_SpekeKeyProvider>;
}

export interface OriginEndpoint_Segment_Scte {
...
export interface OriginEndpoint_Segment {
  /** <p>The parameters for encrypting content.</p> */
  encryption?: OriginEndpoint_Segment_Encryption | Computed<OriginEndpoint_Segment_Encryption>;
  ...
  scte?: OriginEndpoint_Segment_Scte | Computed<OriginEndpoint_Segment_Scte>;
...
const OriginEndpoint_DashManifests_AvailabilityStartTimeConfigurationFields: FieldMap = {
  fixedAvailabilityStartTime: "fixed_availability_start_time",
};

const OriginEndpoint_DashManifests_BaseUrlsFields: FieldMap = {
...
const OriginEndpoint_DashManifests_DvbSettings_ErrorMetricsFields: FieldMap = {
  probability: "probability",
  reportingUrl: "reporting_url",
};

const OriginEndpoint_DashManifests_DvbSettings_FontDownloadFields: FieldMap = {
  fontFamily: "font_family",
  mimeType: "mime_type",
  url: "url",
};

const OriginEndpoint_DashManifests_DvbSettingsFields: FieldMap = {
  errorMetrics: {
...
const OriginEndpoint_DashManifests_FilterConfigurationFields: FieldMap = {
...
const OriginEndpoint_DashManifests_ProgramInformationFields: FieldMap = {
  copyright: "copyright",
...
const OriginEndpoint_DashManifests_ScteDashFields: FieldMap = {
  adMarkerDash: "ad_marker_dash",
  scteInManifests: "scte_in_manifests",
};

const OriginEndpoint_DashManifests_SubtitleConfiguration_TtmlConfigurationFields: FieldMap = {
  ttmlProfile: "ttml_profile",
};

const OriginEndpoint_DashManifests_SubtitleConfigurationFields: FieldMap = {
  ttmlConfiguration: {
...
const OriginEndpoint_DashManifests_UtcTimingFields: FieldMap = {
  timingMode: "timing_mode",
  timingSource: "timing_source",
};

const OriginEndpoint_DashManifestsFields: FieldMap = {
...
const OriginEndpoint_ForceEndpointErrorConfigurationFields: FieldMap = {
  endpointErrorConditions: "endpoint_error_conditions",
};

const OriginEndpoint_MssManifestsFields: FieldMap = {
  filterConfiguration: {
    wireName: "filter_configuration",
    kind: "object",
    fields: OriginEndpoint_DashManifests_FilterConfigurationFields,
...
const OriginEndpoint_Segment_Encryption_EncryptionMethodFields: FieldMap = {
...
const OriginEndpoint_Segment_Encryption_SpekeKeyProvider_EncryptionContractConfigurationFields: FieldMap = {
  presetSpeke20Audio: "preset_speke20_audio",
  presetSpeke20Video: "preset_speke20_video",
};

const OriginEndpoint_Segment_Encryption_SpekeKeyProviderFields: FieldMap = {
...
const OriginEndpoint_Segment_EncryptionFields: FieldMap = {
...
const OriginEndpoint_Segment_ScteFields: FieldMap = {
  customAdTypes: "custom_ad_types",
  scteFilter: "scte_filter",
  scteInSegments: "scte_in_segments",
};

const OriginEndpoint_SegmentFields: FieldMap = {
  encryption: {
    wireName: "encryption",
    kind: "object",
...
export interface OriginEndpointConfig {
  ...
  dashManifests?: OriginEndpoint_DashManifests[] | Computed<OriginEndpoint_DashManifests[]>;
  /** <p>Enter any descriptive text that helps you to identify the origin endpoint.</p> */
  description?: string | Computed<string>;
  /** <p>The failover settings for the endpoint.</p> */
  forceEndpointErrorConfiguration?: OriginEndpoint_ForceEndpointErrorConfiguration | Computed<OriginEndpoint_ForceEndpointErrorConfiguration>;
  /** <p>The Microsoft Smooth Streaming (MSS) manifest configurations associated with this origin endpoint.</p> */
  mssManifests?: OriginEndpoint_MssManifests[] | Computed<OriginEndpoint_MssManifests[]>;
...
export interface OriginEndpointAttrs {
  ...
  /** <p>A DASH manifest configuration.</p> */
  dashManifests: OriginEndpoint_DashManifests[];
  /** <p>Enter any descriptive text that helps you to identify the origin endpoint.</p> */
  description: string;
  /** <p>The failover settings for the endpoint.</p> */
  forceEndpointErrorConfiguration: OriginEndpoint_ForceEndpointErrorConfiguration;
  ...
  hlsManifests: OriginEndpoint_HlsManifests[];
  ...
  lowLatencyHlsManifests: OriginEndpoint_HlsManifests[];
  ...
  /** <p>The Microsoft Smooth Streaming (MSS) manifest configurations associated with this origin endpoint.</p> */
  mssManifests: OriginEndpoint_MssManifests[];
  /** The name of the origin endpoint, which uniquely identifies it within its parent channel and channel group in AWS MediaPackage v2. (AI-inferred) */
