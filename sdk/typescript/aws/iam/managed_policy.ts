...
export interface ManagedPolicyConfig {
  ...
  managedPolicyName?: string | Computed<string>;
...
export interface ManagedPolicyAttrs {
...
export const ManagedPolicy: ResourceBinding<ManagedPolicyConfig, ManagedPolicyAttrs> = {
