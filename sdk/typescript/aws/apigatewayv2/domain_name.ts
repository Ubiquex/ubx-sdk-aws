...
export interface DomainName_DomainNameConfigurations {
...
const DomainName_DomainNameConfigurationsFields: FieldMap = {
...
export interface DomainNameConfig {
  ...
  domainNameConfigurations?: DomainName_DomainNameConfigurations[] | Computed<DomainName_DomainNameConfigurations[]>;
...
export interface DomainNameAttrs {
  ...
  /** The domain name configurations. */
  domainNameConfigurations: DomainName_DomainNameConfigurations[];
  /** If specified, API Gateway performs two-way authentication between the client and the server. Clients must present a trusted certificate to access your API. */
