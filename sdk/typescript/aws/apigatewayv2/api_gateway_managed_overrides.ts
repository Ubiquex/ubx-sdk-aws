...
export interface ApiGatewayManagedOverrides_Integration {
...
export interface ApiGatewayManagedOverrides_Route {
...
export interface ApiGatewayManagedOverrides_Stage_AccessLogSettings {
...
export interface ApiGatewayManagedOverrides_Stage_DefaultRouteSettings {
...
export interface ApiGatewayManagedOverrides_Stage {
  ...
  accessLogSettings?: ApiGatewayManagedOverrides_Stage_AccessLogSettings | Computed<ApiGatewayManagedOverrides_Stage_AccessLogSettings>;
  ...
  defaultRouteSettings?: ApiGatewayManagedOverrides_Stage_DefaultRouteSettings | Computed<ApiGatewayManagedOverrides_Stage_DefaultRouteSettings>;
...
const ApiGatewayManagedOverrides_IntegrationFields: FieldMap = {
...
const ApiGatewayManagedOverrides_RouteFields: FieldMap = {
...
const ApiGatewayManagedOverrides_Stage_AccessLogSettingsFields: FieldMap = {
  destinationArn: "destination_arn",
  format: "format",
};

const ApiGatewayManagedOverrides_Stage_DefaultRouteSettingsFields: FieldMap = {
...
const ApiGatewayManagedOverrides_StageFields: FieldMap = {
  accessLogSettings: {
...
export interface ApiGatewayManagedOverridesConfig {
  ...
  integration?: ApiGatewayManagedOverrides_Integration | Computed<ApiGatewayManagedOverrides_Integration>;
  ...
  route?: ApiGatewayManagedOverrides_Route | Computed<ApiGatewayManagedOverrides_Route>;
  ...
  stage?: ApiGatewayManagedOverrides_Stage | Computed<ApiGatewayManagedOverrides_Stage>;
}

export interface ApiGatewayManagedOverridesAttrs {
  /** The ID of the API for which to override the configuration of API Gateway-managed resources. */
  apiId: string;
  /** A TPS Code is automatically generated on creation and assigned as the unique identifier. */
  id: string;
  /** The integration property is an object that overrides integration settings, such as integration type, HTTP method, payload format version, and timeout, for all integrations defined in the API's OpenAPI definition. (AI-inferred) */
  integration: ApiGatewayManagedOverrides_Integration;
  /** Overrides the configuration of a specific Route in an API Gateway v2 (WebSocket or HTTP) API by specifying properties such as authorization settings, request models, and route response selection expression, replacing the managed defaults. (AI-inferred) */
  route: ApiGatewayManagedOverrides_Route;
  /** The stage property defines overrides for the API Gateway v2 stage, configuring settings such as access log settings, default route throttling, and stage variables that replace the managed stage defaults. (AI-inferred) */
  stage: ApiGatewayManagedOverrides_Stage;
}

export const ApiGatewayManagedOverrides: ResourceBinding<ApiGatewayManagedOverridesConfig, ApiGatewayManagedOverridesAttrs> = {
