...
export interface RobotApplication_RobotSoftwareSuite {
...
export interface RobotApplication_Sources {
...
const RobotApplication_RobotSoftwareSuiteFields: FieldMap = {
  name: "name",
  version: "version",
};

const RobotApplication_SourcesFields: FieldMap = {
...
export interface RobotApplicationConfig {
  ...
  robotSoftwareSuite: RobotApplication_RobotSoftwareSuite | Computed<RobotApplication_RobotSoftwareSuite>;
  /** The sources of the robot application. */
  sources?: RobotApplication_Sources[] | Computed<RobotApplication_Sources[]>;
  /** A key-value pair to associate with a resource. */
  tags?: unknown | Computed<unknown>;
}

export interface RobotApplicationAttrs {
  ...
  name: string;
  /** The robot software suite used by the robot application. */
  robotSoftwareSuite: RobotApplication_RobotSoftwareSuite;
  /** The sources of the robot application. */
  sources: RobotApplication_Sources[];
  /** A key-value pair to associate with a resource. */
  tags: unknown;
}

export const RobotApplication: ResourceBinding<RobotApplicationConfig, RobotApplicationAttrs> = {
