...
export interface MissionProfile_DataflowEdges {
...
export interface MissionProfile_StreamsKmsKey {
...
export interface MissionProfile_Tags {
...
const MissionProfile_DataflowEdgesFields: FieldMap = {
  destination: "destination",
  source: "source",
};

const MissionProfile_StreamsKmsKeyFields: FieldMap = {
  kmsAliasArn: "kms_alias_arn",
  kmsAliasName: "kms_alias_name",
  kmsKeyArn: "kms_key_arn",
};

const MissionProfile_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface MissionProfileConfig {
  ...
  dataflowEdges: MissionProfile_DataflowEdges[] | Computed<MissionProfile_DataflowEdges[]>;
  ...
  streamsKmsKey?: MissionProfile_StreamsKmsKey | Computed<MissionProfile_StreamsKmsKey>;
  ...
  tags?: MissionProfile_Tags[] | Computed<MissionProfile_Tags[]>;
...
export interface MissionProfileAttrs {
  ...
  /** Specifies the list of dataflow edges that define how data moves between satellite and ground station endpoints, with each edge containing source and destination configuration references. (AI-inferred) */
  dataflowEdges: MissionProfile_DataflowEdges[];
...
export const MissionProfile: ResourceBinding<MissionProfileConfig, MissionProfileAttrs> = {
