...
export interface LifecyclePolicy_PolicyDetails_Action_IncludeResources {
...
export interface LifecyclePolicy_PolicyDetails_Action {
  ...
  includeResources?: LifecyclePolicy_PolicyDetails_Action_IncludeResources | Computed<LifecyclePolicy_PolicyDetails_Action_IncludeResources>;
...
export interface LifecyclePolicy_PolicyDetails_ExclusionRules_Amis_LastLaunched {
...
export interface LifecyclePolicy_PolicyDetails_ExclusionRules_Amis {
  ...
  lastLaunched?: LifecyclePolicy_PolicyDetails_ExclusionRules_Amis_LastLaunched | Computed<LifecyclePolicy_PolicyDetails_ExclusionRules_Amis_LastLaunched>;
...
export interface LifecyclePolicy_PolicyDetails_ExclusionRules {
  ...
  amis?: LifecyclePolicy_PolicyDetails_ExclusionRules_Amis | Computed<LifecyclePolicy_PolicyDetails_ExclusionRules_Amis>;
...
export interface LifecyclePolicy_PolicyDetails_Filter {
...
export interface LifecyclePolicy_PolicyDetails {
  ...
  action?: LifecyclePolicy_PolicyDetails_Action | Computed<LifecyclePolicy_PolicyDetails_Action>;
  ...
  exclusionRules?: LifecyclePolicy_PolicyDetails_ExclusionRules | Computed<LifecyclePolicy_PolicyDetails_ExclusionRules>;
  ...
  filter?: LifecyclePolicy_PolicyDetails_Filter | Computed<LifecyclePolicy_PolicyDetails_Filter>;
}

export interface LifecyclePolicy_ResourceSelection_Recipes {
...
export interface LifecyclePolicy_ResourceSelection {
  ...
  recipes?: LifecyclePolicy_ResourceSelection_Recipes[] | Computed<LifecyclePolicy_ResourceSelection_Recipes[]>;
  /** The Image Builder resources to select by tag. */
  tagMap?: unknown | Computed<unknown>;
}

const LifecyclePolicy_PolicyDetails_Action_IncludeResourcesFields: FieldMap = {
  amis: "amis",
...
const LifecyclePolicy_PolicyDetails_ExclusionRules_Amis_LastLaunchedFields: FieldMap = {
  unit: "unit",
  value: "value",
};

const LifecyclePolicy_PolicyDetails_ExclusionRules_AmisFields: FieldMap = {
  isPublic: "is_public",
  lastLaunched: {
...
const LifecyclePolicy_PolicyDetails_ExclusionRulesFields: FieldMap = {
  amis: {
    wireName: "amis",
    kind: "object",
...
const LifecyclePolicy_PolicyDetails_FilterFields: FieldMap = {
...
const LifecyclePolicy_ResourceSelection_RecipesFields: FieldMap = {
  name: "name",
