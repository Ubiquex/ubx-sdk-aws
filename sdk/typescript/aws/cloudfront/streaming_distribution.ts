...
export interface StreamingDistribution_StreamingDistributionConfig_Logging {
...
export interface StreamingDistribution_StreamingDistributionConfig_S3Origin {
...
export interface StreamingDistribution_StreamingDistributionConfig_TrustedSigners {
...
export interface StreamingDistribution_StreamingDistributionConfig {
  ...
  logging?: StreamingDistribution_StreamingDistributionConfig_Logging | Computed<StreamingDistribution_StreamingDistributionConfig_Logging>;
  ...
  s3Origin: StreamingDistribution_StreamingDistributionConfig_S3Origin | Computed<StreamingDistribution_StreamingDistributionConfig_S3Origin>;
  ...
  trustedSigners: StreamingDistribution_StreamingDistributionConfig_TrustedSigners | Computed<StreamingDistribution_StreamingDistributionConfig_TrustedSigners>;
}

export interface StreamingDistribution_Tags {
...
const StreamingDistribution_StreamingDistributionConfig_LoggingFields: FieldMap = {
  bucket: "bucket",
  enabled: "enabled",
  prefix: "prefix",
};

const StreamingDistribution_StreamingDistributionConfig_S3OriginFields: FieldMap = {
  domainName: "domain_name",
  originAccessIdentity: "origin_access_identity",
};

const StreamingDistribution_StreamingDistributionConfig_TrustedSignersFields: FieldMap = {
  awsAccountNumbers: "aws_account_numbers",
  enabled: "enabled",
};

const StreamingDistribution_StreamingDistributionConfigFields: FieldMap = {
  aliases: "aliases",
  comment: "comment",
  enabled: "enabled",
  logging: {
...
const StreamingDistribution_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface StreamingDistributionConfig {
  ...
  streamingDistributionConfig: StreamingDistribution_StreamingDistributionConfig | Computed<StreamingDistribution_StreamingDistributionConfig>;
  ...
  tags: StreamingDistribution_Tags[] | Computed<StreamingDistribution_Tags[]>;
}

export interface StreamingDistributionAttrs {
  ...
  /** Configures the list of tag objects (each with a Key and Value) that are attached to the CloudFront streaming distribution for organization, cost tracking, and access management. (AI-inferred) */
  tags: StreamingDistribution_Tags[];
}

export const StreamingDistribution: ResourceBinding<StreamingDistributionConfig, StreamingDistributionAttrs> = {
