...
export interface CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfig {
...
export interface CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfig {
...
export interface CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfig {
...
export interface CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin {
  /** An object that determines whether any cookies in viewer requests (and if so, which cookies) are included in the cache key and in requests that CloudFront sends to the origin. */
  cookiesConfig: CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfig | Computed<CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfig>;
  ...
  headersConfig: CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfig | Computed<CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfig>;
  /** An object that determines whether any URL query strings in viewer requests (and if so, which query strings) are included in the cache key and in requests that CloudFront sends to the origin. */
  queryStringsConfig: CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfig | Computed<CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfig>;
}

export interface CachePolicy_CachePolicyConfig {
  ...
  parametersInCacheKeyAndForwardedToOrigin: CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin | Computed<CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin>;
}

const CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_CookiesConfigFields: FieldMap = {
  cookieBehavior: "cookie_behavior",
  cookies: "cookies",
};

const CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_HeadersConfigFields: FieldMap = {
  headerBehavior: "header_behavior",
  headers: "headers",
};

const CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOrigin_QueryStringsConfigFields: FieldMap = {
  queryStringBehavior: "query_string_behavior",
  queryStrings: "query_strings",
};

const CachePolicy_CachePolicyConfig_ParametersInCacheKeyAndForwardedToOriginFields: FieldMap = {
  cookiesConfig: {
...
const CachePolicy_CachePolicyConfigFields: FieldMap = {
  comment: "comment",
...
export interface CachePolicyConfig {
  ...
  cachePolicyConfig: CachePolicy_CachePolicyConfig | Computed<CachePolicy_CachePolicyConfig>;
}

export interface CachePolicyAttrs {
  /** A cache policy configuration. This configuration determines the following: + The values that CloudFront includes in the cache key. These values can include HTTP headers, cookies, and URL query strings. CloudFront uses the cache key to find an object in its cache that it can return to the viewer. + The default, minimum, and maximum time to live (TTL) values that you want objects to stay in the CloudFront cache. If your minimum TTL is greater than 0, CloudFront will cache content for at least the duration specified in the cache policy's minimum TTL, even if the ``Cache-Control: no-cache``, ``no-store``, or ``private`` directives are present in the origin headers. The headers, cookies, and query strings that are included in the cache key are also included in requests that CloudFront sends to the origin. CloudFront sends a request when it can't find a valid object in its cache that matches the request's cache key. If you want to send values to the origin but *not* include them in the cache key, use ``OriginRequestPolicy``. */
  cachePolicyConfig: CachePolicy_CachePolicyConfig;
