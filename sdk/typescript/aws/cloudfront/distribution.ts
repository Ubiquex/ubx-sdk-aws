...
export interface Distribution_DistributionConfig_CacheBehaviors_ForwardedValues_Cookies {
...
export interface Distribution_DistributionConfig_CacheBehaviors_ForwardedValues {
  ...
  cookies?: Distribution_DistributionConfig_CacheBehaviors_ForwardedValues_Cookies | Computed<Distribution_DistributionConfig_CacheBehaviors_ForwardedValues_Cookies>;
...
export interface Distribution_DistributionConfig_CacheBehaviors_FunctionAssociations {
...
export interface Distribution_DistributionConfig_CacheBehaviors_GrpcConfig {
  /** Whether gRPC is enabled for this CloudFront cache behavior. (AI-inferred) */
  enabled?: boolean | Computed<boolean>;
}

export interface Distribution_DistributionConfig_CacheBehaviors_LambdaFunctionAssociations {
...
export interface Distribution_DistributionConfig_CacheBehaviors {
  ...
  forwardedValues?: Distribution_DistributionConfig_CacheBehaviors_ForwardedValues | Computed<Distribution_DistributionConfig_CacheBehaviors_ForwardedValues>;
  ...
  functionAssociations?: Distribution_DistributionConfig_CacheBehaviors_FunctionAssociations[] | Computed<Distribution_DistributionConfig_CacheBehaviors_FunctionAssociations[]>;
  /** Specifies whether gRPC is enabled for this cache behavior. (AI-inferred) */
  grpcConfig?: Distribution_DistributionConfig_CacheBehaviors_GrpcConfig | Computed<Distribution_DistributionConfig_CacheBehaviors_GrpcConfig>;
  ...
  lambdaFunctionAssociations?: Distribution_DistributionConfig_CacheBehaviors_LambdaFunctionAssociations[] | Computed<Distribution_DistributionConfig_CacheBehaviors_LambdaFunctionAssociations[]>;
...
export interface Distribution_DistributionConfig_CacheTagConfig {
...
export interface Distribution_DistributionConfig_ConnectionFunctionAssociation {
  /** The association's ID. */
  id: string | Computed<string>;
}

export interface Distribution_DistributionConfig_CustomErrorResponses {
...
export interface Distribution_DistributionConfig_CustomOrigin {
...
export interface Distribution_DistributionConfig_DefaultCacheBehavior {
...
export interface Distribution_DistributionConfig_Logging {
...
export interface Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteria_StatusCodes {
...
export interface Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteria {
  ...
  statusCodes?: Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteria_StatusCodes | Computed<Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteria_StatusCodes>;
}

export interface Distribution_DistributionConfig_OriginGroups_Items_Members_Items {
...
export interface Distribution_DistributionConfig_OriginGroups_Items_Members {
  ...
  items?: Distribution_DistributionConfig_OriginGroups_Items_Members_Items[] | Computed<Distribution_DistributionConfig_OriginGroups_Items_Members_Items[]>;
...
export interface Distribution_DistributionConfig_OriginGroups_Items {
  ...
  failoverCriteria?: Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteria | Computed<Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteria>;
  ...
  members?: Distribution_DistributionConfig_OriginGroups_Items_Members | Computed<Distribution_DistributionConfig_OriginGroups_Items_Members>;
  selectionCriteria?: string | Computed<string>;
}

export interface Distribution_DistributionConfig_OriginGroups {
  /** The items (origin groups) in a distribution. */
  items?: Distribution_DistributionConfig_OriginGroups_Items[] | Computed<Distribution_DistributionConfig_OriginGroups_Items[]>;
  /** The number of origin groups. */
  quantity: number | Computed<number>;
}

export interface Distribution_DistributionConfig_Origins_CustomOriginConfig_OriginMtlsConfig {
...
export interface Distribution_DistributionConfig_Origins_CustomOriginConfig {
  ...
  originMtlsConfig?: Distribution_DistributionConfig_Origins_CustomOriginConfig_OriginMtlsConfig | Computed<Distribution_DistributionConfig_Origins_CustomOriginConfig_OriginMtlsConfig>;
...
export interface Distribution_DistributionConfig_Origins_OriginCustomHeaders {
...
export interface Distribution_DistributionConfig_Origins_OriginShield {
...
export interface Distribution_DistributionConfig_Origins_S3OriginConfig {
...
export interface Distribution_DistributionConfig_Origins_VpcOriginConfig {
...
export interface Distribution_DistributionConfig_Origins {
  ...
  customOriginConfig?: Distribution_DistributionConfig_Origins_CustomOriginConfig | Computed<Distribution_DistributionConfig_Origins_CustomOriginConfig>;
  ...
  originCustomHeaders?: Distribution_DistributionConfig_Origins_OriginCustomHeaders[] | Computed<Distribution_DistributionConfig_Origins_OriginCustomHeaders[]>;
  ...
  originShield?: Distribution_DistributionConfig_Origins_OriginShield | Computed<Distribution_DistributionConfig_Origins_OriginShield>;
  ...
  s3OriginConfig?: Distribution_DistributionConfig_Origins_S3OriginConfig | Computed<Distribution_DistributionConfig_Origins_S3OriginConfig>;
  ...
  vpcOriginConfig?: Distribution_DistributionConfig_Origins_VpcOriginConfig | Computed<Distribution_DistributionConfig_Origins_VpcOriginConfig>;
}

export interface Distribution_DistributionConfig_Restrictions_GeoRestriction {
...
export interface Distribution_DistributionConfig_Restrictions {
  /** A complex type that controls the countries in which your content is distributed. CF determines the location of your users using ``MaxMind`` GeoIP databases. To disable geo restriction, remove the [Restrictions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-distributionconfig.html#cfn-cloudfront-distribution-distributionconfig-restrictions) property from your stack template. */
  geoRestriction: Distribution_DistributionConfig_Restrictions_GeoRestriction | Computed<Distribution_DistributionConfig_Restrictions_GeoRestriction>;
}

export interface Distribution_DistributionConfig_S3Origin {
  /** The domain name assigned to your CF distribution. */
  dnsname: string | Computed<string>;
...
export interface Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_Definition_StringSchema {
  comment?: string | Computed<string>;
  defaultValue?: string | Computed<string>;
  required?: boolean | Computed<boolean>;
}

export interface Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_Definition {
  stringSchema?: Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_Definition_StringSchema | Computed<Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_Definition_StringSchema>;
}

export interface Distribution_DistributionConfig_TenantConfig_ParameterDefinitions {
  definition?: Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_Definition | Computed<Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_Definition>;
  name?: string | Computed<string>;
}

export interface Distribution_DistributionConfig_TenantConfig {
  parameterDefinitions?: Distribution_DistributionConfig_TenantConfig_ParameterDefinitions[] | Computed<Distribution_DistributionConfig_TenantConfig_ParameterDefinitions[]>;
}

export interface Distribution_DistributionConfig_ViewerCertificate {
...
export interface Distribution_DistributionConfig_ViewerMtlsConfig_TrustStoreConfig {
...
export interface Distribution_DistributionConfig_ViewerMtlsConfig {
  ...
  trustStoreConfig?: Distribution_DistributionConfig_ViewerMtlsConfig_TrustStoreConfig | Computed<Distribution_DistributionConfig_ViewerMtlsConfig_TrustStoreConfig>;
}
...
export interface Distribution_DistributionConfig {
  ...
  cacheBehaviors?: Distribution_DistributionConfig_CacheBehaviors[] | Computed<Distribution_DistributionConfig_CacheBehaviors[]>;
  ...
  cacheTagConfig?: Distribution_DistributionConfig_CacheTagConfig | Computed<Distribution_DistributionConfig_CacheTagConfig>;
  ...
  connectionFunctionAssociation?: Distribution_DistributionConfig_ConnectionFunctionAssociation | Computed<Distribution_DistributionConfig_ConnectionFunctionAssociation>;
  ...
  customErrorResponses?: Distribution_DistributionConfig_CustomErrorResponses[] | Computed<Distribution_DistributionConfig_CustomErrorResponses[]>;
  ...
  customOrigin?: Distribution_DistributionConfig_CustomOrigin | Computed<Distribution_DistributionConfig_CustomOrigin>;
  ...
  defaultCacheBehavior: Distribution_DistributionConfig_DefaultCacheBehavior | Computed<Distribution_DistributionConfig_DefaultCacheBehavior>;
  ...
  logging?: Distribution_DistributionConfig_Logging | Computed<Distribution_DistributionConfig_Logging>;
  /** A complex data type for the origin groups specified for a distribution. */
  originGroups?: Distribution_DistributionConfig_OriginGroups | Computed<Distribution_DistributionConfig_OriginGroups>;
  ...
  origins?: Distribution_DistributionConfig_Origins[] | Computed<Distribution_DistributionConfig_Origins[]>;
  ...
  restrictions?: Distribution_DistributionConfig_Restrictions | Computed<Distribution_DistributionConfig_Restrictions>;
  ...
  s3Origin?: Distribution_DistributionConfig_S3Origin | Computed<Distribution_DistributionConfig_S3Origin>;
  ...
  tenantConfig?: Distribution_DistributionConfig_TenantConfig | Computed<Distribution_DistributionConfig_TenantConfig>;
  ...
  viewerCertificate?: Distribution_DistributionConfig_ViewerCertificate | Computed<Distribution_DistributionConfig_ViewerCertificate>;
  /** A viewer mTLS configuration. */
  viewerMtlsConfig?: Distribution_DistributionConfig_ViewerMtlsConfig | Computed<Distribution_DistributionConfig_ViewerMtlsConfig>;
...
const Distribution_DistributionConfig_CacheBehaviors_ForwardedValues_CookiesFields: FieldMap = {
  forward: "forward",
  whitelistedNames: "whitelisted_names",
};

const Distribution_DistributionConfig_CacheBehaviors_ForwardedValuesFields: FieldMap = {
  cookies: {
    wireName: "cookies",
    kind: "object",
...
const Distribution_DistributionConfig_CacheBehaviors_FunctionAssociationsFields: FieldMap = {
  eventType: "event_type",
  functionArn: "function_arn",
};

const Distribution_DistributionConfig_CacheBehaviors_GrpcConfigFields: FieldMap = {
  enabled: "enabled",
};

const Distribution_DistributionConfig_CacheBehaviors_LambdaFunctionAssociationsFields: FieldMap = {
  eventType: "event_type",
  includeBody: "include_body",
  lambdaFunctionArn: "lambda_function_arn",
};

const Distribution_DistributionConfig_CacheBehaviorsFields: FieldMap = {
...
const Distribution_DistributionConfig_CacheTagConfigFields: FieldMap = {
  headerName: "header_name",
};

const Distribution_DistributionConfig_ConnectionFunctionAssociationFields: FieldMap = {
  id: "id",
};

const Distribution_DistributionConfig_CustomErrorResponsesFields: FieldMap = {
...
const Distribution_DistributionConfig_CustomOriginFields: FieldMap = {
  dnsname: "dnsname",
  httpport: "httpport",
  httpsport: "httpsport",
...
const Distribution_DistributionConfig_DefaultCacheBehaviorFields: FieldMap = {
  allowedMethods: "allowed_methods",
  cachePolicyId: "cache_policy_id",
  cachedMethods: "cached_methods",
  compress: "compress",
...
const Distribution_DistributionConfig_LoggingFields: FieldMap = {
  bucket: "bucket",
  includeCookies: "include_cookies",
  prefix: "prefix",
};

const Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteria_StatusCodesFields: FieldMap = {
  items: "items",
  quantity: "quantity",
};

const Distribution_DistributionConfig_OriginGroups_Items_FailoverCriteriaFields: FieldMap = {
  statusCodes: {
...
const Distribution_DistributionConfig_OriginGroups_Items_Members_ItemsFields: FieldMap = {
  originId: "origin_id",
};

const Distribution_DistributionConfig_OriginGroups_Items_MembersFields: FieldMap = {
  items: {
    wireName: "items",
    kind: "list",
...
const Distribution_DistributionConfig_OriginGroups_ItemsFields: FieldMap = {
  failoverCriteria: {
...
const Distribution_DistributionConfig_OriginGroupsFields: FieldMap = {
  items: {
    wireName: "items",
    kind: "list",
...
const Distribution_DistributionConfig_Origins_CustomOriginConfig_OriginMtlsConfigFields: FieldMap = {
  clientCertificateArn: "client_certificate_arn",
};

const Distribution_DistributionConfig_Origins_CustomOriginConfigFields: FieldMap = {
  httpport: "httpport",
  httpsport: "httpsport",
...
const Distribution_DistributionConfig_Origins_OriginCustomHeadersFields: FieldMap = {
  headerName: "header_name",
  headerValue: "header_value",
};

const Distribution_DistributionConfig_Origins_OriginShieldFields: FieldMap = {
  enabled: "enabled",
  originShieldRegion: "origin_shield_region",
};

const Distribution_DistributionConfig_Origins_S3OriginConfigFields: FieldMap = {
  originAccessIdentity: "origin_access_identity",
  originReadTimeout: "origin_read_timeout",
};

const Distribution_DistributionConfig_Origins_VpcOriginConfigFields: FieldMap = {
  originKeepaliveTimeout: "origin_keepalive_timeout",
  originReadTimeout: "origin_read_timeout",
...
const Distribution_DistributionConfig_OriginsFields: FieldMap = {
...
const Distribution_DistributionConfig_Restrictions_GeoRestrictionFields: FieldMap = {
  locations: "locations",
  restrictionType: "restriction_type",
};

const Distribution_DistributionConfig_RestrictionsFields: FieldMap = {
  geoRestriction: {
...
const Distribution_DistributionConfig_S3OriginFields: FieldMap = {
  dnsname: "dnsname",
  originAccessIdentity: "origin_access_identity",
};

const Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_Definition_StringSchemaFields: FieldMap = {
  comment: "comment",
  defaultValue: "default_value",
  required: "required",
};

const Distribution_DistributionConfig_TenantConfig_ParameterDefinitions_DefinitionFields: FieldMap = {
  stringSchema: {
...
const Distribution_DistributionConfig_TenantConfig_ParameterDefinitionsFields: FieldMap = {
  definition: {
    wireName: "definition",
    kind: "object",
...
const Distribution_DistributionConfig_TenantConfigFields: FieldMap = {
...
const Distribution_DistributionConfig_ViewerCertificateFields: FieldMap = {
...
const Distribution_DistributionConfig_ViewerMtlsConfig_TrustStoreConfigFields: FieldMap = {
...
const Distribution_DistributionConfig_ViewerMtlsConfigFields: FieldMap = {
  mode: "mode",
  trustStoreConfig: {
...
const Distribution_DistributionConfigFields: FieldMap = {
  aliases: "aliases",
...
export interface DistributionConfig {
  ...
  distributionConfig: Distribution_DistributionConfig | Computed<Distribution_DistributionConfig>;
