...
export interface MqConfigurationAssociation_Configuration {
...
const MqConfigurationAssociation_ConfigurationFields: FieldMap = {
  id: "id",
  revision: "revision",
};
...
export const MqConfigurationAssociation: ResourceBinding<MqConfigurationAssociationConfig, MqConfigurationAssociationAttrs> = {
