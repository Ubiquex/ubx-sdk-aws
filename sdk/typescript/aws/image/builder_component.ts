...
export interface BuilderComponent_LatestVersion {
...
export interface BuilderComponentAttrs {
  ...
  latestVersion: BuilderComponent_LatestVersion;
  /** The name of the component. */
  name: string;
  /** The platform of the component. */
  platform: string;
...
export const BuilderComponent: ResourceBinding<BuilderComponentConfig, BuilderComponentAttrs> = {
