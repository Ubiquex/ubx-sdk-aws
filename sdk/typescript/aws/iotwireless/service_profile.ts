...
export interface ServiceProfile_LoRaWan {
...
export interface ServiceProfile_Tags {
...
const ServiceProfile_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface ServiceProfileConfig {
  ...
  tags?: ServiceProfile_Tags[] | Computed<ServiceProfile_Tags[]>;
}

export interface ServiceProfileAttrs {
  ...
  loRaWan: ServiceProfile_LoRaWan;
  /** Name of service profile */
  name: string;
  /** A list of key-value pairs that contain metadata for the service profile. */
  tags: ServiceProfile_Tags[];
}

export const ServiceProfile: ResourceBinding<ServiceProfileConfig, ServiceProfileAttrs> = {
