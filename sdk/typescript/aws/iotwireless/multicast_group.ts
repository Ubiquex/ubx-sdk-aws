...
export interface MulticastGroup_LoRaWan {
...
export interface MulticastGroup_Tags {
...
const MulticastGroup_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface MulticastGroupConfig {
  ...
  tags?: MulticastGroup_Tags[] | Computed<MulticastGroup_Tags[]>;
}

export interface MulticastGroupAttrs {
  ...
  loRaWan: MulticastGroup_LoRaWan;
  /** Name of Multicast group */
  name: string;
  /** Multicast group status. Returned after successful read. */
  status: string;
  /** A list of key-value pairs that contain metadata for the Multicast group. */
  tags: MulticastGroup_Tags[];
}

export const MulticastGroup: ResourceBinding<MulticastGroupConfig, MulticastGroupAttrs> = {
