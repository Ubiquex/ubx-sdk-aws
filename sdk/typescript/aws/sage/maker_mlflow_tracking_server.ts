...
const MakerMlflowTrackingServer_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface MakerMlflowTrackingServerConfig {
  ...
  tags?: MakerMlflowTrackingServer_Tags[] | Computed<MakerMlflowTrackingServer_Tags[]>;
...
export interface MakerMlflowTrackingServerAttrs {
  /** The Amazon S3 URI for MLFlow Tracking Server artifacts. */
  ...
  roleArn: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: MakerMlflowTrackingServer_Tags[];
...
export const MakerMlflowTrackingServer: ResourceBinding<MakerMlflowTrackingServerConfig, MakerMlflowTrackingServerAttrs> = {
