...
export interface Pipeline_PipelineActivities_AddAttributes {
...
export interface Pipeline_PipelineActivities_Channel {
...
export interface Pipeline_PipelineActivities_Datastore {
...
export interface Pipeline_PipelineActivities_DeviceRegistryEnrich {
...
export interface Pipeline_PipelineActivities_Filter {
...
export interface Pipeline_PipelineActivities_Lambda {
...
export interface Pipeline_PipelineActivities_Math {
...
export interface Pipeline_PipelineActivities_RemoveAttributes {
...
export interface Pipeline_PipelineActivities {
  ...
  addAttributes?: Pipeline_PipelineActivities_AddAttributes | Computed<Pipeline_PipelineActivities_AddAttributes>;
  ...
  channel?: Pipeline_PipelineActivities_Channel | Computed<Pipeline_PipelineActivities_Channel>;
  ...
  datastore?: Pipeline_PipelineActivities_Datastore | Computed<Pipeline_PipelineActivities_Datastore>;
  ...
  deviceRegistryEnrich?: Pipeline_PipelineActivities_DeviceRegistryEnrich | Computed<Pipeline_PipelineActivities_DeviceRegistryEnrich>;
  ...
  deviceShadowEnrich?: Pipeline_PipelineActivities_DeviceRegistryEnrich | Computed<Pipeline_PipelineActivities_DeviceRegistryEnrich>;
  ...
  filter?: Pipeline_PipelineActivities_Filter | Computed<Pipeline_PipelineActivities_Filter>;
  ...
  lambda?: Pipeline_PipelineActivities_Lambda | Computed<Pipeline_PipelineActivities_Lambda>;
  ...
  math?: Pipeline_PipelineActivities_Math | Computed<Pipeline_PipelineActivities_Math>;
  ...
  removeAttributes?: Pipeline_PipelineActivities_RemoveAttributes | Computed<Pipeline_PipelineActivities_RemoveAttributes>;
  ...
  selectAttributes?: Pipeline_PipelineActivities_RemoveAttributes | Computed<Pipeline_PipelineActivities_RemoveAttributes>;
}
...
const Pipeline_PipelineActivities_AddAttributesFields: FieldMap = {
  attributes: "attributes",
  name: "name",
  next: "next",
};

const Pipeline_PipelineActivities_ChannelFields: FieldMap = {
  channelName: "channel_name",
  name: "name",
  next: "next",
};

const Pipeline_PipelineActivities_DatastoreFields: FieldMap = {
  datastoreName: "datastore_name",
  name: "name",
};

const Pipeline_PipelineActivities_DeviceRegistryEnrichFields: FieldMap = {
  attribute: "attribute",
  name: "name",
  next: "next",
  roleArn: "role_arn",
...
const Pipeline_PipelineActivities_FilterFields: FieldMap = {
  filter: "filter",
  name: "name",
  next: "next",
};

const Pipeline_PipelineActivities_LambdaFields: FieldMap = {
...
const Pipeline_PipelineActivities_MathFields: FieldMap = {
  attribute: "attribute",
  math: "math",
  name: "name",
  next: "next",
...
const Pipeline_PipelineActivities_RemoveAttributesFields: FieldMap = {
  attributes: "attributes",
  name: "name",
  next: "next",
};

const Pipeline_PipelineActivitiesFields: FieldMap = {
  addAttributes: {
...
export interface PipelineConfig {
  ...
  pipelineActivities: Pipeline_PipelineActivities[] | Computed<Pipeline_PipelineActivities[]>;
...
export interface PipelineAttrs {
  ...
  id: string;
  /** Specifies the ordered list of pipeline activities (such as filter, select attributes, math, device registry, and channel or datastore writes) that process messages as they flow through the IoT Analytics pipeline. (AI-inferred) */
  pipelineActivities: Pipeline_PipelineActivities[];
  /** The name of the AWS IoT Analytics pipeline, which serves as the pipeline identifier and must be unique within the AWS account and region. (AI-inferred) */
  pipelineName: string;
  /** Attaches a list of key-value tags to the IoT Analytics pipeline, which can be used for cost allocation, resource categorization, and access control via IAM policies. (AI-inferred) */
  tags: Pipeline_Tags[];
