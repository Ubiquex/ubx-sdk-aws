...
export interface Channel_ChannelStorage_CustomerManagedS3 {
...
export interface Channel_ChannelStorage {
  ...
  customerManagedS3?: Channel_ChannelStorage_CustomerManagedS3 | Computed<Channel_ChannelStorage_CustomerManagedS3>;
...
const Channel_ChannelStorage_CustomerManagedS3Fields: FieldMap = {
  bucket: "bucket",
  keyPrefix: "key_prefix",
  roleArn: "role_arn",
};

const Channel_ChannelStorageFields: FieldMap = {
  customerManagedS3: {
...
const Channel_RetentionPeriodFields: FieldMap = {
...
export interface ChannelConfig {
  ...
  channelStorage?: Channel_ChannelStorage | Computed<Channel_ChannelStorage>;
  /** Specifies how long message data is kept in the channel, either as a finite number of days or indefinitely. (AI-inferred) */
  retentionPeriod?: Channel_RetentionPeriod | Computed<Channel_RetentionPeriod>;
...
export interface ChannelAttrs {
  ...
  channelName: string;
  /** Configures the storage destination for the channel's message data, choosing between an AWS IoT Analytics service-managed S3 bucket or a customer-managed S3 bucket. (AI-inferred) */
  channelStorage: Channel_ChannelStorage;
  id: string;
  /** Specifies how long message data is kept in the channel, either as a finite number of days or indefinitely. (AI-inferred) */
