...
export interface ConfigurationProfile_Tags {
...
export interface ConfigurationProfile_Validators {
...
const ConfigurationProfile_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

const ConfigurationProfile_ValidatorsFields: FieldMap = {
  content: "content",
  type: "type",
};
...
export interface ConfigurationProfileConfig {
  ...
  tags?: ConfigurationProfile_Tags[] | Computed<ConfigurationProfile_Tags[]>;
  ...
  validators?: ConfigurationProfile_Validators[] | Computed<ConfigurationProfile_Validators[]>;
}
...
export interface ConfigurationProfileAttrs {
  ...
  /** Metadata to assign to the configuration profile. Tags help organize and categorize your AWS AppConfig resources. Each tag consists of a key and an optional value, both of which you define. */
  tags: ConfigurationProfile_Tags[];
  /** The type of configurations contained in the profile. When calling this API, enter one of the following values for Type: AWS.AppConfig.FeatureFlags, AWS.Freeform */
  type: string;
  /** A list of methods for validating the configuration. */
  validators: ConfigurationProfile_Validators[];
}
