...
export interface Environment_Monitors {
...
const Environment_MonitorsFields: FieldMap = {
  alarmArn: "alarm_arn",
...
export interface EnvironmentConfig {
  ...
  monitors?: Environment_Monitors[] | Computed<Environment_Monitors[]>;
