...
export interface Stage_MethodSettings {
...
const Stage_AccessLogSettingFields: FieldMap = {
  destinationArn: "destination_arn",
  format: "format",
};

const Stage_CanarySettingFields: FieldMap = {
...
const Stage_MethodSettingsFields: FieldMap = {
...
export interface StageConfig {
  ...
  accessLogSetting?: Stage_AccessLogSetting | Computed<Stage_AccessLogSetting>;
  ...
  canarySetting?: Stage_CanarySetting | Computed<Stage_CanarySetting>;
  ...
  methodSettings?: Stage_MethodSettings[] | Computed<Stage_MethodSettings[]>;
...
export interface StageAttrs {
  ...
  /** Configures per-method settings for the stage, including throttling, caching, metrics, and logging, keyed by method path. (AI-inferred) */
  methodSettings: Stage_MethodSettings[];
  /** The ID of the REST API that this stage is associated with. (AI-inferred) */
  restApiId: string;
  /** The name of the API Gateway stage (e.g., 'prod', 'dev'), which appears in the API's invoke URL and identifies the deployment associated with this stage. (AI-inferred) */
  stageName: string;
