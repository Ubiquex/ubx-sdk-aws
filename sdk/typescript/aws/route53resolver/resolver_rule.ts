...
export interface ResolverRule_Tags {
...
export interface ResolverRule_TargetIps {
...
const ResolverRule_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

const ResolverRule_TargetIpsFields: FieldMap = {
  ip: "ip",
  ipv6: "ipv6",
  port: "port",
  protocol: "protocol",
...
export interface ResolverRuleConfig {
  ...
  tags?: ResolverRule_Tags[] | Computed<ResolverRule_Tags[]>;
  /** An array that contains the IP addresses and ports that an outbound endpoint forwards DNS queries to. Typically, these are the IP addresses of DNS resolvers on your network. Specify IPv4 addresses. IPv6 is not supported. */
  targetIps?: ResolverRule_TargetIps[] | Computed<ResolverRule_TargetIps[]>;
}
...
export interface ResolverRuleAttrs {
  ...
  ruleType: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: ResolverRule_Tags[];
  /** An array that contains the IP addresses and ports that an outbound endpoint forwards DNS queries to. Typically, these are the IP addresses of DNS resolvers on your network. Specify IPv4 addresses. IPv6 is not supported. */
  targetIps: ResolverRule_TargetIps[];
}
