...
export interface ResolverEndpoint_IpAddresses {
...
export interface ResolverEndpoint_Tags {
...
const ResolverEndpoint_IpAddressesFields: FieldMap = {
  ip: "ip",
  ipv6: "ipv6",
  subnetId: "subnet_id",
};

const ResolverEndpoint_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface ResolverEndpointConfig {
  ...
  ipAddresses: ResolverEndpoint_IpAddresses[] | Computed<ResolverEndpoint_IpAddresses[]>;
  ...
  tags?: ResolverEndpoint_Tags[] | Computed<ResolverEndpoint_Tags[]>;
...
export interface ResolverEndpointAttrs {
  ...
  /** The subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a VPC. */
  ipAddresses: ResolverEndpoint_IpAddresses[];
  /** Specifies whether IPv6 Internet Gateway access is enabled through the Outbound Resolver Endpoint. When set to true, this property allows your Endpoint ENIs to reach public IPv6 target nameservers through an internet gateway. Default is false. */
