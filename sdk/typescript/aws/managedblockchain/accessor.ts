...
export interface Accessor_Tags {
...
const Accessor_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface AccessorConfig {
  ...
  tags?: Accessor_Tags[] | Computed<Accessor_Tags[]>;
}

export interface AccessorAttrs {
  /** Specifies the accessor type (BILLING_TOKEN, ETHEREUM_GOERLI, or ETHEREUM_MAINNET), which determines whether the accessor is a billing token or grants access to a specific Ethereum network. (AI-inferred) */
  accessorType: string;
...
export const Accessor: ResourceBinding<AccessorConfig, AccessorAttrs> = {
