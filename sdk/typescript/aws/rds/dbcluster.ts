...
export interface Dbcluster_Endpoint {
...
export interface Dbcluster_MasterUserSecret {
...
export interface Dbcluster_ReadEndpoint {
...
export interface Dbcluster_ScalingConfiguration {
  ...
  autoPause?: boolean | Computed<boolean>;
  ...
  secondsBeforeTimeout?: number | Computed<number>;
  ...
  secondsUntilAutoPause?: number | Computed<number>;
...
const Dbcluster_ScalingConfigurationFields: FieldMap = {
...
export interface DbclusterConfig {
  ...
  enableIamdatabaseAuthentication?: boolean | Computed<boolean>;
  ...
  masterUserAuthenticationType?: string | Computed<string>;
  ...
  scalingConfiguration?: Dbcluster_ScalingConfiguration | Computed<Dbcluster_ScalingConfiguration>;
  ...
  sourceDbClusterResourceId?: string | Computed<string>;
...
export interface DbclusterAttrs {
  ...
  masterUserSecret: Dbcluster_MasterUserSecret;
  /** The name of the master user for the DB cluster. If you specify the ``SourceDBClusterIdentifier``, ``SnapshotIdentifier``, or ``GlobalClusterIdentifier`` property, don't specify this property. The value is inherited from the source DB cluster, the snapshot, or the primary DB cluster for the global database cluster, respectively. Valid for: Aurora DB clusters and Multi-AZ DB clusters */
  ...
  readEndpoint: Dbcluster_ReadEndpoint;
  /** The Amazon Resource Name (ARN) of the source DB instance or DB cluster if this DB cluster is created as a read replica. Valid for: Aurora DB clusters only */
...
export const Dbcluster: ResourceBinding<DbclusterConfig, DbclusterAttrs> = {
  ...
  fields: {
    ...
    dbclusterInstanceClass: "dbcluster_instance_class",
    ...
    masterUserAuthenticationType: "master_user_authentication_type",
    ...
    scalingConfiguration: {
      ...
      kind: "object",
      fields: Dbcluster_ScalingConfigurationFields,
    },
