...
export interface FrontOriginRequestPolicy_OriginRequestPolicyConfig_CookiesConfig {
...
export interface FrontOriginRequestPolicy_OriginRequestPolicyConfig_HeadersConfig {
...
export interface FrontOriginRequestPolicy_OriginRequestPolicyConfig_QueryStringsConfig {
...
export interface FrontOriginRequestPolicy_OriginRequestPolicyConfig {
  /** A comment to describe the origin request policy. The comment cannot be longer than 128 characters. */
  comment?: string | Computed<string>;
  /** An object that determines whether any cookies in viewer requests (and if so, which cookies) are included in requests that CloudFront sends to the origin. */
  cookiesConfig: FrontOriginRequestPolicy_OriginRequestPolicyConfig_CookiesConfig | Computed<FrontOriginRequestPolicy_OriginRequestPolicyConfig_CookiesConfig>;
  /** An object that determines whether any HTTP headers (and if so, which headers) are included in requests that CloudFront sends to the origin. */
  headersConfig: FrontOriginRequestPolicy_OriginRequestPolicyConfig_HeadersConfig | Computed<FrontOriginRequestPolicy_OriginRequestPolicyConfig_HeadersConfig>;
  /** A unique name to identify the origin request policy. */
  name: string | Computed<string>;
  /** An object that determines whether any URL query strings in viewer requests (and if so, which query strings) are included in requests that CloudFront sends to the origin. */
  queryStringsConfig: FrontOriginRequestPolicy_OriginRequestPolicyConfig_QueryStringsConfig | Computed<FrontOriginRequestPolicy_OriginRequestPolicyConfig_QueryStringsConfig>;
}

const FrontOriginRequestPolicy_OriginRequestPolicyConfig_CookiesConfigFields: FieldMap = {
  cookieBehavior: "cookie_behavior",
  cookies: "cookies",
};

const FrontOriginRequestPolicy_OriginRequestPolicyConfig_HeadersConfigFields: FieldMap = {
  headerBehavior: "header_behavior",
  headers: "headers",
};

const FrontOriginRequestPolicy_OriginRequestPolicyConfig_QueryStringsConfigFields: FieldMap = {
  queryStringBehavior: "query_string_behavior",
  queryStrings: "query_strings",
};

const FrontOriginRequestPolicy_OriginRequestPolicyConfigFields: FieldMap = {
  comment: "comment",
  cookiesConfig: {
...
export interface FrontOriginRequestPolicyConfig {
  ...
  originRequestPolicyConfig: FrontOriginRequestPolicy_OriginRequestPolicyConfig | Computed<FrontOriginRequestPolicy_OriginRequestPolicyConfig>;
}

export interface FrontOriginRequestPolicyAttrs {
  ...
  /** An origin request policy configuration. This configuration determines the values that CloudFront includes in requests that it sends to the origin. Each request that CloudFront sends to the origin includes the following: + The request body and the URL path (without the domain name) from the viewer request. + The headers that CloudFront automatically includes in every origin request, including ``Host``, ``User-Agent``, and ``X-Amz-Cf-Id``. + All HTTP headers, cookies, and URL query strings that are specified in the cache policy or the origin request policy. These can include items from the viewer request and, in the case of headers, additional ones that are added by CloudFront. CloudFront sends a request when it can't find an object in its cache that matches the request. If you want to send values to the origin and also include them in the cache key, use ``CachePolicy``. */
  originRequestPolicyConfig: FrontOriginRequestPolicy_OriginRequestPolicyConfig;
}

export const FrontOriginRequestPolicy: ResourceBinding<FrontOriginRequestPolicyConfig, FrontOriginRequestPolicyAttrs> = {
