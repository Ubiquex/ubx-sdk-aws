...
export interface FormationPublicTypeVersionConfig {
...
export interface FormationPublicTypeVersionAttrs {
  /** The Amazon Resource Number (ARN) of the extension. */
  arn: string;
  /** A url to the S3 bucket where logs for the testType run will be available */
...
export const FormationPublicTypeVersion: ResourceBinding<FormationPublicTypeVersionConfig, FormationPublicTypeVersionAttrs> = {
