...
export interface FormationModuleVersionConfig {
...
export interface FormationModuleVersionAttrs {
...
export const FormationModuleVersion: ResourceBinding<FormationModuleVersionConfig, FormationModuleVersionAttrs> = {
