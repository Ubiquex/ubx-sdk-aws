...
export interface FrontFunction_FunctionConfig {
  ...
  keyValueStoreAssociations?: FrontFunction_FunctionConfig_KeyValueStoreAssociations[] | Computed<FrontFunction_FunctionConfig_KeyValueStoreAssociations[]>;
  /** The function's runtime environment version. */
  runtime: string | Computed<string>;
}

export interface FrontFunction_FunctionMetadata {
...
const FrontFunction_FunctionConfig_KeyValueStoreAssociationsFields: FieldMap = {
  keyValueStoreArn: "key_value_store_arn",
};

const FrontFunction_FunctionConfigFields: FieldMap = {
  comment: "comment",
...
const FrontFunction_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface FrontFunctionConfig {
  ...
  functionConfig: FrontFunction_FunctionConfig | Computed<FrontFunction_FunctionConfig>;
  /** A name to identify the function. */
  name: string | Computed<string>;
  /** A complex type that contains zero or more ``Tag`` elements. */
  tags?: FrontFunction_Tags[] | Computed<FrontFunction_Tags[]>;
}
...
export interface FrontFunctionAttrs {
  ...
  functionCode: string;
  /** Contains configuration information about a CloudFront function. */
  functionConfig: FrontFunction_FunctionConfig;
...
export const FrontFunction: ResourceBinding<FrontFunctionConfig, FrontFunctionAttrs> = {
