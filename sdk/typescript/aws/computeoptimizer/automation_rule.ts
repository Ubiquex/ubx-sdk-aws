...
export interface AutomationRule_Criteria_EbsVolumeSizeInGib {
...
export interface AutomationRule_Criteria_EbsVolumeType {
  comparison?: string | Computed<string>;
  values?: string[] | Computed<string[]>;
}

export interface AutomationRule_Criteria_ResourceTag {
...
export interface AutomationRule_Criteria {
  ...
  ebsVolumeSizeInGib?: AutomationRule_Criteria_EbsVolumeSizeInGib[] | Computed<AutomationRule_Criteria_EbsVolumeSizeInGib[]>;
  ...
  ebsVolumeType?: AutomationRule_Criteria_EbsVolumeType[] | Computed<AutomationRule_Criteria_EbsVolumeType[]>;
  ...
  estimatedMonthlySavings?: AutomationRule_Criteria_EbsVolumeSizeInGib[] | Computed<AutomationRule_Criteria_EbsVolumeSizeInGib[]>;
  ...
  lookBackPeriodInDays?: AutomationRule_Criteria_EbsVolumeSizeInGib[] | Computed<AutomationRule_Criteria_EbsVolumeSizeInGib[]>;
  region?: AutomationRule_Criteria_EbsVolumeType[] | Computed<AutomationRule_Criteria_EbsVolumeType[]>;
  ...
  resourceArn?: AutomationRule_Criteria_EbsVolumeType[] | Computed<AutomationRule_Criteria_EbsVolumeType[]>;
  ...
  resourceTag?: AutomationRule_Criteria_ResourceTag[] | Computed<AutomationRule_Criteria_ResourceTag[]>;
  ...
  restartNeeded?: AutomationRule_Criteria_EbsVolumeType[] | Computed<AutomationRule_Criteria_EbsVolumeType[]>;
}

export interface AutomationRule_OrganizationConfiguration {
...
export interface AutomationRule_Schedule {
...
export interface AutomationRule_Tags {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

const AutomationRule_Criteria_EbsVolumeSizeInGibFields: FieldMap = {
  comparison: "comparison",
  values: "values",
};

const AutomationRule_Criteria_EbsVolumeTypeFields: FieldMap = {
  comparison: "comparison",
  values: "values",
};

const AutomationRule_Criteria_ResourceTagFields: FieldMap = {
  comparison: "comparison",
  key: "key",
  values: "values",
};
...
export interface AutomationRuleConfig {
  ...
  organizationConfiguration?: AutomationRule_OrganizationConfiguration | Computed<AutomationRule_OrganizationConfiguration>;
  ...
  schedule: AutomationRule_Schedule | Computed<AutomationRule_Schedule>;
  /** The status of the automation rule. */
  status: string | Computed<string>;
  /** Tags associated with the automation rule. */
  tags?: AutomationRule_Tags[] | Computed<AutomationRule_Tags[]>;
}
...
export interface AutomationRuleAttrs {
  ...
  /** The name of the automation rule. */
  name: string;
  organizationConfiguration: AutomationRule_OrganizationConfiguration;
  /** Rule priority within its group */
  priority: string;
  /** The types of recommended actions this rule will implement. */
  ...
  ruleType: string;
  /** Defines the schedule for when the Compute Optimizer automation rule runs, including the frequency and timing at which the rule's recommended actions are applied to the targeted resources. (AI-inferred) */
  schedule: AutomationRule_Schedule;
  /** The status of the automation rule. */
  status: string;
  /** Tags associated with the automation rule. */
  tags: AutomationRule_Tags[];
}
