...
export interface GroupsTagSyncTaskConfig {
...
export interface GroupsTagSyncTaskAttrs {
  /** The Amazon resource name (ARN) or name of the application group for which you want to create a tag-sync task */
  group: string;
...
export const GroupsTagSyncTask: ResourceBinding<GroupsTagSyncTaskConfig, GroupsTagSyncTaskAttrs> = {
