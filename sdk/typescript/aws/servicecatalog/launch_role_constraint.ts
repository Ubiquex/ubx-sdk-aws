...
export interface LaunchRoleConstraintConfig {
...
export interface LaunchRoleConstraintAttrs {
  /** The language code for the constraint. */
...
export const LaunchRoleConstraint: ResourceBinding<LaunchRoleConstraintConfig, LaunchRoleConstraintAttrs> = {
