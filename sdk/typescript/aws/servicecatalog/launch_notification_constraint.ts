...
export interface LaunchNotificationConstraintConfig {
...
export interface LaunchNotificationConstraintAttrs {
  /** Specifies the language code (e.g., 'en') used for responses from the AWS Service Catalog API when managing this launch notification constraint. (AI-inferred) */
...
export const LaunchNotificationConstraint: ResourceBinding<LaunchNotificationConstraintConfig, LaunchNotificationConstraintAttrs> = {
