...
export interface LiftBuild_StorageLocation {
...
export interface LiftBuild_Tags {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

const LiftBuild_StorageLocationFields: FieldMap = {
  bucket: "bucket",
  key: "key",
...
const LiftBuild_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface LiftBuildConfig {
...
export interface LiftBuildAttrs {
...
export const LiftBuild: ResourceBinding<LiftBuildConfig, LiftBuildAttrs> = {
