...
export interface TablesTablePolicyConfig {
...
export interface TablesTablePolicyAttrs {
...
export const TablesTablePolicy: ResourceBinding<TablesTablePolicyConfig, TablesTablePolicyAttrs> = {
