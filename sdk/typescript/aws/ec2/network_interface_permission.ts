...
export interface NetworkInterfacePermissionConfig {
...
export interface NetworkInterfacePermissionAttrs {
  /** The AWS account ID that is granted permission to attach the network interface to an instance or associate it with an Elastic IP. (AI-inferred) */
  awsAccountId: string;
...
export const NetworkInterfacePermission: ResourceBinding<NetworkInterfacePermissionConfig, NetworkInterfacePermissionAttrs> = {
