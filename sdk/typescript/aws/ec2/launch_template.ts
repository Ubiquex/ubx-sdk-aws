...
export interface LaunchTemplate_LaunchTemplateData_BlockDeviceMappings_Ebs {
...
export interface LaunchTemplate_LaunchTemplateData_BlockDeviceMappings {
  ...
  ebs?: LaunchTemplate_LaunchTemplateData_BlockDeviceMappings_Ebs | Computed<LaunchTemplate_LaunchTemplateData_BlockDeviceMappings_Ebs>;
...
export interface LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification_CapacityReservationTarget {
...
export interface LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification {
  ...
  capacityReservationTarget?: LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification_CapacityReservationTarget | Computed<LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification_CapacityReservationTarget>;
}

export interface LaunchTemplate_LaunchTemplateData_CpuOptions {
...
export interface LaunchTemplate_LaunchTemplateData_CreditSpecification {
  /** The credit option for CPU usage of a T instance. Valid values: ``standard`` | ``unlimited`` */
  cpuCredits?: string | Computed<string>;
}

export interface LaunchTemplate_LaunchTemplateData_EnclaveOptions {
  /** If this parameter is set to ``true``, the instance is enabled for AWS Nitro Enclaves; otherwise, it is not enabled for AWS Nitro Enclaves. */
  enabled?: boolean | Computed<boolean>;
}

export interface LaunchTemplate_LaunchTemplateData_HibernationOptions {
...
export interface LaunchTemplate_LaunchTemplateData_IamInstanceProfile {
...
export interface LaunchTemplate_LaunchTemplateData_InstanceMarketOptions_SpotOptions {
  /** Deprecated. */
...
export interface LaunchTemplate_LaunchTemplateData_InstanceMarketOptions {
  /** The market type. */
  ...
  spotOptions?: LaunchTemplate_LaunchTemplateData_InstanceMarketOptions_SpotOptions | Computed<LaunchTemplate_LaunchTemplateData_InstanceMarketOptions_SpotOptions>;
}

export interface LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount {
...
export interface LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu_References {
...
export interface LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu {
  ...
  references?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu_References[] | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu_References[]>;
}

export interface LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors {
  /** Specifies the CPU performance to consider when using an instance family as the baseline reference. */
  cpu?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu>;
}

export interface LaunchTemplate_LaunchTemplateData_InstanceRequirements {
  /** The minimum and maximum number of accelerators (GPUs, FPGAs, or AWS Inferentia chips) on an instance. */
  acceleratorCount?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  ...
  acceleratorTotalMemoryMiB?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  ...
  baselineEbsBandwidthMbps?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  ...
  baselinePerformanceFactors?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors>;
  ...
  memoryGiBperVcpu?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  /** The minimum and maximum amount of memory, in MiB. */
  memoryMiB?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  ...
  networkBandwidthGbps?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  /** The minimum and maximum number of network interfaces. */
  networkInterfaceCount?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  ...
  totalLocalStorageGb?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
  /** The minimum and maximum number of vCPUs. */
  vcpuCount?: LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount>;
}

export interface LaunchTemplate_LaunchTemplateData_LicenseSpecifications {
...
export interface LaunchTemplate_LaunchTemplateData_MaintenanceOptions {
  /** Disables the automatic recovery behavior of your instance or sets it to default. */
  autoRecovery?: string | Computed<string>;
}

export interface LaunchTemplate_LaunchTemplateData_MetadataOptions {
...
export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces_ConnectionTrackingSpecification {
...
export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification_EnaSrdUdpSpecification {
...
export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification {
  ...
  enaSrdUdpSpecification?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification_EnaSrdUdpSpecification | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification_EnaSrdUdpSpecification>;
}

export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv4Prefixes {
...
export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Addresses {
...
export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Prefixes {
...
export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces_PrivateIpAddresses {
...
export interface LaunchTemplate_LaunchTemplateData_NetworkInterfaces {
  ...
  connectionTrackingSpecification?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces_ConnectionTrackingSpecification | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces_ConnectionTrackingSpecification>;
  ...
  enaSrdSpecification?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification>;
  ...
  ipv4Prefixes?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv4Prefixes[] | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv4Prefixes[]>;
  ...
  ipv6Addresses?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Addresses[] | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Addresses[]>;
  ...
  ipv6Prefixes?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Prefixes[] | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Prefixes[]>;
  ...
  privateIpAddresses?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces_PrivateIpAddresses[] | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces_PrivateIpAddresses[]>;
...
export interface LaunchTemplate_LaunchTemplateData_NetworkPerformanceOptions {
...
export interface LaunchTemplate_LaunchTemplateData_Placement {
...
export interface LaunchTemplate_LaunchTemplateData_PrivateDnsNameOptions {
...
export interface LaunchTemplate_LaunchTemplateData_TagSpecifications_Tags {
...
export interface LaunchTemplate_LaunchTemplateData_TagSpecifications {
  ...
  tags?: LaunchTemplate_LaunchTemplateData_TagSpecifications_Tags[] | Computed<LaunchTemplate_LaunchTemplateData_TagSpecifications_Tags[]>;
}

export interface LaunchTemplate_LaunchTemplateData {
  /** The block device mapping. */
  blockDeviceMappings?: LaunchTemplate_LaunchTemplateData_BlockDeviceMappings[] | Computed<LaunchTemplate_LaunchTemplateData_BlockDeviceMappings[]>;
  ...
  capacityReservationSpecification?: LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification | Computed<LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification>;
  ...
  cpuOptions?: LaunchTemplate_LaunchTemplateData_CpuOptions | Computed<LaunchTemplate_LaunchTemplateData_CpuOptions>;
  ...
  creditSpecification?: LaunchTemplate_LaunchTemplateData_CreditSpecification | Computed<LaunchTemplate_LaunchTemplateData_CreditSpecification>;
  ...
  enclaveOptions?: LaunchTemplate_LaunchTemplateData_EnclaveOptions | Computed<LaunchTemplate_LaunchTemplateData_EnclaveOptions>;
  ...
  hibernationOptions?: LaunchTemplate_LaunchTemplateData_HibernationOptions | Computed<LaunchTemplate_LaunchTemplateData_HibernationOptions>;
  ...
  iamInstanceProfile?: LaunchTemplate_LaunchTemplateData_IamInstanceProfile | Computed<LaunchTemplate_LaunchTemplateData_IamInstanceProfile>;
  ...
  instanceMarketOptions?: LaunchTemplate_LaunchTemplateData_InstanceMarketOptions | Computed<LaunchTemplate_LaunchTemplateData_InstanceMarketOptions>;
  ...
  instanceRequirements?: LaunchTemplate_LaunchTemplateData_InstanceRequirements | Computed<LaunchTemplate_LaunchTemplateData_InstanceRequirements>;
  ...
  licenseSpecifications?: LaunchTemplate_LaunchTemplateData_LicenseSpecifications[] | Computed<LaunchTemplate_LaunchTemplateData_LicenseSpecifications[]>;
  /** The maintenance options of your instance. */
  maintenanceOptions?: LaunchTemplate_LaunchTemplateData_MaintenanceOptions | Computed<LaunchTemplate_LaunchTemplateData_MaintenanceOptions>;
  ...
  metadataOptions?: LaunchTemplate_LaunchTemplateData_MetadataOptions | Computed<LaunchTemplate_LaunchTemplateData_MetadataOptions>;
  ...
  monitoring?: LaunchTemplate_LaunchTemplateData_EnclaveOptions | Computed<LaunchTemplate_LaunchTemplateData_EnclaveOptions>;
  /** The network interfaces for the instance. */
  networkInterfaces?: LaunchTemplate_LaunchTemplateData_NetworkInterfaces[] | Computed<LaunchTemplate_LaunchTemplateData_NetworkInterfaces[]>;
  /** Contains settings for the network performance options for the instance. */
  networkPerformanceOptions?: LaunchTemplate_LaunchTemplateData_NetworkPerformanceOptions | Computed<LaunchTemplate_LaunchTemplateData_NetworkPerformanceOptions>;
  ...
  placement?: LaunchTemplate_LaunchTemplateData_Placement | Computed<LaunchTemplate_LaunchTemplateData_Placement>;
  ...
  privateDnsNameOptions?: LaunchTemplate_LaunchTemplateData_PrivateDnsNameOptions | Computed<LaunchTemplate_LaunchTemplateData_PrivateDnsNameOptions>;
  ...
  tagSpecifications?: LaunchTemplate_LaunchTemplateData_TagSpecifications[] | Computed<LaunchTemplate_LaunchTemplateData_TagSpecifications[]>;
...
const LaunchTemplate_LaunchTemplateData_BlockDeviceMappings_EbsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_BlockDeviceMappingsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification_CapacityReservationTargetFields: FieldMap = {
  capacityReservationId: "capacity_reservation_id",
  capacityReservationResourceGroupArn: "capacity_reservation_resource_group_arn",
};

const LaunchTemplate_LaunchTemplateData_CapacityReservationSpecificationFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_CpuOptionsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_CreditSpecificationFields: FieldMap = {
  cpuCredits: "cpu_credits",
};

const LaunchTemplate_LaunchTemplateData_EnclaveOptionsFields: FieldMap = {
  enabled: "enabled",
};

const LaunchTemplate_LaunchTemplateData_HibernationOptionsFields: FieldMap = {
  configured: "configured",
};

const LaunchTemplate_LaunchTemplateData_IamInstanceProfileFields: FieldMap = {
  arn: "arn",
  name: "name",
};

const LaunchTemplate_LaunchTemplateData_InstanceMarketOptions_SpotOptionsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_InstanceMarketOptionsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCountFields: FieldMap = {
  max: "max",
  min: "min",
};

const LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu_ReferencesFields: FieldMap = {
  instanceFamily: "instance_family",
};

const LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_CpuFields: FieldMap = {
  references: {
    wireName: "references",
    kind: "list",
...
const LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactorsFields: FieldMap = {
  cpu: {
    wireName: "cpu",
    kind: "object",
...
const LaunchTemplate_LaunchTemplateData_InstanceRequirementsFields: FieldMap = {
  acceleratorCount: {
...
const LaunchTemplate_LaunchTemplateData_LicenseSpecificationsFields: FieldMap = {
  licenseConfigurationArn: "license_configuration_arn",
};

const LaunchTemplate_LaunchTemplateData_MaintenanceOptionsFields: FieldMap = {
  autoRecovery: "auto_recovery",
};

const LaunchTemplate_LaunchTemplateData_MetadataOptionsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_NetworkInterfaces_ConnectionTrackingSpecificationFields: FieldMap = {
  tcpEstablishedTimeout: "tcp_established_timeout",
  udpStreamTimeout: "udp_stream_timeout",
  udpTimeout: "udp_timeout",
};

const LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification_EnaSrdUdpSpecificationFields: FieldMap = {
  enaSrdUdpEnabled: "ena_srd_udp_enabled",
};

const LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecificationFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv4PrefixesFields: FieldMap = {
  ipv4Prefix: "ipv4_prefix",
};

const LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6AddressesFields: FieldMap = {
  ipv6Address: "ipv6_address",
};

const LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6PrefixesFields: FieldMap = {
  ipv6Prefix: "ipv6_prefix",
};

const LaunchTemplate_LaunchTemplateData_NetworkInterfaces_PrivateIpAddressesFields: FieldMap = {
  primary: "primary",
  privateIpAddress: "private_ip_address",
};

const LaunchTemplate_LaunchTemplateData_NetworkInterfacesFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_NetworkPerformanceOptionsFields: FieldMap = {
  bandwidthWeighting: "bandwidth_weighting",
};

const LaunchTemplate_LaunchTemplateData_PlacementFields: FieldMap = {
  affinity: "affinity",
...
const LaunchTemplate_LaunchTemplateData_PrivateDnsNameOptionsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateData_TagSpecifications_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

const LaunchTemplate_LaunchTemplateData_TagSpecificationsFields: FieldMap = {
...
const LaunchTemplate_LaunchTemplateDataFields: FieldMap = {
  blockDeviceMappings: {
...
export interface LaunchTemplateConfig {
  ...
  launchTemplateData: LaunchTemplate_LaunchTemplateData | Computed<LaunchTemplate_LaunchTemplateData>;
...
export interface LaunchTemplateAttrs {
  ...
  /** The tags to apply to the launch template on creation. To tag the launch template, the resource type must be ``launch-template``. To specify the tags for resources that are created during instance launch, use [TagSpecifications](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html#cfn-ec2-launchtemplate-launchtemplatedata-tagspecifications). */
  tagSpecifications: LaunchTemplate_LaunchTemplateData_TagSpecifications[];
  /** A description for the first version of the launch template. */
  versionDescription: string;
}

export const LaunchTemplate: ResourceBinding<LaunchTemplateConfig, LaunchTemplateAttrs> = {
