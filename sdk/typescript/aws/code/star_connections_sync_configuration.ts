...
export interface StarConnectionsSyncConfigurationConfig {
...
export interface StarConnectionsSyncConfigurationAttrs {
  /** The name of the branch of the repository from which resources are to be synchronized, */
  branch: string;
  /** The source provider repository path of the sync configuration file of the respective SyncType. */
  configFile: string;
...
export const StarConnectionsSyncConfiguration: ResourceBinding<StarConnectionsSyncConfigurationConfig, StarConnectionsSyncConfigurationAttrs> = {
