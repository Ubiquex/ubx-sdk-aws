...
export interface BuildSourceCredentialConfig {
...
export interface BuildSourceCredentialAttrs {
...
export const BuildSourceCredential: ResourceBinding<BuildSourceCredentialConfig, BuildSourceCredentialAttrs> = {
