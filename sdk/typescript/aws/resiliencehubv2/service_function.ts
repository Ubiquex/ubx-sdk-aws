...
export interface ServiceFunctionConfig {
...
export interface ServiceFunctionAttrs {
...
export const ServiceFunction: ResourceBinding<ServiceFunctionConfig, ServiceFunctionAttrs> = {
