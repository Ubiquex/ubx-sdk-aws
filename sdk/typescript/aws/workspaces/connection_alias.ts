...
export interface ConnectionAlias_Associations {
...
export interface ConnectionAliasConfig {
  ...
  tags?: ConnectionAlias_Tags[] | Computed<ConnectionAlias_Tags[]>;
}
...
export interface ConnectionAliasAttrs {
  ...
  associations: ConnectionAlias_Associations[];
