...
export interface Fleet_FleetProxyConfiguration_OrderedProxyRules {
...
export interface Fleet_FleetProxyConfiguration {
  ...
  orderedProxyRules?: Fleet_FleetProxyConfiguration_OrderedProxyRules[] | Computed<Fleet_FleetProxyConfiguration_OrderedProxyRules[]>;
}

export interface Fleet_FleetVpcConfig {
...
export interface Fleet_ScalingConfiguration {
  ...
  targetTrackingScalingConfigs?: Fleet_ScalingConfiguration_TargetTrackingScalingConfigs[] | Computed<Fleet_ScalingConfiguration_TargetTrackingScalingConfigs[]>;
}
...
const Fleet_FleetProxyConfiguration_OrderedProxyRulesFields: FieldMap = {
  effect: "effect",
  entities: "entities",
  type: "type",
};

const Fleet_FleetProxyConfigurationFields: FieldMap = {
...
const Fleet_FleetVpcConfigFields: FieldMap = {
...
export interface FleetConfig {
  ...
  fleetProxyConfiguration?: Fleet_FleetProxyConfiguration | Computed<Fleet_FleetProxyConfiguration>;
  ...
  fleetVpcConfig?: Fleet_FleetVpcConfig | Computed<Fleet_FleetVpcConfig>;
...
export interface FleetAttrs {
  ...
  /** Specifies the proxy configuration for a CodeBuild fleet, including the default proxy address and HTTP/HTTPS proxy ports used to route outbound traffic from the fleet's compute instances. (AI-inferred) */
  fleetProxyConfiguration: Fleet_FleetProxyConfiguration;
  /** The ARN of the IAM service role that the AWS CodeBuild fleet assumes to access necessary AWS resources such as source code repositories and build artifact storage. (AI-inferred) */
  fleetServiceRole: string;
  /** Specifies the VPC, subnets, and security group IDs that the CodeBuild fleet's compute instances use for network access. (AI-inferred) */
  fleetVpcConfig: Fleet_FleetVpcConfig;
  /** Specifies the container image (e.g., a managed CodeBuild image or a custom Docker image from Amazon ECR) that the fleet uses for its build environments. (AI-inferred) */
  imageId: string;
  /** The name of the CodeBuild fleet, which serves as its identifier and is optional; if not provided, CloudFormation generates a unique name. (AI-inferred) */
  name: string;
