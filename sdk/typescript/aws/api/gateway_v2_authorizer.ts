...
export interface GatewayV2Authorizer_JwtConfiguration {
...
const GatewayV2Authorizer_JwtConfigurationFields: FieldMap = {
  audience: "audience",
  issuer: "issuer",
};

export interface GatewayV2AuthorizerConfig {
  /** The API identifier. */
  ...
  jwtConfiguration?: GatewayV2Authorizer_JwtConfiguration | Computed<GatewayV2Authorizer_JwtConfiguration>;
  /** The name of the authorizer. */
  name: string | Computed<string>;
}

export interface GatewayV2AuthorizerAttrs {
  /** The API identifier. */
  apiId: string;
  /** Specifies the required credentials as an IAM role for API Gateway to invoke the authorizer. To specify an IAM role for API Gateway to assume, use the role's Amazon Resource Name (ARN). To use resource-based permissions on the Lambda function, specify null. Supported only for ``REQUEST`` authorizers. */
  ...
  /** The ``JWTConfiguration`` property specifies the configuration of a JWT authorizer. Required for the ``JWT`` authorizer type. Supported only for HTTP APIs. */
  jwtConfiguration: GatewayV2Authorizer_JwtConfiguration;
  /** The name of the authorizer. */
  name: string;
}

export const GatewayV2Authorizer: ResourceBinding<GatewayV2AuthorizerConfig, GatewayV2AuthorizerAttrs> = {
  ...
  fields: {
    ...
    jwtConfiguration: {
      ...
      kind: "object",
      fields: GatewayV2Authorizer_JwtConfigurationFields,
    },
    name: "name",
  },
};
