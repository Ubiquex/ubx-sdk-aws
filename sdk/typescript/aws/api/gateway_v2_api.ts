...
export interface GatewayV2Api_BodyS3Location {
...
export interface GatewayV2Api_CorsConfiguration {
...
const GatewayV2Api_BodyS3LocationFields: FieldMap = {
  bucket: "bucket",
  etag: "etag",
  key: "key",
  version: "version",
...
const GatewayV2Api_CorsConfigurationFields: FieldMap = {
...
export interface GatewayV2ApiConfig {
  ...
  bodyS3Location?: GatewayV2Api_BodyS3Location | Computed<GatewayV2Api_BodyS3Location>;
  ...
  corsConfiguration?: GatewayV2Api_CorsConfiguration | Computed<GatewayV2Api_CorsConfiguration>;
...
export interface GatewayV2ApiAttrs {
  apiEndpoint: string;
  apiId: string;
  /** An API key selection expression. Supported only for WebSocket APIs. See [API Key Selection Expressions](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-selection-expressions.html#apigateway-websocket-api-apikey-selection-expressions). */
  ...
  body: unknown;
  /** The ``BodyS3Location`` property specifies an S3 location from which to import an OpenAPI definition. Supported only for HTTP APIs. */
  bodyS3Location: GatewayV2Api_BodyS3Location;
  /** The ``Cors`` property specifies a CORS configuration for an API. Supported only for HTTP APIs. See [Configuring CORS](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-cors.html) for more information. */
  corsConfiguration: GatewayV2Api_CorsConfiguration;
  /** This property is part of quick create. It specifies the credentials required for the integration, if any. For a Lambda integration, three options are available. To specify an IAM Role for API Gateway to assume, use the role's Amazon Resource Name (ARN). To require that the caller's identity be passed through from the request, specify ``arn:aws:iam::*:user/*``. To use resource-based permissions on supported AWS services, specify ``null``. Currently, this property is not used for HTTP integrations. Supported only for HTTP APIs. */
...
export const GatewayV2Api: ResourceBinding<GatewayV2ApiConfig, GatewayV2ApiAttrs> = {
