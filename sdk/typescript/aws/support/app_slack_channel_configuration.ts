...
export interface AppSlackChannelConfigurationConfig {
...
export interface AppSlackChannelConfigurationAttrs {
  /** The channel ID in Slack, which identifies a channel within a workspace. */
  channelId: string;
  /** The channel name in Slack. */
  channelName: string;
...
export const AppSlackChannelConfiguration: ResourceBinding<AppSlackChannelConfigurationConfig, AppSlackChannelConfigurationAttrs> = {
