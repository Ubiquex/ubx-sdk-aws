...
export interface AutoScalingConfiguration_Tags {
...
const AutoScalingConfiguration_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface AutoScalingConfigurationConfig {
  ...
  tags?: AutoScalingConfiguration_Tags[] | Computed<AutoScalingConfiguration_Tags[]>;
}

export interface AutoScalingConfigurationAttrs {
  ...
  minSize: number;
  /** A list of metadata items that you can associate with your auto scaling configuration resource. A tag is a key-value pair. */
  tags: AutoScalingConfiguration_Tags[];
}

export const AutoScalingConfiguration: ResourceBinding<AutoScalingConfigurationConfig, AutoScalingConfigurationAttrs> = {
