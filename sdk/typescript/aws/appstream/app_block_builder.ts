...
export interface AppBlockBuilder_AccessEndpoints {
...
export interface AppBlockBuilder_Tags {
...
export interface AppBlockBuilder_VpcConfig {
...
const AppBlockBuilder_AccessEndpointsFields: FieldMap = {
  endpointType: "endpoint_type",
  vpceId: "vpce_id",
};

const AppBlockBuilder_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

const AppBlockBuilder_VpcConfigFields: FieldMap = {
  securityGroupIds: "security_group_ids",
  subnetIds: "subnet_ids",
};

export interface AppBlockBuilderConfig {
  ...
  accessEndpoints?: AppBlockBuilder_AccessEndpoints[] | Computed<AppBlockBuilder_AccessEndpoints[]>;
  ...
  tags?: AppBlockBuilder_Tags[] | Computed<AppBlockBuilder_Tags[]>;
  ...
  vpcConfig: AppBlockBuilder_VpcConfig | Computed<AppBlockBuilder_VpcConfig>;
}

export interface AppBlockBuilderAttrs {
  /** Specifies a list of VPC interface endpoints (each with an endpoint type and VPC endpoint ID) that enable private connectivity to the AppStream 2.0 App Block Builder without traversing the public internet. (AI-inferred) */
  accessEndpoints: AppBlockBuilder_AccessEndpoints[];
  /** Specifies the list of ARNs of AppStream 2.0 app blocks to associate with this app block builder, providing the source applications and content used to build new app blocks. (AI-inferred) */
  appBlockArns: string[];
  ...
  platform: string;
  /** Assigns metadata key-value pairs to the AppStream app block builder, enabling cost tracking, resource organization, and IAM-based access control. (AI-inferred) */
  tags: AppBlockBuilder_Tags[];
  /** Specifies the VPC configuration for the AppStream 2.0 app block builder, including the security group IDs and subnet IDs that define the network environment in which the builder runs. (AI-inferred) */
  vpcConfig: AppBlockBuilder_VpcConfig;
}

export const AppBlockBuilder: ResourceBinding<AppBlockBuilderConfig, AppBlockBuilderAttrs> = {
