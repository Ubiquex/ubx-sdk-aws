...
export interface Application_IconS3Location {
...
const Application_IconS3LocationFields: FieldMap = {
  s3Bucket: "s3_bucket",
  s3Key: "s3_key",
};
...
export interface ApplicationConfig {
  ...
  iconS3Location: Application_IconS3Location | Computed<Application_IconS3Location>;
...
export interface ApplicationAttrs {
  ...
  displayName: string;
  /** Specifies the S3 bucket and key where the application's icon image file is stored. (AI-inferred) */
  iconS3Location: Application_IconS3Location;
  /** Specifies the list of AppStream 2.0 instance families (e.g., GENERAL_PURPOSE, MEMORY_OPTIMIZED) that this application supports, determining which fleet instance types can launch it. (AI-inferred) */
