...
export interface TransitGatewayPeering_Tags {
...
const TransitGatewayPeering_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface TransitGatewayPeeringConfig {
  ...
  tags?: TransitGatewayPeering_Tags[] | Computed<TransitGatewayPeering_Tags[]>;
...
export interface TransitGatewayPeeringAttrs {
  ...
  state: string;
  /** An array of key-value pairs to apply to this resource. */
  tags: TransitGatewayPeering_Tags[];
  /** The ARN (Amazon Resource Name) of the transit gateway that you will peer to a core network */
