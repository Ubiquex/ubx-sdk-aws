...
export interface AutoScalingGroup_AvailabilityZoneDistribution {
...
export interface AutoScalingGroup_AvailabilityZoneImpairmentPolicy {
...
export interface AutoScalingGroup_CapacityReservationSpecification_CapacityReservationTarget {
...
export interface AutoScalingGroup_CapacityReservationSpecification {
  ...
  capacityReservationTarget?: AutoScalingGroup_CapacityReservationSpecification_CapacityReservationTarget | Computed<AutoScalingGroup_CapacityReservationSpecification_CapacityReservationTarget>;
}

export interface AutoScalingGroup_InstanceLifecyclePolicy_RetentionTriggers {
...
export interface AutoScalingGroup_InstanceLifecyclePolicy {
  ...
  retentionTriggers?: AutoScalingGroup_InstanceLifecyclePolicy_RetentionTriggers | Computed<AutoScalingGroup_InstanceLifecyclePolicy_RetentionTriggers>;
}

export interface AutoScalingGroup_InstanceMaintenancePolicy {
...
export interface AutoScalingGroup_LifecycleHookSpecificationList {
...
export interface AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount {
...
export interface AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_Cpu_References {
...
export interface AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_Cpu {
  ...
  references?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_Cpu_References[] | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_Cpu_References[]>;
}

export interface AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors {
  ...
  cpu?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_Cpu | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_Cpu>;
}

export interface AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements {
  ...
  acceleratorCount?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  acceleratorTotalMemoryMiB?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  baselineEbsBandwidthMbps?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  baselinePerformanceFactors?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors>;
  ...
  memoryGiBperVcpu?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  memoryMiB?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  networkBandwidthGbps?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  networkInterfaceCount?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  totalLocalStorageGb?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
  ...
  vcpuCount?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCount>;
}

export interface AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides {
  ...
  instanceRequirements?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements>;
  ...
  launchTemplateSpecification?: AutoScalingGroup_LaunchTemplate | Computed<AutoScalingGroup_LaunchTemplate>;
...
export interface AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate {
  ...
  overrides?: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides[] | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides[]>;
}
...
export interface AutoScalingGroup_MixedInstancesPolicy {
  ...
  instancesDistribution?: AutoScalingGroup_MixedInstancesPolicy_InstancesDistribution | Computed<AutoScalingGroup_MixedInstancesPolicy_InstancesDistribution>;
  ...
  launchTemplate: AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate | Computed<AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate>;
}
...
export interface AutoScalingGroup_Tags {
...
export interface AutoScalingGroup_TrafficSources {
...
const AutoScalingGroup_AvailabilityZoneDistributionFields: FieldMap = {
  capacityDistributionStrategy: "capacity_distribution_strategy",
};

const AutoScalingGroup_AvailabilityZoneImpairmentPolicyFields: FieldMap = {
  impairedZoneHealthCheckBehavior: "impaired_zone_health_check_behavior",
  zonalShiftEnabled: "zonal_shift_enabled",
};

const AutoScalingGroup_CapacityReservationSpecification_CapacityReservationTargetFields: FieldMap = {
...
const AutoScalingGroup_CapacityReservationSpecificationFields: FieldMap = {
...
const AutoScalingGroup_InstanceLifecyclePolicy_RetentionTriggersFields: FieldMap = {
  terminateHookAbandon: "terminate_hook_abandon",
};

const AutoScalingGroup_InstanceLifecyclePolicyFields: FieldMap = {
  retentionTriggers: {
...
const AutoScalingGroup_InstanceMaintenancePolicyFields: FieldMap = {
  maxHealthyPercentage: "max_healthy_percentage",
  minHealthyPercentage: "min_healthy_percentage",
};

const AutoScalingGroup_LaunchTemplateFields: FieldMap = {
  launchTemplateId: "launch_template_id",
  launchTemplateName: "launch_template_name",
  version: "version",
};

const AutoScalingGroup_LifecycleHookSpecificationListFields: FieldMap = {
...
const AutoScalingGroup_MetricsCollectionFields: FieldMap = {
...
const AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_AcceleratorCountFields: FieldMap = {
  max: "max",
  min: "min",
};

const AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_Cpu_ReferencesFields: FieldMap = {
  instanceFamily: "instance_family",
};

const AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactors_CpuFields: FieldMap = {
  references: {
    wireName: "references",
    kind: "list",
...
const AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirements_BaselinePerformanceFactorsFields: FieldMap = {
  cpu: {
    wireName: "cpu",
    kind: "object",
...
const AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_Overrides_InstanceRequirementsFields: FieldMap = {
  acceleratorCount: {
...
const AutoScalingGroup_MixedInstancesPolicy_LaunchTemplate_OverridesFields: FieldMap = {
  imageId: "image_id",
...
const AutoScalingGroup_MixedInstancesPolicy_LaunchTemplateFields: FieldMap = {
  launchTemplateSpecification: {
    wireName: "launch_template_specification",
    kind: "object",
    fields: AutoScalingGroup_LaunchTemplateFields,
...
const AutoScalingGroup_MixedInstancesPolicyFields: FieldMap = {
...
const AutoScalingGroup_NotificationConfigurationFields: FieldMap = {
  notificationTypes: "notification_types",
  topicArn: "topic_arn",
};

const AutoScalingGroup_TagsFields: FieldMap = {
  key: "key",
  propagateAtLaunch: "propagate_at_launch",
  value: "value",
};

const AutoScalingGroup_TrafficSourcesFields: FieldMap = {
...
export interface AutoScalingGroupConfig {
  ...
  availabilityZoneDistribution?: AutoScalingGroup_AvailabilityZoneDistribution | Computed<AutoScalingGroup_AvailabilityZoneDistribution>;
  ...
  availabilityZoneImpairmentPolicy?: AutoScalingGroup_AvailabilityZoneImpairmentPolicy | Computed<AutoScalingGroup_AvailabilityZoneImpairmentPolicy>;
  ...
  capacityReservationSpecification?: AutoScalingGroup_CapacityReservationSpecification | Computed<AutoScalingGroup_CapacityReservationSpecification>;
  /** Reserved. */
  ...
  instanceLifecyclePolicy?: AutoScalingGroup_InstanceLifecyclePolicy | Computed<AutoScalingGroup_InstanceLifecyclePolicy>;
  ...
  instanceMaintenancePolicy?: AutoScalingGroup_InstanceMaintenancePolicy | Computed<AutoScalingGroup_InstanceMaintenancePolicy>;
  ...
  /** Specifies a launch template to use when provisioning EC2 instances for an Auto Scaling group. You must specify the following: + The ID or the name of the launch template, but not both. + The version of the launch template. ``LaunchTemplateSpecification`` is property of the [AWS::AutoScaling::AutoScalingGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-autoscaling-autoscalinggroup.html) resource. It is also a property of the [AWS::AutoScaling::AutoScalingGroup LaunchTemplate](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-launchtemplate.html) and [AWS::AutoScaling::AutoScalingGroup LaunchTemplateOverrides](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-launchtemplateoverrides.html) property types. For information about creating a launch template, see [AWS::EC2::LaunchTemplate](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html) and [Create a launch template for an Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-launch-template.html) in the *Amazon EC2 Auto Scaling User Guide*. For examples of launch templates, see [Create launch templates](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/quickref-ec2-launch-templates.html). */
  launchTemplate?: AutoScalingGroup_LaunchTemplate | Computed<AutoScalingGroup_LaunchTemplate>;
  /** One or more lifecycle hooks to add to the Auto Scaling group before instances are launched. */
  lifecycleHookSpecificationList?: AutoScalingGroup_LifecycleHookSpecificationList[] | Computed<AutoScalingGroup_LifecycleHookSpecificationList[]>;
  ...
  metricsCollection?: AutoScalingGroup_MetricsCollection[] | Computed<AutoScalingGroup_MetricsCollection[]>;
  ...
  mixedInstancesPolicy?: AutoScalingGroup_MixedInstancesPolicy | Computed<AutoScalingGroup_MixedInstancesPolicy>;
  ...
  notificationConfiguration?: AutoScalingGroup_NotificationConfiguration | Computed<AutoScalingGroup_NotificationConfiguration>;
  /** Configures an Auto Scaling group to send notifications when specified events take place. */
  notificationConfigurations?: AutoScalingGroup_NotificationConfiguration[] | Computed<AutoScalingGroup_NotificationConfiguration[]>;
  ...
  tags?: AutoScalingGroup_Tags[] | Computed<AutoScalingGroup_Tags[]>;
  ...
  trafficSources?: AutoScalingGroup_TrafficSources[] | Computed<AutoScalingGroup_TrafficSources[]>;
...
export interface AutoScalingGroupAttrs {
  ...
  /** Describes the Capacity Reservation preference and targeting options. If you specify ``open`` or ``none`` for ``CapacityReservationPreference``, do not specify a ``CapacityReservationTarget``. */
  capacityReservationSpecification: AutoScalingGroup_CapacityReservationSpecification;
  /** Reserved. */
  context: string;
  /** *Only needed if you use simple scaling policies.* The amount of time, in seconds, between one scaling activity ending and another one starting due to simple scaling policies. For more information, see [Scaling cooldowns for Amazon EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-scaling-cooldowns.html) in the *Amazon EC2 Auto Scaling User Guide*. Default: ``300`` seconds */
  cooldown: string;
  ...
  instanceId: string;
  /** The instance lifecycle policy for the Auto Scaling group. This policy controls instance behavior when an instance transitions through its lifecycle states. Configure retention triggers to specify when instances should move to a ``Retained`` state instead of automatic termination. For more information, see [Control instance retention with instance lifecycle policies](https://docs.aws.amazon.com/autoscaling/ec2/userguide/instance-lifecycle-policy.html) in the *Amazon EC2 Auto Scaling User Guide*. */
  instanceLifecyclePolicy: AutoScalingGroup_InstanceLifecyclePolicy;
  /** ``InstanceMaintenancePolicy`` is a property of the [AWS::AutoScaling::AutoScalingGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-autoscaling-autoscalinggroup.html) resource. For more information, see [Instance maintenance policies](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-maintenance-policy.html) in the *Amazon EC2 Auto Scaling User Guide*. */
  instanceMaintenancePolicy: AutoScalingGroup_InstanceMaintenancePolicy;
  /** The name of the launch configuration to use to launch instances. Required only if you don't specify ``LaunchTemplate``, ``MixedInstancesPolicy``, or ``InstanceId``. */
  launchConfigurationName: string;
  /** Specifies a launch template to use when provisioning EC2 instances for an Auto Scaling group. You must specify the following: + The ID or the name of the launch template, but not both. + The version of the launch template. ``LaunchTemplateSpecification`` is property of the [AWS::AutoScaling::AutoScalingGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-autoscaling-autoscalinggroup.html) resource. It is also a property of the [AWS::AutoScaling::AutoScalingGroup LaunchTemplate](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-launchtemplate.html) and [AWS::AutoScaling::AutoScalingGroup LaunchTemplateOverrides](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-launchtemplateoverrides.html) property types. For information about creating a launch template, see [AWS::EC2::LaunchTemplate](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html) and [Create a launch template for an Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-launch-template.html) in the *Amazon EC2 Auto Scaling User Guide*. For examples of launch templates, see [Create launch templates](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/quickref-ec2-launch-templates.html). */
  launchTemplate: AutoScalingGroup_LaunchTemplate;
  /** One or more lifecycle hooks to add to the Auto Scaling group before instances are launched. */
  lifecycleHookSpecificationList: AutoScalingGroup_LifecycleHookSpecificationList[];
  /** A list of Classic Load Balancers associated with this Auto Scaling group. For Application Load Balancers, Network Load Balancers, and Gateway Load Balancers, specify the ``TargetGroupARNs`` property instead. */
  ...
  /** A structure that specifies an Amazon SNS notification configuration for the ``NotificationConfigurations`` property of the [AWS::AutoScaling::AutoScalingGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-autoscaling-autoscalinggroup.html) resource. For an example template snippet, see [Configure Amazon EC2 Auto Scaling resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/quickref-ec2-auto-scaling.html). For more information, see [Get Amazon SNS notifications when your Auto Scaling group scales](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ASGettingNotifications.html) in the *Amazon EC2 Auto Scaling User Guide*. */
  notificationConfiguration: AutoScalingGroup_NotificationConfiguration;
  /** Configures an Auto Scaling group to send notifications when specified events take place. */
  ...
  /** One or more tags. You can tag your Auto Scaling group and propagate the tags to the Amazon EC2 instances it launches. Tags are not propagated to Amazon EBS volumes. To add tags to Amazon EBS volumes, specify the tags in a launch template but use caution. If the launch template specifies an instance tag with a key that is also specified for the Auto Scaling group, Amazon EC2 Auto Scaling overrides the value of that instance tag with the value specified by the Auto Scaling group. For more information, see [Tag Auto Scaling groups and instances](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-tagging.html) in the *Amazon EC2 Auto Scaling User Guide*. */
  tags: AutoScalingGroup_Tags[];
  /** The Amazon Resource Names (ARN) of the Elastic Load Balancing target groups to associate with the Auto Scaling group. Instances are registered as targets with the target groups. The target groups receive incoming traffic and route requests to one or more registered targets. For more information, see [Use Elastic Load Balancing to distribute traffic across the instances in your Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-load-balancer.html) in the *Amazon EC2 Auto Scaling User Guide*. */
  targetGroupArns: string[];
  /** A policy or a list of policies that are used to select the instance to terminate. These policies are executed in the order that you list them. For more information, see [Configure termination policies for Amazon EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-termination-policies.html) in the *Amazon EC2 Auto Scaling User Guide*. Valid values: ``Default`` | ``AllocationStrategy`` | ``ClosestToNextInstanceHour`` | ``NewestInstance`` | ``OldestInstance`` | ``OldestLaunchConfiguration`` | ``OldestLaunchTemplate`` | ``arn:aws:lambda:region:account-id:function:my-function:my-alias`` */
  terminationPolicies: string[];
  /** The traffic sources associated with this Auto Scaling group. */
  trafficSources: AutoScalingGroup_TrafficSources[];
  /** A list of subnet IDs for a virtual private cloud (VPC) where instances in the Auto Scaling group can be created. If this resource specifies public subnets and is also in a VPC that is defined in the same stack template, you must use the [DependsOn attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html) to declare a dependency on the [VPC-gateway attachment](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpc-gateway-attachment.html). When you update ``VPCZoneIdentifier``, this retains the same Auto Scaling group and replaces old instances with new ones, according to the specified subnets. To control how CloudFormation replaces the instances, add an [UpdatePolicy attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html) to your stack. Set the update policy to ``AutoScalingInstanceRefresh``. For more information, see the [AutoScalingInstanceRefresh policy](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html#cfn-attributes-updatepolicy-instancerefresh). Required to launch instances into a nondefault VPC. If you specify ``VPCZoneIdentifier`` with ``AvailabilityZones``, the subnets that you specify for this property must reside in those Availability Zones. */
  vpczoneIdentifier: string[];
}

export const AutoScalingGroup: ResourceBinding<AutoScalingGroupConfig, AutoScalingGroupAttrs> = {
