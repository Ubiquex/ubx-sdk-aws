...
export interface HookDefaultVersionConfig {
...
export interface HookDefaultVersionAttrs {
...
export const HookDefaultVersion: ResourceBinding<HookDefaultVersionConfig, HookDefaultVersionAttrs> = {
