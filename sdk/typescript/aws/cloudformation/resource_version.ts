...
export interface ResourceVersion_LoggingConfig {
...
const ResourceVersion_LoggingConfigFields: FieldMap = {
  logGroupName: "log_group_name",
  logRoleArn: "log_role_arn",
};

export interface ResourceVersionConfig {
  ...
  loggingConfig?: ResourceVersion_LoggingConfig | Computed<ResourceVersion_LoggingConfig>;
...
export interface ResourceVersionAttrs {
  ...
  /** Specifies the logging configuration for the resource type, including the CloudWatch Logs log group name and the IAM role ARN used to deliver logs from the resource provider. (AI-inferred) */
  loggingConfig: ResourceVersion_LoggingConfig;
...
export const ResourceVersion: ResourceBinding<ResourceVersionConfig, ResourceVersionAttrs> = {
  ...
  fields: {
    ...
    loggingConfig: {
      ...
      kind: "object",
      fields: ResourceVersion_LoggingConfigFields,
    },
