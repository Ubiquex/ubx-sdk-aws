...
export interface TypeActivation_LoggingConfig {
...
const TypeActivation_LoggingConfigFields: FieldMap = {
  logGroupName: "log_group_name",
  logRoleArn: "log_role_arn",
};

export interface TypeActivationConfig {
  ...
  loggingConfig?: TypeActivation_LoggingConfig | Computed<TypeActivation_LoggingConfig>;
...
export interface TypeActivationAttrs {
  ...
  /** Specifies the Amazon CloudWatch Logs log group name and IAM role ARN used to deliver logs for the registered resource type. (AI-inferred) */
  loggingConfig: TypeActivation_LoggingConfig;
  /** The Major Version of the type you want to enable */
  majorVersion: string;
  /** The Amazon Resource Number (ARN) assigned to the public extension upon publication */
...
export const TypeActivation: ResourceBinding<TypeActivationConfig, TypeActivationAttrs> = {
