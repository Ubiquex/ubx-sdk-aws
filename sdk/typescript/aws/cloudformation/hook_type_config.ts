...
export interface HookTypeConfigConfig {
...
export interface HookTypeConfigAttrs {
  /** The configuration data for the extension, in this account and region. */
...
export const HookTypeConfig: ResourceBinding<HookTypeConfigConfig, HookTypeConfigAttrs> = {
