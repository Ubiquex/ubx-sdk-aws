...
export interface LambdaHook_LoggingConfig {
...
export interface LambdaHook_StackFilters_StackNames {
...
export interface LambdaHook_StackFilters_StackRoles {
...
export interface LambdaHook_StackFilters {
  ...
  stackNames?: LambdaHook_StackFilters_StackNames | Computed<LambdaHook_StackFilters_StackNames>;
  /** List of stack roles that are performing the stack operations. */
  stackRoles?: LambdaHook_StackFilters_StackRoles | Computed<LambdaHook_StackFilters_StackRoles>;
}

export interface LambdaHook_TargetFilters_Targets {
...
export interface LambdaHook_TargetFilters {
  ...
  targets?: LambdaHook_TargetFilters_Targets[] | Computed<LambdaHook_TargetFilters_Targets[]>;
}

const LambdaHook_LoggingConfigFields: FieldMap = {
  logGroupName: "log_group_name",
  logRoleArn: "log_role_arn",
};

const LambdaHook_StackFilters_StackNamesFields: FieldMap = {
  exclude: "exclude",
  include: "include",
};

const LambdaHook_StackFilters_StackRolesFields: FieldMap = {
  exclude: "exclude",
  include: "include",
};

const LambdaHook_StackFiltersFields: FieldMap = {
...
const LambdaHook_TargetFilters_TargetsFields: FieldMap = {
  action: "action",
  invocationPoint: "invocation_point",
  targetName: "target_name",
};

const LambdaHook_TargetFiltersFields: FieldMap = {
  actions: "actions",
...
export interface LambdaHookConfig {
  ...
  loggingConfig?: LambdaHook_LoggingConfig | Computed<LambdaHook_LoggingConfig>;
  /** Filters to allow hooks to target specific stack attributes */
  stackFilters?: LambdaHook_StackFilters | Computed<LambdaHook_StackFilters>;
  /** Attribute to specify which targets should invoke the hook */
  targetFilters?: LambdaHook_TargetFilters | Computed<LambdaHook_TargetFilters>;
  /** Which operations should this Hook run against? Resource changes, stacks or change sets. */
  targetOperations: string[] | Computed<string[]>;
}

export interface LambdaHookAttrs {
  /** The typename alias for the hook. */
  alias: string;
  /** Whether to automatically update the extension in this account and Region when a new minor version is published by the extension publisher. */
  autoUpdate: boolean;
  ...
  /** Filters to allow hooks to target specific stack attributes */
  stackFilters: LambdaHook_StackFilters;
  /** Attribute to specify which targets should invoke the hook */
  targetFilters: LambdaHook_TargetFilters;
  /** Which operations should this Hook run against? Resource changes, stacks or change sets. */
  targetOperations: string[];
}

export const LambdaHook: ResourceBinding<LambdaHookConfig, LambdaHookAttrs> = {
