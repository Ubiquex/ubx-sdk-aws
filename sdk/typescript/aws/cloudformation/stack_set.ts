...
export interface StackSet_Parameters {
...
export interface StackSet_StackInstancesGroup_DeploymentTargets {
...
export interface StackSet_StackInstancesGroup {
  ...
  deploymentTargets?: StackSet_StackInstancesGroup_DeploymentTargets | Computed<StackSet_StackInstancesGroup_DeploymentTargets>;
  ...
  parameterOverrides?: StackSet_Parameters[] | Computed<StackSet_Parameters[]>;
...
export interface StackSet_Tags {
...
const StackSet_ParametersFields: FieldMap = {
  parameterKey: "parameter_key",
  parameterValue: "parameter_value",
};

const StackSet_StackInstancesGroup_DeploymentTargetsFields: FieldMap = {
...
const StackSet_StackInstancesGroupFields: FieldMap = {
  deploymentTargets: {
...
const StackSet_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface StackSetConfig {
  ...
  parameters?: StackSet_Parameters[] | Computed<StackSet_Parameters[]>;
  /** Describes how the IAM roles required for stack set operations are created. By default, SELF-MANAGED is specified. */
  permissionModel: string | Computed<string>;
  /** A group of stack instances with parameters in some specific accounts and regions. */
  stackInstancesGroup?: StackSet_StackInstancesGroup[] | Computed<StackSet_StackInstancesGroup[]>;
  /** The name to associate with the stack set. The name must be unique in the Region where you create your stack set. */
  stackSetName: string | Computed<string>;
  /** The key-value pairs to associate with this stack set and the stacks created from it. AWS CloudFormation also propagates these tags to supported resources that are created in the stacks. A maximum number of 50 tags can be specified. */
  tags?: StackSet_Tags[] | Computed<StackSet_Tags[]>;
...
export interface StackSetAttrs {
  ...
  /** A group of stack instances with parameters in some specific accounts and regions. */
  stackInstancesGroup: StackSet_StackInstancesGroup[];
