...
export interface ResourceDefaultVersionConfig {
...
export interface ResourceDefaultVersionAttrs {
...
export const ResourceDefaultVersion: ResourceBinding<ResourceDefaultVersionConfig, ResourceDefaultVersionAttrs> = {
