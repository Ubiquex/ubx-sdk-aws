...
export interface ConnectLag_Tags {
...
const ConnectLag_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface ConnectLagConfig {
  ...
  tags?: ConnectLag_Tags[] | Computed<ConnectLag_Tags[]>;
}

export interface ConnectLagAttrs {
  /** The bandwidth of the individual physical dedicated connections bundled by the LAG. */
  ...
  /** The tags associated with the LAG. */
  tags: ConnectLag_Tags[];
}

export const ConnectLag: ResourceBinding<ConnectLagConfig, ConnectLagAttrs> = {
