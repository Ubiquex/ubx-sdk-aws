...
export interface Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxAgeRule {
...
export interface Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxCountRule {
  /** Set to true to delete a version's source bundle from Amazon S3 when Elastic Beanstalk deletes the application version. */
  deleteSourceFromS3?: boolean | Computed<boolean>;
  /** Specify true to apply the rule, or false to disable it. */
  enabled?: boolean | Computed<boolean>;
...
export interface Application_ResourceLifecycleConfig_VersionLifecycleConfig {
  ...
  maxAgeRule?: Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxAgeRule | Computed<Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxAgeRule>;
  ...
  maxCountRule?: Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxCountRule | Computed<Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxCountRule>;
}

export interface Application_ResourceLifecycleConfig {
  ...
  versionLifecycleConfig?: Application_ResourceLifecycleConfig_VersionLifecycleConfig | Computed<Application_ResourceLifecycleConfig_VersionLifecycleConfig>;
}

const Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxAgeRuleFields: FieldMap = {
  deleteSourceFromS3: "delete_source_from_s3",
  enabled: "enabled",
  maxAgeInDays: "max_age_in_days",
};

const Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxCountRuleFields: FieldMap = {
  deleteSourceFromS3: "delete_source_from_s3",
  enabled: "enabled",
  maxCount: "max_count",
};

const Application_ResourceLifecycleConfig_VersionLifecycleConfigFields: FieldMap = {
  maxAgeRule: {
...
const Application_ResourceLifecycleConfigFields: FieldMap = {
...
export interface ApplicationConfig {
  ...
  resourceLifecycleConfig?: Application_ResourceLifecycleConfig | Computed<Application_ResourceLifecycleConfig>;
}
...
export interface ApplicationAttrs {
  ...
  description: string;
  /** Defines how Elastic Beanstalk manages the lifecycle of application versions, including whether to delete expired versions, how long to retain them, and the service role used for cleanup. (AI-inferred) */
  resourceLifecycleConfig: Application_ResourceLifecycleConfig;
}
