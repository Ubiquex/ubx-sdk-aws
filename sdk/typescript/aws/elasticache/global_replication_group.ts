...
export interface GlobalReplicationGroup_Members {
...
export interface GlobalReplicationGroup_RegionalConfigurations_ReshardingConfigurations {
...
export interface GlobalReplicationGroup_RegionalConfigurations {
  ...
  reshardingConfigurations?: GlobalReplicationGroup_RegionalConfigurations_ReshardingConfigurations[] | Computed<GlobalReplicationGroup_RegionalConfigurations_ReshardingConfigurations[]>;
}

const GlobalReplicationGroup_MembersFields: FieldMap = {
  replicationGroupId: "replication_group_id",
  replicationGroupRegion: "replication_group_region",
  role: "role",
};

const GlobalReplicationGroup_RegionalConfigurations_ReshardingConfigurationsFields: FieldMap = {
  nodeGroupId: "node_group_id",
  preferredAvailabilityZones: "preferred_availability_zones",
};

const GlobalReplicationGroup_RegionalConfigurationsFields: FieldMap = {
  replicationGroupId: "replication_group_id",
  replicationGroupRegion: "replication_group_region",
...
export interface GlobalReplicationGroupConfig {
  ...
  members: GlobalReplicationGroup_Members[] | Computed<GlobalReplicationGroup_Members[]>;
  /** Describes the replication group IDs, the AWS regions where they are stored and the shard configuration for each that comprise the Global Datastore */
  regionalConfigurations?: GlobalReplicationGroup_RegionalConfigurations[] | Computed<GlobalReplicationGroup_RegionalConfigurations[]>;
}
...
export interface GlobalReplicationGroupAttrs {
  ...
  /** The replication groups that comprise the Global Datastore. */
  members: GlobalReplicationGroup_Members[];
  /** Describes the replication group IDs, the AWS regions where they are stored and the shard configuration for each that comprise the Global Datastore */
  regionalConfigurations: GlobalReplicationGroup_RegionalConfigurations[];
