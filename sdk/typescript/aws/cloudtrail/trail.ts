...
export interface Trail_AdvancedEventSelectors_FieldSelectors {
...
export interface Trail_AdvancedEventSelectors {
  ...
  fieldSelectors?: Trail_AdvancedEventSelectors_FieldSelectors[] | Computed<Trail_AdvancedEventSelectors_FieldSelectors[]>;
...
export interface Trail_AggregationConfigurations {
...
export interface Trail_EventSelectors_DataResources {
...
export interface Trail_EventSelectors {
  ...
  dataResources?: Trail_EventSelectors_DataResources[] | Computed<Trail_EventSelectors_DataResources[]>;
...
export interface Trail_InsightSelectors {
...
const Trail_AdvancedEventSelectors_FieldSelectorsFields: FieldMap = {
  endsWith: "ends_with",
  equals: "equals",
  field: "field",
...
const Trail_AdvancedEventSelectorsFields: FieldMap = {
  fieldSelectors: {
...
const Trail_AggregationConfigurationsFields: FieldMap = {
  eventCategory: "event_category",
  templates: "templates",
};

const Trail_EventSelectors_DataResourcesFields: FieldMap = {
  type: "type",
  values: "values",
};

const Trail_EventSelectorsFields: FieldMap = {
  dataResources: {
...
const Trail_InsightSelectorsFields: FieldMap = {
  eventCategories: "event_categories",
  insightType: "insight_type",
};

const Trail_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface TrailConfig {
  ...
  advancedEventSelectors?: Trail_AdvancedEventSelectors[] | Computed<Trail_AdvancedEventSelectors[]>;
  ...
  aggregationConfigurations?: Trail_AggregationConfigurations[] | Computed<Trail_AggregationConfigurations[]>;
  ...
  eventSelectors?: Trail_EventSelectors[] | Computed<Trail_EventSelectors[]>;
  /** Specifies whether the trail is publishing events from global services such as IAM to the log files. */
  includeGlobalServiceEvents?: boolean | Computed<boolean>;
  /** Lets you enable Insights event logging by specifying the Insights selectors that you want to enable on an existing trail. */
  insightSelectors?: Trail_InsightSelectors[] | Computed<Trail_InsightSelectors[]>;
  ...
  tags?: Trail_Tags[] | Computed<Trail_Tags[]>;
...
export interface TrailAttrs {
  /** The advanced event selectors that were used to select events for the data store. */
  advancedEventSelectors: Trail_AdvancedEventSelectors[];
  /** Specifies the aggregation configuration to aggregate CloudTrail Events. A maximum of 1 aggregation configuration is allowed. */
  aggregationConfigurations: Trail_AggregationConfigurations[];
  ...
  /** Lets you enable Insights event logging by specifying the Insights selectors that you want to enable on an existing trail. */
  insightSelectors: Trail_InsightSelectors[];
  /** Whether the CloudTrail is currently logging AWS API calls. */
  isLogging: boolean;
  /** Specifies whether the trail applies only to the current region or to all regions. The default is false. If the trail exists only in the current region and this value is set to true, shadow trails (replications of the trail) will be created in the other regions. If the trail exists in all regions and this value is set to false, the trail will remain in the region where it was created, and its shadow trails in other regions will be deleted. As a best practice, consider using trails that log events in all regions. */
...
export const Trail: ResourceBinding<TrailConfig, TrailAttrs> = {
