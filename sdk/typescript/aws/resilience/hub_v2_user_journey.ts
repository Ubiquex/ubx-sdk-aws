...
export interface HubV2UserJourneyConfig {
...
export interface HubV2UserJourneyAttrs {
...
export const HubV2UserJourney: ResourceBinding<HubV2UserJourneyConfig, HubV2UserJourneyAttrs> = {
