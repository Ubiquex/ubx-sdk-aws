...
export interface Firewall_AvailabilityZoneMappings {
...
export interface Firewall_SubnetMappings {
...
export interface Firewall_Tags {
...
const Firewall_AvailabilityZoneMappingsFields: FieldMap = {
  availabilityZone: "availability_zone",
};

const Firewall_SubnetMappingsFields: FieldMap = {
  ipaddressType: "ipaddress_type",
  subnetId: "subnet_id",
};

const Firewall_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};
...
export interface FirewallConfig {
  ...
  availabilityZoneMappings?: Firewall_AvailabilityZoneMappings[] | Computed<Firewall_AvailabilityZoneMappings[]>;
...
export interface FirewallAttrs {
  ...
  /** Specifies the Availability Zones and subnet IDs where the firewall endpoints are created, enabling network traffic filtering in those zones. (AI-inferred) */
  availabilityZoneMappings: Firewall_AvailabilityZoneMappings[];
  /** Whether the firewall is protected from deletion, so you cannot delete it without first disabling this setting. (AI-inferred) */
  ...
  /** Specifies the subnets within the VPC where the Network Firewall endpoint is attached, enabling the firewall to filter traffic for each associated subnet. (AI-inferred) */
  subnetMappings: Firewall_SubnetMappings[];
  tags: Firewall_Tags[];
