...
export interface Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValue {
...
export interface Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue {
  ...
  claimMatchValue?: Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValue | Computed<Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValue>;
}

export interface Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims {
  ...
  authorizingClaimMatchValue?: Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue | Computed<Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue>;
...
export interface Gateway_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint {
  ...
  managedVpcResource?: Gateway_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_ManagedVpcResource | Computed<Gateway_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_ManagedVpcResource>;
  selfManagedLatticeResource?: Gateway_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_SelfManagedLatticeResource | Computed<Gateway_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint_SelfManagedLatticeResource>;
}
...
export interface Gateway_AuthorizerConfiguration_CustomJwtauthorizer {
  ...
  customClaims?: Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims[] | Computed<Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims[]>;
  ...
  privateEndpoint?: Gateway_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint | Computed<Gateway_AuthorizerConfiguration_CustomJwtauthorizer_PrivateEndpoint>;
}

export interface Gateway_AuthorizerConfiguration {
  customJwtauthorizer?: Gateway_AuthorizerConfiguration_CustomJwtauthorizer | Computed<Gateway_AuthorizerConfiguration_CustomJwtauthorizer>;
}

export interface Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilter_Exclude {
...
export interface Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilter {
  exclude?: Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilter_Exclude[] | Computed<Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilter_Exclude[]>;
}

export interface Gateway_InterceptorConfigurations_InputConfiguration {
  ...
  payloadFilter?: Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilter | Computed<Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilter>;
}

export interface Gateway_InterceptorConfigurations_Interceptor_Lambda {
  arn?: string | Computed<string>;
}

export interface Gateway_InterceptorConfigurations_Interceptor {
  ...
  lambda?: Gateway_InterceptorConfigurations_Interceptor_Lambda | Computed<Gateway_InterceptorConfigurations_Interceptor_Lambda>;
}

export interface Gateway_InterceptorConfigurations {
  inputConfiguration?: Gateway_InterceptorConfigurations_InputConfiguration | Computed<Gateway_InterceptorConfigurations_InputConfiguration>;
  ...
  interceptor?: Gateway_InterceptorConfigurations_Interceptor | Computed<Gateway_InterceptorConfigurations_Interceptor>;
}
...
export interface Gateway_ProtocolConfiguration_Mcp {
  ...
  sessionConfiguration?: Gateway_ProtocolConfiguration_Mcp_SessionConfiguration | Computed<Gateway_ProtocolConfiguration_Mcp_SessionConfiguration>;
  ...
  streamingConfiguration?: Gateway_ProtocolConfiguration_Mcp_StreamingConfiguration | Computed<Gateway_ProtocolConfiguration_Mcp_StreamingConfiguration>;
...
export interface Gateway_ProtocolConfiguration {
  mcp?: Gateway_ProtocolConfiguration_Mcp | Computed<Gateway_ProtocolConfiguration_Mcp>;
}
...
const Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValueFields: FieldMap = {
  matchValueString: "match_value_string",
  matchValueStringList: "match_value_string_list",
};

const Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValueFields: FieldMap = {
...
const Gateway_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaimsFields: FieldMap = {
...
const Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilter_ExcludeFields: FieldMap = {
  field: "field",
};

const Gateway_InterceptorConfigurations_InputConfiguration_PayloadFilterFields: FieldMap = {
  exclude: {
    wireName: "exclude",
    kind: "list",
...
const Gateway_InterceptorConfigurations_InputConfigurationFields: FieldMap = {
...
const Gateway_InterceptorConfigurations_Interceptor_LambdaFields: FieldMap = {
  arn: "arn",
};

const Gateway_InterceptorConfigurations_InterceptorFields: FieldMap = {
  lambda: {
    wireName: "lambda",
    kind: "object",
...
const Gateway_InterceptorConfigurationsFields: FieldMap = {
  inputConfiguration: {
