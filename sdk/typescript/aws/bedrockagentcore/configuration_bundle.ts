...
export interface ConfigurationBundle_CreatedBy {
...
export interface ConfigurationBundle_LineageMetadata {
  ...
  createdBy?: ConfigurationBundle_CreatedBy | Computed<ConfigurationBundle_CreatedBy>;
  /** A list of parent version identifiers. */
  parentVersionIds?: string[] | Computed<string[]>;
}

export interface ConfigurationBundle_Tags {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

const ConfigurationBundle_CreatedByFields: FieldMap = {
  arn: "arn",
  name: "name",
};

const ConfigurationBundle_TagsFields: FieldMap = {
  key: "key",
  value: "value",
};

export interface ConfigurationBundleConfig {
  ...
  tags?: ConfigurationBundle_Tags[] | Computed<ConfigurationBundle_Tags[]>;
}

export interface ConfigurationBundleAttrs {
  /** The branch name for version tracking. */
  branchName: string;
  ...
  createdAt: string;
  /** The source that created a configuration bundle version. */
  createdBy: ConfigurationBundle_CreatedBy;
  /** The description for the configuration bundle. */
  description: string;
  /** The ARN of the KMS key used to encrypt component configurations. */
  kmsKeyArn: string;
  /** The version lineage metadata that tracks parent versions and creation source. */
  lineageMetadata: ConfigurationBundle_LineageMetadata;
  /** Tags to assign to the configuration bundle. */
  tags: ConfigurationBundle_Tags[];
...
export const ConfigurationBundle: ResourceBinding<ConfigurationBundleConfig, ConfigurationBundleAttrs> = {
