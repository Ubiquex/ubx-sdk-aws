...
type SourceLocation_AccessConfiguration_SecretsManagerAccessTokenConfiguration struct {
...
type SourceLocation_SegmentDeliveryConfigurations struct {
...
type SourceLocation_Tags struct {
...
type SourceLocationAttrs struct {
	// <p>Access configuration parameters.</p>
	AccessConfiguration any
...
var SourceLocation = ubx.ResourceBinding{
