...
type DataSet_DataSetRefreshProperties_FailureConfiguration_EmailAlert struct {
...
type DataSet_DataSetRefreshProperties_FailureConfiguration struct {
	// Configures email notifications to specified recipients when a dataset refresh fails. (AI-inferred)
	EmailAlert any
}

type DataSet_DataSetRefreshProperties_RefreshConfiguration_IncrementalRefresh_LookbackWindow struct {
...
type DataSet_DataSetRefreshProperties_RefreshConfiguration_IncrementalRefresh struct {
	// <p>The lookback window setup of an incremental refresh configuration.</p>
	LookbackWindow any
}

type DataSet_DataSetRefreshProperties_RefreshConfiguration struct {
...
type DataSet_DatasetParameters_DateTimeDatasetParameter_DefaultValues struct {
...
type DataSet_DatasetParameters_DateTimeDatasetParameter struct {
...
type DataSet_DatasetParameters_DecimalDatasetParameter_DefaultValues struct {
...
type DataSet_DatasetParameters_DecimalDatasetParameter struct {
...
type DataSet_DatasetParameters struct {
...
type DataSet_PerformanceConfiguration_UniqueKeys struct {
...
type DataSet_SemanticModelConfiguration_SemanticMetadata_CustomInstructions_InlineCustomInstruction_UploadedDocumentMetadata struct {
...
type DataSet_SemanticModelConfiguration_SemanticMetadata_CustomInstructions_InlineCustomInstruction struct {
...
type DataSet_SemanticModelConfiguration_SemanticMetadata_CustomInstructions struct {
...
type DataSet_SemanticModelConfiguration_SemanticMetadata_Description struct {
...
type DataSet_SemanticModelConfiguration_SemanticMetadata struct {
