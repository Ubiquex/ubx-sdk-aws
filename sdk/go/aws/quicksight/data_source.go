...
type DataSource_AlternateDataSourceParameters_AmazonElasticsearchParameters struct {
...
type DataSource_AlternateDataSourceParameters_AthenaParameters_IdentityCenterConfiguration struct {
...
type DataSource_AlternateDataSourceParameters_AthenaParameters struct {
...
type DataSource_AlternateDataSourceParameters_AuroraParameters struct {
...
type DataSource_AlternateDataSourceParameters_DatabricksParameters struct {
...
type DataSource_AlternateDataSourceParameters_OracleParameters struct {
...
type DataSource_AlternateDataSourceParameters_PrestoParameters struct {
...
type DataSource_AlternateDataSourceParameters_RdsParameters struct {
...
type DataSource_AlternateDataSourceParameters_RedshiftParameters_Iamparameters struct {
...
type DataSource_AlternateDataSourceParameters_RedshiftParameters struct {
...
type DataSource_AlternateDataSourceParameters_S3Parameters_ManifestFileLocation struct {
...
type DataSource_AlternateDataSourceParameters_S3Parameters struct {
...
type DataSource_AlternateDataSourceParameters_S3TablesParameters struct {
	// The ARN of the S3 table bucket that QuickSight connects to for querying the S3 Tables-backed Iceberg table. (AI-inferred)
	TableBucketArn any
}

type DataSource_AlternateDataSourceParameters_SnowflakeParameters_OauthParameters_IdentityProviderVpcConnectionProperties struct {
...
type DataSource_AlternateDataSourceParameters_SnowflakeParameters_OauthParameters struct {
...
type DataSource_AlternateDataSourceParameters_SnowflakeParameters struct {
...
type DataSource_AlternateDataSourceParameters_SparkParameters struct {
...
type DataSource_AlternateDataSourceParameters_StarburstParameters struct {
...
type DataSource_AlternateDataSourceParameters struct {
...
type DataSource_Credentials_KeyPairCredentials struct {
...
type DataSource_ErrorInfo struct {
	// <p>Error message.</p>
	Message any
...
type DataSource_Permissions struct {
