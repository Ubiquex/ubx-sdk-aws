...
type Service_Assertions struct {
	Text any
}

type Service_AssociatedSystems struct {
...
type Service_EffectivePolicyValues_AvailabilitySlo struct {
...
type Service_InputSources_ResourceConfiguration_Eks struct {
...
type Service_InputSources_ResourceConfiguration struct {
...
type Service_InputSources struct {
	ResourceConfiguration any
}

type Service_PermissionModel_CrossAccountRoleArns struct {
...
type Service_ReportConfiguration_ReportOutput_S3 struct {
...
type Service_ReportConfiguration_ReportOutput struct {
...
type Service_ReportConfiguration struct {
