...
type Bridge_Outputs_NetworkOutput struct {
...
type Bridge_SourceFailoverConfig_SourcePriority struct {
	// The name of the source you choose as the primary source for this flow.
	PrimarySource any
}

type Bridge_SourceFailoverConfig struct {
...
type Bridge_Sources_FlowSource_FlowVpcInterfaceAttachment struct {
...
type Bridge_Sources_FlowSource struct {
...
type Bridge_Sources_NetworkSource_MulticastSourceSettings struct {
...
type Bridge_Sources_NetworkSource struct {
...
var Bridge = ubx.ResourceBinding{
