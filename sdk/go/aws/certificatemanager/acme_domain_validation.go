...
type AcmeDomainValidation_PrevalidationOptions_DnsPrevalidation_DomainScope struct {
...
type AcmeDomainValidation_PrevalidationOptions_DnsPrevalidation struct {
...
type AcmeDomainValidation_PrevalidationOptions struct {
...
type AcmeDomainValidationAttrs struct {
	// The ARN of the ACME endpoint this domain validation is associated with.
	AcmeEndpointArn any
...
var AcmeDomainValidation = ubx.ResourceBinding{
