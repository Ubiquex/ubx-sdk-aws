...
type AcmeEndpoint_CertificateAuthority_PublicCertificateAuthority struct {
	// The allowed key algorithms for certificates issued via this endpoint.
	AllowedKeyAlgorithms any
}

type AcmeEndpoint_CertificateAuthority struct {
...
var AcmeEndpoint = ubx.ResourceBinding{
