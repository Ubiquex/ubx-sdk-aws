...
type AgentCoreConfigurationBundle_CreatedBy struct {
...
type AgentCoreConfigurationBundle_LineageMetadata struct {
...
type AgentCoreConfigurationBundle_Tags struct {
	Key any
	Value any
}

var AgentCoreConfigurationBundle_CreatedByFields = ubx.FieldMap{
		"Arn": ubx.FieldSpec{WireName: "arn"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var AgentCoreConfigurationBundle_TagsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

type AgentCoreConfigurationBundleConfig struct {
...
type AgentCoreConfigurationBundleAttrs struct {
	// The branch name for version tracking.
	BranchName any
...
var AgentCoreConfigurationBundle = ubx.ResourceBinding{
