...
type WirelessDevice_LoRaWan_AbpV10x_SessionKeys struct {
...
type WirelessDevice_LoRaWan_AbpV10x struct {
...
type WirelessDevice_LoRaWan_AbpV11_SessionKeys struct {
...
type WirelessDevice_LoRaWan_AbpV11 struct {
...
type WirelessDevice_LoRaWan_Fports_Applications struct {
...
type WirelessDevice_LoRaWan_Fports struct {
	// A list of optional LoRaWAN application information, which can be used for geolocation.
	Applications any
}

type WirelessDevice_LoRaWan_OtaaV10x struct {
...
type WirelessDevice_LoRaWan_OtaaV11 struct {
...
type WirelessDevice_LoRaWan struct {
...
type WirelessDevice_Tags struct {
...
type WirelessDeviceAttrs struct {
