...
type Template_LaunchTemplateData_BlockDeviceMappings_Ebs struct {
...
type Template_LaunchTemplateData_BlockDeviceMappings struct {
...
type Template_LaunchTemplateData_CapacityReservationSpecification_CapacityReservationTarget struct {
...
type Template_LaunchTemplateData_CapacityReservationSpecification struct {
...
type Template_LaunchTemplateData_CpuOptions struct {
...
type Template_LaunchTemplateData_CreditSpecification struct {
	// The credit option for CPU usage of a T instance. Valid values: ``standard`` | ``unlimited``
	CpuCredits any
}

type Template_LaunchTemplateData_EnclaveOptions struct {
	// If this parameter is set to ``true``, the instance is enabled for AWS Nitro Enclaves; otherwise, it is not enabled for AWS Nitro Enclaves.
	Enabled any
}

type Template_LaunchTemplateData_HibernationOptions struct {
	// If you set this parameter to ``true``, the instance is enabled for hibernation. Default: ``false``
	Configured any
}

type Template_LaunchTemplateData_IamInstanceProfile struct {
...
type Template_LaunchTemplateData_InstanceMarketOptions_SpotOptions struct {
	// Deprecated.
...
type Template_LaunchTemplateData_InstanceMarketOptions struct {
	// The market type.
	MarketType any
...
type Template_LaunchTemplateData_InstanceRequirements_AcceleratorCount struct {
...
type Template_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu_References struct {
...
type Template_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu struct {
...
type Template_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors struct {
	// Specifies the CPU performance to consider when using an instance family as the baseline reference.
	Cpu any
}

type Template_LaunchTemplateData_InstanceRequirements struct {
...
type Template_LaunchTemplateData_LicenseSpecifications struct {
...
type Template_LaunchTemplateData_MaintenanceOptions struct {
	// Disables the automatic recovery behavior of your instance or sets it to default.
	AutoRecovery any
}

type Template_LaunchTemplateData_MetadataOptions struct {
...
type Template_LaunchTemplateData_NetworkInterfaces_ConnectionTrackingSpecification struct {
...
type Template_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification_EnaSrdUdpSpecification struct {
...
type Template_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification struct {
...
type Template_LaunchTemplateData_NetworkInterfaces_Ipv4Prefixes struct {
...
type Template_LaunchTemplateData_NetworkInterfaces_Ipv6Addresses struct {
	// Specifies an IPv6 address to assign to the network interface when the instance launches. (AI-inferred)
	Ipv6Address any
}

type Template_LaunchTemplateData_NetworkInterfaces_Ipv6Prefixes struct {
...
type Template_LaunchTemplateData_NetworkInterfaces_PrivateIpAddresses struct {
...
type Template_LaunchTemplateData_NetworkInterfaces struct {
...
type Template_LaunchTemplateData_NetworkPerformanceOptions struct {
...
type Template_LaunchTemplateData_Placement struct {
...
type Template_LaunchTemplateData_PrivateDnsNameOptions struct {
...
type Template_LaunchTemplateData_TagSpecifications_Tags struct {
...
type Template_LaunchTemplateData_TagSpecifications struct {
...
type Template_LaunchTemplateData struct {
...
var Template_LaunchTemplateData_BlockDeviceMappings_EbsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_BlockDeviceMappingsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_CapacityReservationSpecification_CapacityReservationTargetFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_CapacityReservationSpecificationFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_CpuOptionsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_CreditSpecificationFields = ubx.FieldMap{
		"CpuCredits": ubx.FieldSpec{WireName: "cpu_credits"},
	}

var Template_LaunchTemplateData_EnclaveOptionsFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var Template_LaunchTemplateData_HibernationOptionsFields = ubx.FieldMap{
		"Configured": ubx.FieldSpec{WireName: "configured"},
	}

var Template_LaunchTemplateData_IamInstanceProfileFields = ubx.FieldMap{
		"Arn": ubx.FieldSpec{WireName: "arn"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var Template_LaunchTemplateData_InstanceMarketOptions_SpotOptionsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_InstanceMarketOptionsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_InstanceRequirements_AcceleratorCountFields = ubx.FieldMap{
		"Max": ubx.FieldSpec{WireName: "max"},
		"Min": ubx.FieldSpec{WireName: "min"},
	}

var Template_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu_ReferencesFields = ubx.FieldMap{
		"InstanceFamily": ubx.FieldSpec{WireName: "instance_family"},
	}

var Template_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_CpuFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactorsFields = ubx.FieldMap{
		"Cpu": ubx.FieldSpec{
			WireName: "cpu",
			Kind: "object",
...
var Template_LaunchTemplateData_InstanceRequirementsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_LicenseSpecificationsFields = ubx.FieldMap{
		"LicenseConfigurationArn": ubx.FieldSpec{WireName: "license_configuration_arn"},
	}

var Template_LaunchTemplateData_MaintenanceOptionsFields = ubx.FieldMap{
		"AutoRecovery": ubx.FieldSpec{WireName: "auto_recovery"},
	}

var Template_LaunchTemplateData_MetadataOptionsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_NetworkInterfaces_ConnectionTrackingSpecificationFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification_EnaSrdUdpSpecificationFields = ubx.FieldMap{
		"EnaSrdUdpEnabled": ubx.FieldSpec{WireName: "ena_srd_udp_enabled"},
	}

var Template_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecificationFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_NetworkInterfaces_Ipv4PrefixesFields = ubx.FieldMap{
		"Ipv4Prefix": ubx.FieldSpec{WireName: "ipv4_prefix"},
	}

var Template_LaunchTemplateData_NetworkInterfaces_Ipv6AddressesFields = ubx.FieldMap{
		"Ipv6Address": ubx.FieldSpec{WireName: "ipv6_address"},
	}

var Template_LaunchTemplateData_NetworkInterfaces_Ipv6PrefixesFields = ubx.FieldMap{
		"Ipv6Prefix": ubx.FieldSpec{WireName: "ipv6_prefix"},
	}

var Template_LaunchTemplateData_NetworkInterfaces_PrivateIpAddressesFields = ubx.FieldMap{
		"Primary": ubx.FieldSpec{WireName: "primary"},
		"PrivateIpAddress": ubx.FieldSpec{WireName: "private_ip_address"},
	}

var Template_LaunchTemplateData_NetworkInterfacesFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_NetworkPerformanceOptionsFields = ubx.FieldMap{
		"BandwidthWeighting": ubx.FieldSpec{WireName: "bandwidth_weighting"},
	}

var Template_LaunchTemplateData_PlacementFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_PrivateDnsNameOptionsFields = ubx.FieldMap{
...
var Template_LaunchTemplateData_TagSpecifications_TagsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var Template_LaunchTemplateData_TagSpecificationsFields = ubx.FieldMap{
...
var Template_LaunchTemplateDataFields = ubx.FieldMap{
