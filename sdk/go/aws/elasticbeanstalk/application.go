...
type Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxAgeRule struct {
...
type Application_ResourceLifecycleConfig_VersionLifecycleConfig_MaxCountRule struct {
	// Set to true to delete a version's source bundle from Amazon S3 when Elastic Beanstalk deletes the application version.
	DeleteSourceFromS3 any
	// Specify true to apply the rule, or false to disable it.
	Enabled any
...
type Application_ResourceLifecycleConfig_VersionLifecycleConfig struct {
...
type Application_ResourceLifecycleConfig struct {
