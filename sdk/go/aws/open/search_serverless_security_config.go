...
type SearchServerlessSecurityConfig_IamFederationOptions struct {
...
type SearchServerlessSecurityConfig_IamIdentityCenterOptions struct {
...
type SearchServerlessSecurityConfig_SamlOptions struct {
...
var SearchServerlessSecurityConfig_IamFederationOptionsFields = ubx.FieldMap{
		"GroupAttribute": ubx.FieldSpec{WireName: "group_attribute"},
		"UserAttribute": ubx.FieldSpec{WireName: "user_attribute"},
	}

var SearchServerlessSecurityConfig_SamlOptionsFields = ubx.FieldMap{
		"GroupAttribute": ubx.FieldSpec{WireName: "group_attribute"},
...
type SearchServerlessSecurityConfigConfig struct {
...
type SearchServerlessSecurityConfigAttrs struct {
	// Security config description
	Description any
	// Describe IAM federation options in form of key value map
	IamFederationOptions any
...
var SearchServerlessSecurityConfig = ubx.ResourceBinding{
