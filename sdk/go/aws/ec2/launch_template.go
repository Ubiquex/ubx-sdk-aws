...
type LaunchTemplate_LaunchTemplateData_BlockDeviceMappings_Ebs struct {
...
type LaunchTemplate_LaunchTemplateData_BlockDeviceMappings struct {
...
type LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification_CapacityReservationTarget struct {
...
type LaunchTemplate_LaunchTemplateData_CapacityReservationSpecification struct {
...
type LaunchTemplate_LaunchTemplateData_CpuOptions struct {
...
type LaunchTemplate_LaunchTemplateData_CreditSpecification struct {
	// The credit option for CPU usage of a T instance. Valid values: ``standard`` | ``unlimited``
	CpuCredits any
}

type LaunchTemplate_LaunchTemplateData_EnclaveOptions struct {
	// If this parameter is set to ``true``, the instance is enabled for AWS Nitro Enclaves; otherwise, it is not enabled for AWS Nitro Enclaves.
	Enabled any
}

type LaunchTemplate_LaunchTemplateData_HibernationOptions struct {
	// If you set this parameter to ``true``, the instance is enabled for hibernation. Default: ``false``
	Configured any
}

type LaunchTemplate_LaunchTemplateData_IamInstanceProfile struct {
...
type LaunchTemplate_LaunchTemplateData_InstanceMarketOptions_SpotOptions struct {
	// Deprecated.
...
type LaunchTemplate_LaunchTemplateData_InstanceMarketOptions struct {
	// The market type.
	MarketType any
...
type LaunchTemplate_LaunchTemplateData_InstanceRequirements_AcceleratorCount struct {
...
type LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu_References struct {
...
type LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors_Cpu struct {
...
type LaunchTemplate_LaunchTemplateData_InstanceRequirements_BaselinePerformanceFactors struct {
	// Specifies the CPU performance to consider when using an instance family as the baseline reference.
	Cpu any
}

type LaunchTemplate_LaunchTemplateData_InstanceRequirements struct {
...
type LaunchTemplate_LaunchTemplateData_LicenseSpecifications struct {
...
type LaunchTemplate_LaunchTemplateData_MaintenanceOptions struct {
	// Disables the automatic recovery behavior of your instance or sets it to default.
	AutoRecovery any
}

type LaunchTemplate_LaunchTemplateData_MetadataOptions struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkInterfaces_ConnectionTrackingSpecification struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification_EnaSrdUdpSpecification struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkInterfaces_EnaSrdSpecification struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv4Prefixes struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Addresses struct {
	// Specifies an IPv6 address to assign to the network interface when the instance launches. (AI-inferred)
	Ipv6Address any
}

type LaunchTemplate_LaunchTemplateData_NetworkInterfaces_Ipv6Prefixes struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkInterfaces_PrivateIpAddresses struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkInterfaces struct {
...
type LaunchTemplate_LaunchTemplateData_NetworkPerformanceOptions struct {
...
type LaunchTemplate_LaunchTemplateData_Placement struct {
...
type LaunchTemplate_LaunchTemplateData_PrivateDnsNameOptions struct {
...
type LaunchTemplate_LaunchTemplateData_TagSpecifications_Tags struct {
...
type LaunchTemplate_LaunchTemplateData_TagSpecifications struct {
...
type LaunchTemplateAttrs struct {
...
var LaunchTemplate = ubx.ResourceBinding{
