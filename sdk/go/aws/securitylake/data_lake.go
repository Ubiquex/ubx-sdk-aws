...
type DataLake_LifecycleConfiguration_Expiration struct {
	// Number of days before data expires in the Amazon Security Lake object.
	Days any
}

type DataLake_LifecycleConfiguration_Transitions struct {
