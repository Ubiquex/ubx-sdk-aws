...
type ModelCard_Content_AdditionalInformation struct {
...
type ModelCard_Content_BusinessDetails struct {
...
type ModelCard_Content_EvaluationDetails_MetricGroups_MetricData struct {
...
type ModelCard_Content_EvaluationDetails_MetricGroups struct {
...
type ModelCard_Content_EvaluationDetails struct {
...
type ModelCard_Content_IntendedUses struct {
...
type ModelCard_Content_ModelOverview_InferenceEnvironment struct {
	// SageMaker inference image uri.
	ContainerImage any
}

type ModelCard_Content_ModelOverview struct {
...
type ModelCard_Content_ModelPackageDetails_CreatedBy struct {
	// The name of the user's profile in Studio
	UserProfileName any
}

type ModelCard_Content_ModelPackageDetails_InferenceSpecification_Containers struct {
...
type ModelCard_Content_ModelPackageDetails_InferenceSpecification struct {
	// Contains inference related information which were used to create model package.
	Containers any
}

type ModelCard_Content_ModelPackageDetails_SourceAlgorithms struct {
...
type ModelCard_Content_ModelPackageDetails struct {
...
type ModelCard_Content_TrainingDetails_ObjectiveFunction_Function struct {
...
type ModelCard_Content_TrainingDetails_ObjectiveFunction struct {
...
type ModelCard_Content_TrainingDetails_TrainingJobDetails_HyperParameters struct {
...
type ModelCard_Content_TrainingDetails_TrainingJobDetails_TrainingMetrics struct {
...
type ModelCard_Content_TrainingDetails_TrainingJobDetails struct {
...
type ModelCard_Content_TrainingDetails struct {
...
type ModelCard_CreatedBy struct {
