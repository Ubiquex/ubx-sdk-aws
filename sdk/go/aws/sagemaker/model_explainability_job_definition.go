...
type ModelExplainabilityJobDefinition_JobResources_ClusterConfig struct {
...
type ModelExplainabilityJobDefinition_JobResources struct {
...
type ModelExplainabilityJobDefinition_ModelExplainabilityBaselineConfig_ConstraintsResource struct {
	// The Amazon S3 URI.
	S3Uri any
}
...
type ModelExplainabilityJobDefinition_ModelExplainabilityJobInput_BatchTransformInput_DatasetFormat_Csv struct {
	// A boolean flag indicating if given CSV has header
	Header any
}

type ModelExplainabilityJobDefinition_ModelExplainabilityJobInput_BatchTransformInput_DatasetFormat_Json struct {
	// A boolean flag indicating if it is JSON line format
	Line any
}

type ModelExplainabilityJobDefinition_ModelExplainabilityJobInput_BatchTransformInput_DatasetFormat struct {
	// The CSV format
	Csv any
	// The Json format
	Json any
...
type ModelExplainabilityJobDefinition_ModelExplainabilityJobInput_BatchTransformInput struct {
...
type ModelExplainabilityJobDefinition_ModelExplainabilityJobInput_EndpointInput struct {
...
type ModelExplainabilityJobDefinition_ModelExplainabilityJobOutputConfig_MonitoringOutputs_S3Output struct {
...
type ModelExplainabilityJobDefinition_ModelExplainabilityJobOutputConfig_MonitoringOutputs struct {
...
type ModelExplainabilityJobDefinition_ModelExplainabilityJobOutputConfig struct {
...
type ModelExplainabilityJobDefinition_NetworkConfig_VpcConfig struct {
...
type ModelExplainabilityJobDefinitionAttrs struct {
