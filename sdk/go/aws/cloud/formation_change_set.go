...
type FormationChangeSet_Tags struct {
	Key any
	Value any
}

var FormationChangeSet_TagsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

type FormationChangeSetConfig struct {
...
type FormationChangeSetAttrs struct {
	// The capabilities that are allowed in the stack.
	Capabilities any
...
var FormationChangeSet = ubx.ResourceBinding{
