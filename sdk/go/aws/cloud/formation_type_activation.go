...
type FormationTypeActivation_LoggingConfig struct {
...
var FormationTypeActivation_LoggingConfigFields = ubx.FieldMap{
		"LogGroupName": ubx.FieldSpec{WireName: "log_group_name"},
		"LogRoleArn": ubx.FieldSpec{WireName: "log_role_arn"},
	}

type FormationTypeActivationConfig struct {
...
type FormationTypeActivationAttrs struct {
...
var FormationTypeActivation = ubx.ResourceBinding{
