...
type OriginEndpoint_CmafPackage_Encryption_SpekeKeyProvider_EncryptionContractConfiguration struct {
...
type OriginEndpoint_CmafPackage_Encryption_SpekeKeyProvider struct {
...
type OriginEndpoint_CmafPackage_Encryption struct {
...
type OriginEndpoint_CmafPackage_HlsManifests struct {
...
type OriginEndpoint_CmafPackage_StreamSelection struct {
...
type OriginEndpoint_DashPackage_Encryption struct {
	// Time (in seconds) between each encryption key rotation.
	KeyRotationIntervalSeconds any
	// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
	SpekeKeyProvider any
...
type OriginEndpoint_HlsPackage_Encryption struct {
...
type OriginEndpoint_MssPackage_Encryption struct {
	// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
	SpekeKeyProvider any
}
