...
type LoadBalancingV2TargetGroup_Matcher struct {
...
var LoadBalancingV2TargetGroup_MatcherFields = ubx.FieldMap{
		"GrpcCode": ubx.FieldSpec{WireName: "grpc_code"},
		"HttpCode": ubx.FieldSpec{WireName: "http_code"},
	}

var LoadBalancingV2TargetGroup_TagsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var LoadBalancingV2TargetGroup_TargetsFields = ubx.FieldMap{
...
type LoadBalancingV2TargetGroupConfig struct {
...
type LoadBalancingV2TargetGroupAttrs struct {
	// Indicates whether health checks are enabled. If the target type is lambda, health checks are disabled by default but can be enabled. If the target type is instance, ip, or alb, health checks are always enabled and cannot be disabled.
	HealthCheckEnabled any
	// The approximate amount of time, in seconds, between health checks of an individual target.
	HealthCheckIntervalSeconds any
...
var LoadBalancingV2TargetGroup = ubx.ResourceBinding{
