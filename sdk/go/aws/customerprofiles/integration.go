...
type Integration_FlowDefinition_SourceFlowConfig_IncrementalPullConfig struct {
...
type Integration_FlowDefinition_SourceFlowConfig_SourceConnectorProperties_Marketo struct {
	// The name of the Marketo object (e.g., Lead, Company) from which the integration source connector reads data. (AI-inferred)
	Object any
}

type Integration_FlowDefinition_SourceFlowConfig_SourceConnectorProperties_S3 struct {
...
type Integration_FlowDefinition_SourceFlowConfig_SourceConnectorProperties_Salesforce struct {
...
type Integration_FlowDefinition_SourceFlowConfig_SourceConnectorProperties struct {
...
type Integration_FlowDefinition_SourceFlowConfig struct {
...
type Integration_FlowDefinition_Tasks_ConnectorOperator struct {
...
type Integration_FlowDefinition_Tasks_TaskProperties struct {
...
type Integration_FlowDefinition_Tasks struct {
...
type Integration_FlowDefinition_TriggerConfig_TriggerProperties_Scheduled struct {
...
type Integration_FlowDefinition_TriggerConfig_TriggerProperties struct {
...
type Integration_FlowDefinition_TriggerConfig struct {
...
type Integration_ObjectTypeNames struct {
