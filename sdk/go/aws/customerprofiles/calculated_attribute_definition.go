...
type CalculatedAttributeDefinition_AttributeDetails_Attributes struct {
...
type CalculatedAttributeDefinition_Conditions_Range_ValueRange struct {
...
type CalculatedAttributeDefinition_Conditions_Range struct {
...
type CalculatedAttributeDefinition_Conditions_Threshold struct {
...
type CalculatedAttributeDefinitionAttrs struct {
	// Mathematical expression and a list of attribute items specified in that expression.
	AttributeDetails any
	// The unique name of the calculated attribute.
	CalculatedAttributeName any
...
var CalculatedAttributeDefinition = ubx.ResourceBinding{
