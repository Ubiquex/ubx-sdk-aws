...
type StarConnectionsSyncConfigurationConfig struct {
...
type StarConnectionsSyncConfigurationAttrs struct {
	// The name of the branch of the repository from which resources are to be synchronized,
	Branch any
	// The source provider repository path of the sync configuration file of the respective SyncType.
	ConfigFile any
...
var StarConnectionsSyncConfiguration = ubx.ResourceBinding{
