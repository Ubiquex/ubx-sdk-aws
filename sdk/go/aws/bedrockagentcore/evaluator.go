...
type Evaluator_EvaluatorConfig_LlmAsAjudge_ModelConfig_ResponsesEvaluatorModelConfig_Reasoning struct {
	// The level of reasoning effort the model applies.
	Effort any
}

type Evaluator_EvaluatorConfig_LlmAsAjudge_ModelConfig_ResponsesEvaluatorModelConfig struct {
