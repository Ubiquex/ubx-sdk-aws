...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource_LaunchParameters_CapacityReservationSpecification_CapacityReservationTarget struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource_LaunchParameters_CapacityReservationSpecification struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource_LaunchParameters_EphemeralVolumes_Ebs struct {
	EbsCardIndex any
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource_LaunchParameters_EphemeralVolumes struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource_LaunchParameters_InstanceRequirements struct {
	// List of allowed instance types.
	AllowedInstanceTypes any
}

type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource_LaunchParameters_LicenseSpecifications struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource_LaunchParameters struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_LaunchTemplateSource struct {
	// Parameters for launching EC2 instances.
	LaunchParameters any
}

type CapacityProvider_ComputeConfiguration_Ec2Configuration_LifecycleConfiguration struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_RootVolume struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_Volumes_EbsConfiguration struct {
	Encrypted any
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_Volumes struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration_VpcConfiguration struct {
...
type CapacityProvider_ComputeConfiguration_Ec2Configuration struct {
...
type CapacityProvider_ComputeConfiguration struct {
	// Configuration for EC2-based capacity.
	Ec2Configuration any
}

type CapacityProvider_PermissionsConfiguration struct {
