...
type Harness_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue_ClaimMatchValue struct {
...
type Harness_AuthorizerConfiguration_CustomJwtauthorizer_CustomClaims_AuthorizingClaimMatchValue struct {
...
type Harness_Environment_AgentCoreRuntimeEnvironment_FilesystemConfigurations_EfsAccessPoint struct {
...
type Harness_Environment_AgentCoreRuntimeEnvironment_FilesystemConfigurations_SessionStorage struct {
...
type Harness_Environment_AgentCoreRuntimeEnvironment_FilesystemConfigurations struct {
	EfsAccessPoint any
...
type Harness_Memory_ManagedMemoryConfiguration struct {
...
type Harness_Skills_Git_Auth struct {
...
type Harness_Skills_Git struct {
...
type Harness_Tools_Config_AgentCoreBrowser struct {
	BrowserArn any
}

type Harness_Tools_Config_AgentCoreCodeInterpreter struct {
	CodeInterpreterArn any
}

type Harness_Tools_Config_AgentCoreGateway_OutboundAuth_Oauth struct {
...
type Harness_Tools_Config_AgentCoreGateway_OutboundAuth struct {
...
type Harness_Tools_Config_AgentCoreGateway struct {
	GatewayArn any
...
type Harness_Tools_Config_InlineFunction struct {
...
type Harness_Tools_Config_RemoteMcp struct {
