...
var LiftMatchmakingConfiguration_GamePropertiesFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

type LiftMatchmakingConfigurationConfig struct {
...
type LiftMatchmakingConfigurationAttrs struct {
	// A flag that indicates whether a match that was created with this configuration must be accepted by the matched players
	AcceptanceRequired any
	// The length of time (in seconds) to wait for players to accept a proposed match, if acceptance is required.
	AcceptanceTimeoutSeconds any
...
var LiftMatchmakingConfiguration = ubx.ResourceBinding{
