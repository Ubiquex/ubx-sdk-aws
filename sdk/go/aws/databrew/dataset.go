...
type Dataset_FormatOptions_Csv struct {
...
type Dataset_FormatOptions_Excel struct {
...
type Dataset_FormatOptions_Json struct {
...
type Dataset_Input_DataCatalogInputDefinition_TempDirectory struct {
...
type Dataset_Input_DataCatalogInputDefinition struct {
	// Catalog id
	CatalogId any
	// Database name
	DatabaseName any
...
type Dataset_Input_DatabaseInputDefinition struct {
	// Database table name
...
type Dataset_Input_Metadata struct {
...
type Dataset_PathOptions_FilesLimit struct {
...
type Dataset_PathOptions_LastModifiedDateCondition_ValuesMap struct {
...
type Dataset_PathOptions_LastModifiedDateCondition struct {
...
type Dataset_PathOptions_Parameters_DatasetParameter_DatetimeOptions struct {
...
type Dataset_PathOptions_Parameters_DatasetParameter struct {
...
type Dataset_PathOptions_Parameters struct {
