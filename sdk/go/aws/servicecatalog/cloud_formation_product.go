...
type CloudFormationProduct_ProvisioningArtifactParameters_Info struct {
...
type CloudFormationProduct_ProvisioningArtifactParameters struct {
...
type CloudFormationProduct_SourceConnection_ConnectionParameters_CodeStar struct {
...
type CloudFormationProduct_SourceConnection_ConnectionParameters struct {
...
type CloudFormationProduct_Tags struct {
...
type CloudFormationProductAttrs struct {
	// The language code.
	AcceptLanguage any
	// The description of the product.
	Description any
...
var CloudFormationProduct = ubx.ResourceBinding{
