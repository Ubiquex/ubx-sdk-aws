...
type MakerModelBiasJobDefinition_JobResources_ClusterConfig struct {
...
type MakerModelBiasJobDefinition_JobResources struct {
	// Configuration for the cluster used to run model monitoring jobs.
	ClusterConfig any
}

type MakerModelBiasJobDefinition_ModelBiasAppSpecification struct {
	// The Amazon S3 URI.
	ConfigUri any
...
type MakerModelBiasJobDefinition_ModelBiasBaselineConfig_ConstraintsResource struct {
	// The Amazon S3 URI.
	S3Uri any
}

type MakerModelBiasJobDefinition_ModelBiasBaselineConfig struct {
...
type MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInput_DatasetFormat_Csv struct {
	// A boolean flag indicating if given CSV has header
	Header any
}

type MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInput_DatasetFormat_Json struct {
	// A boolean flag indicating if it is JSON line format
	Line any
}

type MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInput_DatasetFormat struct {
	// The CSV format
	Csv any
	// The Json format
	Json any
...
type MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInput struct {
...
type MakerModelBiasJobDefinition_ModelBiasJobInput_EndpointInput struct {
	// The time offsets in ISO duration format
	EndTimeOffset any
...
type MakerModelBiasJobDefinition_ModelBiasJobInput struct {
...
type MakerModelBiasJobDefinition_ModelBiasJobOutputConfig struct {
...
type MakerModelBiasJobDefinition_NetworkConfig_VpcConfig struct {
...
type MakerModelBiasJobDefinition_NetworkConfig struct {
...
type MakerModelBiasJobDefinition_StoppingCondition struct {
...
var MakerModelBiasJobDefinition_JobResources_ClusterConfigFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_JobResourcesFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_ModelBiasAppSpecificationFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_ModelBiasBaselineConfig_ConstraintsResourceFields = ubx.FieldMap{
		"S3Uri": ubx.FieldSpec{WireName: "s3_uri"},
	}

var MakerModelBiasJobDefinition_ModelBiasBaselineConfigFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInput_DatasetFormat_CsvFields = ubx.FieldMap{
		"Header": ubx.FieldSpec{WireName: "header"},
	}

var MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInput_DatasetFormat_JsonFields = ubx.FieldMap{
		"Line": ubx.FieldSpec{WireName: "line"},
	}

var MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInput_DatasetFormatFields = ubx.FieldMap{
		"Csv": ubx.FieldSpec{
			WireName: "csv",
			Kind: "object",
...
var MakerModelBiasJobDefinition_ModelBiasJobInput_BatchTransformInputFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_ModelBiasJobInput_EndpointInputFields = ubx.FieldMap{
		"EndTimeOffset": ubx.FieldSpec{WireName: "end_time_offset"},
...
var MakerModelBiasJobDefinition_ModelBiasJobInputFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_ModelBiasJobOutputConfig_MonitoringOutputs_S3OutputFields = ubx.FieldMap{
		"LocalPath": ubx.FieldSpec{WireName: "local_path"},
		"S3UploadMode": ubx.FieldSpec{WireName: "s3_upload_mode"},
		"S3Uri": ubx.FieldSpec{WireName: "s3_uri"},
	}

var MakerModelBiasJobDefinition_ModelBiasJobOutputConfig_MonitoringOutputsFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_ModelBiasJobOutputConfigFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_NetworkConfig_VpcConfigFields = ubx.FieldMap{
		"SecurityGroupIds": ubx.FieldSpec{WireName: "security_group_ids"},
		"Subnets": ubx.FieldSpec{WireName: "subnets"},
	}

var MakerModelBiasJobDefinition_NetworkConfigFields = ubx.FieldMap{
...
var MakerModelBiasJobDefinition_StoppingConditionFields = ubx.FieldMap{
		"MaxRuntimeInSeconds": ubx.FieldSpec{WireName: "max_runtime_in_seconds"},
	}

var MakerModelBiasJobDefinition_TagsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

type MakerModelBiasJobDefinitionConfig struct {
	// The name of the endpoint used to run the monitoring job.
	EndpointName any
...
type MakerModelBiasJobDefinitionAttrs struct {
...
var MakerModelBiasJobDefinition = ubx.ResourceBinding{
