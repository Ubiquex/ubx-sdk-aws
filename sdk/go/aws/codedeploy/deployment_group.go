...
type DeploymentGroup_AlarmConfiguration_Alarms struct {
...
type DeploymentGroup_BlueGreenDeploymentConfiguration_DeploymentReadyOption struct {
...
type DeploymentGroup_BlueGreenDeploymentConfiguration_GreenFleetProvisioningOption struct {
	// The method used to add instances to a replacement environment.
	Action any
}

type DeploymentGroup_BlueGreenDeploymentConfiguration_TerminateBlueInstancesOnDeploymentSuccess struct {
...
type DeploymentGroup_Deployment_Revision_GitHubLocation struct {
...
type DeploymentGroup_Deployment_Revision_S3Location struct {
...
type DeploymentGroup_Deployment_Revision struct {
...
type DeploymentGroup_Ecsservices struct {
...
type DeploymentGroup_Ec2TagFilters struct {
...
type DeploymentGroup_Ec2TagSet_Ec2TagSetList struct {
...
type DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoList_ProdTrafficRoute struct {
...
type DeploymentGroup_LoadBalancerInfo_TargetGroupPairInfoList struct {
...
type DeploymentGroup_OnPremisesTagSet_OnPremisesTagSetList struct {
...
type DeploymentGroup_Tags struct {
	Key any
...
type DeploymentGroup_TriggerConfigurations struct {
