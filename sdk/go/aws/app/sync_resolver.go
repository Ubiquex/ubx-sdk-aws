...
type SyncResolver_CachingConfig struct {
...
type SyncResolver_PipelineConfig struct {
	// A list of ``Function`` objects.
	Functions any
}

type SyncResolver_Runtime struct {
...
type SyncResolver_SyncConfig_LambdaConflictHandlerConfig struct {
	// The Amazon Resource Name (ARN) for the Lambda function to use as the Conflict Handler.
	LambdaConflictHandlerArn any
}

type SyncResolver_SyncConfig struct {
...
var SyncResolver_CachingConfigFields = ubx.FieldMap{
		"CachingKeys": ubx.FieldSpec{WireName: "caching_keys"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var SyncResolver_PipelineConfigFields = ubx.FieldMap{
		"Functions": ubx.FieldSpec{WireName: "functions"},
	}

var SyncResolver_RuntimeFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"RuntimeVersion": ubx.FieldSpec{WireName: "runtime_version"},
	}

var SyncResolver_SyncConfig_LambdaConflictHandlerConfigFields = ubx.FieldMap{
		"LambdaConflictHandlerArn": ubx.FieldSpec{WireName: "lambda_conflict_handler_arn"},
	}

var SyncResolver_SyncConfigFields = ubx.FieldMap{
...
type SyncResolverConfig struct {
...
var SyncResolver = ubx.ResourceBinding{
