...
type ProjectProfile_EnvironmentConfigurations_AwsAccount struct {
...
type ProjectProfile_EnvironmentConfigurations_AwsRegion struct {
...
type ProjectProfile_EnvironmentConfigurations_ConfigurationParameters_ParameterOverrides struct {
...
type ProjectProfile_EnvironmentConfigurations_ConfigurationParameters struct {
...
type ProjectProfile_ProjectResourceTags struct {
...
type ProjectProfileAttrs struct {
	// Indicates whether users are allowed to add custom tags to project resources (such as data assets or environments) when using this project profile. (AI-inferred)
	AllowCustomProjectResourceTags any
...
var ProjectProfile = ubx.ResourceBinding{
