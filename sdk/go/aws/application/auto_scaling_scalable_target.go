...
type AutoScalingScalableTarget_ScheduledActions_ScalableTargetAction struct {
	MaxCapacity any
	MinCapacity any
}

type AutoScalingScalableTarget_ScheduledActions struct {
	EndTime any
...
type AutoScalingScalableTarget_SuspendedState struct {
...
var AutoScalingScalableTarget_ScheduledActions_ScalableTargetActionFields = ubx.FieldMap{
		"MaxCapacity": ubx.FieldSpec{WireName: "max_capacity"},
		"MinCapacity": ubx.FieldSpec{WireName: "min_capacity"},
	}

var AutoScalingScalableTarget_ScheduledActionsFields = ubx.FieldMap{
...
var AutoScalingScalableTarget_SuspendedStateFields = ubx.FieldMap{
...
type AutoScalingScalableTargetConfig struct {
...
type AutoScalingScalableTargetAttrs struct {
	Id any
	// The maximum value that you plan to scale out to. When a scaling policy is in effect, Application Auto Scaling can scale out (expand) as needed to the maximum capacity limit in response to changing demand.
	MaxCapacity any
	// The minimum value that you plan to scale in to. When a scaling policy is in effect, Application Auto Scaling can scale in (contract) as needed to the minimum capacity limit in response to changing demand.
...
var AutoScalingScalableTarget = ubx.ResourceBinding{
