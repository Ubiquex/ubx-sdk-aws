...
type TlsinspectionConfiguration_TlsinspectionConfiguration_ServerCertificateConfigurations_CheckCertificateRevocationStatus struct {
...
type TlsinspectionConfiguration_TlsinspectionConfiguration_ServerCertificateConfigurations_Scopes_DestinationPorts struct {
...
type TlsinspectionConfiguration_TlsinspectionConfiguration_ServerCertificateConfigurations_Scopes_Destinations struct {
...
type TlsinspectionConfiguration_TlsinspectionConfiguration_ServerCertificateConfigurations_Scopes struct {
...
type TlsinspectionConfiguration_TlsinspectionConfiguration_ServerCertificateConfigurations_ServerCertificates struct {
...
type TlsinspectionConfiguration_TlsinspectionConfiguration_ServerCertificateConfigurations struct {
...
type TlsinspectionConfiguration_Tags struct {
...
type TlsinspectionConfigurationAttrs struct {
	// An optional user-defined description for the TLS inspection configuration, helping to identify the resource within AWS Network Firewall. (AI-inferred)
	Description any
	// Defines the TLS inspection configuration for the Network Firewall, including the server certificate configurations that specify how encrypted traffic is decrypted and inspected. (AI-inferred)
	TlsinspectionConfiguration any
