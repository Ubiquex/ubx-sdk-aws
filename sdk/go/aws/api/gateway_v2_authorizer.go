...
type GatewayV2Authorizer_JwtConfiguration struct {
...
var GatewayV2Authorizer_JwtConfigurationFields = ubx.FieldMap{
		"Audience": ubx.FieldSpec{WireName: "audience"},
		"Issuer": ubx.FieldSpec{WireName: "issuer"},
	}

type GatewayV2AuthorizerConfig struct {
	// The API identifier.
	ApiId any
...
type GatewayV2AuthorizerAttrs struct {
	// The API identifier.
	ApiId any
	// Specifies the required credentials as an IAM role for API Gateway to invoke the authorizer. To specify an IAM role for API Gateway to assume, use the role's Amazon Resource Name (ARN). To use resource-based permissions on the Lambda function, specify null. Supported only for ``REQUEST`` authorizers.
	AuthorizerCredentialsArn any
...
var GatewayV2Authorizer = ubx.ResourceBinding{
