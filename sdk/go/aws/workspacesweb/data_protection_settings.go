...
type DataProtectionSettings_InlineRedactionConfiguration_InlineRedactionPatterns_CustomPattern struct {
...
type DataProtectionSettings_InlineRedactionConfiguration_InlineRedactionPatterns_RedactionPlaceHolder struct {
...
type DataProtectionSettings_InlineRedactionConfiguration_InlineRedactionPatterns struct {
...
type DataProtectionSettingsAttrs struct {
	// Provides additional encryption context key-value pairs that are included in the encryption context for AWS KMS keys used to protect data, enabling finer-grained access control and audit logging. (AI-inferred)
	AdditionalEncryptionContext any
