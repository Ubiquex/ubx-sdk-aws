...
type ApiSagemakerHubs_HubSummaries struct {
	CreationTime any
	HubArn any
	HubDescription any
	HubDisplayName any
...
type ApiSagemakerHubsConfig struct {
...
type ApiSagemakerHubsAttrs struct {
	CreationTimeAfter any
	CreationTimeBefore any
	HubSummaries any
	LastModifiedTimeAfter any
...
var ApiSagemakerHubs = ubx.DataSourceBinding{
