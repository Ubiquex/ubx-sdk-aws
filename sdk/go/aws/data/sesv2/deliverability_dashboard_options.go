...
type DeliverabilityDashboardOptions_ActiveSubscribedDomains_InboxPlacementTrackingOption struct {
	Global any
	TrackedIsps any
}

type DeliverabilityDashboardOptions_ActiveSubscribedDomains struct {
	Domain any
	InboxPlacementTrackingOption any
	SubscriptionStartDate any
}

type DeliverabilityDashboardOptionsConfig struct {
}

type DeliverabilityDashboardOptionsAttrs struct {
...
var DeliverabilityDashboardOptions = ubx.DataSourceBinding{
