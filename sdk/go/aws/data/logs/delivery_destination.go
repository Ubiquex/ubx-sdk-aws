...
type DeliveryDestination_DeliveryDestination_DeliveryDestinationConfiguration struct {
	DestinationResourceArn any
}

type DeliveryDestination_DeliveryDestination struct {
	Arn any
...
var DeliveryDestination = ubx.DataSourceBinding{
