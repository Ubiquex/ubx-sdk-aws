...
type AwsdefaultServiceQuota_Quota_ErrorReason struct {
	ErrorCode any
	ErrorMessage any
}

type AwsdefaultServiceQuota_Quota_Period struct {
	PeriodUnit any
	PeriodValue any
}

type AwsdefaultServiceQuota_Quota_QuotaContext struct {
	ContextId any
	ContextScope any
	ContextScopeType any
}

type AwsdefaultServiceQuota_Quota_UsageMetric struct {
...
type AwsdefaultServiceQuota_Quota struct {
	Adjustable any
	Description any
...
type AwsdefaultServiceQuotaConfig struct {
	QuotaCode any
	ServiceCode any
}

type AwsdefaultServiceQuotaAttrs struct {
...
var AwsdefaultServiceQuota = ubx.DataSourceBinding{
