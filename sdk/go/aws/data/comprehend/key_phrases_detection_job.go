...
type KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig_DocumentReaderConfig struct {
	DocumentReadAction any
	DocumentReadMode any
	FeatureTypes any
}

type KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_InputDataConfig struct {
...
type KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_OutputDataConfig struct {
	KmsKeyId any
	S3Uri any
}

type KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties_VpcConfig struct {
	SecurityGroupIds any
	Subnets any
}

type KeyPhrasesDetectionJob_KeyPhrasesDetectionJobProperties struct {
...
type KeyPhrasesDetectionJobConfig struct {
	JobId any
}

type KeyPhrasesDetectionJobAttrs struct {
	JobId any
	// <p>Provides information about a key phrases detection job.</p>
	KeyPhrasesDetectionJobProperties any
}

var KeyPhrasesDetectionJob = ubx.DataSourceBinding{
