...
type EntitiesDetectionJob_EntitiesDetectionJobProperties_InputDataConfig_DocumentReaderConfig struct {
	DocumentReadAction any
	DocumentReadMode any
	FeatureTypes any
}

type EntitiesDetectionJob_EntitiesDetectionJobProperties_InputDataConfig struct {
...
type EntitiesDetectionJob_EntitiesDetectionJobProperties_OutputDataConfig struct {
	KmsKeyId any
	S3Uri any
}

type EntitiesDetectionJob_EntitiesDetectionJobProperties_VpcConfig struct {
	SecurityGroupIds any
	Subnets any
}

type EntitiesDetectionJob_EntitiesDetectionJobProperties struct {
...
type EntitiesDetectionJobConfig struct {
	JobId any
}

type EntitiesDetectionJobAttrs struct {
	// <p>Provides information about an entities detection job.</p>
	EntitiesDetectionJobProperties any
	JobId any
}

var EntitiesDetectionJob = ubx.DataSourceBinding{
