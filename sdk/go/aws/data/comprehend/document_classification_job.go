...
type DocumentClassificationJob_DocumentClassificationJobProperties_InputDataConfig_DocumentReaderConfig struct {
	DocumentReadAction any
	DocumentReadMode any
	FeatureTypes any
}

type DocumentClassificationJob_DocumentClassificationJobProperties_InputDataConfig struct {
...
type DocumentClassificationJob_DocumentClassificationJobProperties_OutputDataConfig struct {
	KmsKeyId any
	S3Uri any
}

type DocumentClassificationJob_DocumentClassificationJobProperties_VpcConfig struct {
	SecurityGroupIds any
	Subnets any
}

type DocumentClassificationJob_DocumentClassificationJobProperties struct {
...
type DocumentClassificationJobConfig struct {
	JobId any
}

type DocumentClassificationJobAttrs struct {
	// <p>Provides information about a document classification job.</p>
	DocumentClassificationJobProperties any
	JobId any
}

var DocumentClassificationJob = ubx.DataSourceBinding{
