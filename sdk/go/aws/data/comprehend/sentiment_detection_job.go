...
type SentimentDetectionJob_SentimentDetectionJobProperties_InputDataConfig_DocumentReaderConfig struct {
	DocumentReadAction any
	DocumentReadMode any
	FeatureTypes any
}

type SentimentDetectionJob_SentimentDetectionJobProperties_InputDataConfig struct {
...
type SentimentDetectionJob_SentimentDetectionJobProperties_OutputDataConfig struct {
	KmsKeyId any
	S3Uri any
}

type SentimentDetectionJob_SentimentDetectionJobProperties_VpcConfig struct {
	SecurityGroupIds any
	Subnets any
}

type SentimentDetectionJob_SentimentDetectionJobProperties struct {
...
type SentimentDetectionJobConfig struct {
	JobId any
}

type SentimentDetectionJobAttrs struct {
	JobId any
	// <p>Provides information about a sentiment detection job.</p>
	SentimentDetectionJobProperties any
}

var SentimentDetectionJob = ubx.DataSourceBinding{
