...
type FleetLocationCapacity_FleetCapacity_GameServerContainerGroupCounts struct {
	Active any
	Idle any
	Pending any
	Terminating any
...
type FleetLocationCapacity_FleetCapacity_InstanceCounts struct {
	Active any
	Desired any
	Idle any
	Maximum any
...
type FleetLocationCapacity_FleetCapacity_ManagedCapacityConfiguration struct {
	ScaleInAfterInactivityMinutes any
	ZeroCapacityStrategy any
}

type FleetLocationCapacity_FleetCapacity struct {
	FleetArn any
	FleetId any
...
type FleetLocationCapacityConfig struct {
	FleetId any
	Location any
}

type FleetLocationCapacityAttrs struct {
...
var FleetLocationCapacity = ubx.DataSourceBinding{
