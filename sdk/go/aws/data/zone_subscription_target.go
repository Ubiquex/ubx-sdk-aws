...
var ZoneSubscriptionTarget_SubscriptionTargetConfigFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"FormName": ubx.FieldSpec{WireName: "form_name"},
	}

type ZoneSubscriptionTargetConfig struct {
...
type ZoneSubscriptionTargetAttrs struct {
	// The asset types that can be included in the subscription target.
	ApplicableAssetTypes any
	// The authorized principals of the subscription target.
	AuthorizedPrincipals any
...
var ZoneSubscriptionTarget = ubx.ResourceBinding{
