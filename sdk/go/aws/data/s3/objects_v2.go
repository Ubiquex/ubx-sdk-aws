...
type ObjectsV2_CommonPrefixes struct {
	Prefix any
}

type ObjectsV2_Contents_Owner struct {
	DisplayName any
	Id any
}

type ObjectsV2_Contents_RestoreStatus struct {
	IsRestoreInProgress any
	RestoreExpiryDate any
}

type ObjectsV2_Contents struct {
...
var ObjectsV2 = ubx.DataSourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"FetchOwner": ubx.FieldSpec{WireName: "fetch_owner"},
