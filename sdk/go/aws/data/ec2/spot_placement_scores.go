...
type SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_AcceleratorCount struct {
	Max any
	Min any
}

type SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_Cpu_References struct {
	InstanceFamily any
}

type SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_Cpu struct {
	References any
}

type SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors struct {
	// <p>The CPU performance to consider, using an instance family as the baseline reference.</p>
	Cpu any
}

type SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements struct {
...
type SpotPlacementScores_InstanceRequirementsWithMetadata struct {
...
type SpotPlacementScores_SpotPlacementScores struct {
	AvailabilityZoneId any
	Region any
	Score any
}

var SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_AcceleratorCountFields = ubx.FieldMap{
		"Max": ubx.FieldSpec{WireName: "max"},
		"Min": ubx.FieldSpec{WireName: "min"},
	}

var SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_Cpu_ReferencesFields = ubx.FieldMap{
		"InstanceFamily": ubx.FieldSpec{WireName: "instance_family"},
	}

var SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactors_CpuFields = ubx.FieldMap{
...
var SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirements_BaselinePerformanceFactorsFields = ubx.FieldMap{
		"Cpu": ubx.FieldSpec{
			WireName: "cpu",
			Kind: "object",
...
var SpotPlacementScores_InstanceRequirementsWithMetadata_InstanceRequirementsFields = ubx.FieldMap{
...
var SpotPlacementScores_InstanceRequirementsWithMetadataFields = ubx.FieldMap{
...
type SpotPlacementScoresConfig struct {
	DryRun any
	IncludeLocalZones any
	...
	InstanceRequirementsWithMetadata any
	InstanceTypes any
	MaxResults any
	NextToken any
	RegionNames any
...
type SpotPlacementScoresAttrs struct {
	DryRun any
	IncludeLocalZones any
	// <p>The architecture type, virtualization type, and other attributes for the instance types. When you specify instance attributes, Amazon EC2 will identify instance types with those attributes.</p> <p>If you specify <code>InstanceRequirementsWithMetadataRequest</code>, you can't specify <code>InstanceTypes</code>.</p>
	InstanceRequirementsWithMetadata any
	...
	RegionNames any
	SingleAvailabilityZone any
	SpotPlacementScores any
	TargetCapacity any
	TargetCapacityUnitType any
}

var SpotPlacementScores = ubx.DataSourceBinding{
	WireType: "aws_ec2_spot_placement_scores",
	Fields: ubx.FieldMap{
		"DryRun": ubx.FieldSpec{WireName: "dry_run"},
		"IncludeLocalZones": ubx.FieldSpec{WireName: "include_local_zones"},
		"InstanceRequirementsWithMetadata": ubx.FieldSpec{
