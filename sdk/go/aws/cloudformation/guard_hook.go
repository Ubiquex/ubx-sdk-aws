...
type GuardHook_RuleLocation struct {
...
type GuardHook_StackFilters_StackNames struct {
...
type GuardHook_StackFilters_StackRoles struct {
...
type GuardHook_TargetFilters_Targets struct {
