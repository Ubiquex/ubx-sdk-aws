...
type LambdaHook_LoggingConfig struct {
...
type LambdaHook_StackFilters_StackNames struct {
...
type LambdaHook_StackFilters_StackRoles struct {
...
type LambdaHook_TargetFilters_Targets struct {
