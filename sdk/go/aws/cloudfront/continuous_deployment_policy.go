...
type ContinuousDeploymentPolicy_ContinuousDeploymentPolicyConfig_SingleHeaderPolicyConfig struct {
...
type ContinuousDeploymentPolicy_ContinuousDeploymentPolicyConfig_SingleWeightPolicyConfig_SessionStickinessConfig struct {
...
type ContinuousDeploymentPolicy_ContinuousDeploymentPolicyConfig_SingleWeightPolicyConfig struct {
...
type ContinuousDeploymentPolicy_ContinuousDeploymentPolicyConfig_TrafficConfig struct {
...
type ContinuousDeploymentPolicyAttrs struct {
	// Contains the configuration for a continuous deployment policy.
	ContinuousDeploymentPolicyConfig any
