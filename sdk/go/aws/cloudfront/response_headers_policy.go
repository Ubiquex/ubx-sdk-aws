...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_CorsConfig_AccessControlAllowHeaders struct {
	// The list of HTTP header names. You can specify ``*`` to allow all headers.
	Items any
}

type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_CorsConfig struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_CustomHeadersConfig_Items struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_CustomHeadersConfig struct {
	// The list of HTTP response headers and their values.
	Items any
}

type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_RemoveHeadersConfig_Items struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_RemoveHeadersConfig struct {
	// The list of HTTP header names.
	Items any
}

type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_SecurityHeadersConfig_ContentSecurityPolicy struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_SecurityHeadersConfig_ContentTypeOptions struct {
	// A Boolean that determines whether CloudFront overrides the ``X-Content-Type-Options`` HTTP response header received from the origin with the one specified in this response headers policy.
	Override any
}

type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_SecurityHeadersConfig_FrameOptions struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_SecurityHeadersConfig_ReferrerPolicy struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_SecurityHeadersConfig_StrictTransportSecurity struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_SecurityHeadersConfig_Xssprotection struct {
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_SecurityHeadersConfig struct {
	// The policy directives and their values that CloudFront includes as values for the ``Content-Security-Policy`` HTTP response header. For more information about the ``Content-Security-Policy`` HTTP response header, see [Content-Security-Policy](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy) in the MDN Web Docs.
	ContentSecurityPolicy any
...
type ResponseHeadersPolicy_ResponseHeadersPolicyConfig_ServerTimingHeadersConfig struct {
...
type ResponseHeadersPolicyAttrs struct {
