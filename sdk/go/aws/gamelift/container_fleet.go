...
type ContainerFleet_InstanceConnectionPortRange struct {
...
type ContainerFleet_InstanceInboundPermissions struct {
...
type ContainerFleet_Locations_LocationCapacity_ManagedCapacityConfiguration struct {
...
type ContainerFleet_Locations_LocationCapacity struct {
...
type ContainerFleet_Locations struct {
...
type ContainerFleet_ScalingPolicies_TargetConfiguration struct {
...
type ContainerFleet_ScalingPolicies struct {
...
type ContainerFleet_Tags struct {
...
type ContainerFleetAttrs struct {
	// Indicates whether to use On-Demand instances or Spot instances for this fleet. If empty, the default is ON_DEMAND. Both categories of instances use identical hardware and configurations based on the instance type selected for this fleet.
	BillingType any
...
var ContainerFleet = ubx.ResourceBinding{
