...
type Task_ManifestConfig_Source_S3 struct {
...
type Task_ManifestConfig_Source struct {
...
type Task_TaskReportConfig_Destination_S3 struct {
...
type Task_TaskReportConfig_Destination struct {
	// Specifies the Amazon S3 bucket where DataSync uploads your task report.
	S3 any
}

type Task_TaskReportConfig_Overrides_Deleted struct {
	// Specifies whether you want your task report to include only what went wrong with your transfer or a list of what succeeded and didn't.
	ReportLevel any
}

type Task_TaskReportConfig_Overrides struct {
