...
type LocationFsxOpenZfs_Protocol_Nfs_MountOptions struct {
	// The specific NFS version that you want DataSync to use to mount your NFS share.
	Version any
}

type LocationFsxOpenZfs_Protocol_Nfs struct {
...
type LocationFsxOpenZfs_Tags struct {
	Key any
...
type LocationFsxOpenZfsAttrs struct {
	// The Amazon Resource Name (ARN) for the FSx OpenZFS file system.
	FsxFilesystemArn any
...
var LocationFsxOpenZfs = ubx.ResourceBinding{
