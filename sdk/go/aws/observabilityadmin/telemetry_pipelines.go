...
type TelemetryPipelines_Configuration struct {
	Body any
}

type TelemetryPipelines_Pipeline_StatusReason struct {
...
type TelemetryPipelines_Pipeline_Tags struct {
...
var TelemetryPipelines = ubx.ResourceBinding{
