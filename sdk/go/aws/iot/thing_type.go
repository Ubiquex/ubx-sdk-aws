...
type ThingType_Tags struct {
	Key any
	// Specifies the value part of a tag key-value pair used to label the AWS IoT Thing Type. (AI-inferred)
	Value any
}

type ThingType_ThingTypeProperties_Mqtt5Configuration_PropagatingAttributes struct {
...
type ThingType_ThingTypeProperties_Mqtt5Configuration struct {
