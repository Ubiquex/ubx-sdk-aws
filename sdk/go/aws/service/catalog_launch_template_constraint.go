...
type CatalogLaunchTemplateConstraintConfig struct {
	// The language code.
	AcceptLanguage any
...
type CatalogLaunchTemplateConstraintAttrs struct {
	// The language code.
	AcceptLanguage any
	// The description of the constraint.
	Description any
...
var CatalogLaunchTemplateConstraint = ubx.ResourceBinding{
