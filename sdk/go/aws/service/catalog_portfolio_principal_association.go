...
type CatalogPortfolioPrincipalAssociationConfig struct {
	// The language code.
	AcceptLanguage any
...
type CatalogPortfolioPrincipalAssociationAttrs struct {
	// The language code.
	AcceptLanguage any
	// The portfolio identifier.
	PortfolioId any
...
var CatalogPortfolioPrincipalAssociation = ubx.ResourceBinding{
