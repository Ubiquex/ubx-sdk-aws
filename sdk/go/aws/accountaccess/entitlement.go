...
type Entitlement_Entitlement_PrincipalRole_Principal_IdentityCenter struct {
	// The ID of the group
	GroupId any
	// The ID of the user
	UserId any
...
type Entitlement_Entitlement_PrincipalRole_Principal struct {
...
type Entitlement_Entitlement_PrincipalRole struct {
	// The AWS account ID
	Account any
