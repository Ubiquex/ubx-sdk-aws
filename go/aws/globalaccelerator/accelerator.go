...
type Accelerator_Attributes struct {
	FlowLogsEnabled any
	FlowLogsS3Bucket any
	FlowLogsS3Prefix any
}

type Accelerator_Timeouts struct {
	Create any
	Update any
}

var Accelerator_AttributesFields = ubx.FieldMap{
...
var Accelerator_TimeoutsFields = ubx.FieldMap{
